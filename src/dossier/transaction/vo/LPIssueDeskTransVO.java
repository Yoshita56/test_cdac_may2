...
public class LPIssueDeskTransVO implements TransferObject {
	...
	public String getDossierReqStatus() {
		return dossierReqStatus;
	}
	public void setDossierReqStatus(String dossierReqStatus) {
		this.dossierReqStatus = dossierReqStatus;
	}
	...
	public WebRowSet getWsIssueDetailsExtraItems() {
		return wsIssueDetailsExtraItems;
	}
	public void setWsIssueDetailsExtraItems(WebRowSet wsIssueDetailsExtraItems) {
		this.wsIssueDetailsExtraItems = wsIssueDetailsExtraItems;
	}
