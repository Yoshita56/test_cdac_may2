...
public class DossierSettlementDAO {
	...
	public static void getIssueDtlsList(DossierSettlementVO vo) 
	{
		String err;
		//String strSlNoflg;
		HisDAO        dao = null;
		...
		try 
		{
			...
			System.out.println("<<<------DossierSettlementDAO---pkg_dossier_view.Proc_Emp_Issue_Detail -[ Mode - 1  ]------------>>>");
			
			dao = new HisDAO("mms","global.IssueTransDAO.getStockItemDtlsList(DossierSettlementVO vo)");			
	...
	public static void getStoreList(DossierSettlementVO voObj) {
	...
	public static void getViewStoreList(DossierSettlementVO voObj) 
	{
	...
	public static void getPatinetTypeCmb(DossierSettlementVO voObj) {
	...
	public static void getItemCatDtls(DossierSettlementVO voObj) {
	...
	public static void getDossierDtls(DossierSettlementVO voObj) {
	...
	public static void getDeptDtls(DossierSettlementVO voObj) {
	...
	public static void getItemCatDtls1(DossierSettlementVO voObj) {
	...
	public static void getissuetopatient(DossierSettlementVO vo) 
	{
	...
	public static void getCancelIssueDtls(DossierSettlementVO voObj)
	{
	...
	public static void getIssueDetail(DossierSettlementVO voObj) {
	...
	public static void getIssueDetailTwo(DossierSettlementVO vo) 
	{
	...
	public static void getIssueDtlPopUp(DossierSettlementVO voObj) {
	...
	public static void getRequestDtls(DossierSettlementVO voObj) {

		HisDAO daoObj = null;
		HisDAO daoObj1 = null;
		WebRowSet ws = null;

		String strProcName = "{call Pkg_Dossier_View.proc_pat_dossier_list(?,?,?,?,?)}";
		int nProcIndex = 0;
		...
		try {
			...
			System.out.println("--------------------Pkg_Dossier_View.proc_pat_dossier_list---[ Mode - 1 ]-------------");

			daoObj.setProcInValue(nProcIndex, "modeval", 	"1",1);
			daoObj.setProcInValue(nProcIndex, "cr_no", 		voObj.getStrCrNumber(),2);
			daoObj.setProcInValue(nProcIndex, "hosp_code", 	voObj.getStrHospitalCode(),3);
	...
	public static void getRequestDetails(DossierSettlementVO voObj) {
	...
	public static void getFrequencyDetails(DossierSettlementVO voObj) {
	...
	public static void getDoseDetails(DossierSettlementVO voObj) {
	...
	public static void getDeptDetails(DossierSettlementVO voObj) {
	...
	public static void getUnitDetails(DossierSettlementVO voObj) {
	...
	public static void getPrescribedBy(DossierSettlementVO voObj) {
	...
	public static void getItemDetails(DossierSettlementVO voObj) {
	...
	public static void getUnitCombo(DossierSettlementVO voObj) {
	...
	public static void getStoreGroupList(DossierSettlementVO vo) {
	...
	public static synchronized void insert(DossierSettlementVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	public static synchronized void insertipd(DossierSettlementVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	public static synchronized void inserttemp(DossierSettlementVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	 ...
	 * @param vo
	 */
	public static synchronized void insertWithoutCrNo(DossierSettlementVO vo)
	{
...
//							.append("</b></font></td> ");
	...
	public static void getGenderCombo(DossierSettlementVO voObj) {
	...
	public static void getLFAccountDetails(DossierSettlementVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
	...
	public static void getLFAccountSummary(DossierSettlementVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
	 ...
	 * 
	 * @param DossierSettlementVO	the DossierSettlementVO
	 */
	public static void getPatientDiagDetails(DossierSettlementVO vo)
	{
	 ...
	 * @param DossierSettlementVO	the DossierSettlementVO
	 */
	public static void getIcdList(DossierSettlementVO vo)
	{
	 ...
	 * @param DossierSettlementVO	the DossierSettlementVO
	 */
	public static void getEmpList(DossierSettlementVO vo)
	{
	...
	public static void getBilledItemDtls(DossierSettlementVO vo) 
	{
	...
	public static void save(DossierSettlementVO vo) 
	{
	...
	public static void deleteIssueDtls(DossierSettlementVO vo) 
	{
	...
	public static void getTariffDtls(DossierSettlementVO vo) 
	{
	...
	public static void getOnlineTreatmentDtls(DossierSettlementVO voObj) {
		...
		System.out.println("--DossierSettlementDAO--pkg_mms_view.PROC_HRGT_PATIENT_TREATMENT_DTL_DRUGWISE-[Mode - 3]---");
	...
	public static void getDossierItemDetails(DossierSettlementVO voObj) {

		HisDAO daoObj = null;
		WebRowSet ws = null;

		String strProcName = "{call pkg_dossier_view.proc_pat_dossier_items_list(?,?,?,?,?,?)}";
		int nProcIndex = 0;
		...
		try {
			...
			nProcIndex = daoObj.setProcedure(strProcName);
				...
				daoObj.setProcInValue(nProcIndex, "modeVal",   "1",1);
				daoObj.setProcInValue(nProcIndex, "cr_no",     voObj.getStrReqNo().split("@")[1],2);
				daoObj.setProcInValue(nProcIndex, "req_no",    voObj.getStrReqNo().split("@")[0],3);
				daoObj.setProcInValue(nProcIndex, "hosp_code", strHospcode,4);
				daoObj.setProcOutValue(nProcIndex, "err",      1,5);
				daoObj.setProcOutValue(nProcIndex, "resultset",2,6);
				daoObj.executeProcedureByPosition(nProcIndex);
				...
				ws = daoObj.getWebRowSet(nProcIndex, "resultset");
				//System.out.println("getDossierItemsDtls ::::::: "+ws.size());
            	if (strErr.equals("")) {
	...
	public static void getServiceDetails(DossierSettlementVO voObj) {
	...
	public static void getStoreNameDetails(DossierSettlementVO voObj) {
	...
	public static synchronized void insertDossierSettelment(DossierSettlementVO vo) 
	{
		HisDAO dao = null;
		WebRowSet ws = null;

		String proc_name1 = "{call pkg_dossier_dml.dml_dossier_finalize_dtl(?,?,?,?,? ,?)}";
		
		System.out.println("------------DossierSettlementDAO.insertDossierSettelment()---------------");
		
		System.out.println("------------pkg_dossier_dml.dml_dossier_finalize_dtl--[ Mode - 1 ]----------");
		...
		{				
				...
				dao.setProcInValue(nProcIndex, "req_id",  vo.getStrDossierHlpHidden().split("@")[0],2);//2
				...
				dao.setProcOutValue(nProcIndex,"err", 1,6); // 1 for string return //7
				//dao.executeProcedureByPosition(nProcIndex);
				dao.executeProcedureByPosition(nProcIndex);
		}		
		catch (Exception e) {
	...
	public static synchronized void insertOPDDossier(DossierSettlementVO vo) 
	{
		HisDAO dao = null,dao1 = null;
		WebRowSet ws = null;

		String proc_name1 = "{call pkg_dossier_dml.dmlytyy_dossier_dtl(?,?,?,?,? ,?,?,?,?,? ,?,?,?,?,? ,?,?,?,?,? ,?,?,?,?,? ,?)}";
	...
	public static void getPatientAccountBalance(DossierSettlementVO vo) {
...
public static synchronized void insertDossierOT(DossierSettlementVO vo){
		...
		try{
		    ...
		    oos.writeObject(vo);
		    byte[] DossierSettlementVOAsBytes = baos.toByteArray();
			...
			ps.setObject(5, DossierSettlementVOAsBytes);
			ps.setString(6, "1");
	...
	//Added By Ranjit for Dossier OT Integration
	public static Map getOperationName(DossierSettlementVO voObj) {
	...
	//Added By Ranjit for Dossier OT Integration
	public static String getDossierStatusString(DossierSettlementVO voObj) {
	...
	//Added By Ranjit for Dossier OT Integration
	public static String ajaxGetDossierStatusString(DossierSettlementVO voObj) {
...
//            				dossierStatusString=dossierStatusString+"<tr><td  >"+ws.getString(3)+"</td><td >"+ws.getString(5)+"</td><td >"+ws.getString(6)+"</td></tr>";
	...
	//Added By Ranjit for Dossier OT Integration
	public static void rejectDossier(DossierSettlementVO voObj) {
	...
	//Added By Ranjit for Dossier OT Integration
	public static Map getOTDossierId(DossierSettlementVO voObj) {
	...
	//Added By Ranjit for Dossier OT Integration
	public static Map getRaisedOTDossier(DossierSettlementVO voObj) {
