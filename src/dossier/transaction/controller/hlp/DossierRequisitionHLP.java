...
public class DossierRequisitionHLP {
	

	
	public static String getPatientDtl(DossierRequisitionFB formBean) throws Exception 
	{
    ...
    public static String getIssueRptForDotMatrix(DossierRequisitionFB formBean)throws SQLException, UnsupportedEncodingException
    {	
	    String rptContents = "";
	 ...
	 *             the exception
	 */
	public static String getIssueDtlsInitView(DossierRequisitionFB formBean) throws Exception {
		...
		try 
		{
			...
			sb.append("<tr>");
			if(formBean.getStrMode().equals("6"))
				sb.append("<td width='100%' align='center' colspan='4'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Dossier Settlement Voucher</b></font></td> ");
			else
...
//						.append("</b></font></td> ");
			...
			sb.append("</tr> ");
			  sb.append("<tr> ");	
			   ...
			   sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Consultant Name :</b></font></td> ");
			     sb.append("<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' >").append(formBean.getStrHindiText())
						.append("</font></td> ");
			...
			if(formBean.getStrMode().equals("6"))
			{
				sb.append("<tr> ");	
				   ...
				   sb.append("<td width='25%' align='right'>.</td> ");
				   sb.append("<td width='25%' align='right'>.</td> ");
			     sb.append("<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' size='2'><b>Dossier Settled</font></b></td> ");
			...
			sb.append("<td align='center' width='42%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Drug Name</b></font> ");
			sb.append("</td>");
			...
			if (ws != null && ws.size() > 0) 
			{
				...
				while (ws.next()) 
				{
					...
					sb.append("<td align='left' width='42%'><font face='Verdana, Arial, Helvetica, sans-serif' size='1' >");
...
//					String FinaltotalCost = formatter.format(new BigDecimal(totalCost)); 					
					...
					if(formBean.getStrMode().equals("6"))
						...
						sb.append("<td colspan='5' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Approx. Dossier Cost (Rs.)</b></font></td>");
				...
				//s	myFormatter.format(Double.parseDouble(FinaltotalCost)));				
					...
					sb.append("</tr>");	
						...
						sb.append("<tr>");
						sb.append("<td colspan='4' align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Delivery Location/Other Remarks : </b></font>"+rem+"</td>");
						//sb.append("<td colspan='2' align='left'>"+rem+"</td>");	
						
						if(formBean.getStrMode().equals("6"))
						{
							sb.append("<td colspan='3' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Setteled By : </b></font> "+user.split("-")[0]+"</td>");
						}
						else
						{	
...
//						sb.append("</tr> ");						
			...
			else 
			{
				...
				sb.append("<tr> ");
				sb.append("<td colspan='7' align='center'><font face='Verdana, Arial, Helvetica, sans-serif' ><br/><b>Details Not Available</b><br/><br/></font></td> ");
				sb.append("</tr> ");
	 ...
	 public static String getIssuePopUp(String strHospCode,String strStoreId,String strIssueNo)throws IOException 
	 {
		 ...
		 DossierRequisitionVO vo = new DossierRequisitionVO();
		 DossierRequisitionBO bo = new DossierRequisitionBO();
	...
	//		DossierRequisitionBO bo = null;
			DossierRequisitionVO vo = null;
	...
	//		String strUnitValues = "";
		...
		//		bo = new DossierRequisitionBO();
				vo = new DossierRequisitionVO();
...
//								}
	 ...
	 public static String getBilledItemDtls(DossierRequisitionVO vo)throws SQLException 
		{
			StringBuffer br = new StringBuffer();
	 ...
	 public static String getOnlineTreatmentDtls(WebRowSet ws , DossierRequisitionFB formBean) throws Exception
		{ 
				...
				/*	str.append("<td width='10%' class='LABEL' style='text-align:center'>Aval Qty</td>");
				  ...
				  /*  
				    ...
				    str.append("<input type='hidden' name='itemCalcValue' id='itemCalcValue1-"
						...
						String strDefaultRate1=ws.getString(24);
						...
						str.append("</td><td width='8%' class='multiControl'>");
						str.append(strAvalqty);
						
						str.append("</td><td width='8%' class='multiControl'><div id=strDefaultRateDiv1-"+i+"> ");
						str.append(strDefaultRate);
						str.append("</div></td>");
						
						str.append("<input name='strAvalqty' id=strAvalqty1-"+i+" value="+strAvalqty+" class='txtFldMin' type='hidden'>");
						str.append("<input name='strRateDefault' id='strRate1-"+i+" value="+strDefaultRate+" class='txtFldMin' type='hidden'>");
						...
						*/
						...
						//if(Integer.parseInt(strReqqty) < Integer.parseInt(strAvalqty))
						//{
						str.append("<td WIDTH='8%' CLASS='multiControl' ><input type='text' autocomplete='off' maxlength='15' onkeypress='return validateData(event,5);' id='strQtyText1-"+i+"' onblur='QtyValidation(\"1-" + i + "\");'  name='strQtyText2' class='txtFldMin' value="+strReqqty+" disabled> </td>");
						//}else{
...
public static String getOnlineTreatmentDtlsopd(WebRowSet ws , DossierRequisitionFB formBean) throws Exception
{ 
 StringBuffer str = new StringBuffer("");
 int i=1;
 int count = 0;
		...
		/*	str.append("<td width='10%' class='LABEL' style='text-align:center'>Aval Qty</td>");
		  ...
		  /*  
		    ...
		    str.append("<input type='hidden' name='itemCalcValue' id='itemCalcValue1-"
				...
				str.append(DossierRequisitionHLP.getValue(RateValue, i));
