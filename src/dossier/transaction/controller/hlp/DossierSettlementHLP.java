...
public class DossierSettlementHLP {
	

	
	public static String getPatientDtl(DossierSettlementFB formBean) throws Exception 
	{
    ...
    public static String getIssueRptForDotMatrix(DossierSettlementFB formBean)throws SQLException, UnsupportedEncodingException
    {	
	    String rptContents = "";
	 ...
	 *             the exception
	 */
	public static String getIssueDtlsInitView(DossierSettlementFB formBean) throws Exception {
...
//			sb.append("This is Testing Slip");
			...
			*/
			...
			sb.append("<tr>");
			sb.append("<td width='100%' align='center' colspan='4'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Dossier Issue Request Voucher</b></font></td> ");
			sb.append("</tr><tr><td width='100%' align='center' colspan='4'>.</td> ");
			sb.append("<td width='100%' align='center' colspan='4'>.</td> ");
			sb.append("</tr>");
...
//						.append("</b></font></td> ");
			...
			sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Issue Request No:</b></font></td> ");
...
//						.append("</b></font></td> ");
			...
			sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Raising Department:</b></font></td> ");
		     sb.append("<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' >").append(formBean.getStrDepartment())
					.append("</font></td> ");
			...
			/*sb.append("<td width='25%' colspan='2' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Dossier Name :</b></font></td> ");
		     sb.append("<td width='75%' ><font face='Verdana, Arial, Helvetica, sans-serif' >").append(formBean.getStrDossierName())
					.append("</font></td> ");*/
		   
	    	/* sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' >Service Type</font></td> ");
	    	 sb.append("<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' "+formBean.getStrServiceName()+"></font></td> ");*/
			...
			sb.append("</td>");						
			sb.append("<td align='center' width='50%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Drug Name</b></font> ");
			sb.append("</td>");
			if(formBean.getStrPatientType().equals("2"))
			{
			...
			sb.append("</td> ");*/
			sb.append("<td align='right' width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Request Qty</b></font>");
			sb.append("</td> ");
			sb.append("<td align='right' width='10%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Brought By Patient</b></font>");
			sb.append("</td> ");
    		sb.append("<td align='right'  width='15%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Rate/Unit</b></font>");
		sb.append("</td> ");
		...
		sb.append("</td> ");
			...
			if (ws != null && ws.size() > 0) 
			{
				...
				while (ws.next()) 
				{
					...
					sb.append("</font></td> ");
					if(formBean.getStrPatientType().equalsIgnoreCase("2"))
					{
					...
					sb.append("</font></td> ");*/
					sb.append("<td style=\"text-align:right;\" width='5%'><font face='Verdana, Arial, Helvetica, sans-serif' >");
...
//					String FinaltotalCost = formatter.format(new BigDecimal(totalCost)); 					
					...
					sb.append("<tr>");
					sb.append("<td colspan='6' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Approx. Dossier Cost (Rs.)</b></font></td>");
...
//						sb.append("</tr> ");
						...
						sb.append("<tr>");
						sb.append("<td colspan='3' align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Delivery Location/Other Remarks : </b></font>"+rem+"</td>");
						//sb.append("<td colspan='2' align='left'>"+rem+"</td>");					
						sb.append("<td colspan='3' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Raised By : </b></font> "+user.split("-")[0]+"</td>");
						//sb.append("<td colspan='3' align='left'>"+user.split("-")[0]+"</td>");					
						sb.append("</tr>");
...
//								}
	 ...
	 public static String getRequestDtls(WebRowSet wb)
		{ 
			...
			try{
				...
				//br.append("<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px'>");
				//br.append("<tr><td class='TITLE' colspan='5'>Issued Dossier(s)</td></tr>");
				//br.append("</table> ");
				...
				br.append("<td width='25%' class='multiLabel'>Dossier Name</td>");
				br.append("<td width='20%' class='multiLabel'>Req No(Date)</td>");
				br.append("<td width='20%' class='multiLabel'>Issue By</td>");
				br.append("<td width='20%' class='multiLabel'>Settlement Status</td>");
				br.append("<tr></table> ");
				br.append("<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px' bgcolor='#6097BC'>");
		                 ...
		                 while (wb.next())
		                    {
								...
								String strReqDate                = wb.getString(4);
								String strIssueByStore           = wb.getString(5);
		                    	...
		                    	br.append("<TR>");
		                    	if(i==0 )
		                    		br.append("<TD WIDTH='10%' CLASS='multiControl'><input type='radio' name='strRadioOnlineReqVal' id = 'strRadioOnlineReqVal' value="+ strRadioOnlineReqVal + " onclick='getRequestItemDetail(this);'  ></TD>");
		                    	else
		                    		br.append("<TD WIDTH='10%' CLASS='multiControl'><input type='radio' name='strRadioOnlineReqVal' id = 'strRadioOnlineReqVal' value="+ strRadioOnlineReqVal + " onclick='getRequestItemDetail(this);' ></TD>");
		    				    br.append("<TD WIDTH='25%' CLASS='multiControl'>"+ strOnlineDept + "</TD>");
		    				    br.append("<TD WIDTH='20%' CLASS='multiControl'>"+ strReqDate + "</TD>");
		    				    br.append("<TD WIDTH='20%' CLASS='multiControl'>"+ strIssueByStore + "</TD>");
	 ...
	 public static String getBilledItemDtls(DossierSettlementVO vo)throws SQLException 
		{
			StringBuffer br = new StringBuffer();
	 ...
	 public static String getOnlineTreatmentDtls(WebRowSet ws , DossierSettlementFB formBean) throws Exception
		{ 
		 ...
		 WebRowSet ws1 =null;
		 Double strTotalAmt=0.00;
		 	//voObj.setStrValue1(formBean.getStrCrNo());
			//voObj.setStrValue2(formBean.getStrHospitalCode());
			//System.out.println("strStoreId"+formBean.getStrStoreId().split("\\^")[0]);
		//	voObj.setStrValue3("10201102");
		 try{	
			 				
				System.out.println("ws:: HLp"+ws.size());
				if (ws != null && ws.size() > 0)
				{			
					str.append("<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px' bgcolor=''>");
					str.append("<tr id=''>");
					str.append("<input type='hidden' name='strHideItemHlp' id='strHideItemHlp'  value='1' />");
					str.append("<td width='45%' class='multiLabel' style='text-align:center'>Item Name</td>");
					str.append("<td width='15%' class='multiLabel' style='text-align:center'>Issue Qty</td>");
					str.append("<td width='15%' class='multiLabel' style='text-align:center'>Batch</td>");
					str.append("<td width='15%' class='multiLabel' style='text-align:center'>Rate/Unit</td>");
					str.append("<td width='15%' class='multiLabel' style='text-align:center'>Cost.</td>");
					str.append("</tr>");
					
				    while (ws.next()) 
				    {   
						String strdrugName = ws.getString(1);
						String strReqqty =  ws.getString(2);
						String strBatchNo =  ws.getString(3);
						String rate=ws.getString(4);
						String strCost=ws.getString(5);
						
						if (strdrugName == null)
							strdrugName = "----";
						/*str.append("<input type='hidden' name='strAvalqtyHlp' id='strAvalqtyHlp"
								+ i + "' value='" + strAvalqty + "' />");
						str.append("<input type='hidden' name='strReqqtyHlp' id='strReqqtyHlp"
								+ i + "' value='" + strReqqty + "' />");*/
						
						//String strDossierHlpHidden =ws.getString(1)+"^"+ws.getString(2)+"^"+ws.getString(3)+"^"+ws.getString(4)+"^"+ws.getString(5)+"^"+ws.getString(6)+"^"+ws.getString(7)+"^"+ws.getString(8)+"^"+ws.getString(9)+"^"+ws.getString(10)+"^"+ws.getString(11)+"^"+ws.getString(12)+"^"+ws.getString(13)+"^"+ws.getString(14)+"^"+ws.getString(15)+"^"+ws.getString(16)+"^"+ws.getString(17)+"^"+ws.getString(18)+"^"+ws.getString(19)+"^"+ws.getString(20)+"^"+ws.getString(21)+"^"+ws.getString(22)+"^"+ws.getString(23)+"^"+ws.getString(24);
						str.append("<input name='strDossierHlpHidden' id='strDossierHlpHidden' value='"+formBean.getStrRequestNo()+"' class='txtFldMin' type='hidden'>");
						str.append("<tr>");
						/*str.append("<td width='5%' class='multiControl'>  ");
						str.append(counts);*/
						str.append("<td width='45%' class='multiControl' style=\"text-align:left;\">  ");
						str.append(strdrugName);
						str.append("</td>");
						str.append("<td width='15%' class='multiControl'>  ");
						...
						str.append("</tr>");
						i++;
						strTotalAmt=strTotalAmt+Double.parseDouble(strCost);
					}
				   // str.append("<input type='hidden' name='strCountLength' id='strCountLength' value='" + count + "' />");
				    str.append("<input name='strtotalHidden' id='strtotalHidden'  value="+strTotalAmt+" class='txtFldMin' type='hidden'>");
				    str.append("<tr><td class='LABEL' colspan='4'><font color='red'>Total Cost </font></td>");
				    str.append("<td class='LABEL' colspan='0'><font color='red'><div id='strtotalDiv'>Rs. "+HisUtil.getAmountWithDecimal(strTotalAmt, 2)+"</div></font></td></tr>");
				    str.append("</table>");
					str.append("</div>");
				...
				{
					str.append("<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px' bgcolor='#6097BC'>");
					str.append("<tr><td class='multiControl' colspan='8'><font color='red'>No record Found</font></td></tr></table>");
				} 
			}
			catch (Exception e) 
			{  e.printStackTrace();
...
public static String getOnlineTreatmentDtlsopd(WebRowSet ws , DossierSettlementFB formBean) throws Exception
{ 
 StringBuffer str = new StringBuffer("");
 int i=1;
 int count = 0;
 ...
 try{	
		...
		str.append("<tr id=''>");
		str.append("<input type='hidden' name='strHideItemHlp' id='strHideItemHlp'  value='1' />");
			/*str.append("<td width='5%' class='LABEL' style='text-align:center'>S No.</td>");*/
			str.append("<td width='23%' class='LABEL' style='text-align:center'>Item Name</td>");
			str.append("<td width='4%' class='LABEL' style='text-align:center'>Item Type</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Category</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Is Brought By Patient</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Batch No.</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Avl Qty</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Rate/Unit</td>");
			//str.append("<td width='8%' class='LABEL' style='text-align:center'>Cost/Unit</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Quantity</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Cost.</td>");
			//str.append("<td width='8%' class='LABEL' style='text-align:center'>Cost</td>");
			/*str.append("<td width='4%' class='LABEL' style='text-align:center'>-</td>");*/
		/*	str.append("<td width='10%' class='LABEL' style='text-align:center'>Dose/Frequency</td>");
			str.append("<td width='10%' class='LABEL' style='text-align:center'>Start Date/End Date</td>");*/
		/*	str.append("<td width='10%' class='LABEL' style='text-align:center'>Aval Qty</td>");
			str.append("<td width='15%' class='LABEL' style='text-align:center'>Batch No</td>");*/
			/*str.append("<td width='10%' class='LABEL' style='text-align:center'>Req Qty</td>");
			//str.append("<td width='10%' class='LABEL' style='text-align:center'>Issue Qty</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Cost</td>");*/
			str.append("</tr>");
		    ...
		    String	itemParamValue="0"; //ws.getString(1);
		  /*  
		    ...
		    str.append("<input type='hidden' name='itemCalcValue' id='itemCalcValue1-"
				...
				String strStartDate = "";
				String strEndDate = "";
				String strAvalqty =ws.getString(20);
				String strItemCatName =ws.getString(22);
				System.out.println("strItemCatName"+strItemCatName);
				String strReqqty =  ws.getString(12);
				String strBatchNo =  "";
				String isBroughtByPat=ws.getString(23);
				
				String strItemType=ws.getString(25);
				String strDefaultRate="0.00";
				String rate=ws.getString(21);
				String RateValue=ws.getString(26);
				String strDefaultRate1=(RateValue.split("#")[0]).split("\\^")[1];
				...
				String strDossierHlpHidden =ws.getString(1)+"^"+ws.getString(2)+"^"+ws.getString(3)+"^"+ws.getString(4)+"^"+ws.getString(5)+"^"+ws.getString(6)+"^"+ws.getString(7)+"^"+ws.getString(8)+"^"+ws.getString(9)+"^"+ws.getString(10)+"^"+ws.getString(11)+"^"+ws.getString(12)+"^"+ws.getString(13)+"^"+ws.getString(14)+"^"+ws.getString(15)+"^"+ws.getString(16)+"^"+ws.getString(17)+"^"+ws.getString(18)+"^"+ws.getString(19)+"^"+ws.getString(20)+"^"+ws.getString(21)+"^"+ws.getString(22)+"^"+ws.getString(23)+"^"+ws.getString(24);
				str.append("<input name='strDossierHlpHidden' id='strDossierHlpHidden-"+i+"' value='"+strDossierHlpHidden+"' class='txtFldMin' type='hidden'>");
				str.append("<tr>");
				/*str.append("<td width='5%' class='multiControl'>  ");
				str.append(counts);*/
				str.append("<td width='23%' class='multiControl'>  ");
				str.append(strdrugName);
				str.append("</td>");
				str.append("<td width='4%' class='multiControl'>  ");
				str.append(strItemType);
				str.append("</td>");
				/*str.append("</td><td width='10%' class='multiControl'>");
				str.append(strDoseName+"/"+strFrequency);
				str.append("</td><td width='10%' class='multiControl'>");
				str.append(strStartDate+"/"+strEndDate</td>);*/
				str.append("<td width='8%' class='multiControl'>");
				str.append(strItemCatName);
				
				str.append("</td><td width='8%' class='multiControl'>");
				if(isBroughtByPat.equalsIgnoreCase("0")){
					strDefaultRate=strDefaultRate1;
					str.append("<input name='strHiddenRate' id=strHiddenRate1-"+i+" value="+strDefaultRate1+" class='txtFldMin' type='hidden'>");
					str.append("<select name='isBroughtByPatient1' id=isBroughtByPatient1-"+i+"  onChange='setNewRate(this ,"+i+");'><option value='0'>No</option><option value='1'>Yes</option></select>");	
				}else{
					strDefaultRate="0.00" ;
					str.append("<input name='strHiddenRate' id=strHiddenRate1-"+i+" value="+strDefaultRate1+" class='txtFldMin' type='hidden'>");
					str.append("<select name='isBroughtByPatient1'  id=isBroughtByPatient1-"+i+" onChange='setNewRate(this,"+i+");'><option value='1'>Yes</option><option value='0'>No</option></select>");
				}
				str.append("</td><td width='8%' class='multiControl'>");
				//str.append("<input name='strAcctualRate' id=strAcctualRate-"+i+" value="+strDefaultRate1+" class='txtFldMin' type='hidden'>");
				str.append(DossierSettlementHLP.getValue(RateValue, i));
				str.append("</td><td width='8%' class='multiControl'><div id=strAcctualAvailDiv1-"+i+">");
				str.append((RateValue.split("#")[0]).split("\\^")[2]);
				
				str.append("</td><td width='8%' class='multiControl'><div id=strDefaultRateDiv1-"+i+"> ");
				str.append((RateValue.split("#")[0]).split("\\^")[1]);
				str.append("</div></td>");
				
				str.append("<input name='strAvalqty' id=strAvalqty1-"+i+" value="+(RateValue.split("#")[0]).split("\\^")[2]+" class='txtFldMin' type='hidden'>");
				str.append("<input name='strRateDefault' id=strRate1-"+i+" value="+(RateValue.split("#")[0]).split("\\^")[1]+" class='txtFldMin' type='hidden'>");
				...
				*/
				...
				/*str.append("</td><td width='8%' class='multiControl'>");
				str.append(strBatchNo.replace("&", "<br>"));*/
				String strAcctrate=(RateValue.split("#")[0]).split("\\^")[2];
				if(Double.parseDouble(strReqqty) < Double.parseDouble(strAcctrate))
				{
				str.append("<td WIDTH='8%' CLASS='multiControl' ><input type='text' autocomplete='off' maxlength='15' onkeypress='return validateData(event,5);' id='strQtyText1-"+i+"' onblur='QtyValidation(\"1-" + i + "\");'  name='strQtyText2' class='txtFldMin' value="+strReqqty+" > </td>");
				}else{
					str.append("<td WIDTH='8%' CLASS='multiControl' ><input type='text' autocomplete='off' maxlength='15' onkeypress='return validateData(event,5);' id='strQtyText1-"+i+"' onblur='QtyValidation(\"1-" + i + "\");'  name='strQtyText2' class='txtFldMin' value='0' > </td>");
				}
				strTotalAmt=strTotalAmt+Double.parseDouble(strReqqty) * Double.parseDouble(strDefaultRate);
				str.append("</td><td WIDTH='8%' CLASS='multiControl' ><div id='strCost1-"+i+"' style='display: block'>"+HisUtil.getAmountWithDecimal(Double.parseDouble(strReqqty) * Double.parseDouble(strDefaultRate),2) +"</div></td>");
				
				str.append("<input name='strTotalHiddenDiv1' id='strTotalHiddenDiv1-"+i+"' value="+HisUtil.getAmountWithDecimal(Double.parseDouble(strReqqty) * Double.parseDouble(strDefaultRate),2)+" class='txtFldMin' type='hidden'>");
				/*str.append("<td width='8%' class='multiControl'>");
				str.append("<input name='strTotalCost' id='strTotalCost1-"+i+"' class='txtFldMin' type='hidden'>");
										str.append("<div id='strQuantityText1-"+i+"' style='display: block'>");
												str.append("<input name='strQtyText1' id='strTotalCostText1-"+i+"' class='txtFldMin' onkeyup='' maxlength='5' readonly='' type='text'>");
														str.append("</div></td>");*/
				...
				str.append("</td><td WIDTH='10%' CLASS='multiControl' ><input type='text' autocomplete='off' maxlength='15' onkeypress='return validateData(event,5);' id='strQtyText1-"+i+"' onblur='QtyValidation(\"1-" + i + "\");'  name='strQtyText' class='txtFldMin' value='' > </td>");
				
				str.append("</td width='10%' class='multiControl'>");
				
				str.append("<td class='multiControl' width='8%'>");
				
				str.append("<input name='strTotalCost' id='strTotalCost1-"+i+"' class='txtFldMin' type='hidden'>");*/
/*						str.append("<div id='strQuantityText1-"+i+"' style='display: block'>");
						str.append("<input name='strTotalCostText' id='strTotalCostText1-"+i+"' class='txtFldMin' onkeyup='' maxlength='5' readonly='' type='text'>");
								str.append("</div></td>");
*/					
		   ...
		   // str.append("<input type='hidden' name='strCountLength' id='strCountLength' value='" + count + "' />");
		    str.append("<input name='strtotalHidden' id='strtotalHidden'  value="+strTotalAmt+" class='txtFldMin' type='hidden'>");
		    str.append("<tr><td class='LABEL' colspan='7'><font color='red'>Total Cost </font></td>");
		    str.append("<td class='LABEL' colspan='0'><font color='red'><div id='strtotalDiv'>Rs. "+HisUtil.getAmountWithDecimal(strTotalAmt, 2)+"</div></font></td></tr>");
		    str.append("</table>");
			str.append("</div>");
		...
		else 
		{
			str.append("<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px' bgcolor='#6097BC'>");
			str.append("<tr>");
			str.append("<td width='23%' class='LABEL' style='text-align:center'>Drug Name</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Category</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Is Brought By Patient</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Batch No.</td>");
			str.append("<td width='8%' class='LABEL' style='text-align:center'>Avl Qty</td>");
...
public static String getValue(String Value , int j)
{
	StringBuffer sb=new StringBuffer();
	sb.append("<select name='strItemBatchRate' id=strItemBatchRate-"+j+"  onChange='setItemBatchRate(this ,"+j+");'>");
	if(Value !=null)
	{
		...
		{
			sb.append("<option value="+temp[i]+">"+temp[i].split("\\^")[0]+"</option>");
		}
		
		
	}else{
		sb.append("<option value='0^0^0^'>Select Value</option>");
	}
	sb.append("</select>");
	return sb.toString();
}
