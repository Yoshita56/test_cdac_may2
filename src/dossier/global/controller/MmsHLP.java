...
public class MmsHLP {
	...
	public static String getSearchItemInitView(MmsFB formBean) throws Exception {
		...
		try {
			...
			sb.append("<td class='CONTROL' width='75%'><div id='GroupIDDiv'><select  ");
		...
		*/	
			...
			sb.append(" <select class='comboMin' name='strSearchLeftOption' onchange='setSelectedIndexValue();' tabindex='1' > ");
					sb.append(" <option value='1' >Name</option> ");
							...
							if(formBean.getStrModeVal().equals("3")){
								...
								sb.append(" <option value='3' >Batch No.</option> ");
							}
			...
			sb.append("<table align='center' cellpadding='1px' cellspacing='1px' style='width:"+strTableWidth+"vw;' > ");
			sb.append("<tr> ");
			...
			if (formBean.getStrModeVal().equals("1")) {
				...
				sb.append("<tr> ");
				sb.append("<td class='LABEL'>Manufacturer ");
				sb.append("</td> ");
				sb
						.append(" <td class='CONTROL' style='color : blue;font-weight:bold'><div id='stockParamManufDivId'></div> ");
				sb.append(" </td> ");
				sb.append(" <td class='LABEL'> Supplier");
				sb.append(" </td> ");
				sb
						.append(" <td class='CONTROL' style='color : blue;font-weight:bold'> <div id='stockParamSuppDivId'></div> ");
				sb.append("</td> ");
				sb.append("</tr> ");
				sb.append("</table> ");
				sb.append("</div>");
				...
				sb.append("</td> ");
				sb
						.append(" <td class='TITLE' colspan='3'>Last Purchase Parameters ");
				sb.append("</td> ");
				sb.append("</tr> ");
				...
				sb.append(" </tr> ");
				sb.append("<tr> ");
				sb.append(" <td class='LABEL'>Issued Quantity ");
				sb.append("</td> ");
				sb
				...
				sb
						.append("<table style='width:"+strTableWidth+"vw;' lign='center' cellpadding='1px' cellspacing='1px'> ");
				sb.append(" <tr> ");
				...
				if (formBean.getStrItemCategoryId().equals("1")) {
					...
					sb.append(" </td> ");
					sb.append(" <td class='LABEL'>Batch No. ");
					sb.append(" </td> ");
					sb
			...
			sb.append("<tr class='FOOTER'> ");
			sb
					.append("<td colspan='5'><font size='2' color='red'>*</font> Mandatory Fields&nbsp;&nbsp;<font size='2' color='black'>*</font>Items with * are Rate Contracted  </td> ");
			sb.append("</tr> ");
			sb.append("</table> ");
...
//				sb.append("</tr> ");
				...
				if (ws != null && ws.size() > 0) 
				{
					...
					while (ws.next()) 
					{
						...
						else 
						{
							...
							sb.append("<input type='text' autocomplete='off' class='txtFldMin' maxlength='7' disabled='disabled' onkeypress='return validateData(event,7);' onkeyup='checkAvailQtyTwo(\""
											+ count
											+ "\",\"strAvailableQty\",\"strAvailableQtyUnit\",\"strStockCostId\");' name='strAvailableQty' id='strAvailableQty"
											+ count + "'>");
				...
				sb.append("<table width='"+ strTableWidth+ "' align='center' cellpadding='1px' cellspacing='1px'> ");
				sb.append("<tr class='FOOTER'> ");
				sb.append("<td colspan='4'><font size='2' color='red'>*</font> Mandatory Fields<font size='2' color='black'>*</font>Items with * are Generic drug/item  </td> ");
				sb.append("</tr> ");
				sb.append("</table> ");
				...
				sb.append("<td class='multiLabel' width='14%'>Batch No. ");
				sb.append("</td> ");
				...
				sb.append("<td class='multiLabel' width='16%'>Batch No. ");
				sb.append("</td> ");
				...
				sb.append("<tr class='FOOTER'> ");
				sb
						.append("<td colspan='4'>['*'] Reserved/Branded Item  <font size='2' color='red'>*</font> Mandatory Fields <font size='2' color='black'>*</font>Items with * are Generic drug/item </td> ");
				sb.append("</tr> ");
				sb.append("</table> ");
	 ...
	 *             the exception
	 */
	public static String getIssueDtlsInitView(MmsFB formBean,String strUCReq) throws Exception {
		...
		String strAdmNo="",strIndentNo="",strIndentDate="",strSupp="",strICD="",strOper="";
		/*
		String str2 = "76.39";
		...
		*/
		...
		//if(formBean.getStrTinNo() != null && !formBean.getStrTinNo().equals("") )
		//	strTinNo = formBean.getStrTinNo();
		...
		try 
		{
			...
			}else
			{
				...
				sb.append("<tr> ");
				sb.append("<td width='8%'>&nbsp;</td> ");
				sb.append("<td width='82%' align='center'> <font face='Verdana, Arial, Helvetica, sans-serif' size='2'><b> ");
				sb.append(res.getString("FULL_TITLE")+" "+ res.getString("CITY"));
				sb.append("</font></b></td> <td width='10%'>&nbsp;</td> ");
				sb.append("</tr> ");
				/*sb.append("<tr> ");
				sb.append("<td width='8%'>&nbsp;</td> ");
			...
			else 
			{
				...
				else
				{
					sb.append("<TABLE ALIGN='CENTER' cellspacing='1px' cellpadding='1px' border='0' WIDTH='")
					.append(strTableWidth)
					.append("'><TR> <td align='center' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Return Voucher</b></font></td></tr></table> ");
			...
			*/
			...
			String strDLNo=formBean.getStrLocDL().split("@")[1];
			String strAddress=formBean.getStrLocDL().split("@")[0];
			
			/*sb.append("<tr> ");
			
			sb.append("<td width='50%' colspan='2'  align='center' ><font face='Verdana, Arial, Helvetica, sans-serif' >").append(strAddress)
					.append("</font></td> ");			

			sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
					util.appendSpace("D.L. No.", 15,0)).append(":</b></font></td> ");
			sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(strDLNo).append(
					"</b></font></td> ");
			sb.append("</tr> ");*/
			...
			{	
				...
				{	
					sb.append("<tr> ");
					sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
							util.appendSpace("Tin No.", 15,0)).append(":</b></font></td> ");
					sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(strTinNo).append(
							"</b></font></td> ");
					
					sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
							util.appendSpace("CR No", 15,0)).append(":</b></font></td> ");
					sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(formBean.getStrCrno()).append(
							"</b></font></td> ");
					
					//sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ></font> Cr No.: </td> ");
					//sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ></font></td> ");
					sb.append("</tr> ");
				...
				sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(formBean.getStrIssueNo())
						.append("</b></font></td> ");
	
				sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
						util.appendSpace("Issue Date", 15,0)).append(":</b></font></td> ");
				sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(strIssueDate).append(
						"</b></font></td> ");
				sb.append("</tr> ");
				...
				if (!formBean.getStrIndentNo().equals("0")) 
				{
					sb.append("<tr> ");
					sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
							util.appendSpace("Indent No.", 15,0)).append(":</b></font></td> ");
					...
					sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
							util.appendSpace("Indent Date", 15,0)).append(	":</b></font></td> ");
					sb.append("<td width='25%'  align='LEFT' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
				...
				if(!formBean.getStrModeVal().equals("3"))
				{
					...
					{
						sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
								util.appendSpace("Bill Receipt No.", 15,0)).append(":</b></font></td> ");
						sb.append("<td width='25%' align='left' colspan='3'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
								formBean.getStrBillNo()).append("</b></font></td> ");
					}
					/*sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
					...
					sb.append("<td width='25%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
							formBean.getStrBudget()).append("</b></font></td> ");*/  // Commented By Adil Wasi
					...
					if(formBean.getStrModeVal().equals("1"))
					{
						...
						sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
								util.appendSpace("Issuing Store", 15,0)).append(":</b></font></td> ");
						sb.append("<td width='25%' align='left' colspan='3'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
								formBean.getStrStoreName()).append("</b></font></td> ");
						
						sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b></b></font></td> ");
						sb.append("<td width='25%' align='left' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b></b></font></td> ");
			...
			else
			{
				...
				sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
						util.appendSpace("Patient Name", 15,0)).append(":</b></font></td> ");
				sb.append("<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
						formBean.getStrIssueTo().split("\\@")[0]).append("</b></font></td> ");
				sb.append("</tr> ");
...
//			}
			...
			if(!formBean.getStrModeVal().equals("5") && !formBean.getStrModeVal().equals("6"))
			{
				if(formBean.getStrModeVal().equals("4"))
					sb.append("<td align='center' width='16%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Issued/Received. Qty</b></font>");
				else
					sb.append("<td align='center' width='9%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Issued Qty</b></font>");
			   sb.append("</td> ");
...
//					}
					...
					sb.append((ws.getString(22).equals("/") || ws.getString(22).equals(""))?ws.getString(7):ws.getString(22));
					sb.append("</font></td> ");
					sb.append("<td align='center' width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' >");
					...
					if(formBean.getStrModeVal().equals("4"))
					{
						sb.append("<td style=\"text-align:center;\" width='16%'><font face='Verdana, Arial, Helvetica, sans-serif' >");
						sb.append(ws.getString(10)+"/"+ws.getString(35));
						sb.append("</font></td> ");
					}
					else
					{	
...
//						}
					...
					if(strUCReq.equals("1"))
					{				
						
						sb1.append("<table align='center' width='825' border='0' cellspacing='4' cellpadding='4'>");
						sb1.append("<tr><td colspan = 4 ><hr size='1'></td></tr>");
							sb1.append("<tr> ");
							
							sb1.append("<td width='25%' align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("RC No. : </b></font></td> ");
							sb1.append("<td width='25%'  align='left' >.</td> ");
				
							sb1.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Date : </b></font></td> ");
							sb1.append("<td width='25%'  align='left' >").append(util.getASDate("dd-MMM-yyyy")).append("</td> ");
							sb1.append("</tr> ");
							sb1.append("</table>");
							...
							sb1.append("<td width='82%' align='center'> <b><font face='Verdana, Arial, Helvetica, sans-serif' size='3'> ");
							sb1.append("<u>UTILITY CERTIFICATE</u>");
							sb1.append("</font></b></td> <td width='10%'>&nbsp;</td> ");
							sb1.append("</tr> ");
							sb1.append("</table>");
							
							sb1.append("<br><br> ");
							sb1.append("<table align='center' width='825' border='0' cellspacing='2' cellpadding='2'>");
							sb1.append("<tr> ");
							sb1.append("<td width='75%' colspan=3 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("1.  Item detail : </b>").append(strGenName).append("</font></td> ");
							//sb1.append("<td width='25%'  align='LEFT' >").append(strItemName).append("</td> ");
							sb1.append("<td width='25%' colspan=1 align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Quantity Used : </b>").append(strIssueQty).append("</font></td> ");
							//sb1.append("<td width='25%'  align='LEFT' >").append(strIssueQty).append("</td> ");
							sb1.append("</tr> ");
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Name : </b>").append(strItemName).append("</font></td> ");
							//sb1.append("<td width='75%' colspan=3 align='LEFT' ></td> ");
							sb1.append("</tr> ");

							sb1.append("<tr> ");
							sb1.append("<td width='100%' align='left' colspan=4 ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Item Description : </b></font></td> ");
							//sb1.append("<td width='75%' colspan=3 align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("2. Supplied by : </b>").append(strSupp).append("</font></td> ");
							//sb1.append("<td width='75%' colspan=3 align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='50%' colspan=2 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("3. Indent No. : </b>").append(strIndentNo).append("</font></td> ");
							//sb1.append("<td width='25%'  align='LEFT' ></td> ");
							sb1.append("<td width='50%' align='right' colspan=2 ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Date : </b>").append(strIndentDate).append("</font></td> ");
							//sb1.append("<td width='25%'  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='50%' colspan=2 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("4. Patient's Name : </b>").append(formBean.getStrIssueTo().split("\\@")[0]).append("</font></td> ");
							//sb1.append("<td width='25%'  align='LEFT' ></td> ");
							sb1.append("<td width='50%' colspan=2 align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("5. IP No. : </b>").append(strAdmNo).append("</font></td> ");
							//sb1.append("<td width='25%'  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("6. Diagnosis : </b>").append(strICD).append("</font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("7. Date of Implantation/Procedure/(Operation) : </b>").append(strOper).append("</font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("8. Case Sheet Billing Particulars : Amount Rs. \n (Mention Handling Charges separately)</b> ").append(strItemTotCost).append("</font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("9. Operating/Implanting Doctor : ").append("</b></font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							sb1.append("</table>");
							...
							sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0'>");
							sb1.append("<tr> ");
							sb1.append("<td width='50%' colspan=2 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Signature of Operating/Implanting Doctor  ").append("</b></font></td> ");
							sb1.append("<td width='50%' colspan=2 align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Signature of Head of the Unit  ").append("</b></font></td> ");
							sb1.append("</tr> ");
							sb1.append("</table>");
							...
							sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0'>");
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Note : Please send separate Utility Certificates if two or more items used, along with D.C. and Indent").append("</b></font></td> ");
							sb1.append("</tr> ");
						sb1.append("</table>");
						
						sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0' height='69'> ");
							sb1.append("<tr><td width='8%'>&nbsp;</td> ");
							sb1.append("<td width='82%' align='center'> <b><font face='Verdana, Arial, Helvetica, sans-serif' size='2'> ");
							sb1.append("<u>TO BE FILLED IN BY A.F.C. (BILLING)</u>");
							sb1.append("</font></b></td> <td width='10%'>&nbsp;</td> ");
							sb1.append("</tr> ");
						sb1.append("</table> ");
						
						sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0'>"); 
							sb1.append("<tr><td> This is to certify that amount of Rs.<b> ").append(strItemTotCost).append(" </b>is billed for the patient <b>").append(formBean.getStrIssueTo()).append(" </b>IP No. <b>").append(strAdmNo).append(" </b></td></tr>");
						sb1.append("</table>");
						sb1.append("<br><br><br>");
						sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0'>");
							sb1.append("<tr> ");
							...
							sb1.append("<td width='50%' colspan=2 align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Signature of A.F.C. (Billing)").append("</b></font></td> ");
							sb1.append("</tr> ");
						sb1.append("</table>");
						...
						sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0' height='69'> ");
							sb1.append("<tr><td width='8%'>&nbsp;</td> ");
							sb1.append("<td width='82%' align='center'> <b><font face='Verdana, Arial, Helvetica, sans-serif' size='2'> ");
							sb1.append("<u>TO BE FILLED IN BY THE STORES</u>");
							sb1.append("</font></b></td> <td width='10%'>&nbsp;</td> ");
							sb1.append("</tr> ");
						sb1.append("</table> ");
						...
						sb1.append("<table align='center' width='825' border='0' cellspacing='2' cellpadding='2'>");
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("10. Particulars of Stores entry \n Stock book details :").append("</b></font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Page No. : ").append("</b></font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4  align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("11. DC No. and Supply date : ").append("</b></font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"11. Whether the supply is made by the supplier Rate Contract, if so the S.I. No. of Rate Contract Schedule : ").append("</b></font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");
							
							sb1.append("<tr> ");
							sb1.append("<td width='100%' colspan=4 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"12. If purchased from other source details of approval for supply and procurement of link file and date  : ").append("</b></font></td> ");
							//sb1.append("<td width='75%' colspan=3  align='LEFT' ></td> ");
							sb1.append("</tr> ");	
							sb1.append("</table>");
							...
							sb1.append("<tr> ");
							sb1.append("<td width='50%' colspan=2 align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Clerk").append("</b></font></td> ");
							sb1.append("<td width='50%' colspan=2 align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Office Supdt.(Stores) ").append("</b></font></td> ");
							sb1.append("</tr> ");
							
						sb1.append("</table>");
						sb1.append("<br><br> ");
						sb1.append("<table align='center' width='825' border='0' cellspacing='0' cellpadding='0'>");
							sb1.append("<tr><td> Approved for release of payment Rs. <b>").append(strItemTotCost).append(" </b> (in Words <b>").append(util.getAmountStr(strItemTotCost)).append("</b>)</td></tr>");
						sb1.append("</table>");
						sb1.append("<br><br> ");
						sb1.append("<br><br> ");
						sb1.append("<table  align='center' width='825' border='0' cellspacing='0' cellpadding='0'>"); 
							sb1.append("<tr> ");
							sb1.append("<td width='33%'  align='left'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"A.M.S (Stores)").append("</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td> ");
							sb1.append("<td width='33%'  align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"AFD/DFC(F&A)").append("</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> ");
							sb1.append("<td width='33%'  align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append(
									"Medical Supdt.").append("</b></font></td> ");
							sb1.append("</tr> ");
						sb1.append("</table>");
				...
				{	
					...
					sb.append("<tr>");
					sb.append("<td colspan='6' align='center'><font face='Verdana, Arial, Helvetica, sans-serif' ><div align='right'><b>TOTAL</b></div></font></td>");
				...
				if (formBean.getStrModeVal().equals("4")) 
				{
					...
					sb.append("<tr> "); 
					sb.append("<td colspan='1' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><br><br><br><br><b>Remarks:<br><b></font></td>");
				...
				else 
				{
					...
					if(!formBean.getStrModeVal().equals("5") && !formBean.getStrModeVal().equals("6"))
					{
						...
						{	
					        ...
					        sb.append("<tr> "); 
							sb.append("<td colspan='1' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Recd. By:</font></td>");
							sb.append("<td colspan='7' align='left'><font face='Verdana, Arial, Helvetica, sans-serif'>");							
							sb.append(strRecivedBy.trim());									
							sb.append("</font></td>");
					        sb.append("</tr> ");   							
					        sb.append("<tr> "); 
							sb.append("<td colspan='1' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Remarks:<b></font></td>");
							sb.append("<td colspan='7' align='left'><font face='Verdana, Arial, Helvetica, sans-serif'>");
					        ...
					        sb.append("</tr> ");      
					        //sb.append("<tr> ");
							//sb.append("<td colspan='8' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><br><b>[ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;"+formBean.getStrStoreName()+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td> ");
							//sb.append("</tr> ");
							//sb.append("<tr> ");
					...
					else
					{
						...
						sb.append("<tr> ");
						sb
								.append("<td colspan='8' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><br><br><br><br><b>Return By<br><b> "+formBean.getStrIssueTo().split("\\@")[1]+"</font></td> ");
						sb.append("</tr> ");
			...
			if(formBean.getStrLPRequestNo() != null && !formBean.getStrLPRequestNo().equals("0"))
			{
				sb.append("<tr> ");
				sb.append("<td colspan='8' align='Left'><font face='Verdana, Arial, Helvetica, sans-serif' ><br/><b>Partially Issued with LP Request No. : "+formBean.getStrLPRequestNo() +".</b><br/><br/></font></td> ");
				sb.append("</tr> ");
			}
			
			sb.append("<tr> ");
			sb
					.append("<td colspan='8' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><br/><b>Signature :  </b></font></td> ");
			sb.append("</tr> ");
			if(formBean.getStrModeVal().equals("1"))
			{
			sb.append("<tr> ");
			sb
					.append("<td colspan='8' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><br/><b>"+formBean.getStrUserName() +" </b></font></td> ");
			sb.append("</tr> ");
			}
			sb.append("</table><div id='id1'></div><div id='id2'></div>");
	...
	public static String getFreeAndPartItemDtlsView(MmsFB formBean,
		...
		try {
			...
			sb.append("</td> ");
			sb.append("<td class='multiLabel' width='25%'>Batch No. ");
			sb.append("</td> ");
	...
	public static String getFreeOrPartItemInitView(MmsFB formBean,
		...
		try {
			...
			if (formBean.getStrIsBatchReq().equals("1")) {
				...
				sb.append("<font color='red'>*</font>Batch No.");
				sb
	...
	public static String getNewItemAddDetails(MmsFB formBean,
		...
		if(formBean.getStrNewItemFlag().trim().equals("2")){
			...
			sb
					.append("<td class='CONTROL' colspan='2' ><input type='hidden' name='strDefaultUnitId' value='"+MmsConfigUtil.UNIT_ID+"' ><input type='text' class='txtFldMax' maxlength='100' name='strNewItemName' onkeypress='return validateData(event,4);' ></td> ");
			sb.append("</tr> ");
		...
		sb.append("<tr class='FOOTER'> ");
		sb
				.append(" <td colspan='4'><font size='2' color='red'>*</font> Mandatory Fields <font size='2' color='black'>*</font>Items with * are Generic drug/item  </td> ");
		sb.append("</tr> ");
		sb.append("</table> ");
