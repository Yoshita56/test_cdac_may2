...
//			
//			//development - CDAC
//			con = DriverManager.getConnection("jdbc:edb://10.226.2.98:5444/hmis_aiims_patna", "hmisaiimsp", "hmisaiimsp");
//			
...
//			con = dataSource.getConnection();
			...
			//onsite DB
			//con = DriverManager.getConnection("jdbc:edb://10.0.1.38:5444/hmis_aiimsp", "aiimspatna", "aiimspatna");
			
			//onsite DB - new
//			con = DriverManager.getConnection("jdbc:edb://10.0.1.46:5444/hmis_aiimsp", "aiimspatna", "aiimspatna");
...
//			}
	...
	public static String getDateYYYYMMDD(){
		...
		int monthNumber  = now.get(Calendar.MONTH)+1;
		String monthInString=String.valueOf(monthNumber);
		if (monthInString.length()==1){
			monthInString="0"+monthInString;
		}
		
		int dateNumber  = now.get(Calendar.DATE);
		String dateInString=String.valueOf(dateNumber);
		if (dateInString.length()==1){
			dateInString="0"+dateInString;
		}
		return yearInString+monthInString+dateInString;
	}
