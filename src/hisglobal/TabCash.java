...
public  class TabCash extends TagSupport
{
	...
	public int doStartTag()//throws JspTagException
	{
		try
		{
			...
			/*	str += "<div class='multisteps-form'>\n";
				str += "<div class='row'>";
				str += "<div class='col-12'>";
				str += "<div class='multisteps-form__progress'>";*/
				
				str += "<div class='container-fluid' style=\"margin-bottom:20px\">";
				str += "<ul class='nav nav-tabs'>";

				/*
				 * str += " <li class='nav-item'>"; str +=
				 * "<a class='nav-link disabled' href='#'>Disabled</a>"; str += "</li> ";
				 */
...
// round rupee icon
			//		if(pagename.equals("ONLINE") || pagename.equals("OFFLINE"))
			//			label+="&nbsp;<i  class=\"fas fa-rupee-sign roundIcon\"></i>";
			//		if(pagename.equals("PATWALLET"))
			//			label+="&nbsp;<i class=\"fas fa-wallet roundIcon\"></i>";
					
//image instead of icon
					
							if(pagename.equals("ONLINE") )
								label+="&nbsp;<img src='../../hisglobal/images/cOnline.png'  class='roundIcon' style='height:1.8rem;width:1.8rem'>";
							if( pagename.equals("OFFLINE"))
								label+="&nbsp;<img src='../../hisglobal/images/cOffline.png' class='roundIcon' style='height:1.8rem;width:1.8rem'>";
							if(pagename.equals("PATWALLET"))
								label+="&nbsp;<i class='fas fa-wallet roundIcon'></i>";
					...
					else
					{
					    ...
					    str += " <li class='nav-item'>";
					    str += " <a onClick='onClickTab(\"" + pagename + "\");' onKeyPress='onEnterTab(event,\"" + pagename +"\")' class='nav-link' href='#'>" + label + "</a>";
					      str += " </li>";
						
						/*
						 * str += "	<button class='multisteps-form__progress-btn '  " ; str +=
						 * "		onClick=\"onClickTab('" + pagename +
						 * "');\" onKeyPress=\"onEnterTab(event,'" + pagename + "')\" "; str +=
						 * "		 "; str += "		>\n"; str += "		  &nbsp;" + label +
						 * "</button>\n";
						 */
