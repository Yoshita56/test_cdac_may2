...
public class PatientDtlHLP 
{
	...
	public static String patientDtl_RJ_OLD_unuse(String strCrNo, boolean fAddress) throws Exception 
	{
		...
		try 
		{
			System.out.println("------PATIENT_DTL------- pkg_simple_view.PROC_HRGT_PATIENT_DTL [ Mode - 1 ] -------------");
	...
	public static String patientDtl(String strCrNo, boolean fAddress) throws Exception 
	{
		...
		{
			boObj.getPatientDetails(voObj);
			System.out.println("-------PatientDtlHLP.patientDtl()-----pkg_simple_view.PROC_HRGT_PATIENT_DTL [ Mode - 1 ]---------");
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strPatientName);sb.append("</div>");
					sb.append("<div class='col-md-2'>Patient Category");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strCategoryName);					sb.append("<input type='hidden' name='strCatgoryCode' value='"+ strCategoryCode + "'><input type='hidden' name='strCatGrp' value='"+ catGrp + "'><input type='hidden' name='strVisitType' value='"+ visitType + "'><input type='hidden' name='strEpisodeCode' value='"+ episodeCode + "'>");
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Age/Gender");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strAgeAndSex);sb.append("</div>");
					sb.append("</div>");
					
					sb.append("<div class='row rowFlex reFlex'>");
					sb.append("<div class='col-md-2 px-4'>Father Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strFatherOrHusbandName);sb.append("</div>");
					sb.append("<div class='col-md-2'>Spouse Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strSpouseName);sb.append("</div>");
					...
					if (id[4].equals("1")) 
					{
						...
						sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strMlcNo);sb.append("</div>");
						sb.append("</div>");
					...
					if (fAddress) 
					{
						...
						sb.append("<div class='col-md-8' style='font-weight: 400;word-wrap:break-word;'>");
						sb.append(strAddress);
						sb.append("</div>");
						sb.append("</div>");
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					sb.append("</div>");
					sb.append("<div class='col-sm-2' style='font-weight: 400;word-wrap:break-word;'>");
					sb.append(strPatientName);
					sb.append("</div>");
					...
					sb.append("</div>");
					sb.append("<div class='col-sm-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strSpouseName);sb.append("</div>");
	...
	public static String admissionDtl(String strCrNo, String strHospitalCode) throws Exception 
	{
		...
		try 
		{
			boObj.getAdmissionDetails(voObj);
			 System.out.println("------PatientDtlHLP.admissionDtl()------pkg_ipd_view.PROC_HIPT_PATADMISSION_DTL [ Mode - 1 ]---------");
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strAdmissionNo);sb.append("</div>");
					sb.append("<div class='col-md-2'>Adm Date/Time");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strAdmissionDate);
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Dept / Unit");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strDeptName).append(" / ").append(strUnitName);sb.append("</div>");
					sb.append("</div>");
					
					sb.append("<div class='row rowFlex reFlex'>");
					sb.append("<div class='col-md-2 px-4'>Ward / Room / Bed");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;''>");sb.append(strWardName).append(" / ").append(strRoomName).append(" / ").append(strBedName);sb.append("</div>");
					sb.append("<div class='col-md-2'>Treatment Category");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strTreatmentCategoryName);
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Consultant Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strConsultantName);sb.append("</div>");
					sb.append("</div>");
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					sb.append("<div class='col-sm-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strAdmissionNo);sb.append("</div>");
					sb.append("<div class='col-sm-2'>Adm Date/Time");sb.append("</div>");
					sb.append("<div class='col-sm-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strAdmissionDate);
					sb.append("<div class='col-sm-2'>");sb.append("</div>");
					sb.append("</div>");
					sb.append("</div>");
					sb.append("<div class='row rowFlex reFlex'>");
					...
					sb.append("<div class='col-sm-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strDeptName).append(" / ").append(strUnitName);sb.append("</div>");
					
					
					
					sb.append("<div class='col-sm-2'>Ward / Room / Bed");sb.append("</div>");
					sb.append("<div class='col-sm-4' style='font-weight: 400;word-wrap:break-word;''>");sb.append(strWardName).append(" / ").append(strRoomName).append(" / ").append(strBedName);sb.append("</div>");
					...
					sb.append("<div class='col-sm-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strTreatmentCategoryName);
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Consultant Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight: 400;word-wrap:break-word;'>");sb.append(strConsultantName);sb.append("</div>");
					sb.append("</div>");
	...
	public static String admissionDtlRequestForLP_RJ_OLD_unuse(String strCrNo, String strHospitalCode,String balanceAmount,String AccountNo,String patType)
			throws Exception {
	...
	public static String admissionDtlRequestForLP(String strCrNo, String strHospitalCode,String balanceAmount,String AccountNo,String patType)
		...
		try {
			...
			if (ws != null && ws.size() > 0) {
				if (ws.next()) {
					...
					if (strMLCNo == null)
					  ...
					  sb.append("<div class='row' align='left'>");
					  sb.append("<div class='col-sm-3'>Adm No</div>");
					  sb.append("<div class='col-sm-3'>");
					  sb.append(strAdmissionNo);
					  sb.append("</div>");
					  sb.append("<div class='col-sm-3'>Adm Date/Time</div>");
					  sb.append("<div class='col-sm-3'>");
					  sb.append(strAdmissionDate);
					  sb.append("</div></div>");
					  ...
					  sb.append("<div class='row' align='left'>");
					  sb.append("<div class='col-sm-3'>Dept / Unit</div>");
					  sb.append("<div class='col-sm-3'>");
					  sb.append(strDeptName).append(" / ").append(strUnitName);
					  sb.append("</div>");
					  sb.append("<div class='col-sm-3'>Ward / Room / Bed</div>");
					  sb.append("<div class='col-sm-3'>");
					  sb.append(strWardName).append(" / ").append(strRoomName).append(" / ").append(strBedName);
					  sb.append("</div></div>");
					
					  sb.append("<div class='row' align='left'>");
					  sb.append("<div class='col-sm-3'>Treatment Category</div>");
					  sb.append("<div class='col-sm-3'>");
					  sb.append(strTreatmentCategoryName);
					  sb.append("</div>");
					  sb.append("<div class='col-sm-3'>Consultant Name</div>");
					  sb.append("<div class='col-sm-3'>");
					  sb.append(strConsultantName);
					  sb.append("</div></div>");
					...
					{
						  sb.append("<div class='row' align='left'>");
						  sb.append("<div class='col-sm-3'>Account Balance</div>");
						  sb.append("<div class='col-sm-3'>");
						  sb.append(balanceAmount);
						  sb.append("</div>");
						...
						/*
						 * sb.append("<tr>"); sb.append("<td width='25%' class='LABEL'>");
						 * sb.append("Account Balance"); sb.append("</td>");
						 * sb.append("<td width='25%' class='CONTROL'>"); sb.append(balanceAmount);
						 * sb.append("</td>"); sb.append("<td width='25%' class='LABEL'>");
						 * sb.append("</td>"); sb.append("<td width='25%' class='CONTROL'>");
					...
					/*
					 * sb.append("<tr>");
					 * sb.append("<input type='hidden' name='strAdmissionDtlHidVal' value='"+
					 * strHiddenValue + "'>");
					 * sb.append("<input type='hidden' name='strBalanceAmount' value='"+
					 * balanceAmount + "'>");
					 * sb.append("<input type='hidden' name='strPatAccountNo' value='"+ AccountNo +
					 * "'><input type='hidden' name='strPtType' value='0'>"); sb.append("</td>");
					 * sb.append("</tr>");
					 * 
					 * sb.append("</table>");
					 */
			...
			{
				sb.append("<div class='table' align='center'>");
				sb.append("<tr><td width='100%' align='center'><input type='hidden' name='strPtType' value='1'> ");
				sb.append("<font color='red' size='3'>Patient is not Admitted/dead/gone for final bill settlement</font>");
				sb.append("</td></tr></div>");
				 ...
				 * ); sb.
				 * append("<tr><td width='100%' align='center'><input type='hidden' name='strPtType' value='1'> "
				 * ); sb.
				 * append("<font color='red' size='3'>Patient is not Admitted/dead/gone for final bill settlement</font>"
				 * ); sb.append("</td></tr></table>");
				 */
			}
	...
	public static String patientWithAdmissionDtlRequestForLP(String strCrNo,
		...
		try {
			...
			throw new Exception("PatientDtlHLP-->patientWithAdmissionDtlRequestForLP-->"
					+ e.getMessage());
		}

		return sb.toString();
	}
	public static String patientWithAdmissionDtlRequestForLP_OLD(String strCrNo,
			String strHospitalCode,String balanceAmount,String AccountNo, boolean fAddress,String patType) throws Exception {

		StringBuffer sb = new StringBuffer("");

		try {
			sb.append(PatientDtlHLP.patientDtl_RJ_OLD_unuse(strCrNo, fAddress));
			if(patType.equals("1") || !AccountNo.equals(""))
				sb.append(PatientDtlHLP.admissionDtlRequestForLP_RJ_OLD_unuse(strCrNo, strHospitalCode,balanceAmount,AccountNo,patType));
			else
				sb.append("<table><tr><td><input type='hidden' name='strPtType' value='0'></td></tr></table>");
		} catch (Exception e) {
			throw new Exception("PatientDtlHLP-->patientWithAdmissionDtlRequestForLP_OLD-->"
					+ e.getMessage());
		}
	...
	//added by shalini on 12-Jan-2014 for patient treatment detail in indent desk
			...
			//	voObj.setStrValue2(strHospitalCode);
				...
				//	ws = voObj.getTreatmentDetailWs();
					...
					if (ws != null && ws.size() > 0)
					{
						str.append("<table class='' width='100%' align='center' cellpadding='1px' cellspacing='1px'>");
						str.append("<tr>");
					    ...
					    while (ws.next()) 
					    {
							...
							{
								str.append("<tr>");								
								str.append("<td width='45%' class='' style='font-weight:350 !important ;font-size: 16px !important;text-align:left' >  ");
								...
								str.append("</td>");
								str.append("<td width='18%' class=''>");
								if(itemParamValue.equals("-"))
								{									
									str.append("<input type='text' class='form-control' disabled='true'  name='strReqQty' value='"+0+"'>");
								}
								else
								{										
								    str.append("<input type='text' class='form-control' autocomplete='off'  name='strReqQty' value='"+strReqQty+"'>");
								}
								str.append("</td>");
								/*
								...
								*/
								str.append("<td width='17%' class=''>");
								str.append("<select class='browser-default custom-select' name=strUnitName ><option value='6301^1.000^0'>"+ strUnit + "</option></select>");								
								str.append("<input type='hidden' name = 'strUnitName' id= 'strUnitName' value = '6301^1.000^0'>");
								str.append("</td>");
