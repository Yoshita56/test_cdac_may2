...
public class dateforadviceTag extends TagSupport
{
	/**
	 * 
	 */
	...
	public int doEndTag() throws JspTagException
		{
			...
			try{					
					...
					pageContext.getOut().write("<input size='9%' type=\"text\" name=\""+getName()+"\" id=\""+getId()+"\" readonly=\""+getReadOnly()+"\" value='"+getValue()+"' onChange='"+getJsFunc()+"'> "+
					"	<img src=\"/INVMGM/hisglobal/images/imgDatepicker.png\" id=\""+getId()+"1\" style=\"cursor: pointer; border: 1px solid red;\"  "+
					"	title=\"Date selector\"  "+
