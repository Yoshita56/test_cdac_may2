...
public class OnLineReqDiscountDtlNew implements Tag {
		...
		try 
		{
			...
			//{
				if (wb != null && wb.size() > 0) 
				{
					...
					{
						// rowSize = wb.size();
						sb.append("<p class='subHeaders'><img alt=\"\" src=\"../../hisglobal/images/request.png\" style=\";width: 3%\">&nbsp;OnLine Requests<p>");
						sb.append("<table class='table'> ");
						sb.append("<input type='hidden' name='tmpMsg' value="+tmp+">");
						
						sb.append("<thead>");
						sb.append("<tr><th>#</th>");
						sb.append("<th>Request No.</th>");
						sb.append("<th>Request Date</th>");
						sb.append("<th>Dept/Ward</th>");
						sb.append("<th>Hospital Service</th>");
						sb.append("<th>Request Type</th></tr>");
						sb.append("</thead>");
						sb.append("<tbody>");
						...
						for (int i = 0; wb.next(); i++) 
						{
							...
							if (i == 0) 
							{
								sb.append("<tr><td><label class='container'><input type='radio' checked name='strChk_values' id='strChk_values' value=\""+strChk+"\" onclick='groupCheck(this,"+i+");'><span class='checkmark'></span></label></td>");
							} 
							else 
							{
								sb.append("<tr><td><label class='container'><input type='radio' name='strChk_values' id='strChk_values' value=\""+strChk+"\" onclick='groupCheck(this,"+i+");'><span class='checkmark'></span></label></td>");
							}
							sb.append("<td><label class='labelcaps'>"+strReqNo+"</label></td>");
							sb.append("<td><label class='labelcaps'>"+strReqDate+"</label></td>");
							sb.append("<td><label class='labelcaps'>"+strName+"</label></td>");
							sb.append("<td><label class='labelcaps'>"+strHospitalService+"</label></td>");
							sb.append("<td><label class='CustomFont labelcaps'>"+strReqType+"</label></td></tr>");
				...
				{					
					...
					sb.append("<tr><td colspan='6' width='5%' class='multiControl'><div class='alert alert-danger'>NO ONLINE REQUESTS FOUND!....</div></td>");
