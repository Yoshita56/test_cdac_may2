...
public  class TabsNew extends TagSupport
{
	...
	public int doStartTag()//throws JspTagException
	{
		try
		{
			...
			if(tabList!=null)
			{
				...
				/*str += "<nav>";
				str += "<ol class='cd-breadcrumb triangle'>";*/
				...
				while(it.hasNext())
				{
					...
					{
						str += " <button class=\"multisteps-form__progress-btn js-active\" disabled>";
						str += "<div class='blinking'>" + label + "</div>";
						str += "</button>";
					...
					else
					{
						...
						str += "	<button class='multisteps-form__progress-btn '  " ;
