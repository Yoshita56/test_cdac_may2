 ...
 */
public class CashCollectionOfflineTransDATA
{
	...
	public static boolean init(HttpServletRequest request, CashCollectionOfflineTransFB formBean)
	{
		...
		try
		{
			...
			CashCollectionOfflineTransDATA.initOffLineDetails(formBean, bo, voObj);
	...
	public static boolean initAdvancedCash(HttpServletRequest request, CashCollectionOfflineTransFB formBean)
	{
		...
		try
		{
			...
			CashCollectionOfflineTransDATA.initAdvancedOffLineDetails(formBean, bo, voObj);
	...
	public static void initOffLineDetails(CashCollectionOfflineTransFB formBean, CashCollectionOfflineTransBO bo,CashCollectionOfflineTransVO voObj)
	{
		...
		try
		{
			...
			if(formBean.getStrOffLineBillingService().equals("13"))
			{
				...
				strPackageDtls = CashCollectionOfflineTransHLP.getOffLinePackageAppDetailsView(voObj,selectedTreatmentCat);
			...
			if (bo.isPartPaymentorAdvanceExist(voObj))
			{
				...
				if (voObj.getStrOffLineBillingService().equals("19"))
				{
					strPartOrAdvanceDtls = CashCollectionOfflineTransHLP.getOffLineAdvanceDetailsView(voObj);
				} 
				else
				{
					strPartOrAdvanceDtls = CashCollectionOfflineTransHLP.getOffLinePartPaymentDetailsView(voObj);
				}
		...
		try
		{
			...
			if (bo.isPartPaymentorAdvanceExist(voObj))
			{
				...
				if (voObj.getStrOffLineBillingService().equals("19"))
				{
					...
					temp = CashCollectionOfflineTransHLP.getOffLineAdvanceDetailsView(voObj);
				} else
				{
	...
	public static void getClientDetails(HttpServletRequest request, HttpServletResponse response)
	{
		...
		try
		{
			...
			temp = temp + CashCollectionOfflineTransHLP.getOffLineOtherDetailsView(voObj);
	...
	public static boolean insertOfflineReceiptPartPayment(CashCollectionOfflineTransFB formBean,HttpServletRequest request)
	{
		...
		try
		{
			hisUtil = new HisUtil("Billing", "CashCollectionOfflineTransDATA");
			bo = new CashCollectionOfflineTransBO();
			...
			{
				/*
				 * String smsMsg="You Paid Rs. "+formBean.getStrOfflineTotalRecAmount()
				 * +" for IPD Account Recharge Against Receipt No. "+formBean.getStrBillNo()+
				 * "/1"; voObj.setStrMobileNo(formBean.getStrMobileNo());
				 * System.out.println("formBean.getStrMobileNo()"+formBean.getStrMobileNo());
				 */
				String smsMsg="Dear "+formBean.getStrPatientDtlHidVal().replace("^","#").split("#")[7]  +", Payment of Rs. "+formBean.getStrOfflineTotalRecAmount()+" Received Against Bill No. "+formBean.getStrBillNo()+ "/1 on "+hisUtil.getDSDate("")+" "+hisUtil.getDSDate("hh:mi:ss:AM")+". AIIMS Mangalagiri";
	...
	public static boolean insertOfflineReceiptPackage(CashCollectionOfflineTransFB formBean,HttpServletRequest request)
	{
		...
		} catch (Exception e)
		{
			...
			HisException eObj = new HisException("Billing Transaction",
					"CashCollectionTransDATA.insertOfflineReceiptPackage()-->", e.getMessage());
	...
	public static void setPackageAmountValues( CashCollectionOfflineTransFB formBean, HttpServletRequest request,
		...
		try {
			...
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction",
					"CashCollectionTransDATA->setPackageAmountValues()", strmsgText);
	...
	public static void getAdvanceDtls(CashCollectionOfflineTransFB formBean,		
		...
		try{		
			...
			e.printStackTrace();		
			HisException eObj = new HisException("Billing Transaction","CashCollectionTransDATA.insertOfflineReceiptPackage()-->", e.getMessage());		
			formBean.setStrErrMsg("Application Error [ERROR ID : " + eObj.getErrorID() + "],Contact System Administrator! ");		
			eObj = null;		
		}		
	...
	public static void getPaymentModeListByPatCategory(CashCollectionOfflineTransFB formBean,HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
			String strmsgText = e.getMessage();
			new HisException("Billing", "CashCollectionTransDATA->getPaymentModeListByPatCategory()", strmsgText);
