...
public class NewConsLedgerRptFB extends ActionForm{
...
private static final long serialVersionUID = 02L;
	...
	private String strYearVal;	//new edition	//different variable for combo box 
	// write the same name for getters and setters else 'property' can't recognise if var and method names aren't same
	private String strMonth;

	public String getStrYearVal() {		// write the same name for getters and setters else 'property' can't recognise if var and method names aren't same
		return strYearVal;
	}

	public void setStrYearVal(String strYearVal) {		// write the same name for getters and setters else 'property' can't recognise if var and method names aren't same
		this.strYearVal = strYearVal;
	}
