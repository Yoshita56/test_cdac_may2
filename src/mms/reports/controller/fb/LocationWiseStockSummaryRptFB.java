/**********************************************************
 Project:	   DWH_ANDHRA	
 File:         LocationWiseStockSummaryRptFB.java
 Created:      Jul 3, 2014
...
/**
 * The Class LocationWiseStockSummaryRptFB.
 */
public class LocationWiseStockSummaryRptFB extends ActionForm {
	...
	/** The str drug class name. */
	private String strDrugClassName = "";

	/** The str drug class code. */
	...
	/** The str drug classification val. */
	...
	private String strStockStatusName = "";
	
	private String strCatgCombo="";
	
	private String strCatgId="10";
	...
	/**
	 * Gets the str drug classification val.
	 * 
	 * @return the str drug classification val
	 */
	...
	/**
	 * Sets the str drug classification val.
	 * 
	 * @param strDrugClassVal
	 *            the new str drug classification val
	 */
	...
	/**
	 * Gets the str drug class name.
	 * 
	 * @return the str drug class name
	 */
	...
	/**
	 * Sets the str drug class name.
	 * 
	 * @param strDrugClassName
	 *            the new str drug class name
	 */
	...
	/**
	 * Gets the str drug class code.
	 * 
	 * @return the str drug class code
	 */
	...
	/**
	 * Sets the str drug class code.
	 * 
	 * @param strDrugClassCode
	 *            the new str drug class code
	 */
	...
	public String getStrStockStatusName() {
		return strStockStatusName;
	}

	public void setStrStockStatusName(String strStockStatusName) {
		this.strStockStatusName = strStockStatusName;
	}
