...
public class IssueReceiveLedgerRptFB extends ActionForm {
	...
	public String getStrFYCombo() {
		return strFYCombo;
	}

	public void setStrFYCombo(String strFYCombo) {
		this.strFYCombo = strFYCombo;
	}
