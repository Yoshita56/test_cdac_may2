...
public class StoreHierarchyViewFB extends ActionForm {
	...
	private String strStoreHie="";
	
	
	public String getStrStoreHie() {
		return strStoreHie;
	}

	public void setStrStoreHie(String strStoreHie) {
		this.strStoreHie = strStoreHie;
	}
