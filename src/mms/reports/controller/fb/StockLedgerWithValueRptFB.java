 ...
 */
public class StockLedgerWithValueRptFB extends ActionForm {
	...
	private String strFTD = "";
	private String strFTDValues = "";
	
	public String getStrFTD() {
		return strFTD;
	}

	public void setStrFTD(String strFTD) {
		this.strFTD = strFTD;
	}

	public String getStrFTDValues() {
		return strFTDValues;
	}

	public void setStrFTDValues(String strFTDValues) {
		this.strFTDValues = strFTDValues;
	}
