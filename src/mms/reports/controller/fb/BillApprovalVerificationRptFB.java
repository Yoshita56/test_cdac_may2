...
public class BillApprovalVerificationRptFB extends ActionForm {
	...
	public void setPONoCmbWS(WebRowSet pONoCmbWS) {
		PONoCmbWS = pONoCmbWS;
	}
	...
	public String getStrPoNoName() {
		return strPoNoName;
	}
	public void setStrPoNoName(String strPoNoName) {
		this.strPoNoName = strPoNoName;
	}
	...
	public String getStrPoNoCombo() {
		return strPoNoCombo;
	}
	public void setStrPoNoCombo(String strPoNoCombo) {
		this.strPoNoCombo = strPoNoCombo;
	}
	...
	public String getStrPatCatVal() {
		return strPatCatVal;
	}
	public void setStrPatCatVal(String strPatCatVal) {
		this.strPatCatVal = strPatCatVal;
	}
