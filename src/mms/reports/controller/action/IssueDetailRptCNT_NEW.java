...
import mms.reports.controller.data.IssueDetailRptData_NEW;
 ...
 * 
 */
public class IssueDetailRptCNT_NEW extends DispatchAction {
//
	/*
	 * (non-Javadoc)
	 * 
	...
	public ActionForward INITDETAIL(ActionMapping mapping, ActionForm form,
		...
		String target = "index";
		IssueDetailRptFB_NEW formBean = (IssueDetailRptFB_NEW) form;
		IssueDetailRptData_NEW.setInitDtl(formBean, request);
	...
	public ActionForward ITEMCATEGORYCOMBO(ActionMapping mapping,
		...
		IssueDetailRptFB_NEW formBean = (IssueDetailRptFB_NEW) form;
		IssueDetailRptData_NEW.setItemCategComboDtl(formBean, request, response);
		return null;
	...
	public ActionForward DRUGNAMECOMBO(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB_NEW formBean = (IssueDetailRptFB_NEW) form;
		IssueDetailRptData_NEW.setDrugNameCombo(formBean, request, response);
		return null;
	...
	public ActionForward EXISTINGBATCH(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB_NEW formBean = (IssueDetailRptFB_NEW) form;
		IssueDetailRptData_NEW.getExistingBatchList(formBean, request, response);
		return null;
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptData_NEW.showReport(formBean, request, response);
	...
	public void SHOWRPT1(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB_NEW formBean = (IssueDetailRptFB_NEW) form;
		formBean.setStrHospCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		IssueDetailRptData_NEW.showReport1(formBean, request, response);
	...
	public void SHOWRPTNEW(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB_NEW formBean = (IssueDetailRptFB_NEW) form;
		formBean.setStrHospCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		IssueDetailRptData_NEW.showReportNew(formBean, request, response);
