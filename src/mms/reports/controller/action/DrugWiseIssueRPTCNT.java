...
import mms.reports.controller.data.DrugWiseIssueRPTDATA;
import mms.reports.controller.fb.DrugWiseIssueRPTFB;

public class DrugWiseIssueRPTCNT extends CSRFGardTokenAction {
...
String strtarget = "";
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		DrugWiseIssueRPTFB formBean = (DrugWiseIssueRPTFB)form;
		DrugWiseIssueRPTDATA.initialGenAdd(formBean,request);
...
//		String target = "LocalPurchase";
	...
	public ActionForward LPITEMNAME(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
			...
			DrugWiseIssueRPTFB formBean = (DrugWiseIssueRPTFB)form;
			DrugWiseIssueRPTDATA.lpitemName(formBean, request, response);
			return null;
	}
	...
	public ActionForward GOVIEWPAGE(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
	{
		...
		DrugWiseIssueRPTFB fb = (DrugWiseIssueRPTFB) form;
		DrugWiseIssueRPTDATA.getViewDtl(fb, request, response);
		return null;
	}	
}
