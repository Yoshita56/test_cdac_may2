...
import mms.reports.controller.data.IssueAgainstIndentRptDATA;
import mms.reports.controller.fb.IssueAgainstIndentRptFB;

public class IssueAgainstIndentRptCNT extends CSRFGardTokenAction {
...
String strtarget = "";
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		IssueAgainstIndentRptFB formBean = (IssueAgainstIndentRptFB)form;
		IssueAgainstIndentRptDATA.initialGenAdd(formBean,request);
	...
	public ActionForward LPITEMNAME(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
			...
			IssueAgainstIndentRptFB formBean = (IssueAgainstIndentRptFB)form;
			IssueAgainstIndentRptDATA.lpitemName(formBean, request, response);
			return null;
	}
	...
	public ActionForward GOVIEWPAGE(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
	{
		...
		IssueAgainstIndentRptFB fb = (IssueAgainstIndentRptFB) form;
		IssueAgainstIndentRptDATA.getViewDtl(fb, request, response);
		return null;
	}	
}
