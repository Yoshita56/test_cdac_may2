...
import mms.reports.controller.data.MiscItemListingRptData_NEW;
import mms.reports.controller.fb.MiscItemListingRptFB_NEW;


	public class MiscItemListingRptCNT_NEW extends DispatchAction {
	...
	public ActionForward INITDETAIL(ActionMapping mapping, ActionForm form,
		...
		String target = "index";
		MiscItemListingRptFB_NEW formBean = (MiscItemListingRptFB_NEW) form;
		MiscItemListingRptData_NEW.setInitDtl(formBean, request);
	...
	public ActionForward ITEMCATEGORYCOMBO(ActionMapping mapping,
		...
		MiscItemListingRptFB_NEW formBean = (MiscItemListingRptFB_NEW) form;
		MiscItemListingRptData_NEW.setItemCategComboDtl(formBean, request, response);
		return null;
	...
	public ActionForward GROUPNAME(ActionMapping mapping, ActionForm form,
		...
		MiscItemListingRptFB_NEW formBean = (MiscItemListingRptFB_NEW)form;
		MiscItemListingRptData_NEW.groupName(formBean, request, response);
			return null;
	...
	public ActionForward DRUGNAMECOMBO(ActionMapping mapping, ActionForm form,
		...
		MiscItemListingRptFB_NEW formBean = (MiscItemListingRptFB_NEW) form;
		MiscItemListingRptData_NEW.setDrugNameCombo(formBean, request, response);
		return null;
	...
	public ActionForward EXISTINGBATCH(ActionMapping mapping, ActionForm form,
		...
		MiscItemListingRptFB_NEW formBean = (MiscItemListingRptFB_NEW) form;
		MiscItemListingRptData_NEW.getExistingBatchList(formBean, request, response);
		return null;
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		MiscItemListingRptData_NEW.showReportNew(formBean, request, response);
	...
	public void SHOWRPT1(ActionMapping mapping, ActionForm form,
		...
		MiscItemListingRptFB_NEW formBean = (MiscItemListingRptFB_NEW) form;
		formBean.setStrHospCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		MiscItemListingRptData_NEW.showReport1(formBean, request, response);
