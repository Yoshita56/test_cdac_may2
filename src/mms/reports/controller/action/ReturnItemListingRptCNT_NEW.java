...
import mms.reports.controller.data.ReturnItemListingRptData_NEW;
 ...
 * 
 */
public class ReturnItemListingRptCNT_NEW extends DispatchAction {
//
	/*
	 * (non-Javadoc)
	 * 
	...
	public ActionForward INITDETAIL(ActionMapping mapping, ActionForm form,
		...
		ReturnItemListingRptData_NEW.setInitDtl(formBean, request, response);
	...
	public ActionForward ITEMCATEGORYCOMBO(ActionMapping mapping,
		...
		ReturnItemListingRptFB_NEW formBean = (ReturnItemListingRptFB_NEW) form;
		ReturnItemListingRptData_NEW.setItemCategComboDtl(formBean, request, response);
		return null;
	...
	public ActionForward DRUGNAMECOMBO(ActionMapping mapping, ActionForm form,
		...
		ReturnItemListingRptFB_NEW formBean = (ReturnItemListingRptFB_NEW) form;
		ReturnItemListingRptData_NEW.setDrugNameCombo(formBean, request, response);
		return null;
	...
	public ActionForward EXISTINGBATCH(ActionMapping mapping, ActionForm form,
		...
		ReturnItemListingRptFB_NEW formBean = (ReturnItemListingRptFB_NEW) form;
		ReturnItemListingRptData_NEW.getExistingBatchList(formBean, request, response);
		return null;
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		ReturnItemListingRptData_NEW.showReportNew(formBean, request, response);
