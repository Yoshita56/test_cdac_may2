...
import mms.reports.controller.hlp.AcknowledgeReceiptPORptHLP;
import mms.reports.vo.AcknowledgeReceiptPORptVO;
import mms.reports.bo.AcknowledgeReceiptPORptBO;

public class AcknowledgeReceiptPORptDATA {

	public static void initialGenAdd(AcknowledgeReceiptPORptFB formBean,
			HttpServletRequest request) {
		AcknowledgeReceiptPORptVO vo = null;
		AcknowledgeReceiptPORptBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new AcknowledgeReceiptPORptVO();
			bo = new AcknowledgeReceiptPORptBO();
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(AcknowledgeReceiptPORptFB formBean,HttpServletRequest request, HttpServletResponse response) {
		AcknowledgeReceiptPORptVO vo=null;
		AcknowledgeReceiptPORptBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(AcknowledgeReceiptPORptFB _AcknowledgeReceiptPORptFB,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   AcknowledgeReceiptPORptVO vo = null;
		   AcknowledgeReceiptPORptBO bo = null;
		   ...
		   try{
			    ...
			    String strResult=AcknowledgeReceiptPORptHLP.getLPMRNDetails(vo);
			   ...
			   strmsgText = _err.getMessage();
				...
				_AcknowledgeReceiptPORptFB.setStrErrMsg("ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
				//_AcknowledgeReceiptPORptFB.setStrMsgType("1");
				eObj = null;
		   }	   
	}
}
