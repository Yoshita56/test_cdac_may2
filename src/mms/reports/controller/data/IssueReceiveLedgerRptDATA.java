...
import mms.reports.bo.IssueReceiveLedgerRptBO;
import mms.reports.controller.fb.IssueReceiveLedgerRptFB;
import mms.reports.controller.hlp.IssueReceiveLedgerRptHLP;
import mms.reports.vo.IssueReceiveLedgerRptVO;

public class IssueReceiveLedgerRptDATA 
{
	 ...
	 */
	public static void getDistrictList(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) 
	{

		IssueReceiveLedgerRptBO bo = null;
		IssueReceiveLedgerRptVO voObj = null;
		String strmsgText = null;
		HisUtil util = null;
		try {

			bo = new IssueReceiveLedgerRptBO();
			voObj = new IssueReceiveLedgerRptVO();
			...
			util = new HisUtil("MMS Reports", "IssueReceiveLedgerRptDATA");
			/* util = new HisUtil("MMS Reports", "IssueReceiveLedgerRptDATA"); */
			...
			e.printStackTrace();
			strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getDistrictList --> "
					+ e.getMessage();
			/*
			 * strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getDistrictList --> " +
			 * e.getMessage();
			...
			HisException eObj = new HisException("mms",
					"IssueReceiveLedgerRptDATA->getDistrictList()", strmsgText);
	 ...
	 */
	public static void getStoreCombo(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getStoreCombo --> "
					+ e.getMessage();
			/*
			 * strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getStoreCombo --> " +
			 * e.getMessage();
			 */
			HisException eObj = new HisException("mms",
					"IssueReceiveLedgerRptDATA->getStoreCombo()", strmsgText);
			/*
			 * HisException eObj = new HisException("mms",
			 * "IssueReceiveLedgerRptDATA->getStoreCombo()", strmsgText);
			 */
	 ...
	 */
	public static void getStoreTypeList(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			e.printStackTrace();
			strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getStoreTypeList --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueReceiveLedgerRptDATA->getStoreTypeList()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "
					+ eObj.getErrorID() + "],Contact System Administrator! ");
	 ...
	 */
	public static void getSubStoreCombo(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getItemCatList(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			e.printStackTrace();
			strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getItemCatList --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueReceiveLedgerRptDATA->getItemCatList()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "
					+ eObj.getErrorID() + "],Contact System Administrator! ");
	 ...
	 */
	public static void getGroupList(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			e.printStackTrace();
			strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getGroupList --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueReceiveLedgerRptDATA->getGroupList()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "
					+ eObj.getErrorID() + "],Contact System Administrator! ");
	 ...
	 */
	public static void getDrugList(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			e.printStackTrace();
			strmsgText = "mms.reports.IssueReceiveLedgerRptDATA.getDrugList --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueReceiveLedgerRptDATA->getDrugList()", strmsgText);
			try {
				response.setHeader("Cache-Control", "no-cache");
	...
	public static void getDrugList1(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getProgrammeCombo(IssueReceiveLedgerRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void showRpt(IssueReceiveLedgerRptFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException 
	{
		...
		IssueReceiveLedgerRptBO bo = null;
		IssueReceiveLedgerRptVO vo = null;		
		HisUtil util = null;	
		try 
		{
			util = new HisUtil("MMS Reports", "IssueReceiveLedgerRptDATA");
			bo = new IssueReceiveLedgerRptBO();
			vo = new IssueReceiveLedgerRptVO();
			...
			System.out.println("------------ IssueReceiveLedgerRptDATA . showReport_NEW -----------------");
			...
			System.out.println("strReportTypeId [1 - Date Wise , 2 - Month Wise]----------"+formBean.getStrReportTypeId());
			System.out.println("StrReportMonthId----------"+formBean.getStrReportMonthId());
			System.out.println("StrSelectedDate----------"+formBean.getStrSelectedDate());
			System.out.println("-----------------------------");
			...
			vo.setStrReportMonthId(formBean.getStrReportMonthId());
			vo.setStrSelectedDate(formBean.getStrSelectedDate());
			vo.setStrItemCatgName(formBean.getStrItemCatgName());
			...
			String strIndentItemList = IssueReceiveLedgerRptHLP.prinRpt(vo, strReportName , request,formBean);				
