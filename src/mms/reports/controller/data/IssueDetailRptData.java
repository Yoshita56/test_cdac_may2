...
public class IssueDetailRptData {
	...
	public static void showReportNEW(IssueDetailRptFB formBean,HttpServletRequest request, HttpServletResponse response) 
	{
		ReportUtil ts = new ReportUtil();		
		String reportFormat = "html";
		IssueDetailRptVO vo =null;
		...
		{	
			...
			if (vo.getStrMsgType().equals("1")) 
			{
				...
				{
					String strResult = "";
					strResult=IssueDetailRptHLP.generateReport(vo); 
