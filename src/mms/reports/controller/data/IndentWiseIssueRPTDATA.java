...
import mms.reports.bo.IndentWiseIssueRPTBO;
import mms.reports.controller.fb.IndentWiseIssueRPTFB;
import mms.reports.controller.hlp.IndentWiseIssueRPTHLP;
import mms.reports.vo.IndentWiseIssueRPTVO;

public class IndentWiseIssueRPTDATA {

	public static void initialGenAdd(IndentWiseIssueRPTFB formBean,HttpServletRequest request) {
		IndentWiseIssueRPTVO vo = null;
		IndentWiseIssueRPTBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new IndentWiseIssueRPTVO();
			bo = new IndentWiseIssueRPTBO();
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(IndentWiseIssueRPTFB formBean,HttpServletRequest request, HttpServletResponse response) {
		IndentWiseIssueRPTVO vo=null;
		IndentWiseIssueRPTBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(IndentWiseIssueRPTFB _LocalPurchaseMRN_FB,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   IndentWiseIssueRPTVO vo = null;
		   IndentWiseIssueRPTBO bo = null;
		   ...
		   try
		   {
			    ...
			    vo=new IndentWiseIssueRPTVO();
			   	...
			   	System.out.println("--------- IndentWiseIssueRPTCNT . getViewDtl ----------");
				...
				strResult=IndentWiseIssueRPTHLP.getTransferDetails(vo);
