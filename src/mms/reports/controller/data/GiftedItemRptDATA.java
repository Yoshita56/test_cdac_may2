...
import mms.reports.bo.GiftedItemRptBO;
import mms.reports.controller.fb.GiftedItemRptFB;
import mms.reports.controller.hlp.GiftedItemRptHLP;
import mms.reports.vo.GiftedItemRptvo;

public class GiftedItemRptDATA {

	public static void initialGenAdd(GiftedItemRptFB formBean,
			HttpServletRequest request) {
		GiftedItemRptvo vo = null;
		GiftedItemRptBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new GiftedItemRptvo();
			bo = new GiftedItemRptBO();
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(GiftedItemRptFB formBean,HttpServletRequest request, HttpServletResponse response) {
		GiftedItemRptvo vo=null;
		GiftedItemRptBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(GiftedItemRptFB _GiftedItemRptFB,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   GiftedItemRptvo vo = null;
		   GiftedItemRptBO bo = null;
		   ...
		   try{
			    ...
			    String strResult=GiftedItemRptHLP.getLPMRNDetails(vo);
			   ...
			   strmsgText = _err.getMessage();
				...
				_GiftedItemRptFB.setStrErrMsg("ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
				//_GiftedItemRptFB.setStrMsgType("1");
				eObj = null;
		   }	   
	}
}
