...
import mms.reports.bo.DrugStockRPTBO;
import mms.reports.controller.fb.DrugStockRPTFB;
import mms.reports.controller.hlp.DrugStockRPTHLP;
import mms.reports.vo.DrugStockRPTVO;

public class DrugStockRPTDATA {

	public static void initialGenAdd(DrugStockRPTFB formBean,HttpServletRequest request) {
		DrugStockRPTVO vo = null;
		DrugStockRPTBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new DrugStockRPTVO();
			bo = new DrugStockRPTBO();
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(DrugStockRPTFB formBean,HttpServletRequest request, HttpServletResponse response) {
		DrugStockRPTVO vo=null;
		DrugStockRPTBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(DrugStockRPTFB formBean,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   DrugStockRPTVO vo = null;
		   DrugStockRPTBO bo = null;
		   ...
		   try{
				...
				vo.setStrItemBrandName(request.getParameter("strItemName"));	
				...
				strResult=DrugStockRPTHLP.getTransferDetails(vo,request,formBean);
