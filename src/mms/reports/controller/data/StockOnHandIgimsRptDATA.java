...
import mms.reports.bo.StockOnHandIgimsRptBO;
import mms.reports.controller.fb.StockOnHandIgimsRptFB;
import mms.reports.controller.hlp.StockOnHandIgimsRptHLP;
import mms.reports.vo.StockOnHandIgimsRptVO;

public class StockOnHandIgimsRptDATA {

	public static void getStoreCombo(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {

		StockOnHandIgimsRptBO bo = null;
		StockOnHandIgimsRptVO voObj = null;
		
		String strmsgText = null;
		HisUtil util = null;
		try {

			bo = new StockOnHandIgimsRptBO();
			voObj = new StockOnHandIgimsRptVO();
			...
			if (voObj.getStrStoreWs() != null && voObj.getStrStoreWs().size() > 0) 
			{
				...
				strStoreVal = util.getOptionValue(voObj.getStrStoreWs(), "","^All", false);

			} else
				strStoreVal = "<option value=''>All</option>";
	...
	public static void getDistrictList(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getStoreTypeList(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getSubStoreCombo(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getItemCatList(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getGroupList(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getDrugList(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getDrugList1(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getProgrammeCombo(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 *            the response
	 */
	public static void showReport(StockOnHandIgimsRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void showReport_NEW(StockOnHandIgimsRptFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException 
	{
...
//			String strStoreId       = formBean.getStrStoreId() == null ? "0" : formBean.getStrStoreId();
			String strStoreId = (formBean.getStrStoreId() == null || formBean.getStrStoreId().isEmpty()) ? "0" : formBean.getStrStoreId();
			...
			if(strStatusId.equals("12")) //12 ZERO STOCK 
			{ 	
				if (strIsGroupWise.equalsIgnoreCase("1")) //1 default value & its for with batch checkbox 
				{ 
						// with batch
						...
						String strIndentItemList = StockOnHandIgimsRptHLP.printBatchWiseZeroStockReportRpt(vo, strReportName , request,formBean);				
				...
				else if (strIsGroupWise.equalsIgnoreCase("0"))  //0 for without batch checkbox 
				{ 
						// without batch
						...
						formBean.setStrCurrentDate(util.getASDate("dd-MMM-yyyy  hh:mm"));					
						response.setContentType("text/html;charset=UTF-8");									
						String strIndentItemList = StockOnHandIgimsRptHLP.printWithOutBatchZeroStockReport(vo, strReportName , request,formBean);				
						formBean.setStrViewItemDtls(strIndentItemList);
						formBean.setStrTableWidth(vo.getStrTableWidth());
				  }	
			} else if(strStatusId.equals("10"))  { //10-ACTIVE CASE   
			
			if(strIsGroupWise.equalsIgnoreCase("1")) { //1 default value & its for with batch checkbox  
									
						    System.out.println("<-----With Batch-- PKG_MMS_VIEW2.proc_rptm_new_igims_peripheral [ Mode - 4] -->");
							...
							{
								//formBean.setStrUserName(ws1.getString(14));
								formBean.setStrUserName(ws1.getString(17));
							}
							...
							formBean.setStrCurrentDate(util.getASDate("dd-MMM-yyyy  hh:mm"));									
							response.setContentType("text/html;charset=UTF-8");										
							String strIndentItemList = StockOnHandIgimsRptHLP.printWithOutBatchReport(vo, strReportName , request,formBean);	
					...
					if (strIsGroupWise.equalsIgnoreCase("0")) 
					{ // without batch
					    ...
					    System.out.println("<-----With Batch-- PKG_MMS_VIEW2.proc_rptm_new_igims_peripheral [ Mode - 4] -->");
							...
							WebRowSet ws1 = vo.getStrStockInHandRptWS();	
							//System.out.println("ws1 Size"+ws1.size());
							
							if(ws1.next())
							{
								//formBean.setStrUserName(ws1.getString(10));
								formBean.setStrUserName(ws1.getString(17));
								//System.out.println("ws1.getString(17)"+ws1.getString(17)); // User Name
							}					
							ws1.beforeFirst();
