...
import mms.reports.bo.ProjectionOrderRptBO;
import mms.reports.controller.fb.ProjectionOrderRptFB;
import mms.reports.controller.hlp.ProjectionOrderRptHLP;
import mms.reports.vo.ProjectionOrderRptVO;

// TODO: Auto-generated Javadoc
/**
 * The Class ProjectionOrderRptDATA.
 */
public class ProjectionOrderRptDATA 
{
	 ...
	 */
	public static void getDistrictList(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) 
	{

		ProjectionOrderRptBO bo = null;
		ProjectionOrderRptVO voObj = null;
		String strmsgText = null;
		HisUtil util = null;
		try {

			bo = new ProjectionOrderRptBO();
			voObj = new ProjectionOrderRptVO();
	 ...
	 */
	public static void getStoreCombo(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getStoreTypeList(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getSubStoreCombo(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getItemCatList(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getGroupList(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getDrugList(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getDrugList1(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static void getProgrammeCombo(ProjectionOrderRptFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void showReport_NEW(ProjectionOrderRptFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException 
	{
		...
		ProjectionOrderRptBO bo = null;
		ProjectionOrderRptVO vo = null;		
		HisUtil util = null;	
		try 
		{
			util = new HisUtil("MMS Reports", "StockOnHandRptDATA");
			bo = new ProjectionOrderRptBO();
			vo = new ProjectionOrderRptVO();
			...
			String strIndentItemList = ProjectionOrderRptHLP.printBatchWiseReportRpt_Mode_Two(vo, strReportName , request,formBean);				
