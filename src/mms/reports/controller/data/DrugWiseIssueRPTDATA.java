...
import mms.reports.bo.DrugWiseIssueRPTBO;
import mms.reports.controller.fb.DrugWiseIssueRPTFB;
import mms.reports.controller.hlp.DrugWiseIssueRPTHLP;
import mms.reports.vo.DrugWiseIssueRPTVO;

public class DrugWiseIssueRPTDATA {

	public static void initialGenAdd(DrugWiseIssueRPTFB formBean,HttpServletRequest request) {
		DrugWiseIssueRPTVO vo = null;
		DrugWiseIssueRPTBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new DrugWiseIssueRPTVO();
			bo = new DrugWiseIssueRPTBO();
...
//-----------------------------------Item Category----------------------------------------------	
			...
			{
				temp2 = hisutil.getOptionValue(vo.getWsItemCategoryCombo(),"0", "0^All", false);
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(DrugWiseIssueRPTFB formBean,HttpServletRequest request, HttpServletResponse response) {
		DrugWiseIssueRPTVO vo=null;
		DrugWiseIssueRPTBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(DrugWiseIssueRPTFB _LocalPurchaseMRN_FB,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   DrugWiseIssueRPTVO vo = null;
		   DrugWiseIssueRPTBO bo = null;
		   ...
		   try{
				...
				strResult=DrugWiseIssueRPTHLP.getTransferDetails(vo);  // pkg_mms_view2.Indent_Wise_Issue_Report [ Mode - 2 ]
