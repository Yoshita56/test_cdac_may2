...
import mms.reports.bo.StockLedgerForSubStoresRptItemNewBO;
import mms.reports.controller.fb.StockLedgerForSubStoresRptItemNewFB;
import mms.reports.controller.hlp.StockLedgerForSubStoresRptItemNewHLP;
 ...
 * 
 */
public class StockLedgerForSubStoresRptItemNewDATA {
	 ...
	 * @throws IOException 
	 */
	public static void getInitVal(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {

		StockLedgerForSubStoresRptItemNewBO bo = null;
		StockLedgerForSubStoresRptItemNewVO voObj = null;
		String strMsgText = null;
		String strStoreVal = "";
		HisUtil util = null;
		try {

			bo = new StockLedgerForSubStoresRptItemNewBO();
			voObj = new StockLedgerForSubStoresRptItemNewVO();
			...
			util = new HisUtil("MMS Transactions", "StockLedgerForSubStoresRptItemNewDATA");
		...
		//	formBean.setStrGroupCombo(temp1);
			...
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.setInitDtl()",			strMsgText, request, response);
	 ...
	 * @throws IOException 
	 */
	public static void getItemCatList(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getItemCatList()",	strMsgText, request, response);
		} finally {
	 ...
	 * @throws IOException 
	 */
	public static void getGroupList(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getGroupList()",	strMsgText, request, response);
		} finally {
	 ...
	 * @throws IOException 
	 */
	public static void getItemList(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getItemList()",strMsgText, request, response);
		} finally {
	 ...
	 * @throws IOException 
	 */
	public static void getStockLedgerDtl(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {

		StockLedgerForSubStoresRptItemNewBO bo = null;
		StockLedgerForSubStoresRptItemNewVO vo = null;
		StockLedgerForSubStoresRptItemNewHLP hlp = null;
		HisUtil util = null;
		String strMsgText = null;
		try 
		{
			System.out.println("<<------StockLedgerForSubStoresRptItemNewDATA.getStockLedgerDtl----->>");
			
			bo = new StockLedgerForSubStoresRptItemNewBO();
			vo = new StockLedgerForSubStoresRptItemNewVO();
			hlp = new StockLedgerForSubStoresRptItemNewHLP();
		...
		//	vo.setStrItemCatId("10");
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getStockLedgerDtl()",strMsgText, request, response);
		} finally {
	 ...
	 * @throws IOException 
	 */
	public static void getConsolidatedStockLedgerReport(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request,
		...
		try {
			...
			System.out.println("----------- StockLedgerForSubStoresRptItemNewDATA.getConsolidatedStockLedgerRpt -----------");
			bo = new StockLedgerForSubStoresRptItemNewBO();
			vo = new StockLedgerForSubStoresRptItemNewVO();
			hlp = new StockLedgerForSubStoresRptItemNewHLP();
			vo.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getConsolidatedStockLedgerReport()",	strMsgText, request, response);
		} finally {
	 ...
	 * @throws IOException 
	 */
	public static void getDetailedStockLedger(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			System.out.println("<<------StockLedgerForSubStoresRptItemNewDATA.getDetailedStockLedger----->>");
			...
			// Calling BO
			bo.getDetailedStockLedgerDtl(vo);  // Pkg_Mms_rpt.Rptm_dtl_ledger_dtl [ Mode 1 for Drug 2 for Item]
			response.setContentType("text/html;charset=UTF-8");
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getDetailedStockLedger()",strMsgText, request, response);
		} finally {
			if (bo != null) {
				bo = null;
			}
	 ...
	 * @throws IOException 
	 */
	public static void getDetailedStockLedgerDtlRpt(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		StockLedgerForSubStoresRptItemNewHLP hlp = null;
		try {
			System.out.println("<<------StockLedgerForSubStoresRptItemNewDATA.getDetailedStockLedgerDtlRpt----->>");
			bo = new StockLedgerForSubStoresRptItemNewBO();
			vo = new StockLedgerForSubStoresRptItemNewVO();
			hlp = new StockLedgerForSubStoresRptItemNewHLP();
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getDetailedStockLedgerDtlRpt()",	strMsgText, request, response);
		} finally {
	 ...
	 * @throws IOException 
	 */
	public static void getDrugList(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			System.out.println("<<------StockLedgerForSubStoresRptItemNewDATA.getDrugList----->>");
			util = new HisUtil("MMS Reports", "StockLedgerForSubStoresRptItemNewDATA");
			bo = new StockLedgerForSubStoresRptItemNewBO();
			voObj = new StockLedgerForSubStoresRptItemNewVO();
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.getDrugList()",strMsgText, request, response);
		} finally {
			if (voObj != null) {
				voObj = null;
			}
	 ...
	 * @throws IOException 
	 */
	public static void generatePdf(StockLedgerForSubStoresRptItemNewFB formBean, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			strMsgText = e.getMessage();
			//new HisException("e-Aushadhi", "StockLedgerForSubStoresRptItemNewDATA.generatePdf()",	strMsgText, request, response);
		}
