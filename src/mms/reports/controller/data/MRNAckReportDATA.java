...
import mms.reports.bo.MRNAckReportBO;
import mms.reports.controller.fb.MRNAckReportFB;
import mms.reports.controller.hlp.MRNAckReportHLP;
import mms.reports.vo.MRNAckReportVO;


public class MRNAckReportDATA {

	public static void initialGenAdd(MRNAckReportFB formBean,
			HttpServletRequest request) {
		MRNAckReportVO vo = null;
		MRNAckReportBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new MRNAckReportVO();
			bo = new MRNAckReportBO();
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(MRNAckReportFB formBean,HttpServletRequest request, HttpServletResponse response) {
		MRNAckReportVO vo=null;
		MRNAckReportBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(MRNAckReportFB _MRNAckReportFB,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   MRNAckReportVO vo = null;
		   MRNAckReportBO bo = null;
		   ...
		   try{
				...
				vo.setStrPoNo(_MRNAckReportFB.getStrPoNo());
				System.out.println("vo.setStrPoNo---------------------------- "+_MRNAckReportFB.getStrPoNo());
				...
				int ActID =Integer.parseInt(vo.getStrActId());
				 if (ActID == 2) {
					 ...
					 strResult=MRNAckReportHLP.getLPMRNDetails(vo);
					
				 }else if(ActID == 4){
					 System.out.println("------mode val 4--------");
					 bo.setViewPageDtl(vo);
					 strResult=MRNAckReportHLP.getConsolidatedDetails(vo);
...
//				bo.setViewPageDtl(vo);
//
//			    String strResult=MRNAckReportHLP.getLPMRNDetails(vo);
			   ...
			   strmsgText = _err.getMessage();
				...
				_MRNAckReportFB.setStrErrMsg("ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
				//_MRNAckReportFB.setStrMsgType("1");
				eObj = null;
		   }	   
	}
}
