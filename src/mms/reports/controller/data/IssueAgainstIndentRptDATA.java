...
import mms.reports.bo.IssueAgainstIndentRptBO;
import mms.reports.controller.fb.IssueAgainstIndentRptFB;
import mms.reports.controller.hlp.IssueAgainstIndentRptHLP;
import mms.reports.vo.IssueAgainstIndentRptVO;

public class IssueAgainstIndentRptDATA {

	public static void initialGenAdd(IssueAgainstIndentRptFB formBean,
			HttpServletRequest request) {
		IssueAgainstIndentRptVO vo = null;
		IssueAgainstIndentRptBO bo = null;
		HisUtil hisutil = null;
		String strCurrentDate;


		try {
			vo = new IssueAgainstIndentRptVO();
			bo = new IssueAgainstIndentRptBO();
...
//------------------------------------------------------------------------------------------------
	...
	public static void lpitemName(IssueAgainstIndentRptFB formBean,HttpServletRequest request, HttpServletResponse response) {
		IssueAgainstIndentRptVO vo=null;
		IssueAgainstIndentRptBO bo= null;
		HisUtil hisutil = null;
		String hosCode = "";
	...
	public static void getViewDtl(IssueAgainstIndentRptFB _IssueAgainstIndentRptFB,HttpServletRequest request,HttpServletResponse response)
	{
	       String strmsgText = "";
		   IssueAgainstIndentRptVO vo = null;
		   IssueAgainstIndentRptBO bo = null;
		   ...
		   try{
			    ...
			    String strResult=IssueAgainstIndentRptHLP.getLPMRNDetails(vo);
			   ...
			   strmsgText = _err.getMessage();
				...
				_IssueAgainstIndentRptFB.setStrErrMsg("ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
				//_IssueAgainstIndentRptFB.setStrMsgType("1");
				eObj = null;
		   }	   
	}
}
