...
public class New_Report_For_AcknowledgeHLP {

	private static final String strColor = "red";
	private static final String defaultColor = "blue";

public static String getIssueDetails(New_Report_For_AcknowledgeVO vo) 
	 {
...
public static String getTransferDetails(New_Report_For_AcknowledgeVO vo) 
{
	StringBuffer sb = new StringBuffer("");
	WebRowSet ws = vo.getWsItemCategoryCombo();
	int i=1;
	...
	if (ws != null) 
	{
		if(ws.size() != 0)
		{
			...
			sb.append("<table width='100%' align='center' cellspacing='1px' cellpadding='1px' border='0'>" + 
					"<tr> "
					+ " <td colspan='3'></td>"
					+ " <td colspan='3'align='center' style='font-size:15px'><b>Acknowledge Report For Item Transfer</b></td>"
					+ " <td colspan='3'></td>");
			sb.append("</tr>");
			...
			sb.append("</table>");
					 ...
					 * + "<td align='center' colspan='3'>" +
					 * "<font face='Verdana, Arial, Helvetica, sans-serif' size='2'>" +
					 * "<b>"+"Acknowledge Report For Item Transfer"+"</b>" +
					 * "</font></td><td align='center' colspan='2'><div id='printImg'><img style='cursor: pointer;'  text-align=right  title='Print Page' src='../../hisglobal/images/printer_symbol.gif' onClick='printDataOne();' /></div></td></tr>"
					 * 
					 * + " <tr><td align='center' colspan='3'></td> " +
					 * "<td align='center' colspan='3'>" +
	        ...
	        sb.append("<td width='5%' align='center'><b>S.No</b>");
		    sb.append("</td>");
	        sb.append("<td width='15%' align='center'><b>Issue Date</b>");
		    sb.append("</td>");
//		    sb.append("<td width='15%' align='center'><b>Supplier Name</b>");
//		    sb.append("</td>");
		    sb.append("<td width='30%' align='center'><b>Item Name</b>");
	        sb.append("</td>");
	        sb.append("<td width='15%' align='center'><b>Batch No.</b>");
	        sb.append("</td>");
	        sb.append("<td width='10%' align='center'><b>Expiry Date</b>");
	        sb.append("</td>");
	        sb.append("<td width='5%' align='center'><b>Qty</b>");
	        sb.append("</td>");
	        sb.append("</tr>");
...
//						sb.append("</td>");
						...
						sb.append("<td  width='10%' align='right'>");			//  Qty
						sb.append(ws.getString(8));									
						sb.append("</td>");
