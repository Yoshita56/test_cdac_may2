 ...
 * 
 */
public class StockLedgerForSubStoresRptItemHLP {
	/*
	 ...
	 */
	public String getStockLedgerDtl(StockLedgerForSubStoresRptItemVO vo, HttpServletRequest request) throws Exception {
...
//								+ "</td>");
			...
			e.printStackTrace();
			throw new Exception("StockLedgerForSubStoresRptItemHLP.getStockLedgerDtl()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	 ...
	 * @throws Exception the exception
	 */
	public String getStockLedgerDtlBatch(StockLedgerForSubStoresRptItemVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerDtl(StockLedgerForSubStoresRptItemVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try {
			...
			if (ws != null && ws.size() > 0) {
				...
				br.append("<a href='#' class='button' title='Print' onClick='printItemDetailedStockLedgerReport(this);' ><span class='print'>"+HisLanguageProperties.getValue(request, "label.common.Print")+"</span></a>");
				...
				brPagination.append("<table width='95%' align='center' cellspacing='0px' cellpadding='1px' border='1' >");
				brPagination.append("<tr class='FOOTER' style='text-align:left;'><td colspan='" + nColspan + "'>Item Details</td></tr>");
			...
			e.printStackTrace();
			throw new Exception("StockLedgerForSubStoresRptItemHLP.getDetailedStockLedgerDtl()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	 ...
	 * @throws Exception the exception
	 */
	public String getConsolidatedStockLedgerRpt(StockLedgerForSubStoresRptItemVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							...
							+ "<body><form action='/DWH_GUJARAT/mms/reports/StockLedgerForSubStoresRptItemCNT.cnt' method='post'><div id='consolidatedStockLedgerRptDivId'>"
	 ...
	 * @throws Exception the exception
	 */
	public String getConsolidatedStockLedgerRptBatch(StockLedgerForSubStoresRptItemVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							+ "<script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
							+ "<body><form action='/DWH_GUJARAT/mms/reports/StockLedgerForSubStoresRptItemCNT.cnt' method='post'><div id='consolidatedBatchWiseStockLedgerRptDivId'>"
							+ "" + "<table align='center' width='").append(strTableWidth).append("' border='0' cellspacing='0' cellpadding='0''> ");
			try {
				br.append("<td colspan='1' width='10%' align='center'><div  align='center'> <img  align='absmiddle' src='http://" + request.getServerName() + ":"
						+ request.getServerPort() + HisLanguageProperties.getValue(request,"imageHeader.common.VoucherReport")+"'/></div></td>");
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerRpt(StockLedgerForSubStoresRptItemVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							+ "<script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
							+ "<body><form action='/HBIMS/mms/reports/StockLedgerForSubStoresRptItemCNT.cnt' method='post'><div id='detailedStockLedgerRptDivId'>"
							+ "" + "<table align='center' width='").append(strTableWidth).append("' border='0' cellspacing='0' cellpadding='0''> ");
			try {
