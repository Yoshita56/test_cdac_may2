 ...
 * 
 */
public class StockLedgerWithValueRptHLP 
{
	 ...
	 */
	public String getStockLedgerDtl(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			e.printStackTrace();
			throw new Exception("StockLedgerWithValueRptHLP.getStockLedgerDtl()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	 ...
	 * @throws Exception the exception
	 */
	public String getStockLedgerDtl_ValueWise(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
	 ...
	 * @throws Exception the exception
	 */
	public String getStockLedgerDtlBatch(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
	 ...
	 * @throws Exception the exception
	 */
	public String getStockLedgerDtl_ValueRpt(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		*/
		...
		try 
		{
			...
			e.printStackTrace();
			throw new Exception("StockLedgerWithValueRptHLP.getStockLedgerDtl_ValueRpt()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	...
	public String getConsolidatedStockLedgerRpt_ValuePopUp(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception 
	{
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		*/
		...
		try 
		{
			System.out.println("----------- StockLedgerWithValueRptHLP.getConsolidatedStockLedgerRpt_ValuePopUp -----------");
			...
			if (ws != null && ws.size() > 0) 
			{
				...
				brPagination.append(
						"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
								...
								+ "<body><form action='/INVMGM/mms/reports/StockLedgerWithValueRptCNT.cnt' method='post'><div id='consolidatedBatchWiseStockLedgerRptDivId'>");
	...
	public String getStockLedgerDtlBatch_ValueWiseRpt(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try 
		{
			...
			System.out.println("------------- StockLedgerWithValueRptHLP.getStockLedgerDtlBatch_ValueWiseRpt() --------------");
			ws = vo.getWrsData();
			...
			if (ws != null && ws.size() > 0) 
			{
				...
				while (ws.next()) 
				{
					...
					{					
						...
						//System.out.println("-A.1--"+nClosingBalanceActive+"*"+prevRate+"----"+String.format("%1$,.2f", (nClosingBalanceActive*Double.parseDouble(prevRate))));
						...
						nRecTotActiveValue = nRecTotActiveValue + nRecActiveValue;
						/*
						System.out.println("-A.2--"+nClosingBalanceTotActiveValue);
						System.out.println("-A.3--"+nIssueTotActiveValue);
						System.out.println("-A.4--"+nRecTotActiveValue);
						*/
				...
				nRecTotActiveValue = nRecTotActiveValue + nRecActiveValue;
				/*
				System.out.println("-B.2--"+nClosingBalanceTotActiveValue);
				System.out.println("-B.3--"+nIssueTotActiveValue);
				System.out.println("-B.4--"+nRecTotActiveValue);
				*/
	...
	public String getConsolidatedStockLedgerRptBatch_ValuePopUp(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		NumberFormat formatter = new DecimalFormat("###############.##");  
		HisUtil 		hisutil = new HisUtil("MMS", "StockLedgerWithValueRptHLP");

		try 
		{
			
			System.out.println("------------- StockLedgerWithValueRptHLP.getConsolidatedStockLedgerRptBatch_ValuePopUp() --------------");
			ws = vo.getWrsData();
			...
			e.printStackTrace();
			throw new Exception("StockLedgerWithValueRptHLP.getConsolidatedStockLedgerRptBatch()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	...
	public StringBuffer getHeader(int callType) 
	{
		...
		if (callType == 3) {
			...
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='32%'>Particulars</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='12%'>Received Qty * Rate</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='10%'>Value</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='12%'>Issued Qty * Rate</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='10%'>Value</td>");
		...
		// detail as clicked on item name [without batch with Value]
		if (callType == 7) 
		{
			brHeader.append("<tr>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='5%'>S. No.</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Date</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Batch No</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Expiry</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='23%'>Particulars</td>");			
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Received Qty</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Value</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Issued Qty</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Value</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Closing Bal</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='8%'>Value</td>");
			brHeader.append("</tr>");
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerDtl(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try 
		{
			...
			System.out.println("------------- StockLedgerWithValueRptHLP.getDetailedStockLedgerDtl() --------------");
			...
			{
				br.append(getHeader(7).toString());
				nColspan = 11;				
			} 
			else 
			{
			...
			if (vo.getStrBatchNo().equals("0")) 
			{
				...
				br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='8%'><b>" + vo.getStrFromDate()+ "</b></td>");
				br.append("<td style=\"text-align: left;\"   class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
				br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
				br.append("<td style=\"text-align: left;\"   class= " + strCssClass + " colspan='1' width='23%'><b>Opening Balance</b></td>");
				br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>" + nBalanceActiveQty + "</b></td>");
				br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
				br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
				br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
				br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
				br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");				
			...
			if (ws != null && ws.size() > 0) 
			{
				...
				while (ws.next()) 
				{
					...
					nRate 	  = Double.parseDouble(ws.getString(13));

					//System.out.println("nRate"+nRate);
					...
					if (vo.getStrBatchNo().equals("0")) 
					{   
						//System.out.println("-X.1-"+ws.getString(11)+"-"+nRecQty+"*"+nRate+"----"+String.format("%1$,.2f", (nRecQty*nRate)));
						//System.out.println("-X.2-"+ws.getString(11)+"-"+nIssueQty+"*"+nRate+"----"+String.format("%1$,.2f", (nIssueQty*nRate)));
						//System.out.println("-X.3-"+ws.getString(11)+"-"+nBalanceActiveQty+"*"+nRate+"----"+String.format("%1$,.2f", (nBalanceActiveQty*nRate)));
						
						br.append("<td style=\"text-align: center;\"class= " + strCssClass + " colspan='1' width='8%'>" + ws.getString(1) + "</td>");
						br.append("<td style=\"text-align: left;\" 	class= " + strCssClass + " colspan='1' width='8%'>" + ws.getString(11)+"<br>[ "+nRate +" ]" + "</td>");
						br.append("<td style=\"text-align: center;\"class= " + strCssClass + " colspan='1' width='8%'>" + ws.getString(12)+ "</td>");
						br.append("<td style=\"text-align: left;\" 	class= " + strCssClass + " colspan='1' width='23%'>" + ws.getString(2) + "</td>");
						br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + nRecQty + strRecString+ "</td>");
						br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + String.format("%1$,.2f", (nRecQty*nRate)) + "</td>");
						br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + nIssueQty + strIssueString+ "</td>");	
						br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + String.format("%1$,.2f", (nIssueQty*nRate)) + "</td>");
						br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + nBalanceActiveQty + "</td>");
						br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + String.format("%1$,.2f", (nBalanceActiveQty*nRate)) + "</td>");
					...
					else 
					{
							...
							br.append("<td style=\"text-align: left;\"   class= " + strCssClass + " colspan='1' width='32%'>" + ws.getString(2) + "</td>");							
							br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='12%'>" + nRecQty+"*"+nRate+"</td>");					
							br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='10%'>" + String.format("%.2f", nRecQty * nRate) + "</td>");					
							//br.append("<td style=\"text-align: right;\" class= " + strCssClass + " colspan='1' width='8%'>" + nIssueQty + strIssueString+ "</td>");
							br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='12%'>" + nIssueQty+"*"+nRate+ "</td>");					
							br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='10%'>" + String.format("%.2f", nIssueQty * nRate) + "</td>");					
							br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='10%'>" + nBalanceActiveQty + "</td>");
					}
					...
					if (vo.getStrBatchNo().equals("0")) 
					{
						...
						brHeader.append("</tr>");
						*/
						br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='8%'><b>" + vo.getStrToDate()+ "</b></td>");
						br.append("<td style=\"text-align: left;\"   class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
						br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='8%'><b>--</b></td>");
						br.append("<td style=\"text-align: left;\"   class= " + strCssClass + " colspan='1' width='25%'><b>Closing Balance</b></td>");
						br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'>--</td>");
						br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'>--</td>");	
						br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'>--</td>");
						br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'>--</td>");											
						br.append("<td style=\"text-align: right;\"  class= " + strCssClass + " colspan='1' width='8%'><b>"+nBalanceActiveQty+"</b></td>");
					...
					brPagination.append("<HTML><head><link href='../../hisglobal/css/dwh.css' rel='stylesheet' type='text/css'>"
							...
							+ "<script language='Javascript' src='../../mms/js/stockLedgerWithValue_mmsrpt.js'>"
					...
					/*
					brPagination.append("<tr>");
					brPagination.append("<td class='multiRPTLabel'   width='20%'>Rate</td>");
					brPagination.append("<td class='multiRPTControl' width='30%'><div align='left'>" + nRate+ "</div></td>");
					brPagination.append("<td class='multiRPTLabel'   width='20%'></td>");
					brPagination.append("<td class='multiRPTControl' width='30%'></td>");
					brPagination.append("</tr>");
					*/
			...
			e.printStackTrace();
			throw new Exception("StockLedgerWithValueRptHLP.getDetailedStockLedgerDtl()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerDtl_NEW(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception 
	{
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
	...
	public String getConsolidatedStockLedgerRpt(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try 
		{
			System.out.println("----------- StockLedgerWithValueRptHLP.getConsolidatedStockLedgerRpt -----------");
	 ...
	 * @throws Exception the exception
	 */
	public String getConsolidatedStockLedgerRpt_OLD(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							+ "<script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
							+ "<body><form action='/INVMGM/mms/reports/StockLedgerWithValueRptCNT.cnt' method='post'><div id='consolidatedStockLedgerRptDivId'>"
	...
	public String getConsolidatedStockLedgerRptBatch(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try 
		{
			...
			System.out.println("------------- StockLedgerWithValueRptHLP.getConsolidatedStockLedgerRptBatch() --------------");
			ws = vo.getWrsData();
	 ...
	 * @throws Exception the exception
	 */
	public String getConsolidatedStockLedgerRptBatch_OLD(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerRpt(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockLedgerWithValue_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							+ "<script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
							+ "<body><form action='/INVMGM/mms/reports/StockLedgerWithValueRptCNT.cnt' method='post'><div id='detailedStockLedgerRptDivId'>"
							+ "" + "<table align='center' width='").append(strTableWidth).append("' border='0' cellspacing='0' cellpadding='0''> ");
...
//					+ "' align='center'> <b><font size='2' face='Verdana, Arial, Helvetica, sans-serif' size='3'> ");
			...
			/*	br.append("<tr bgcolor='#cdc9c9'> ");
				...
				br.append("<tr bgcolor='#cdc9c9'> ");
				br.append("<td colspan='1' width='4%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>S.No.</b></font></td>");
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Date</b></font></td>");
				br.append("<td colspan='1' width='32%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Particulars</b></font></td>");
				br.append("<td colspan='1' width='12%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Received Qty * Rate</td>");
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Value</td>");
				br.append("<td colspan='1' width='12%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Issued Qty * Rate</td>");
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Value</td>");
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Balance</b></font></td>");
				br.append("</tr>");
			...
			if (vo.getStrBatchNo().equals("0")) {
				br.append("<tr>");
				br.append("<td style=\"text-align: center;\" colspan='1' width='4%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
						+ sNo + "</font></b></td>");
				...
				br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
						+ vo.getStrFromDate() + "</font></b></td>");
				br.append("<td style=\"text-align: left;\"  colspan='1' width='32%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b> Opening Balance</font></b></td>");
				br.append("<td style=\"text-align: center;\"  colspan='1' width='12%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: center;\"  colspan='1' width='12%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
			...
			if (ws != null && ws.size() > 0) {
				while (ws.next()) {
					...
					br.append("<td  style=\"text-align: center;\"  colspan='1' width='4%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
							+ sNo + "</font></td>");
					...
					if (vo.getStrBatchNo().equals("0")) {
						...
						br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ ws.getString(1) + "</font></td>");
						br.append("<td style=\"text-align: left;\"  colspan='1' width='32%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ ws.getString(2) + "</font></td>");
						...
						br.append("<td style=\"text-align: right;\"  colspan='1' width='12%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ nRecQty+"*"+rate+ "</font></td>");
						br.append("<td style=\"text-align: right;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ String.format("%.2f", nRecQty * rate) + "</font></td>");

						br.append("<td style=\"text-align: right;\"  colspan='1' width='12%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ nIssueQty+"*"+rate+ "</font></td>");
						br.append("<td style=\"text-align: right;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ String.format("%.2f", nIssueQty * rate) + "</font></td>");
				...
				if (vo.getStrBatchNo().equals("0")) {
					...
					//br.append("<td style=\"text-align: left;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
					//		+ "Received Qty:"+nRecQty + "</font></b></td>");
					br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");

					br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");

					//br.append("<td style=\"text-align: left;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
					//		+ "Issued Qty:" +nIssueQty + "</font></b></td>");
					br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
	...
	public String getDetailedStockLedgerRpt_Value(StockLedgerWithValueRptVO vo, HttpServletRequest request) throws Exception {
...
//					+ "' align='center'> <b><font size='2' face='Verdana, Arial, Helvetica, sans-serif' size='3'> ");
			...
			if (vo.getStrBatchNo().equals("0")) 
			{
				br.append("<tr bgcolor='#cdc9c9'> ");
				br.append("<td colspan='1' width='5%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>S.No.</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Date</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Batch No</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Expiry Date</b></font></td>");
				br.append("<td colspan='1' width='23%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Particulars</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Received Qty</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Value</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Issued Qty</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Value</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Balance</b></font></td>");
				br.append("<td colspan='1' width='8%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>Value</b></font></td>");
				br.append("</tr>");
			...
			if (vo.getStrBatchNo().equals("0")) 
			{
				...
				br.append("<td style=\"text-align: center;\" colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+ vo.getStrFromDate() + "</font></b></td>");
				br.append("<td style=\"text-align: left;\"   colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: center;\" colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: left;\"   colspan='1' width='23%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b> Opening Balance </font></b></td>");
				br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
			...
			if (ws != null && ws.size() > 0) 
			{
				while (ws.next()) 
				{
					...
					if (vo.getStrBatchNo().equals("0")) 
					{
						...
						br.append("<td style=\"text-align: center;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ ws.getString(1) + "</font></td>");
						br.append("<td style=\"text-align: left;\"    colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ ws.getString(11)+"<br>[ "+rate +" ]" + "</td>");
						br.append("<td style=\"text-align: center;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ ws.getString(12) + "</font></td>");
						br.append("<td style=\"text-align: left;\"    colspan='1' width='23%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ ws.getString(2) + "</font></td>");
						br.append("<td style=\"text-align: right;\"   colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ nRecQty + strRecString + "</font></td>");
						...
						br.append("<td style=\"text-align: right;\"   colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
								+ String.format("%.2f", nBalanceActiveQty * rate) + "</font></td>");
				...
				if (vo.getStrBatchNo().equals("0")) 
				{
					br.append("<td style=\"text-align: center;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
							+ vo.getStrToDate() + "</font></b></td>");
					br.append("<td style=\"text-align: left;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
					br.append("<td style=\"text-align: center;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
					br.append("<td style=\"text-align: left;\"  colspan='1' width='23%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b> Closing Balance</font></b></td>");
					br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
							+ nRecQty + "</font></b></td>");
					br.append("<td style=\"text-align: center;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
					br.append("<td style=\"text-align: right;\"  colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
