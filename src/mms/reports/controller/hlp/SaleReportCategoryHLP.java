...
public class SaleReportCategoryHLP {
...
sb.append("<tr>"
	...
	public static String getSaleDetails(SaleReportCategoryFB fb,SaleReportCategoryVO vo) 
	{
		...
		try {
		    if (ws != null) {
		        ...
		        sb.append("<table width='100%' align='center' cellspacing='1px' cellpadding='1px' border='0'>" + 
		                "<tr> "
		                + " <td colspan='3'></td>"
		                +"<td colspan='3' align='center' style='font-size:18px;font-weight:normal;font face:Verdana, Arial, Helvetica, sans-serif'>Sale Report</td>"
		                + " <td colspan='3'></td>");
		        sb.append("</tr>");
		        ...
		        sb.append(" <tr><td align='center' colspan='3'></td> " +
		          ...
		          "<font face='Verdana, Arial, Helvetica, sans-serif' size='2'>" +
		          "Issue By Store::<b>"+vo.getStrStoreName()+"</b></font></td><td align='center' colspan='2'></td></tr>");
		          
		        sb.append(" <tr><td align='center' colspan='3'></td> " +
		                  "<td align='center' colspan='3'>" +
		                  "<font face='Verdana, Arial, Helvetica, sans-serif' size='2'>" +
		                  "For Patient Category ::<b>"+vo.getStrPatientCategoryName()+"</b></font></td><td align='center' colspan='2'></td></tr>");
		        ...
		        if (ws.size() != 0) {
		            ...
		            sb.append("<td width='10%' ><b>CR No</b>");
		            sb.append("</td>");
		            
		            sb.append("<td width='15%' ><b>Patient Name</b>");
		            sb.append("</td>");
		            
		            sb.append("<td width='5%' ><b>Age/Gender</b>");
		            sb.append("</td>");
		            
		            sb.append("<td width='12%' ><b>Issue No</b>");
		            sb.append("</td>");
		            
		            sb.append("<td width='10%' ><b>Issue Dt</b>");
		            sb.append("</td>");
		    
		            sb.append("<td width='10%' ><b>Department</b>");
		            sb.append("</td>");
		            
		            sb.append("<td width='10%' ><b>Net Amount</b>");
		            sb.append("</td>");
		            ...
		            while (ws.next()) {
		            	if (i == 0) {
		            	    String netCostStr = ws.getString(8);
		            	    
		            	    // Validate the string before parsing
		            	    if (netCostStr != null && !netCostStr.trim().isEmpty()) {
		            	        try {
		            	            totalnetcost = Double.parseDouble(netCostStr.trim()); // Convert string to double
		            	        } catch (NumberFormatException e) {
		            	            System.err.println("Error parsing net cost: " + netCostStr + " - " + e.getMessage());
		            	            totalnetcost = 0.0; // Default to 0.0 in case of a parsing error
		            	        }
		            	    } else {
		            	        totalnetcost = 0.0; // Default to 0.0 if the string is null or empty
		            	    }
		            	} else {
		            	    String netCostStr = ws.getString(8);
		            	    ...
		            	    if (netCostStr != null && !netCostStr.trim().isEmpty()) {
		            	        try {
		            	            totalnetcost += Double.parseDouble(netCostStr.trim()); // Add parsed value to totalnetcost
		            	        } catch (NumberFormatException e) {
		            	            System.err.println("Error parsing net cost: " + netCostStr + " - " + e.getMessage());
		            	            // Skip adding to totalnetcost in case of an error
		            	        }
		            	    }
		            	}
		                ...
		                sb.append(ws.getString(1)); // CR NO
		                sb.append("</td>");
		                ...
		                sb.append("<td  width='10%' align='center'>");
//		                sb.append(ws.getString(8) != null && !ws.getString(8).isEmpty() ? ws.getString(8) : "-"); 
		                
		                sb.append(ws.getString(8) != null && !ws.getString(8).isEmpty() ? String.format("%.2f", Double.parseDouble(ws.getString(8).trim())) : "-"); // net cost 
		            ...
		            sb.append("<tr>");
		            sb.append("<td colspan='7' align='right'><b> TOTAL </b>");
		            sb.append("</td>");        
		            
		     
		            sb.append("<td colspan='1' align='center'>");
		            sb.append(String.format("%.2f",totalnetcost));                                
		            sb.append("</td>");
	  ...
	  {
		    e.printStackTrace();
		    new HisException("Issue to Patient Report","IssueToPatientHLP.getSaleDetails()-->",e.getMessage());
	  }
	return sb.toString();
	}
}