/**********************************************************
 Project:	   DWH_GUJARAT	
 File:         CovidStockLedgerRptHLP.java
 Created:      Jul 3, 2014
 ...
 * 
 */
public class CovidStockLedgerRptHLP {
	/*
	 ...
	 */
	public String getStockLedgerDtl(CovidStockLedgerRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);

		WebRowSet ws = null;
		int count = 0;
		HisUtil util = new HisUtil("mms", "LabItemMapMstPrint--->getPrintPage()");
		int g=1;
		int i = 1;
		int width1 = 2;
		int width2 = 7;
		...
		//ResourceBundle res = ResourceBundle.getBundle("mms.hisglobal.hisconfig.hisReport");
		//mms.qryHandler_mms.res = res;
		

try {
	ws = vo.getWrsData();
	br.append("<div id='wrapper' style='width:1500;'><table id='mainTableRptId' class='TABLEWIDTH' width='1250' border='0' align='center' cellspacing='1px' cellpadding='1px'>");
	...
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width3
				+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Item Name<b></font></th>\n");
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width4
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Batch No<b></font></th>");
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width5
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Trans Date<b></font></th>\n");
	
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width6
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Opening Balance<b></font></th>\n");

	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width8
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Received<b></font></th>\n");

	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width8
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Issued<b></font></th>\n");

	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width9
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Closing Balance<b></font></th>\n");
	
	br.append("</tr>");
	br.append("<tr>");
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width1
			+ "%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b><b></font></th>\n");
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width2
			+ "%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b<b></font></th>\n");
	...
	br.append("<th style=\"text-align: center;\" colspan='1' width='" + width6
			+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Active Qty.(No.)<b></font></th>\n");
	...
	if (ws != null)
	{
		if (ws.size() != 0) 
		{
			while (ws.next()) 
			{
				String strCheckHidValue = ws.getString(1)+"^"+ws.getString(5)+"^"+ws.getString(7)+"^"+ws.getString(8);
				String trans_code = ws.getString(13);
				
						br.append("<tr> ");
						br.append("<input type='hidden' name='strCheckHidValue' id='strCheckHidValue" + g + "' value='" + strCheckHidValue + "'>");
						br.append("<tr> ");
						if(trans_code.equals("EMSGAA"))
						{

							br.append("<td style=\"text-align: center;\" colspan='1' width='" + width1
									+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"+g+"</font></td>\n");
							...
							br.append("<td style=\"text-align: left;\" colspan='1'   width='" + width3
										+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + ws.getString(1)
										+ "</font></td>\n");
							br.append("<td style=\"text-align: center;\" colspan='1'   width='" + width4 + "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >"
									+ "<a STYLE='cursor:pointer;cursor:hand;color:blue' title='Get Issue Details' name='strIssueDetails' id='strIssueDetails"
									+ g + "' onClick='onBatchClick(this,\"" + g + "\")'>" + ws.getString(5) + "</a></font></td>\n");
							
							br.append("<td style=\"text-align: center;\" colspan='1' width='" + width5
									+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + ws.getString(7) + "</font></td>\n");
							br.append("<td style=\"text-align: right;\" colspan='1'  width='" + width6
							...
							br.append("<td style=\"text-align: right;\" colspan='1'   width='" + width8
									+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + ws.getString(14)
									+ "</font></td>\n");
						br.append("<td style=\"text-align: right;\" colspan='1'   width='" + width8
								+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + "0"
								+ "</font></td>\n");
						
						br.append("<td style=\"text-align: right;\" colspan='1'   width='" + width9
								+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + ws.getString(15)
								+ "</font></td>\n");
						...
						if(Integer.parseInt(ws.getString(9))!=0)
						{		
						  br.append("<td style=\"text-align: right;\" colspan='1'  width='" + width6
								+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + ws.getString(9) + "</font></td>\n");
						}
						...
						{
							  br.append("<td style=\"text-align: right;\" colspan='1'  width='" + width6
										+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + ws.getString(15) + "</font></td>\n");
						}
					...
					{
					br.append("<td style=\"text-align: right;\" colspan='1'   width='" + width8
							+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + (Integer.parseInt(ws.getString(9))-Integer.parseInt(ws.getString(15)))
							+ "</font></td>\n");
					}
					else
					{
						br.append("<td style=\"text-align: right;\" colspan='1'   width='" + width8
								+ "%' ><font size='1' face='Verdana, Arial, Helvetica, sans-serif' >" + Integer.parseInt(ws.getString(15))
								+ "</font></td>\n");
					}
	...
	throw new Exception("CovidStockLedgerRptVO.getChallanProcessDtl()->" + e.getMessage());
}
...
br.append("</form></body></HTML>");
	 ...
	 * @throws Exception the exception
	 */
	public String getStockLedgerDtlBatch(CovidStockLedgerRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try {
			...
			e.printStackTrace();
			throw new Exception("CovidStockLedgerRptHLP.getStockLedgerDtl()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	...
	public StringBuffer getHeader(int callType) {
		...
		if (callType == 1) {
			...
			brHeader.append("<td CLASS='multiRPTLabel' colspan='3' width='15%'>Opening Balance</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='3' width='15%'>Received Qty</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='3' width='15%'>Issued Qty</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='3' width='15%'>Closing Balance</td>");
			brHeader.append("</tr>");
		...
		if (callType == 3) {
			...
			brHeader.append("<td CLASS='multiRPTLabel' colspan='3' width='24%'>Balance</td>");
			brHeader.append("</tr>");
		...
		if (callType == 4) {
			...
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='10%'>Received Qty</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='1' width='10%'>Issued Qty</td>");
			brHeader.append("<td CLASS='multiRPTLabel' colspan='3' width='15%'>Balance</td>");
			brHeader.append("</tr>");
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerDtl(CovidStockLedgerRptVO vo, HttpServletRequest request) throws Exception {
		StringBuffer br = new StringBuffer(1000);
		StringBuffer brPagination = new StringBuffer(3000);
		...
		try {
			...
			if (vo.getStrBatchNo().equals("0")) {
				...
				br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='15%'><b>" + vo.getStrFromDate()
						+ "</b></td>");
				br.append("<td style=\"text-align: left;\" class= " + strCssClass + " colspan='1' width='31%'><b>"+HisLanguageProperties.getValue(request, "label.common.Opening_balance")+"</b></td>");
				br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='10%'><b>--</b></td>");
				br.append("<td style=\"text-align: center;\" class= " + strCssClass + " colspan='1' width='10%'><b>--</b></td>");
			...
			e.printStackTrace();
			throw new Exception("CovidStockLedgerRptHLP.getDetailedStockLedgerDtl()->" + e.getMessage());
		} finally {
			if (ws != null) {
				ws.close();
				ws = null;
	 ...
	 * @throws Exception the exception
	 */
	public String getConsolidatedStockLedgerRpt(CovidStockLedgerRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			if (vo.getStrItemBrandId() == null || vo.getStrItemBrandId().equals("0")) {
				...
				if (ws != null && ws.size() > 0) {
					if (ws.next()) {
						vo.setStrDrugName(ws.getString(1));
					}
				}
				ws.beforeFirst();
			}
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							...
							+ "<body><form action='/DWH_GUJARAT/mms/reports/CovidStockLedgerRptCNT.cnt' method='post'><div id='consolidatedStockLedgerRptDivId'>"
			...
			br.append("<table cellspacing='0' border='0' cellpadding='0' width='").append(strTableWidth).append("' align='center'> ");
			br.append("<tr bgcolor='#cdc9c9'> ");
			br.append("<div id='wrapper' style='width:1500;'><table id='mainTableRptId' class='TABLEWIDTH' width='").append(strTableWidth).append("' border='1px' align='center' cellspacing='1px' cellpadding='1px'>");

			br.append("<tr id='tableHeaderId'> ");
			br.append("<th style=\"text-align: center;\" colspan='1' width='" + width1
					+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.S.No.")+"<b></font></th>\n");
			br.append("<th style=\"text-align: center;\" colspan='1' width='" + width2
					+ "%'><font size='2' face='Verdana, Arial, Helvetica, sans-serif' ><b>Store Name<b></font></th>\n");
			...
			br.append("<th style=\"text-align: center;\" colspan='1' width='" + width4
					+ "%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b<b></font></th>");*/
			br.append("<th style=\"text-align: center;\" colspan='5' width='" + width5
					+ "%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b><b></font></th>\n");
	 ...
	 * @throws Exception the exception
	 */
	public String getConsolidatedStockLedgerRptBatch(CovidStockLedgerRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							+ "<script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
							+ "<body><form action='/DWH_GUJARAT/mms/reports/CovidStockLedgerRptCNT.cnt' method='post'><div id='consolidatedBatchWiseStockLedgerRptDivId'>"
							+ "" + "<table align='center' width='").append(strTableWidth).append("' border='0' cellspacing='0' cellpadding='0''> ");
			try {
				br.append("<td colspan='1' width='10%' align='center'><div  align='center'> <img  align='absmiddle' src='http://" + request.getServerName() + ":"
						+ request.getServerPort() + HisLanguageProperties.getValue(request,"imageHeader.common.VoucherReport")+"'/></div></td>");
			...
			br.append("<td style=\"text-align: center;\" colspan='3' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Opening_balance")+"</b></font></td>");
			br.append("<td style=\"text-align: center;\" colspan='3' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Received_qty")+" </b></font></td>");
			br.append("<td style=\"text-align: center;\" colspan='3' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Issued_qty")+" </b></font></td>");
			br.append("<td style=\"text-align: center;\" colspan='3' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Closing_bal")+" </b></font></td>");
			br.append("</tr>");
	 ...
	 * @throws Exception the exception
	 */
	public String getDetailedStockLedgerRpt(CovidStockLedgerRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><script language='Javascript' src='../../mms/js/stockledgerForSubStores_mmsrpt.js'></script><script language='JavaScript' src='../../hisglobal/jquery/3.6.0.min.js'></script>"
							+ "<script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
							+ "<body><form action='/DWH_GUJARAT/mms/reports/CovidStockLedgerRptCNT.cnt' method='post'><div id='detailedStockLedgerRptDivId'>"
							+ "" + "<table align='center' width='").append(strTableWidth).append("' border='0' cellspacing='0' cellpadding='0''> ");
			try {
...
//					+ "' align='center'> <b><font size='2' face='Verdana, Arial, Helvetica, sans-serif' size='3'> ");
			...
			if (vo.getStrBatchNo().equals("0")) {
				...
				br.append("<td colspan='3' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Balance")+"</b></font></td>");
				br.append("</tr>");
				...
				br.append("<td colspan='1' width='31%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Particulars")+"</b></font></td>");
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Received_qty")+"</b></font></td>");
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Issued_qty")+"</b></font></td>");
				br.append("<td colspan='3' width='24%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Balance")+"</b></font></td>");
				br.append("</tr>");
				...
				br.append("<td colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b></b></font></td>");
				// Closing Balance
				br.append("<td colspan='1' width='8%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Ready_for_issue")+"</b></font></td>");
			...
			if (vo.getStrBatchNo().equals("0")) {
				...
				br.append("<td style=\"text-align: center;\"  colspan='1' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
						+ vo.getStrFromDate() + "</font></b></td>");
				br.append("<td style=\"text-align: left;\"  colspan='1' width='31%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Opening_balance")+"</font></b></td>");
				br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
				br.append("<td style=\"text-align: center;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>--</font></b></td>");
			...
			if (ws != null && ws.size() > 0) {
				...
				if (vo.getStrBatchNo().equals("0")) {
					...
					br.append("<td style=\"text-align: center;\"  colspan='1' width='15%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
							+ vo.getStrToDate() + "</font></b></td>");
					br.append("<td style=\"text-align: left;\"  colspan='1' width='31%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"+HisLanguageProperties.getValue(request, "label.common.Closing_bal")+"</font></b></td>");
					br.append("<td style=\"text-align: right;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
							+ nRecQty + "</font></b></td>");
					br.append("<td style=\"text-align: right;\"  colspan='1' width='10%'><font size='1' face='Verdana, Arial, Helvetica, sans-serif' ><b>"
							+ nIssueQty + "</font></b></td>");
