...
public class LPCStatusRptHLP {
	public static String getTransferDetails(LPCStatusRptVO vo,HttpServletRequest request,LPCStatusRptFB formBean) throws Exception  
	{

		System.out.println("--------------------- LPCStatusRptHLP.getIssueDtls -------------------------------");
		StringBuffer sb = new StringBuffer("");
		int i=1;
		HisUtil util = new HisUtil("MMS", "LPCStatusRptHLP");
		...
		try 
		{
			...
			sb.append("<table width='100%' align='center' cellspacing='1px' cellpadding='1px' border='0'>" + 
				"<tr> "
				+ " <td colspan='3'></td>"
				+ " <td colspan='3'align='center' style='font-size:15px'><b>LPC Status Report</b></td>"
				+ " <td colspan='3'></td>");
			sb.append("</tr>");
			...
			"For Category ::<b>"+vo.getStrCategoryName()
			...
			if(ws != null && ws.size() > 0)
			{
				...
				sb.append("<td align='center' 	width='25%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Name</b></font></td>");  
				sb.append("<td align='center' 	width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>90 Days<br>Consumption</b></font></td>");
				sb.append("<td align='center' 	width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>45 Days<br>Consumption</b></font></td>");
				sb.append("<td align='center' 	width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Stock</b></font></td>");
				
				sb.append("<td align='center' 	width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Req Qty</b></font></td>");
				sb.append("<td align='center' 	width='15%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Po Status</b></font></td>");
				sb.append("<td align='center' 	width='15%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Cunsumption<br>Pattern</b></font></td>");
				sb.append("</tr> ");
				   
					/*
					 * 1. ITEM_NAME
					 * 2. 90_Days_Consumption
					 * 3. 45_Days_Consumption
					 * 4. Stock
					 * 5. REQ_Qty
					 * 6. Po_Status
					...
					{			
							...
							sb.append(ws.getString(2)); //90_Days_Consumption
							sb.append("</font></td> ");
							
							sb.append("<td align='center'  width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' >");   
							sb.append(ws.getString(3));  //45_Days_Consumption
							sb.append("</font></td> ");
							...
							sb.append("<td align='center'  width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' >");   
							sb.append(ws.getString(4)); //Stock
							sb.append("</font></td> ");
							
							sb.append("<td align='center'  width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' >");   
							sb.append(ws.getString(5)); //REQ_Qty
							sb.append("</font></td> ");
														
							sb.append("<td align='center'  width='15%'><font face='Verdana, Arial, Helvetica, sans-serif' >");  
							sb.append(ws.getString(6)); // Po_Status
							sb.append("</font></td> ");	
							
							sb.append("<td align='center'  width='15%'><font face='Verdana, Arial, Helvetica, sans-serif' >");  
							sb.append(ws.getString(7)); // Consumption Pattern
							sb.append("</font></td> ");		
