 ...
 */
public class StockOnHandRptHLP {
	 ...
	 */
	public static String printVitalDrugList(StockOnHandRptVO_NEW vo) throws Exception {
		int programmeSize = 0;
		int counter = 0;
		int slNo = 0;
		int keyValue = 0;
	...
	public static String printReportRpt1(StockOnHandRptVO_NEW vo,String reportHeader, HttpServletRequest request) throws Exception
	{
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
	...
	public static String printBatchWiseReportRpt(StockOnHandRptVO_NEW vo,String reportHeader, HttpServletRequest request,StockOnHandRptFB_NEW formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
...
//							br.append("</tr>");
	...
	public static String printBatchWiseReportRptNew(StockOnHandRptVO_NEW vo,String reportHeader, HttpServletRequest request,StockOnHandRptFB_NEW formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
	...
	public static String printBatchWiseReportRptForMail(StockOnHandRptVO_NEW vo,String reportHeader, HttpServletRequest request,StockOnHandRptFB_NEW formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
	...
	public static String printWithOutBatchReport(StockOnHandRptVO_NEW vo,String reportHeader, HttpServletRequest request ,StockOnHandRptFB_NEW formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
...
//						+ "onClick='generateXLSCommon(event, indentItemListDivId);' /></div></td></tr></table>");
	...
	public static String getReportHeader(
			StockOnHandRptVO_NEW vo,
			StockOnHandRptFB_NEW formBean,  String strIndentItemList,
