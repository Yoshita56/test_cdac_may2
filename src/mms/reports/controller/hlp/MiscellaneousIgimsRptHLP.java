...
public class MiscellaneousIgimsRptHLP {

	public static String getMiscellaneousConsDetails(MiscellaneousIgimsRptVO vo) 
	{
		...
		if (ws != null) 
		{
			sb.append("<table  width='100%' align='center' cellspacing='1px' cellpadding='1px' border='0'>"
					+ " <tr> "
					+ " <td colspan='1'><div align='center'><img src='/INVMGM/hisglobal/images/aiims_header_24922.png' ></div></td>"
...
//							+ "<font face='Verdana, Arial, Helvetica, sans-serif' size='2'>"						
//							+ "For CR No::<b>"+vo.getStrCrNo()+"</b></font></td><td align='center' colspan='2'></td></tr>"); 
