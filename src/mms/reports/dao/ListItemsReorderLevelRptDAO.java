...
public class ListItemsReorderLevelRptDAO {
	
	public static void getStoreList(ListItemsReorderLevelRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","ListItemsReorderLevelRptDAO");
			...
			voObj
					.setStrMsgString("ListItemsReorderLevelRptDAO.getStoreList() --> "
							+ e.getMessage());
	...
	public static void getItemCatList(ListItemsReorderLevelRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListItemsReorderLevelRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
