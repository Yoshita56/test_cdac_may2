 ...
 */
public class ConsolidatedChallanDAO_NEW {
	 ...
	 */
	public static void getCircleList(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	public static void getDistrictList(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	/*public static void getStoreTypeList(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	public static void getDwhTypeCombo(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	public static void getStoreList(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	public static void getSubStoreList(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	public static void getItemCatList(ConsolidatedChallanVO_NEW voObj) {
...
-*/
	 ...
	 */
	public static void getGroupList(ConsolidatedChallanVO_NEW voObj) {
	 ...
	 */
	public static void getDrugList(ConsolidatedChallanVO_NEW voObj) {
	...
	/*public static void getDrugList(ConsolidatedChallanVO_NEW vo) {
...
*/
	 ...
	 *            the vo obj
	 */
	public static void GetUserLevel(ConsolidatedChallanVO_NEW voObj) {
		HisDAO daoObj = null;
		WebRowSet ws = null;
	 ...
	 */
	public static void getItemTypeValues(ConsolidatedChallanVO_NEW vo) {
		HisDAO dao = null;
		String strQuery = "";
		int nQueryIndex = 0;
		WebRowSet web = null;
	 ...
	 */
	public static void getProgrammeCombo(ConsolidatedChallanVO_NEW vo) {
	...
	public static void getPoCombo(ConsolidatedChallanVO_NEW voObj) {
