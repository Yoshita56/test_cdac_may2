...
public class ItemTransferRPTDAO {
	
	public static void storeName(ItemTransferRPTVO vo)
	{
	...
	public static void getViewDtl(ItemTransferRPTVO vo)
	{
		
//		String strProcName = "{call pkg_mms_view2.Indent_Wise_Issue_Report(?,?,?,?,?,?,?,?)}";
		String strProcName = "{call pkg_mms_view2.proc_item_transfer_report(?,?,?,?,?  ,?,?,?,? )}";
		int nProcIndex = 0;
		String strErr = "";
		...
		try
		{
			...
			daoObj.setProcInValue(nProcIndex, "debitNo", 		"0",7);
	...
	public static void itemCategory(ItemTransferRPTVO vo)
	{
	...
	public static void getInstituteList(ItemTransferRPTVO vo) {
	...
	public static void lpitemName(ItemTransferRPTVO vo) {
...
//	Supplier Combo
	...
	public static void getSupplierCombo(ItemTransferRPTVO vo) {
	...
	public static void getImageHeader(ItemTransferRPTVO vo)
	{
		String strFuncName = "";
		String strLogoName = "";
