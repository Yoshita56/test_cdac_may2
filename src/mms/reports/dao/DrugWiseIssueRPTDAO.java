...
public class DrugWiseIssueRPTDAO {
	
	public static void storeName(DrugWiseIssueRPTVO vo)
	{
	...
	public static void getViewDtl(DrugWiseIssueRPTVO _LocalPurchaseMRN_VO)
	{
		...
		try
		{
			...
			System.out.println(" ----------pkg_mms_view2.Indent_Wise_Issue_Report ------ [Mode - 2]");
	...
	public static void itemCategory(DrugWiseIssueRPTVO vo)
	{
	...
	public static void getInstituteList(DrugWiseIssueRPTVO vo) {
	...
	public static void lpitemName(DrugWiseIssueRPTVO vo) {
...
//	Supplier Combo
	...
	public static void getSupplierCombo(DrugWiseIssueRPTVO vo) {
	...
	public static void getImageHeader(DrugWiseIssueRPTVO vo)
	{
		String strFuncName = "";
		String strLogoName = "";
