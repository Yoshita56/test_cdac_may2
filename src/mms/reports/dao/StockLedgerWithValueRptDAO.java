/**********************************************************
 Project:	   DWH_GUJARAT	
 File:         StockLedgerWithValueRptDAO.java
 Created:      Jul 3, 2014
 ...
 * 
 */
public class StockLedgerWithValueRptDAO {
	 ...
	 */
	public static void getStoreList(StockLedgerWithValueRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions", "StockLedgerWithValueRptDAO");
			...
			voObj.setStrMsgString("StockLedgerWithValueRptDAO.getStoreList() --> " + e.getMessage());
	 ...
	 * @param voObj the vo obj
	 */
	public static void getItemCatList(StockLedgerWithValueRptVO voObj) {
		...
		try {
			...
			voObj.setStrMsgString("StockLedgerWithValueRptDAO.getItemCatList() --> " + e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 * @param voObj the vo obj
	 */
	public static void getSectionList(StockLedgerWithValueRptVO vo) 
	{
	...
	public static void getGroupList(StockLedgerWithValueRptVO voObj) {
		...
		try {
			...
			voObj.setStrMsgString("StockLedgerWithValueRptDAO.getGroupList() --> " + e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 * @param voObj the vo obj
	 */
	public static void getItemList(StockLedgerWithValueRptVO voObj) {
...
String strore=voObj.getStrStoreId()==null || voObj.getStrStoreId()==""?"0":voObj.getStrStoreId();
	 ...
	 */
	public static void getData_ORG(StockLedgerWithValueRptVO vo) {
		String err = "";
		...
		try {
			...
			dao = new HisDAO("MMS Reports", "StockLedgerWithValueRptDAO");
			//dao.setConnType("2");
			...
			dao.setProcInValue(procIndex1, "grpId", 		(vo.getStrgroupId()==null || vo.getStrgroupId().equals(""))?"0":vo.getStrgroupId());
			...
			e.printStackTrace();
			vo.setStrMsgString("StockLedgerWithValueRptDAO.getData() --> " + e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void getData(StockLedgerWithValueRptVO vo) {
		String err = "";
		String strProcName = "{call pkg_mms_view2.rptm__new_cons_ledger_dtl(?,?,?,?,?, ?,?,?,?,?,  ?)}"; //11
		...
		try {
			...
			if(vo.getStrItemCatId().equals("10"))
			{
				...
				dao.setProcInValue(procIndex1, "modeval", 	"3"); // Batch Wise Or Without Batch Wise
			}
			else
			{	
	 ...
	 * @param vo the stock ledger for sub stores rpt v o_p
	 */
	public static void getDetailedStockLedgerDtl_ORG(StockLedgerWithValueRptVO vo) {
		String err = "";
	...
	public static void getDetailedStockLedgerDtl(StockLedgerWithValueRptVO vo) {
		String err = "";
		String strProcName = "{call Pkg_Mms_view2.rptm_new_dtl_ledger_dtl(?,?,?,?,?, ?,?,?,?)}"; // Total
																									// 9
																									// Variables
	 ...
	 * @param vo the vo
	 */
	public static  void  getItemTypeValues (StockLedgerWithValueRptVO vo) {
		HisDAO dao = null;
		String strQuery = "";
		int nQueryIndex = 0;
		WebRowSet web = null;
		try {
			dao = new HisDAO("MMS", "StockLedgerWithValueRptDAO");
	 ...
	 * @param vo the vo
	 */
	public static  void  getJobInitializeDate(StockLedgerWithValueRptVO vo) {
		HisDAO dao = null;
		String strQuery = "";
		int nQueryIndex = 0;
		WebRowSet web = null;
	...
	public static void getFYCombo(StockLedgerWithValueRptVO voObj) {
		...
		try {
			...
			daoObj.setProcInValue(nProcIndex, "hosp_code",voObj.getStrHospitalCode() );
			daoObj.setProcInValue(nProcIndex, "demandstrid", voObj.getStrStoreId() == null ? "0" : voObj.getStrStoreId());
			daoObj.setProcOutValue(nProcIndex, "err", 1);
			daoObj.setProcOutValue(nProcIndex, "resultset", 2);
			...
			voObj.setStrMsgString("StockLedgerForSubStoresRptItemNewDAO.setFYCombo() --> " + e.getMessage());
			voObj.setStrMsgType("1");
