 ...
 */
public class ItemListingRptDAO_NEW {
	...
	public static void setStoreCombo(ItemListingRptVO_NEW _IssueDetailRptVO_NEW) {
	...
	public static void setItemCategCombo(ItemListingRptVO_NEW _IssueDetailRptVO_NEW) {
	 ...
	 */
	public static void getDrugNameCombo(ItemListingRptVO_NEW voObj) {
	...
	public static void getExistingBatchList(ItemListingRptVO_NEW vo) {
	 ...
	 */
	public static void getProgrammeCombo(ItemListingRptVO_NEW vo) {
