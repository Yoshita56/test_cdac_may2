...
public class StockReceiptRegisterRptDAO {
	
	public static void getStoreList(StockReceiptRegisterRptVO voObj) {
		...
		strErr = daoObj.getString(nprocIndex, "err");
			...
			voObj.setStrMsgString("StockReceiptRegisterRptDAO.getStoreList() --> "+ e.getMessage());
	...
	public static void getItemCatList(StockReceiptRegisterRptVO voObj) {
		...
		try
		{daoObj = new HisDAO("mms", "StockReceiptRegisterRptDAO");
		String strProcName = "{call pkg_mms_rpt.Rptm_item_category_list(?,?,?,?,?)}";
		nprocIndex = daoObj.setProcedure(strProcName);
	...
	public static void getItemList(StockReceiptRegisterRptVO voObj) {
	...
	public static void getSupplierList(StockReceiptRegisterRptVO voObj) {
	...
	public static void GetUserLevel(StockReceiptRegisterRptVO voObj) {
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		//	
			...
			voObj.setStrMsgString("StockReceiptRegisterRptDAO.getUserLevel() --> "	+ e.getMessage());
			voObj.setStrMsgType("1");
