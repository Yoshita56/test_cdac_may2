...
public class StockOnHand_oldRptDAO {
	
	public static void getStoreList(StockOnHand_oldRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","StockOnHand_oldRptDAO");
			...
			voObj
					.setStrMsgString("StockOnHand_oldRptDAO.getStoreList() --> "
							+ e.getMessage());
	 ...
	 * @param voObj
	 */
	public static void getDistrictStoreList(StockOnHand_oldRptVO voObj) {
	...
	public static void getItemCatList(StockOnHand_oldRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("StockOnHand_oldRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getGroupList(StockOnHand_oldRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("StockOnHand_oldRptDAO.getGroupList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
