...
public class MiscellaneousIgimsRptDAO {

	public static void setStoreCombo(MiscellaneousIgimsRptVO _IssueDetailRptVO_NEW) {
	...
	public static void setItemCategCombo(MiscellaneousIgimsRptVO _IssueDetailRptVO_NEW) {
	...
	public static void getDrugNameCombo(MiscellaneousIgimsRptVO voObj) {
	...
	public static void getExistingBatchList(MiscellaneousIgimsRptVO vo) {
	...
	public static void getProgrammeCombo(MiscellaneousIgimsRptVO vo) {
	...
	public static void getImageHeader(MiscellaneousIgimsRptVO voObj)
	{
		String strFuncName = "";
		String strLogoName = "";
	...
	public static void getViewDtl(MiscellaneousIgimsRptVO voObj)
	{
		...
		try 
		{
			...
			daoObj.setProcInValue(nProcIndex,  "crno", voObj.getStrCrNo(),7);	
			daoObj.setProcInValue(nProcIndex, "groupid", "0",8);
