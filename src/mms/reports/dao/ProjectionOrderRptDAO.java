...
/**
 * The Class ProjectionOrderRptDAO.
 */
public class ProjectionOrderRptDAO {
	 ...
	 */
	public static void getCircleList(ProjectionOrderRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions", "projectionOrderRptDAO");
			//
			...
			voObj.setStrMsgString("ProjectionOrderRptDAO.getCircleList() --> "
					+ e.getMessage());
	 ...
	 */
	public static void getDistrictList(ProjectionOrderRptVO voObj) {
		...
		try {
			...
			voObj.setStrMsgString("ProjectionOrderRptDAO.getDistrictList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getDwhTypeCombo(ProjectionOrderRptVO voObj) {
		...
		try {
			daoObj = new HisDAO("DWH", "projectionOrderRptDAO");
			//
			nProcIndex = daoObj.setProcedure(strProcName);
			...
			e.printStackTrace();
			voObj.setStrMsgString("ProjectionOrderRptDAO.getStoreList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getStoreList(ProjectionOrderRptVO voObj) {
	...
	//	String strProcName = "{call Pkg_Mms_View.poc_hstt_store_mst(?,?,?,?,?,?,?)}";
		...
		strErr = daoObj.getString(nprocIndex, "err");
			...
			voObj
					.setStrMsgString("ProjectionOrderRptDAO.getStoreList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getSubStoreList(ProjectionOrderRptVO voObj) {
		...
		try {
            ...
            e.printStackTrace();
			voObj.setStrMsgString("ProjectionOrderRptDAO.getStoreList() --> "+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getItemCatList(ProjectionOrderRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ProjectionOrderRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
...
-*/
	 ...
	 */
	public static void getGroupList(ProjectionOrderRptVO voObj) {
		...
		try {
			...
			voObj.setStrMsgString("ProjectionOrderRptDAO.getGroupList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getDrugList(ProjectionOrderRptVO voObj) {
		...
		try {
			...
			e.printStackTrace();
			voObj.setStrMsgString("ProjectionOrderRptDAO.getDrugList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
...
*/
	 ...
	 *            the vo obj
	 */
	public static void GetUserLevel(ProjectionOrderRptVO voObj) {
		HisDAO daoObj = null;
		WebRowSet ws = null;
	 ...
	 */
	public static void getItemTypeValues(ProjectionOrderRptVO vo) {
		HisDAO dao = null;
		String strQuery = "";
		int nQueryIndex = 0;
		WebRowSet web = null;
		try {
			dao = new HisDAO("MMS", "projectionOrderRptDAO");
			...
			// e.printStackTrace();
			vo.setStrMsgString("ProjectionOrderRptDAO.getItemValues() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (dao != null) {
	 ...
	 */
	public static void getProgrammeCombo(ProjectionOrderRptVO vo) {
	...
	public static void getFYCombo(ProjectionOrderRptVO vo) 
	{
	...
	public static void getReport(ProjectionOrderRptVO vo) 
	{	
		HisDAO dao = null;
		WebRowSet ws = null;
		int procIndex1 = 0;
		...
		try{
			dao = new HisDAO("MMS Transactions","projectionOrderRptDAO");
			String strProcName = "{call PKG_MMS_VIEW2.proc_rptm_projection_order_report(?,?,?,?,? , ?,?,?,?,?)}";
