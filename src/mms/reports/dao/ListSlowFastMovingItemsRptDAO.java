...
public class ListSlowFastMovingItemsRptDAO {
	
	public static void getStoreList(ListSlowFastMovingItemsRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","ListSlowFastMovingItemsRptDAO");
			...
			voObj
					.setStrMsgString("ListSlowFastMovingItemsRptDAO.getStoreList() --> "
							+ e.getMessage());
	...
	public static void getItemCatList(ListSlowFastMovingItemsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListSlowFastMovingItemsRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
