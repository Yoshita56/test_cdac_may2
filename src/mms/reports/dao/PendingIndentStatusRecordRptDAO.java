...
public class PendingIndentStatusRecordRptDAO {
	
	public static void getStoreList(PendingIndentStatusRecordRptVO voObj) {
	...
	public static void getItemCatList(PendingIndentStatusRecordRptVO voObj) {
...
*/
	...
	strErr = daoObj.getString(nprocIndex, "err");
		...
		if (strErr.equals("")) {
			...
			ws = daoObj.getWebRowSet(nprocIndex, "resultset");
			//System.out.println("getItemCatList ::ws.size()"+ws.size());
	...
	public static void getIReqTypeList(PendingIndentStatusRecordRptVO voObj) {
	...
	/* ==new Added== */
	public static void getViewDtl(PendingIndentStatusRecordRptVO voObj)
	{
	...
	public static void getPartialIssueDtls(PendingIndentStatusRecordRptVO voObj) 
	{
		...
		{							 
			...
			daoObj = new HisDAO("MMS Transactions","PendingIndentStatusRecordRptDAO");
		    String strproc_name = "{call pkg_mms_rpt.rptm_partial_issue_dtl(?,?,?,?,?  ,?,?,?,?)}"; 
		    nprocIndex = daoObj.setProcedure(strproc_name);		
			daoObj.setProcInValue(nprocIndex, "modeval",	"1",1);
			daoObj.setProcInValue(nprocIndex, "hosp_code",	voObj.getStrHospitalCode(),2);
			...
			if (strErr.equals("")) {
				...
				ws = daoObj.getWebRowSet(nprocIndex, "resultset");
				//System.out.println("getPartialIssueDtls :: ws.size()"+ws.size());
			...
			voObj.setStrMsgString("PendingIndentStatusRecordRptDAO.getStoreList() --> "+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getIssuedDtls(PendingIndentStatusRecordRptVO voObj) 
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		int nprocIndex = 0;
		...
		{							 
			daoObj = new HisDAO("MMS Transactions","PendingIndentStatusRecordRptDAO");
//		    String strproc_name = "{call pkg_mms_rpt.rptm_pendingindent_status_issued(?,?,?,?,?  ,?,?,?,?,?)}";
		    String strproc_name = "{call pkg_mms_view2.rptm_issuednotissued_status(?,?,?,?,?  ,?,?,?,?)}";
			...
			if (strErr.equals("")) {
				...
				ws = daoObj.getWebRowSet(nprocIndex, "resultset");
				//System.out.println("getStrIssueWs :: ws.size()"+ws.size());
				voObj.setStrIssueWs(ws);
	...
	public static void getNotIssuedDtls(PendingIndentStatusRecordRptVO voObj) 
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		int nprocIndex = 0;
		...
		{							 
			daoObj = new HisDAO("MMS Transactions","PendingIndentStatusRecordRptDAO");
//		    String strproc_name = "{call pkg_mms_rpt.rptm_pendingindent_status(?,?,?,?,?  ,?,?,?,?)}";
		    String strproc_name = "{call pkg_mms_view2.rptm_issuednotissued_status(?,?,?,?,?  ,?,?,?,?)}";
			...
			if (strErr.equals("")) {
				...
				ws = daoObj.getWebRowSet(nprocIndex, "resultset");
				//System.out.println("getStrNotIssueWs :: ws.size()"+ws.size());
				voObj.setStrNotIssueWs(ws);
