...
public class DrugWarehouseWiseSupplierDeliveryDetailRptDAO
{
	 ...
	 * @param voObj
	 */
	public static void getDwhTypeCombo(DrugWarehouseWiseSupplierDeliveryDetailRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("DWH","DrugWarehouseWiseSupplierDeliveryDetailRptDAO");
...
//				voObj.setStrDrugWarehouseTypeWs(ws);
			...
			voObj
					.setStrMsgString("DrugWarehouseWiseSupplierDeliveryDetailRptDAO.getDwhTypeCombo() --> "
							+ e.getMessage());
	 ...
	 * @param voObj
	 */
	public static void getStoreList(DrugWarehouseWiseSupplierDeliveryDetailRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("DrugWarehouseWiseSupplierDeliveryDetailRptDAO.getStoreList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getSuppliedByList(DrugWarehouseWiseSupplierDeliveryDetailRptVO vo) {
