...
public class IssueReceiveLedgerRptDAO {
	 ...
	 */
	public static void getCircleList(IssueReceiveLedgerRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions", "IssueReceiveLedgerRptDAO");
			//
			...
			voObj.setStrMsgString("IssueReceiveLedgerRptDAO.getCircleList() --> "
					+ e.getMessage());
	 ...
	 */
	public static void getDistrictList(IssueReceiveLedgerRptVO voObj) {
		...
		try {
			...
			voObj.setStrMsgString("IssueReceiveLedgerRptDAO.getDistrictList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getDwhTypeCombo(IssueReceiveLedgerRptVO voObj) {
		...
		try {
			daoObj = new HisDAO("DWH", "IssueReceiveLedgerRptDAO");
			//
			nProcIndex = daoObj.setProcedure(strProcName);
			...
			e.printStackTrace();
			voObj.setStrMsgString("IssueReceiveLedgerRptDAO.getStoreList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getStoreList(IssueReceiveLedgerRptVO voObj) {
	...
	//	String strProcName = "{call Pkg_Mms_View.poc_hstt_store_mst(?,?,?,?,?,?,?)}";
		...
		strErr = daoObj.getString(nprocIndex, "err");
			...
			voObj
					.setStrMsgString("IssueReceiveLedgerRptDAO.getStoreList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getSubStoreList(IssueReceiveLedgerRptVO voObj) {
		...
		try {
            ...
            e.printStackTrace();
			voObj.setStrMsgString("IssueReceiveLedgerRptDAO.getStoreList() --> "+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getItemCatList(IssueReceiveLedgerRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("IssueReceiveLedgerRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
...
-*/
	 ...
	 */
	public static void getGroupList(IssueReceiveLedgerRptVO voObj) {
		...
		try {
			...
			voObj.setStrMsgString("IssueReceiveLedgerRptDAO.getGroupList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getDrugList(IssueReceiveLedgerRptVO voObj) {
		...
		try {
			...
			e.printStackTrace();
			voObj.setStrMsgString("IssueReceiveLedgerRptDAO.getDrugList() --> "
					+ e.getMessage());
			voObj.setStrMsgType("1");
...
*/
	 ...
	 *            the vo obj
	 */
	public static void GetUserLevel(IssueReceiveLedgerRptVO voObj) {
		HisDAO daoObj = null;
		WebRowSet ws = null;
	 ...
	 */
	public static void getItemTypeValues(IssueReceiveLedgerRptVO vo) {
		HisDAO dao = null;
		String strQuery = "";
		int nQueryIndex = 0;
		WebRowSet web = null;
		try {
			dao = new HisDAO("MMS", "IssueReceiveLedgerRptDAO");
			...
			// e.printStackTrace();
			vo.setStrMsgString("IssueReceiveLedgerRptDAO.getItemValues() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (dao != null) {
	 ...
	 */
	public static void getProgrammeCombo(IssueReceiveLedgerRptVO vo) {
	...
	public static void getFYCombo(IssueReceiveLedgerRptVO vo) 
	{
	...
	public static void getImageHeader(IssueReceiveLedgerRptVO vo)
	{
		String strFuncName = "";
		String strLogoName = "";
		...
		try 
		{
			...
			e.printStackTrace();
			vo.setStrMsgType("1");
			vo.setStrMsgString("IssueReceiveLedgerRptDAO.getImageHeader() --> "+ e.getMessage());
	...
	public static void getReport(IssueReceiveLedgerRptVO vo) 
	{	
		HisDAO dao = null;
		WebRowSet ws = null;
		int procIndex1 = 0;
		...
		try{
			dao = new HisDAO("MMS Transactions","IssueReceiveLedgerRptDAO");
//			modeval character varying, hosp_code character varying, catcode character varying, grpid character varying, 
//			drugtypeid character varying, p_hstnum_store_id character varying, p_itembrand_id character varying, 
//			p_financial_year character varying, p_report_type character varying, p_month character varying, 
//			OUT err character varying, OUT resultset refcursor
			String strProcName = "{call PKG_MMS_VIEW2.proc_issue_receive_ledger_report(?,?,?,?,? , ?,?,?,?,?,  ?,?)}";  //12
			...
			dao.setProcInValue(procIndex1, "p_date", 		    vo.getStrSelectedDate(),5);				
			...
			dao.setProcInValue(procIndex1, "p_report_type", 	vo.getStrReportTypeId(),9);
			dao.setProcInValue(procIndex1, "p_month", 	        vo.getStrReportMonthId(),10);
			...
			if (strErr.equals("")) {
				...
				{	
				   if(ws.next())
				   {
					   vo.setStrReportMonthName(ws.getString(3));					   
					   ws.beforeFirst();
				   }
				}
