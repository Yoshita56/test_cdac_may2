...
public class IndentWiseIssueRPTDAO {
	
	public static void storeName(IndentWiseIssueRPTVO vo)
	{
	...
	public static void getViewDtl(IndentWiseIssueRPTVO _LocalPurchaseMRN_VO)
	{
		
		String strProcName = "{call pkg_mms_view2.Indent_Wise_Issue_Report(?,?,?,?,?,?,?,?)}";
		int nProcIndex = 0;
		String strErr = "";
		...
		try
		{
			...
			System.out.println(" ----------pkg_mms_view2.Indent_Wise_Issue_Report ------ " +  _LocalPurchaseMRN_VO.getStrActId());
	...
	public static void itemCategory(IndentWiseIssueRPTVO vo)
	{
	...
	public static void getInstituteList(IndentWiseIssueRPTVO vo) {
	...
	public static void lpitemName(IndentWiseIssueRPTVO vo) {
...
//	Supplier Combo
	...
	public static void getSupplierCombo(IndentWiseIssueRPTVO vo) {
	...
	public static void getImageHeader(IndentWiseIssueRPTVO vo)
	{
		String strFuncName = "";
		String strLogoName = "";
