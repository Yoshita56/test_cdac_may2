...
public class StoreHierarchyViewVO {
	...
	private WebRowSet WsReturnReqDtlRpt = null;
	/* <= */
    ...
    private String strReqTypeId="17";
    
    private WebRowSet strIssuingStoreWs = null;
	
	private String strToStoreCombo = "";
	
	private String strCatgName = "";
	private String strReqName = "";
	private String strIssuingStoreName = "";
	...
	public String getStrIssuingStoreName() {
		return strIssuingStoreName;
	}

	public void setStrIssuingStoreName(String strIssuingStoreName) {
		this.strIssuingStoreName = strIssuingStoreName;
	}
	...
	public WebRowSet getStrIssuingStoreWs() {
		return strIssuingStoreWs;
	}

	public void setStrIssuingStoreWs(WebRowSet strIssuingStoreWs) {
		this.strIssuingStoreWs = strIssuingStoreWs;
	}
	...
	public WebRowSet getWsReturnReqDtlRpt() {
		return WsReturnReqDtlRpt;
	}

	public void setWsReturnReqDtlRpt(WebRowSet wsReturnReqDtlRpt) {
		WsReturnReqDtlRpt = wsReturnReqDtlRpt;
	}
