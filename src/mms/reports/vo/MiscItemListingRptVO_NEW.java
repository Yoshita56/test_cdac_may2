 ...
 */
public class MiscItemListingRptVO_NEW {
	...
	/* change */
	private WebRowSet WsMiscellaneousConsDtlRpt =null;
	/* change */
	...
	public WebRowSet getWsMiscellaneousConsDtlRpt() {
		return WsMiscellaneousConsDtlRpt;
	}

	public void setWsMiscellaneousConsDtlRpt(WebRowSet wsMiscellaneousConsDtlRpt) {
		WsMiscellaneousConsDtlRpt = wsMiscellaneousConsDtlRpt;
	}
	...
	public void setStrReportFormat(String setStrReportFormat) {
		this.StrReportFormat = setStrReportFormat;
	}
