...
/**
 * The Class ProjectionOrderRptVO.
 */
public class IssueReceiveLedgerRptVO {
	...
	private WebRowSet strSectionWS = null;
	private WebRowSet strStockInHandRptWS = null;
	...
	private String strDrugTypeName;
	private String strIsItemWise;
	private String strIsGroupWise;
	
	private WebRowSet strFYCmbWS = null;
    private String strFYId;
	
    private String strLogoName;
	private String strSelectedDate;
	private String strReportMonthId;
	private String strReportTypeId;
	
	private String strItemCatgName;
	private String strReportMonthName;

	public String getStrReportMonthName() {
		return strReportMonthName;
	}

	public void setStrReportMonthName(String strReportMonthName) {
		this.strReportMonthName = strReportMonthName;
	}
	...
	public String getStrSelectedDate() {
		return strSelectedDate;
	}

	public void setStrSelectedDate(String strSelectedDate) {
		this.strSelectedDate = strSelectedDate;
	}

	public String getStrReportMonthId() {
		return strReportMonthId;
	}

	public void setStrReportMonthId(String strReportMonthId) {
		this.strReportMonthId = strReportMonthId;
	}
	...
	public String getStrFYId() {
		return strFYId;
	}

	public void setStrFYId(String strFYId) {
		this.strFYId = strFYId;
	}
	...
	public void setStrFYCmbWS(WebRowSet strFYCmbWS) {
		this.strFYCmbWS = strFYCmbWS;
	}
	...
	public String getStrDrugTypeName() {
		return strDrugTypeName;
	}

	public void setStrDrugTypeName(String strDrugTypeName) {
		this.strDrugTypeName = strDrugTypeName;
	}
	...
	public WebRowSet getStrSectionWS() {
		return strSectionWS;
	}

	public void setStrSectionWS(WebRowSet strSectionWS) {
		this.strSectionWS = strSectionWS;
	}

	public WebRowSet getStrStockInHandRptWS() {
		return strStockInHandRptWS;
	}

	public void setStrStockInHandRptWS(WebRowSet strStockInHandRptWS) {
		this.strStockInHandRptWS = strStockInHandRptWS;
	}
