 ...
 */
public class TransferOrderDetailTransFB extends GenericFormBean {
	...
	private String strStoreNameList;
	...
	public String getStrStoreNameList() {
		return strStoreNameList;
	}

	public void setStrStoreNameList(String strStoreNameList) {
		this.strStoreNameList = strStoreNameList;
	}
	 ...
	 * 
	 * @param strDemandRequest
	 *            the new str demand request
	 */
	 ...
	 * 
	 * @param strTransferOrderQty
	 *            the new str transfer order qty
	 */
	 ...
	 * 
	 * @param strTransferingDetails
	 *            the new str transfering details
	 */
	 ...
	 * 
	 * @param strDemandRequestDetails
	 *            the new str demand request details
	 */
