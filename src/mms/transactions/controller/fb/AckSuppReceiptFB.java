 ...
 * Date : 18/Jun/09
 */
public class AckSuppReceiptFB extends GenericFormBean {
	...
	public String getStrMrnNo() {
		return strMrnNo;
	}
	public void setStrMrnNo(String strMrnNo) {
		this.strMrnNo = strMrnNo;
	}
	...
	public String getStrMfgCombo() {
		return strMfgCombo;
	}
	public void setStrMfgCombo(String strMfgCombo) {
		this.strMfgCombo = strMfgCombo;
	}
	...
	public String getStrPurWidTaxRate() {
		return strPurWidTaxRate;
	}
	public void setStrPurWidTaxRate(String strPurWidTaxRate) {
		this.strPurWidTaxRate = strPurWidTaxRate;
	}
