...
public class LPIssueDeskTransFB extends GenericFormBean {
	...
	private String strAppRemarks;

	
	
	public String getStrAppRemarks() {
		return strAppRemarks;
	}
	public void setStrAppRemarks(String strAppRemarks) {
		this.strAppRemarks = strAppRemarks;
	}
