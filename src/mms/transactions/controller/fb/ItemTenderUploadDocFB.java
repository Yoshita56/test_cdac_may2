...
public class ItemTenderUploadDocFB extends ActionForm 
{
	...
	private String strUploadFileId4 = "";
	private String strUploadFileIdUpload = "";
	public String getStrUploadFileIdUpload() {
		return strUploadFileIdUpload;
	}



	public void setStrUploadFileIdUpload(String strUploadFileIdUpload) {
		this.strUploadFileIdUpload = strUploadFileIdUpload;
	}



	private String strUploadFileId3 = "";
	private String strHospitalCode = "";
	private String strFtpdestpath;
	private String strFtpPort;
	private String strFtpUsername;
	private String strFtpConnectionUri;
	private String strFtpPassword;
	private String strFtpRptconnection;
	...
	private String strUploadFileName3 = "";
	public String getStrUploadFileName3() {
		return strUploadFileName3;
	}



	public void setStrUploadFileName3(String strUploadFileName3) {
		this.strUploadFileName3 = strUploadFileName3;
	}



	public String getStrUploadFileName4() {
		return strUploadFileName4;
	}



	public void setStrUploadFileName4(String strUploadFileName4) {
		this.strUploadFileName4 = strUploadFileName4;
	}



	private String strUploadFileName4 = "";
	...
	public String getStrUploadFileId3() {
		return strUploadFileId3;
	}



	public void setStrUploadFileId3(String strUploadFileId3) {
		this.strUploadFileId3 = strUploadFileId3;
	}



	
	public String getStrUploadFileId4() {
		return strUploadFileId4;
	}



	public void setStrUploadFileId4(String strUploadFileId4) {
		this.strUploadFileId4 = strUploadFileId4;
	}
	public String getStrFtpdestpath() {
		return strFtpdestpath;
	}



	public void setStrFtpdestpath(String strFtpdestpath) {
		this.strFtpdestpath = strFtpdestpath;
	}



	public String getStrFtpPort() {
		return strFtpPort;
	}



	public void setStrFtpPort(String strFtpPort) {
		this.strFtpPort = strFtpPort;
	}



	public String getStrFtpUsername() {
		return strFtpUsername;
	}



	public void setStrFtpUsername(String strFtpUsername) {
		this.strFtpUsername = strFtpUsername;
	}



	public String getStrFtpConnectionUri() {
		return strFtpConnectionUri;
	}



	public void setStrFtpConnectionUri(String strFtpConnectionUri) {
		this.strFtpConnectionUri = strFtpConnectionUri;
	}
	...
	public String getStrFtpRptconnection() {
		return strFtpRptconnection;
	}



	public void setStrFtpRptconnection(String strFtpRptconnection) {
		this.strFtpRptconnection = strFtpRptconnection;
	}
