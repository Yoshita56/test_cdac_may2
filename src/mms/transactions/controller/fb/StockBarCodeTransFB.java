...
public class StockBarCodeTransFB extends ActionForm {
	...
	private String strHtmlCode=null;
	
	private String strSupplierCombo="";
	private String strSupplierName="";
	private String strSupplierId="";
	private String LpItemName="";
    ...
    private String strBarCodeHLP="";
    
    
	
	public String getStrBarCodeHLP() {
		return strBarCodeHLP;
	}
	public void setStrBarCodeHLP(String strBarCodeHLP) {
		this.strBarCodeHLP = strBarCodeHLP;
	}
	public String getLpItemName() {
		return LpItemName;
	}
	public void setLpItemName(String lpItemName) {
		LpItemName = lpItemName;
	}
	public String getLpItemvalue() {
		return LpItemvalue;
	}
	public void setLpItemvalue(String lpItemvalue) {
		LpItemvalue = lpItemvalue;
	}
