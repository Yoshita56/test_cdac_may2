...
public class DupSupplierReturnFromTransFB extends GenericFormBean {	
    ...
    private String strDebitNoteNumber;
    ...
    private String strdebitNoteList;
	...
	public String getStrDebitNoteNumber() {
		return strDebitNoteNumber;
	}
	public void setStrDebitNoteNumber(String strDebitNoteNumber) {
		this.strDebitNoteNumber = strDebitNoteNumber;
	}
	public String getStrdebitNoteList() {
		return strdebitNoteList;
	}
	public void setStrdebitNoteList(String strdebitNoteList) {
		this.strdebitNoteList = strdebitNoteList;
	}
