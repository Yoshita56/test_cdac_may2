 ...
 */
public class TransferRequestTransFB extends GenericFormBean {
	...
	/** The str order no view. */
	private String strOrderNoView = "";

	/** The str order no date. */
	private String strOrderNoDate = "";

	/** The str raising ddw view. */
	private String strRaisingDDWView = "";

	/** The str transfer ddw view. */
	private String strTransferDDWView = "";

	/** The str transfer req no view. */
	private String strTransferReqNoView = "";

	/** The str order qty view. */
	private String strOrderQtyView = "";

	/** The str transfer qty view. */
	private String strTransferQtyView = "";

	/** The str transfer details view. */
	private String strTransferDetailsView = "";

	// change by Sunit Rana
	/** The str time period. */
	...
	private String strOnlineAppStatus = "0";
	...
	/**
	 * Gets the str order no view.
	 * 
	 * @return the str order no view
	 */
	public String getStrOrderNoView() {
		return strOrderNoView;
	}

	/**
	 * Sets the str order no view.
	 * 
	 * @param strOrderNoView the new str order no view
	 */
	public void setStrOrderNoView(String strOrderNoView) {
		this.strOrderNoView = strOrderNoView;
	}

	/**
	 * Gets the str order no date.
	 * 
	 * @return the str order no date
	 */
	public String getStrOrderNoDate() {
		return strOrderNoDate;
	}

	/**
	 * Sets the str order no date.
	 * 
	 * @param strOrderNoDate the new str order no date
	 */
	public void setStrOrderNoDate(String strOrderNoDate) {
		this.strOrderNoDate = strOrderNoDate;
	}

	/**
	 * Gets the str raising ddw view.
	 * 
	 * @return the str raising ddw view
	 */
	public String getStrRaisingDDWView() {
		return strRaisingDDWView;
	}

	/**
	 * Sets the str raising ddw view.
	 * 
	 * @param strRaisingDDWView the new str raising ddw view
	 */
	public void setStrRaisingDDWView(String strRaisingDDWView) {
		this.strRaisingDDWView = strRaisingDDWView;
	}

	/**
	 * Gets the str transfer ddw view.
	 * 
	 * @return the str transfer ddw view
	 */
	public String getStrTransferDDWView() {
		return strTransferDDWView;
	}

	/**
	 * Sets the str transfer ddw view.
	 * 
	 * @param strTransferDDWView the new str transfer ddw view
	 */
	public void setStrTransferDDWView(String strTransferDDWView) {
		this.strTransferDDWView = strTransferDDWView;
	}

	/**
	 * Gets the str transfer req no view.
	 * 
	 * @return the str transfer req no view
	 */
	public String getStrTransferReqNoView() {
		return strTransferReqNoView;
	}

	/**
	 * Sets the str transfer req no view.
	 * 
	 * @param strTransferReqNoView the new str transfer req no view
	 */
	public void setStrTransferReqNoView(String strTransferReqNoView) {
		this.strTransferReqNoView = strTransferReqNoView;
	}

	/**
	 * Gets the str order qty view.
	 * 
	 * @return the str order qty view
	 */
	public String getStrOrderQtyView() {
		return strOrderQtyView;
	}

	/**
	 * Sets the str order qty view.
	 * 
	 * @param strOrderQtyView the new str order qty view
	 */
	public void setStrOrderQtyView(String strOrderQtyView) {
		this.strOrderQtyView = strOrderQtyView;
	}

	/**
	 * Gets the str transfer qty view.
	 * 
	 * @return the str transfer qty view
	 */
	public String getStrTransferQtyView() {
		return strTransferQtyView;
	}

	/**
	 * Sets the str transfer qty view.
	 * 
	 * @param strTransferQtyView the new str transfer qty view
	 */
	public void setStrTransferQtyView(String strTransferQtyView) {
		this.strTransferQtyView = strTransferQtyView;
	}

	/**
	 * Gets the str transfer details view.
	 * 
	 * @return the str transfer details view
	 */
	public String getStrTransferDetailsView() {
		return strTransferDetailsView;
	}

	/**
	 * Sets the str transfer details view.
	 * 
	 * @param strTransferDetailsView the new str transfer details view
	 */
	public void setStrTransferDetailsView(String strTransferDetailsView) {
		this.strTransferDetailsView = strTransferDetailsView;
	}
	...
	/**
	 * Gets the str excess qty.
	 * 
	 * @return the str excess qty
	 */
	...
	/**
	 * Sets the str excess qty.
	 * 
	 * @param strExcessQty the new str excess qty
	 */
	...
	/**
	 * Gets the str batch dtl ws.
	 * 
	 * @return the str batch dtl ws
	 */
	...
	/**
	 * Sets the str batch dtl ws.
	 * 
	 * @param strBatchDtlWs the new str batch dtl ws
	 */
	...
	/**
	 * Gets the str batch hidden value.
	 * 
	 * @return the str batch hidden value
	 */
	...
	/**
	 * Sets the str batch hidden value.
	 * 
	 * @param strBatchHiddenValue the new str batch hidden value
	 */
	...
	/**
	 * Gets the str batch no detail.
	 * 
	 * @return the str batch no detail
	 */
	...
	/**
	 * Sets the str batch no detail.
	 * 
	 * @param strBatchNoDetail the new str batch no detail
	 */
	...
	/**
	 * Gets the str avl qty.
	 * 
	 * @return the str avl qty
	 */
	...
	/**
	 * Sets the str avl qty.
	 * 
	 * @param strAvlQty the new str avl qty
	 */
	...
	/**
	 * Gets the str mfg date.
	 * 
	 * @return the str mfg date
	 */
	...
	/**
	 * Sets the str mfg date.
	 * 
	 * @param strMfgDate the new str mfg date
	 */
	 ...
	 * 
	 * @param strExpDate the new str exp date
	 */
