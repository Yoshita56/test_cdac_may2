...
public class RequestForLPPatientCNT extends CSRFGardTokenAction
{
	...
	{
		 System.out.println("<<------ RequestForLPPatientCNT.GO    [ add_RequestForLPPatientTrans_mms.jsp ]    ------>>");
		generateToken(request);
	    ...
	    {
		   System.out.println("<<------ CR No != NULL ->> GetData1 ------>>");
	       RequestForLPPatientDATA.GetData1_OLD(fb, request);
	    }	
	...
	public ActionForward GO1(ActionMapping mapping, ActionForm form,
			...
			throws HisException, SQLException 
	{
		System.out.println("<<------ RequestForLPPatientCNT.GO1        ------>>");
		String strTarget = "requestForLpPatientJsp";
		RequestForLPPatientFB fb = (RequestForLPPatientFB) form;
		fb.setStrCrNo("");
		fb.setStrGoFlg("0");
	...
	public ActionForward INSERT(ActionMapping mapping, ActionForm form,
			...
			throws Exception 
	{
		System.out.println("<<------ RequestForLPPatientCNT.INSERT        ------>>");
