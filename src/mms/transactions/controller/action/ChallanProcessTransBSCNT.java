...
public class ChallanProcessTransBSCNT extends GenericController {
	...
	public ChallanProcessTransBSCNT() {

		super(new ChallanProcessTransUTL(),
				"/transactions/ChallanProcessTransBSCNT");
	}
			...
			throws HisException, SQLException 
	{
		...
		System.out.println("--------ChallanProcessTransBSCNT . RECEIVECHL -----");
	...
	public ActionForward VERIFYCHL(ActionMapping mapping, ActionForm form,
		...
		System.out.println("--------ChallanProcessTransBSCNT . VERIFYCHL -----");
			...
			HttpServletResponse response) throws HisException, SQLException 
	{
		...
		System.out.println("--------ChallanProcessTransBSCNT . SCHEDULEDTL -----");
	...
	public ActionForward VIEWCHL(ActionMapping mapping, ActionForm form,
		...
		System.out.println("--------ChallanProcessTransCNT . VIEWCHL --[ challanprocess_view_mmstrans.jsp ]---");
