...
public class ItemInventoryWithProgramTransCNT extends GenericController {
	...
	public ActionForward ADD(ActionMapping mapping, ActionForm form,
		...
		System.out.println("----------ItemInventoryWithProgramTransCNT.ADD----[ itemInventory_program_add_mmstrans.jsp ]---------");
		strtarget = "add";
	...
	public ActionForward ITEMNAME(ActionMapping mapping, ActionForm form,
		...
		System.out.println("----------ItemInventoryWithProgramTransCNT.ITEMNAME-------------");
	...
	public ActionForward GETGROUPNAME(ActionMapping mapping, ActionForm form,
		...
		System.out.println("----------ItemInventoryWithProgramTransCNT.GETGROUPNAME-------------");
	...
	public ActionForward ITEMBRANDNAME(ActionMapping mapping, ActionForm form,
		...
		System.out.println("----------ItemInventoryWithProgramTransCNT.ITEMBRANDNAME-------------");
	...
	public ActionForward EXISTINGBATCH(ActionMapping mapping, ActionForm form,
			...
			throws HisException, SQLException {
		ItemInventoryWithProgramTransFB formBean = (ItemInventoryWithProgramTransFB) form;
		System.out.println("----------ItemInventoryWithProgramTransCNT.EXISTINGBATCH-------------");
	...
	public ActionForward EXISTINGBATCHMODIFY(ActionMapping mapping, ActionForm form,
		...
		System.out.println("----------ItemInventoryWithProgramTransCNT.EXISTINGBATCHMODIFY-------------");
	...
	public ActionForward INSERT(ActionMapping mapping, ActionForm form,
			...
			throws HisException, SQLException {
		try {
			System.out.println("----------ItemInventoryWithProgramTransCNT.INSERT-------------");
	...
	public ActionForward INSERT2(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			//System.out.println("----------ItemInventoryWithProgramTransCNT.INSERT2-------------");
	...
	public ActionForward MODIFY(ActionMapping mapping, ActionForm form,
			...
			throws HisException, SQLException {
		try {
			//System.out.println("----------ItemInventoryWithProgramTransCNT.MODIFY-------------");
	...
	public ActionForward UPDATE(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			//System.out.println("----------ItemInventoryWithProgramTransCNT.UPDATE-------------");
	...
	public ActionForward PRINTVOUCHER(ActionMapping mapping, ActionForm form,
		...
		//System.out.println("----------ItemInventoryWithProgramTransCNT.PRINTVOUCHER-------------");
