 ...
 * 
 */
  public class PODeskGenerateTransBSCNT extends CSRFGardTokenAction   {
	...
	public ActionForward CANCELTODESK(ActionMapping mapping, ActionForm form,
		...
		acFwd.setPath("/mms/transactions/PODeskTransBSCNT.cnt?hmode=unspecified");
	...
	public ActionForward CANCELTOAPPROVALDESK(ActionMapping mapping, ActionForm form,
			...
			throws HisException {
		ActionForward acFwd = new ActionForward();
		acFwd.setPath("/mms/transactions/POApprovalDeskBSCNT.cnt?hmode=unspecified");
		acFwd.setContextRelative(true);
		return acFwd;
	}
	...
	public ActionForward GENERATE(ActionMapping _mapping, ActionForm _form,
		...
		System.out.println("*************** PODeskGenerateTransBSCNT . GENERATE [ generate_PODeskTrans_mmsNew.jsp , PODesk.js , POGenerateJSBS.js ] ***");
	...
	public ActionForward POMODIFY(ActionMapping _mapping, ActionForm _form,
		...
		System.out.println("*************** PODeskGenerateTransBSCNT . POMODIFY [ Modify_PODeskTrans_mms.jsp , PODesk.js , POGenerateJSBS.js ] ***");
		...
		PODeskGenerateTransDATA.setDeliveryLocationValues(poDeskGenerateTransFB, _request);
		PODeskGenerateTransDATA.setCurrencyValues(poDeskGenerateTransFB, _request);
		PODeskGenerateTransDATA.getRequestModifyItemDetailsBS(poDeskGenerateTransFB, _request, _response);
		ResourceBundle resObj = ResourceBundle.getBundle("hisglobal.hisconfig.hisProperties");
	...
	public ActionForward REQUESTDETAILS(ActionMapping _mapping, ActionForm _form,
			...
			throws HisException {
		PODeskGenerateTransFB poDeskGenerateTransFB = (PODeskGenerateTransFB)_form;
		PODeskGenerateTransDATA.getRequestDetailsBS(poDeskGenerateTransFB, _request, _response);
		return null;
	}
	...
	public ActionForward GETREQUESTITEMDETAILS(ActionMapping _mapping, ActionForm _form,
		...
		PODeskGenerateTransFB poDeskGenerateTransFB = (PODeskGenerateTransFB)_form;
		PODeskGenerateTransDATA.getRequestItemDetailsBS(poDeskGenerateTransFB, _request, _response);
		return null;
	}
	...
	public ActionForward APPROVAL(ActionMapping _mapping, ActionForm _form,
			...
			throws HisException 
	{
		System.out.println("*************** PODeskGenerateTransBSCNT . APPROVAL [ generate_POApproval_mms.jsp ] ***");
			...
			throws HisException 
	{
		...
		System.out.println("*************** PODeskGenerateTransBSCNT . VIEWAPPROVALPO [ view_POWithItemTransApproval_mms.jsp , POGenerateWithItem.js  ] ***");
			...
			throws HisException 
	{
		...
		System.out.println("*************** PODeskGenerateTransBSCNT . GENERATEITEMWISE [ generate_POWithItemTrans_mms.jsp , POGenerateWithItem.js ] ***");
	...
	public ActionForward SUPPLIERWISECOMPILATION(ActionMapping _mapping, ActionForm _form,
		...
		PODeskGenerateTransFB poDeskGenerateTransFB = (PODeskGenerateTransFB)_form;
		PODeskGenerateTransDATA.getSupplierWiseCompiledDataBS(poDeskGenerateTransFB, _request, _response);
		return null;
	}
	...
	public ActionForward INDENTNODETAIL(ActionMapping _mapping, ActionForm _form,
			...
			throws HisException {
		PODeskGenerateTransFB poDeskGenerateTransFB = (PODeskGenerateTransFB)_form;
		PODeskGenerateTransDATA.indentDetailBS(poDeskGenerateTransFB, _request, _response);
		return null;
	}
