...
public class RateContractDtlTransCNT extends GenericController 
{
			...
			throws HisException, SQLException 
	{
        ...
        System.out.println("-----------RateContractDtlTransCNT . ADD-----[ add_rate_contract_details_trans.jsp ]-------");
	...
	public ActionForward RENEW(ActionMapping mapping, ActionForm form,
		...
		RateContractDtlTransFB formBean = (RateContractDtlTransFB) form;
		 ...
		 System.out.println("-----------RateContractDtlTransCNT . RENEW-----[ renew_rate_contract_details_trans.jsp ]-------");
	...
	public ActionForward RCEXTN(ActionMapping mapping, ActionForm form,
        ...
        System.out.println("-----------RateContractDtlTransCNT . RCEXTN-----[ extn_rate_contract_details_trans.jsp ]-------");
		RateContractDtlTransFB formBean = (RateContractDtlTransFB) form;
		RateContractDtlTransDATA.viewDetails(formBean, request);// to get
		strtarget = "extn";
		return mapping.findForward(strtarget);
	...
	*/
	...
	public ActionForward VIEW(ActionMapping mapping, ActionForm form,
		...
		System.out.println("-----------RateContractDtlTransCNT . VIEW-----[ view_rate_contract_details_trans.jsp ]-------");
	...
	public ActionForward MODIFY(ActionMapping mapping, ActionForm form,
		...
		System.out.println("-----------RateContractDtlTransCNT . MODIFY-----[ modify_rate_contract_details_trans.jsp ]-------");
