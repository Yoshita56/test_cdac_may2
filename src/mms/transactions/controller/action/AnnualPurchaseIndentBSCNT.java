...
public class AnnualPurchaseIndentBSCNT extends CSRFGardTokenAction
{
	String strtarget;
	 ...
	 */
	public AnnualPurchaseIndentBSCNT()
	{
	...
	{
		System.out.println("----------- AnnualPurchaseIndentBSCNT . GO ----[ add_AnnualPurchaseIndentTrans_mmsNew.jsp ]-------");
		generateToken(request);
	...
	public ActionForward GO_NEW(ActionMapping mapping, ActionForm form,
			...
			throws HisException, SQLException 
	{
		System.out.println("----------- AnnualPurchaseIndentBSCNT . GO_NEW ----[ add_AnnualPurchaseIndentTrans_mmsNew.jsp ]-------");
		generateToken(request);
		String strTarget = "AnnualPurchaseIndentJsp";
		AnnualPurchaseIndentFB fb = (AnnualPurchaseIndentFB) form;
		AnnualPurchaseIndentDATA.GetData_NEW(fb, request);
	    return mapping.findForward(strTarget);
	}
