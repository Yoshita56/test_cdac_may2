...
import mms.transactions.controller.data.TransferExcessApprovalTransDATA;
import mms.transactions.controller.fb.TransferExcessApprovalTransFB;

/**
 * The Class TransferExcessApprovalTransCNT.
 */
public class TransferExcessApprovalTransCNT extends DispatchAction {
	...
	public ActionForward approve(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		TransferExcessApprovalTransFB formBean = (TransferExcessApprovalTransFB) form;
		...
		TransferExcessApprovalTransDATA.initialApproval(formBean, request,response);
	...
	public ActionForward insertRecord(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			retValue=TransferExcessApprovalTransDATA.insertRecord(formBean,request,response);
			if (retValue) {
			...
			System.out.println("TransferExcessApprovalTransCNT.INSERT >> " + e.getMessage());
		}
	...
	SQLException, IOException, ServletException {
		...
		formBean.setStrPath(path.trim());
		strTarget = "view";
		TransferExcessApprovalTransDATA.viewData(formBean, request,response);
		return mapping.findForward(strTarget);
		}
	/**
	 * Cancel to list.
