...
/**
 * Developer : Amit Kumar Version : 1.0 Date : 1/June/2009 Modif Date : 17/March
 * /2010
 */
...
public class IndentApprovalDeskCNT extends GenericController {
	...
	public ActionForward APPROVAL(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (strReqTypeId.equals("64") || strReqTypeId.equals("47") || strReqTypeId.equals("61")
				|| strReqTypeId.equals("65") || strReqTypeId.equals("15") || strReqTypeId.equals("16")
				|| strReqTypeId.equals("17") || strReqTypeId.equals("18") || strReqTypeId.equals("10")
				|| strReqTypeId.equals("11") || strReqTypeId.equals("12") || strReqTypeId.equals("13")
				|| strReqTypeId.equals("14") || strReqTypeId.equals("19") || strReqTypeId.equals("80")
				|| strReqTypeId.equals("81") || strReqTypeId.equals("82") || strReqTypeId.equals("86")
				|| strReqTypeId.equals("85") || strReqTypeId.equals("84") || strReqTypeId.equals("83")
				|| strReqTypeId.equals("90")) {
			System.out.println(
					"------IndentApprovalDeskCNT.APPROVAL------- [ IndentApproval_DeskTrans_mms.jsp ] -------------");

			strtarget = "indentApprovalDesk";
			IndentApprovalDeskDATA.ApprovedRecord(request, formBean);
		} else {
			System.out.println(
					"------IndentApprovalDeskCNT.APPROVAL------- [ IndentApproval_PhysicalStockVerif_DeskTrans_mms.jsp ] -------------");
	...
	/**
	 * View method is used to forward control to view page Controller
	 * 
	 * @param mapping
	 * @param form
	 * @param request
	...
	public ActionForward VIEW(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (strReqTypeId.equals("64") || strReqTypeId.equals("19") || strReqTypeId.equals("47")
				|| strReqTypeId.equals("61") || strReqTypeId.equals("65") || strReqTypeId.equals("15")
				|| strReqTypeId.equals("16") || strReqTypeId.equals("17") || strReqTypeId.equals("18")
				|| strReqTypeId.equals("10") || strReqTypeId.equals("11") || strReqTypeId.equals("12")
				|| strReqTypeId.equals("13") || strReqTypeId.equals("14") || strReqTypeId.equals("80")
				|| strReqTypeId.equals("81") || strReqTypeId.equals("82") || strReqTypeId.equals("85")
				|| strReqTypeId.equals("84") || strReqTypeId.equals("83") || strReqTypeId.equals("86")
				|| strReqTypeId.equals("90")) {
			if (appStatus.equals("0")) {
				strTarget = "view";
				System.out.println(
						"------IndentApprovalDeskCNT.APPROVAL------- [ IndentApproval_View_Trans_mms.jsp ] -------------");
				IndentApprovalDeskDATA.viewData(formBean, request);
			} else {
				strTarget = "appview";
				System.out.println(
						"------IndentApprovalDeskCNT.APPROVAL------- [ IndentApproval_AfterAppView_Trans_mms.jsp ] -------------");
				IndentApprovalDeskDATA.viewData(formBean, request);
			}
		} else {
	...
	public ActionForward INSERT(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		System.out.println("------IndentApprovalDeskCNT.INSERT------");
	 ...
	 * 
	 */
	public ActionForward INSERTPHYSICALSTOCK(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception, SQLException {
	 ...
	 */
	public ActionForward APPROVALPRINT(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws HisException, SQLException {

		IndentApprovalDeskFB formBean = (IndentApprovalDeskFB) form;
		System.out.println("-----------IndentApprovalDeskCNT . APPROVALPRINT [ Approval Voucher ]--------------");
		IndentApprovalDeskDATA.indentAppPrint(request, response, formBean);
	 ...
	 * @throws SQLException
	 */
	public ActionForward BLOCKEDITEMDTL(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws HisException, SQLException {
		IndentApprovalDeskFB formBean = (IndentApprovalDeskFB) form;
	...
	public ActionForward NONDISCREPANCYREPORT(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws HisException, SQLException {
	...
	public ActionForward BATCHWISEDTL(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws HisException, SQLException {
	...
	public ActionForward CANCELTODESK(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) {

		return this.CANCEL(mapping, form, request, response);
	}
	public ActionForward VOUCHER(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)
			throws HisException, SQLException {
		System.out.println("---- IndentApprovalDeskCNT . VOUCHER ----");

		IndentApprovalDeskFB formBean = (IndentApprovalDeskFB) form;
		IndentApprovalDeskDATA.getVoucherDtl(formBean, request, response);
