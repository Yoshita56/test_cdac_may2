...
import mms.transactions.bo.DrugInventoryWithProgramTransBO;
import mms.transactions.controller.fb.DrugInventoryWithProgramTransFB;
import mms.transactions.controller.hlp.DrugInventoryTransWithProgramHLP;
 ...
 */
public class DrugInventoryTransWithProgramDATA {
	...
	public static void initialAdd(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request) {

		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
		String strmsgText = "";
		...
		try {
			bo = new DrugInventoryWithProgramTransBO();
			vo = new DrugInventoryWithProgramTransVO();
	...
	public static void initialAddDummy(
			DrugInventoryWithProgramTransFB formBean, HttpServletRequest request) {
	...
	public static void initialAddPHD(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request) {
		...
		try 
		{
			System.out.println("--- DrugInventoryWithProgramTransDATA . initialAddPHD  -------");
			...
			if (vo.getStrManufactureComboWS().size() == 0 || vo.getStrManufactureComboWS() == null) {
				...
				manufCmb = hisutil.getOptionValue(vo.getStrManufactureComboWS(), "0", "0^Select Value",	true);
			}
	 ...
	 *            the form bean
	 */
	public static void modify(DrugInventoryWithProgramTransFB formBean,HttpServletRequest request, HttpServletResponse response) {
		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
		String strmsgText = "";
		HisUtil hisutil = null;
		...
		try {
			...
			if (!formBean.getComboValue().equals("")) {
				...
				strCmbNames = strCmbNames.replace("&", "and");
				String[] temp = strCmbNames.replace("^", "#").split("#");
				formBean.setStrStoreName(temp[0]);
				formBean.setStrGroupName(temp[1]);
			...
			*/
			if (vo.getStrManufactureComboWS().size() == 0
				...
				manufCmb = hisutil.getOptionValue(
						vo.getStrManufactureComboWS(), "0", "0^Select Value",
						true);
			}
			formBean.setStrManufactureCombo(manufCmb);
			formBean.setStrStoreTypeFlag(vo.getStrStoreTypeFlag());
	...
	public static void itemName(DrugInventoryWithProgramTransFB formBean,
	...
	public static void subGroupCombo(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getGroupName(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getExistingBatchInStock(
			DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getExistingBatchList(
		...
		try {
			...
			String cmbstr = hisutil.getOptionValue(
					vo.getStrExistingBatchComboWS(), "", "0^New Batch", false);
	...
	public static void getExistingBatchListModify(
		...
		try {
			...
			//formBean.setStrGroupName(temp[1]);
			//System.out.println("store id is "+temp[6]);*/
			...
			String strSeatId = request.getSession().getAttribute("SEATID").toString();
			 //String strStoreId = (String)temp[6];
			String strItemBrandId = (String) request.getParameter("strItemBrandId");
			String strIndex = (String) request.getParameter("index");
			String strProgrammeId=request.getParameter("strProgrammeId");
	...
	public static void getRateUnit(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			System.out.println("-------------DrugInventoryWithProgramTransDATA . getRateUnit----------------");
			bo = new DrugInventoryWithProgramTransBO();
			vo = new DrugInventoryWithProgramTransVO();
			...
			System.out.println("vo.getStrUnitListWs().size()--------"+vo.getStrUnitListWs().size());
			...
			strmsgText = "DrugInventory.DrugInventoryTransDATA.getRateUnit(vo) --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"DrugInventoryTransDATA->getRateUnit()", strmsgText);
			try {
				response.setHeader("Cache-Control", "no-cache");
				response.getWriter().print(
						"ERROR#### Application Error [ERROR ID : "
	...
	public static void itemBrandName(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void manufectuteName(
		...
		try {
			...
			HisUtil hisutil = new HisUtil("mms", "DrugInventoryTransDATA");
			String cmbstr = hisutil.getOptionValue(
					vo.getStrManufactureComboWS(), vo.getStrManufactureId(),
	...
	public static void insert2(DrugInventoryWithProgramTransFB formBean) {
		String strmsgText = "";
		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
		...
		try {
			...
			vo = (DrugInventoryWithProgramTransVO) TransferObjectFactory
					.populateData(
							"mms.transactions.vo.DrugInventoryWithProgramTransVO",
							formBean);
	...
	public static void insert(DrugInventoryWithProgramTransFB formBean) {
		String strmsgText = "";
		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
	...
	public static void dummyinsert(DrugInventoryWithProgramTransFB formBean) {
		String strmsgText = "";
		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
		...
		try {
			bo = new DrugInventoryWithProgramTransBO();
			vo = (DrugInventoryWithProgramTransVO) TransferObjectFactory
					.populateData("mms.transactions.vo.DrugInventoryWithProgramTransVO",formBean);
			...
			formBean.setStrStoreIdValue(vo.getStrStoreId());
	...
	public static void updateRecord(DrugInventoryWithProgramTransFB formBean,HttpServletRequest request) {
		String strmsgText = "";
		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
		...
		try {
			...
			vo.setStrUnitRateID(formBean.getStrUnitRateID());
			vo.setStrDrugTotCost(formBean.getStrDrugTotCost());
			//System.out.println("store "+formBean.getStrStoreId());
			bo.updateRecord(vo);			
	...
	public static void unitNameCombo(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 */
	public static boolean update(DrugInventoryWithProgramTransFB formBean) {
		String strmsgText = "";
		DrugInventoryWithProgramTransBO bo = null;
		DrugInventoryWithProgramTransVO vo = null;
	 ...
	 */
	public static void getIsModify(DrugInventoryWithProgramTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void printVoucher(HttpServletRequest request,
			HttpServletResponse response, DrugInventoryWithProgramTransFB formBean) 
	{
		...
		/*	if(formBean.getWsItemDetails().next() && formBean.getWsItemDetails().size() > 0)
			{
				...
				//System.out.println("valuee"+formBean.getWsItemDetails().getString(1));
				//System.out.println("valuee"+formBean.getWsItemDetails().getString(2));
			...
			*/
			...
			strItemAddedView = DrugInventoryTransWithProgramHLP.getAddItemVoucherView(formBean,vo);
