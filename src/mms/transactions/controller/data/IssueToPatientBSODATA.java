...
import mms.transactions.controller.hlp.IssueTransOHLP;
...
public class IssueToPatientBSODATA {
...
//   private String   rptContents;	
	...
	public static void getViewDtl(IssueTransOFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		 /* Declaring Variables */
	       String strmsgText = "";
		   ...
		   try
		   {
               ...
               /* Calling BO method */
			    bo.setViewPageDtl(vo);
			       ...
			       strResult = IssueTransOHLP.getIssuedDetail(vo.getStrIssueDetailWs());
	...
	public static void issueDtlsInit(HttpServletRequest request,
			HttpServletResponse response, IssueTransOFB formBean) 
	{
		...
		try {
			...
			*/
			...
			strSearchItemInitView = IssueTransOHLP.getIssueDtlsInitView(formBean);
...
//					   System.out.println("setStrCrNo:::"+formBean.getWsIssueDetails().getString(35));
	...
	public static void getStoreDtls(IssueTransOFB formBean, HttpServletRequest request) 
	{
		IssueTransOBO       bo = null;
		IssueTransOVO       vo = null;
		HisUtil          util = null;
	...
	public static void getStoreDtlsView(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void getGroupDetails(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void getItemCatDtls(IssueTransOFB formBean,
			HttpServletRequest request, HttpServletResponse response) {

		IssueTransOBO bo = null;
		IssueTransOVO voObj = null;
		String strmsgText = null;
		HisUtil util = null;
		try {

			bo = new IssueTransOBO();
			voObj = new IssueTransOVO();
	...
	public static void GET_PAT_ACC_STATUS(IssueTransOFB formBean,
			HttpServletRequest request, HttpServletResponse response) 
	{
	...
	public static int getissuetopatientcount(IssueTransOFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getCancelPatientDetails(IssueTransOFB formBean, HttpServletRequest request, 
			HttpServletResponse response)
	{
		...
		// HLP Method
		 strPatientDetails = IssueTransOHLP.getPatientDtl(formBean);
	...
	public static void getPatientDetails(IssueTransOFB formBean, HttpServletRequest request, 
						HttpServletResponse response) {
	 ...
	 */
public static void getPatientDetails_BS(IssueTransOFB formBean, HttpServletRequest request, 
			HttpServletResponse response) {
	...
	public static void getOnlineReqDtl(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientTransBSDATA.getOnlineReqDtl  ------- ");
				...
				String strReqValues = IssueTransOHLP.getRequestDtls(vo.getStrRequestWs());
	...
	public static void getItemDetails(IssueTransOFB formBean, HttpServletRequest request, 
			HttpServletResponse response ) {
		...
		try {
			...
			strItemDetails = IssueTransOHLP.getItemDetails(vo.getStrHospitalCode(),vo.getStrItemDetailWs());
	...
	public static void getIssueDetails(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response)
		{
			...
			String strIssueDetails = IssueTransOHLP.getIssueDetailsBS(ws,vo);
	...
	public static void getRequestDetails(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response) {
		...
		//	//System.out.println("3----"+vo.getStrCrNumber());
			...
			String strRequestDetails=IssueTransOHLP.getRequestDetails(ws);
	...
	public static void getFrequencyDetails(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void getDoseDetails(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void getDeptDetails(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void getUnitDetails(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getUnitDetails1(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getPrescribedBy(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response) {
...
//	System.out.println("vo.getStrUnitCode"+vo.getStrUnitCode());		
	...
	public static void insert(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void insertipd(IssueTransOFB formBean, HttpServletRequest request) {
	...
	public static void inserttemp(IssueTransOFB formBean, HttpServletRequest request) {
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientTransBSDATA.inserttemp  ------- ");
	...
	public static void insertCancel(IssueTransOFB formBean, HttpServletRequest request) 
	{
...
//			System.out.println("Issue No==>"+formBean.getStrIssueNo());
	...
	public static void getMmsConfigFlags(IssueTransOFB formBean, HttpServletRequest request, 
			HttpServletResponse response) 
	{
//		IssueTransOBO bo = null;
//		IssueTransOVO vo = null;
...
//			    System.out.println("mcu.getStrDoseFrqFlg()==>"+mcu.getStrDoseFrqFlg());
	...
	public static void getGenderCombo(IssueTransOFB formBean,HttpServletRequest request) 
	{
		IssueTransOBO bo = null;
		IssueTransOVO vo = null;
	...
	public static void insertWithoutCrNo(IssueTransOFB formBean, HttpServletRequest request) 
	{
		int debugPoint = 1;
		IssueTransOBO bo  			  = null;
		IssueTransOVO vo				  = null;
...
//			}			
			...
			{	
					...
					if (vo.getStrMsgType().equals("1")) 
					{
						...
						formBean.getWsIssueDetails().beforeFirst();
						//String str = IssueTransOHLP.getIssueRptForDotMatrix(formBean);
...
public static void getOnlineTreatmentDtl(IssueTransOFB formBean,HttpServletRequest request, HttpServletResponse response) 
{
	...
	try 
	{
		 System.out.println(" ------- IssueToPatientTransBSDATA.getOnlineTreatmentDtl  ------- ");
			...
			String strReqValues = IssueTransOHLP.getOnlineTreatmentDtls(vo.getOnlineTreatmentDtlsWs() , formBean);
...
public static void getBilledItemDtls(IssueTransOFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueTransOVO vo = null;
		...
		//   	vo.setStrFlagVal(request.getParameter("strFlagVal"));
           ...
           /* Calling BO method */
		    bo.getBilledItemDtls(vo);
		       ...
		       strResult = IssueTransOHLP.getBilledItemDtls(vo);
...
public static void save(IssueTransOFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueTransOVO vo = null;
...
public static void deleteIssueDtls(IssueTransOFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueTransOVO vo = null;
...
public static void getTariffDtl(IssueTransOFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueTransOVO vo = null;
...
public static void getAlreadyIssueDrug(IssueTransOFB formBean,HttpServletRequest request,HttpServletResponse response)
{
...
public static void getDiirecIssueInitData(IssueTransOFB formBean, HttpServletRequest request,
		HttpServletResponse response) {
...
public static void getReqType(IssueTransOFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
...
public static void insertDirectIssue(IssueTransOFB formBean, HttpServletRequest request) {
	...
	{
		//e.printStackTrace();
		strmsgText = vo.getStrMsgString();
		HisException eObj = new HisException("mms","IssueToPatientBSODATA->insertWithoutCrNo()",vo.getStrMsgString());
				
		if(strmsgText.contains("$"))
		{
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ vo.getStrMsgString().split("\\$")[1] + "],Contact System Administrator! ");
		}
		else
		{	
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "],Contact System Administrator! ");
	...
	public static void REPEAT_ISSUE_INSERT(IssueTransOFB formBean, HttpServletRequest request) {
...
public static void getEpisodeDtl(IssueTransOFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
...
public static void getPresFormDtl(IssueTransOFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
	IssueTransOBO bo = null;
	IssueTransOVO voObj = null;
	HisUtil util = null;
	...
	public static void afterIssueSave(IssueTransOFB fb,HttpServletRequest request)
	{
		...
		try 
		{
			System.out.println("************** IssueTransODATA --> afterIssueSave()  **********CHK****"+request.getParameter("chk"));
			...
			String strAfterSaveVoucher = IssueTransOHLP.getAfterSaveVoucher(vo,"1");	
			...
			e.printStackTrace();
			strmsgText = "Issue Desk.IssueTransODATA.getInitDetailForIssuePage(vo) --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueTransODATA->getIndentDetails()", strmsgText);
		...
		public static void getIssuePopUp(IssueTransOFB formBean, HttpServletRequest request, HttpServletResponse response) {
		...
		try 
		{
			...
			System.out.println("************** IssueTransODATA --> afterIssueSave() --> mms.patDtl.PatientDtlHLP.patientWithAdmissionDtl **************");
		    ...
		    System.out.println("---  IssueTransOHLP.getIssueDtlsInitView  ----");
		    if(viewMode.equals("0"))
		    {		 
		        strAfterSaveVoucher = IssueTransOHLP.getAfterSaveVoucher(vo,"2");
		    }
		    else
		    {
		    	strAfterSaveVoucher = IssueTransOHLP.getAfterSaveVoucher(vo,"1");
		    }
		...
		public static void initViewPageDtl(IssueTransOFB formBean,HttpServletRequest request)
		{
			 /* Declaring Variables */
		       String strmsgText = "";
		...
		public static void getViewDtlNEW(IssueTransOFB formBean,HttpServletRequest request,HttpServletResponse response)
		{
			 /* Declaring Variables */
		       String strmsgText = "";
		       IssueTransOBO bo    = null;
			   ...
			   try
			   {
				    ...
				    String strResult = IssueTransOHLP.getIssuedDetailNEW(vo.getIssueNoDtlWs());
		...
		public static boolean patientDetailNEW(IssueTransOFB formBean,HttpServletRequest request)
		{
				...
				String strPatientDetailhlp = "",strPrevIssueDrugList="";
					...
					try 
					{
						...
						if (vo.getStrMsgType().equals("1")) {
							...
							System.out.println("------------ IssueTransODATA . getIssueDetailsNEW -> IssueTransOHLP.getItem_ALL_LIST()----------");
							
													
							strPrevIssueDrugList = IssueTransOHLP.patientRepeatTreatmentDtlfrmIPD(vo.getItemDetailsWS(),vo);
		 ...
		 * @param formBean
		 */
		public static void recommendedBy(IssueTransOFB formBean,HttpServletRequest request) 
		{
			IssueTransOBO bo    = null;
			IssueTransOVO vo    = null;
			HisUtil hisutil = null;
			...
			try 
			{
				System.out.println("------------ IssueTransODATA .recommendedBy  ------------");
