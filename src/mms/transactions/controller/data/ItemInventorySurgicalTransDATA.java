...
import mms.transactions.bo.ItemInventorySurgicalTransBO;
 ...
 * 
 */
public class ItemInventorySurgicalTransDATA {
	...
	public static void initialAdd(ItemInventorySurgicalTransFB formBean,
			HttpServletRequest request) {

		ItemInventorySurgicalTransBO bo = null;
		ItemInventorySurgicalTransVO vo = null;
		...
		try {
			bo = new ItemInventorySurgicalTransBO();
			vo = new ItemInventorySurgicalTransVO();
	...
	public static void itemName(ItemInventorySurgicalTransFB formBean,
	...
	public static void itemBrandName(ItemInventorySurgicalTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getBrandDetails(ItemInventorySurgicalTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void manufectuteName(ItemInventorySurgicalTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void insert(ItemInventorySurgicalTransFB formBean) {
		String strmsgText = "";
		ItemInventorySurgicalTransBO bo = null;
		ItemInventorySurgicalTransVO vo = null;
		...
		try {
			...
			vo = (ItemInventorySurgicalTransVO) TransferObjectFactory.populateData(
					"mms.transactions.vo.ItemInventorySurgicalTransVO", formBean);
	...
	public static void modify(ItemInventorySurgicalTransFB formBean) {
		String strmsgText = "";
		ItemInventorySurgicalTransBO bo = null;
		ItemInventorySurgicalTransVO vo = null;
		HisUtil util = null;
	...
	public static void unitNameCombo(ItemInventorySurgicalTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static boolean update(ItemInventorySurgicalTransFB formBean) {
		String strmsgText = "";
		ItemInventorySurgicalTransBO bo = null;
		ItemInventorySurgicalTransVO vo = null;
		MmsConfigUtil mmsUtil = null;
	...
	public static void getIsModify(ItemInventorySurgicalTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
