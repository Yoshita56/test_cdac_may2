...
import mms.transactions.controller.hlp.DuplicateIssueToPatientVoucherTransHLP;
 ...
 * 
 */
public class DuplicateIssueToPatientVoucherTransDATA {

	/**
	 * This function is used to set initial parameters required to display on main page 
	 * @param formBean
	 */
	public static void storeName(DuplicateIssueToPatientVoucherTransFB formBean,HttpServletRequest request) {
		...
		try {
			...
			hisutil = new HisUtil("mms", "DuplicateIssueToPatientVoucherTransDATA");
			...
			if(vo.getStoreNameWS()!= null
			    ...
			    strCmb = hisutil.getOptionValue(vo.getStoreNameWS(),(formBean.getStrId()!=null && !formBean.getStrId().equals(""))?formBean.getStrId():"0" , "", true);
			}
			else
			{
			...
			HisException eObj = new HisException("mms", "DuplicateIssueToPatientVoucherTransDATA->storeName()", strmsgText);
	 ...
	 * @param request
	 */
	public static void itemCategory(DuplicateIssueToPatientVoucherTransFB formBean,	HttpServletRequest request,HttpServletResponse response)
	{
			...
			HisUtil hisutil = null;	
				...
				try {
					...
					strmsgText = "transactions.DuplicateIssueToPatientVoucherTransDATA.itemCategory(vo) --> "
						+ e.getMessage();
				HisException eObj = new HisException("mms",
						"DuplicateIssueToPatientVoucherTransDATA->itemCategory()", strmsgText);
				try {
					response.setHeader("Cache-Control", "no-cache");
	...
	public static boolean patientDetail(DuplicateIssueToPatientVoucherTransFB formBean,
			...
			String strPatientDetailhlp = "";
				...
				catch (Exception e) 
				{
			         ...
			         else
			         {
		         		...
		         		strmsgText = "DuplicateIssueToPatientVoucherTransDATA.patientDetail(vo) --> "+ e.getMessage();
				        HisException eObj = new HisException("mms","DuplicateIssueToPatientVoucherTransDATA->patientDetail()", strmsgText);
	...
	public static boolean patientDetailNEW(DuplicateIssueToPatientVoucherTransFB formBean,
			HttpServletRequest request){
	...
	public static boolean patientDetailNEW1(DuplicateIssueToPatientVoucherTransFB formBean,
			HttpServletRequest request){
		...
		MmsConfigUtil mcu = null;
			...
			String strPatientDetailhlp = "";
				...
				try {
					...
					issueNoDateCombo(formBean, request);
	 ...
	 * @param request
	 */
	public static void issueNoCombo(DuplicateIssueToPatientVoucherTransFB formBean,HttpServletRequest request) 
	{
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		String strmsgText = "";
...
//				}
		  ...
		  catch (Exception e) 
		  {
			  e.printStackTrace();
				...
				HisException eObj = new HisException("mms", "DuplicateIssueToPatientVoucherTransDATA->issueNoCombo()", strmsgText);
				formBean.setStrErr("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
				eObj = null;
		} finally {
			bo = null;
	...
	public static void issueNoDateCombo(DuplicateIssueToPatientVoucherTransFB formBean,HttpServletRequest request) 
	{
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		String strmsgText = "";
...
//				}
	 ...
	 * @param response
	 */
	public static void getIssueDetails(DuplicateIssueToPatientVoucherTransFB formBean,
		...
		try {
			...
			if (vo.getStrMsgType().equals("1")) {
				...
				strHlp = DuplicateIssueToPatientVoucherTransHLP.getItemDetails(vo.getStrItemCategoryNo(),vo.getStrHospitalCode(), vo.getItemDetailsWS(),vo.getStrStoreId());
		...
		//	e.printStackTrace();
			strmsgText = "DuplicateIssueToPatientVoucherTransDATA.getIssueDetails(vo) --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"DuplicateIssueToPatientVoucherTransDATA->getIssueDetails()", strmsgText);
			try {
				response.setHeader("Cache-Control", "no-cache");
				response.getWriter().print(
						"ERROR#### Application Error [ERROR ID : "
	...
	public static void getIssueDetailsNEW(DuplicateIssueToPatientVoucherTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (vo.getStrMsgType().equals("1")) {
				...
				strHlp = DuplicateIssueToPatientVoucherTransHLP.getItemDetailsNEW(vo.getStrItemCategoryNo(),vo.getStrHospitalCode(), vo.getItemDetailsWS(),vo.getStrStoreId());
	 ...
	 * @param formBean
	 */
	public static void recommendedBy(DuplicateIssueToPatientVoucherTransFB formBean,HttpServletRequest request) {
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		HisUtil hisutil = null;
		...
		try {
			...
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("mms", "DuplicateIssueToPatientVoucherTransDATA->recommendedBy()", strmsgText);
			formBean.setStrErr("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
		finally {
	 ...
	 * @param formBean
	 */
	public static void insert(DuplicateIssueToPatientVoucherTransFB formBean,HttpServletRequest request)
	{
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		MmsConfigUtil mcu = null;
		...
		try
			{
			 ...
			 // ////System.out.println("formBean.getStrAdmissionDtlHidVal();-->"+formBean.getStrAdmissionDtlHidVal());
			  ...
			  int nMultiRowLen = formBean.getStrReturnQty().length;
			    ...
			    /*vo = (DuplicateIssueToPatientVoucherTransVO) TransferObjectFactory.populateData(
						"mms.transactions.vo.DuplicateIssueToPatientVoucherTransVO", formBean);*/
			...
			{
				e.printStackTrace();
				strmsgText = "hisglobaltransactionutil.DuplicateIssueToPatientVoucherTransDATA.insert(vo) --> "
						+ e.getMessage();
				HisException eObj = new HisException(
						"mms",
						"DuplicateIssueToPatientVoucherTransDATA->insert()",
						strmsgText);
				formBean.setStrErr("Application Error [ERROR ID : "
	...
	//Change Request
	public static void getMmsConfigFlags(DuplicateIssueToPatientVoucherTransFB formBean, HttpServletRequest request, 
...
//				formBean.setStrDoseFrqFlg(mcu.getStrDoseFrqFlg());
	...
	public static boolean validateIssueNumber(DuplicateIssueToPatientVoucherTransFB formBean, HttpServletRequest request,HttpServletResponse response) 
	{
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		MmsConfigUtil mcu = null;
		...
		try {
			...
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("mms", "DuplicateIssueToPatientVoucherTransDATA->validateIssueNumber()", strmsgText);
			formBean.setStrErr("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
		finally {
	 ...
	 * @return
	 */
	public static void getIssueDetailsBasedOnPatientNameOrCrNo(DuplicateIssueToPatientVoucherTransFB formBean, HttpServletRequest request,HttpServletResponse response) 
	{
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		MmsConfigUtil mcu = null;
		...
		try {
			...
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("mms", "DuplicateIssueToPatientVoucherTransDATA->getIssueDetailsBasedOnPatientNameOrCrNo()", strmsgText);
			formBean.setStrErr("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
		finally {
...
//			AGE_GENDER:6
	 ...
	 * @param request
	 */
	public static void getpatientDemographicDetail(DuplicateIssueToPatientVoucherTransFB formBean,
			HttpServletRequest request) 
	{
		...
		MmsConfigUtil mcu = null;
			...
			//			formBean.setStrPatientAgeUnit(vo.getStrPatientAgeUnit());
				...
				{
				e.printStackTrace();
				 strmsgText = "DuplicateIssueToPatientVoucherTransDATA.getpatientDemographicDetail(vo) --> "+ e.getMessage();
		         HisException eObj = new HisException("mms","DuplicateIssueToPatientVoucherTransDATA->getpatientDemographicDetail()", strmsgText);
				 eObj = null;
				} 
				finally
				{
	 ...
	 * @param formBean
	 */
	public static void insertWithoutCrNo(DuplicateIssueToPatientVoucherTransFB formBean,HttpServletRequest request)
	{
		DuplicateIssueToPatientVoucherTransVO vo=null;
		DuplicateIssueToPatientVoucherTransBO bo= null;
		MmsConfigUtil mcu = null;
