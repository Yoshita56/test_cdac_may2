...
import mms.transactions.bo.IPDIssuetoPatDirectTransBO;
import mms.transactions.controller.fb.IPDIssuetoPatDirectTransFB;
import mms.transactions.controller.hlp.IPDIssuetoPatDirectTransHLP;
import mms.transactions.vo.IPDIssuetoPatDirectTransVO;

public class IPDIssuetoPatDirectTransDATA {
...
//   private String   rptContents;	
	...
	public static void getViewDtl(IPDIssuetoPatDirectTransFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		 /* Declaring Variables */
	       String strmsgText = "";
		   IPDIssuetoPatDirectTransVO vo = null;
		   IPDIssuetoPatDirectTransBO bo = null;
		   HisUtil util = null;
		   String strResult = "";
		   try
		   {
			    /* Creating Object */   	
			    vo=new IPDIssuetoPatDirectTransVO();
			   	bo=new IPDIssuetoPatDirectTransBO();
               ...
               /* Calling BO method */
			    bo.setViewPageDtl(vo);
			       ...
			       strResult = IPDIssuetoPatDirectTransHLP.getIssuedDetail(vo.getStrIssueDetailWs());
	...
	public static void issueDtlsInit(HttpServletRequest request,
			HttpServletResponse response, IPDIssuetoPatDirectTransFB formBean) 
	{
		...
		try {
			...
			*/
			...
			strSearchItemInitView = IPDIssuetoPatDirectTransHLP.getIssueDtlsInitView(formBean);
...
//					   System.out.println("setStrCrNo:::"+formBean.getWsIssueDetails().getString(35));
	...
	public static void getStoreDtls(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) 
	{
		IPDIssuetoPatDirectTransBO       bo = null;
		IPDIssuetoPatDirectTransVO       vo = null;
		HisUtil          util = null;
	...
	public static void getStoreDtlsView(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void getGroupDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void getItemCatDtls(IPDIssuetoPatDirectTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {

		IPDIssuetoPatDirectTransBO bo = null;
		IPDIssuetoPatDirectTransVO voObj = null;
		String strmsgText = null;
		HisUtil util = null;
		try {

			bo = new IPDIssuetoPatDirectTransBO();
			voObj = new IPDIssuetoPatDirectTransVO();
	...
	public static void GET_PAT_ACC_STATUS(IPDIssuetoPatDirectTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) 
	{
	...
	public static int getissuetopatientcount(IPDIssuetoPatDirectTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getCancelPatientDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response)
	{
		...
		// HLP Method
		 strPatientDetails = IPDIssuetoPatDirectTransHLP.getPatientDtl(formBean);
	...
	public static void getPatientDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, 
						HttpServletResponse response) {
	 ...
	 */
public static void getPatientDetails_BS(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response) {
	...
	public static void getOnlineReqDtl(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try 
		{
			 System.out.println(" ------- NewIPDIssueToPatTrans.getOnlineReqDtl  ------- ");
				...
				String strReqValues = IPDIssuetoPatDirectTransHLP.getRequestDtls(vo.getStrRequestWs());
	...
	public static void getItemDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response ) {
		...
		try {
			...
			strItemDetails = IPDIssuetoPatDirectTransHLP.getItemDetails(vo.getStrHospitalCode(),vo.getStrItemDetailWs());
	...
	public static void getIssueDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response)
		{
			...
			String strIssueDetails = IPDIssuetoPatDirectTransHLP.getIssueDetailsBS(ws,vo);
	...
	public static void getRequestDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
		...
		//	//System.out.println("3----"+vo.getStrCrNumber());
			...
			String strRequestDetails=IPDIssuetoPatDirectTransHLP.getRequestDetails(ws);
	...
	public static void getFrequencyDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void getDoseDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void getDeptDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void getUnitDetails(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getUnitDetails1(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getPrescribedBy(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
...
//	System.out.println("vo.getStrUnitCode"+vo.getStrUnitCode());		
	...
	public static void insert(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void insertipd(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void insertCancel(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) 
	{
...
//			System.out.println("Issue No==>"+formBean.getStrIssueNo());
	...
	public static void getMmsConfigFlags(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response) 
	{
//		IPDIssuetoPatDirectTransBO bo = null;
//		IPDIssuetoPatDirectTransVO vo = null;
...
//			    System.out.println("mcu.getStrDoseFrqFlg()==>"+mcu.getStrDoseFrqFlg());
	...
	public static void getGenderCombo(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request) 
	{
		IPDIssuetoPatDirectTransBO bo = null;
		IPDIssuetoPatDirectTransVO vo = null;
	...
	{
		IPDIssuetoPatDirectTransBO bo = new IPDIssuetoPatDirectTransBO();
		IPDIssuetoPatDirectTransVO vo	= new IPDIssuetoPatDirectTransVO();
	...
	public static void getOnlineTreatmentDtl(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try 
		{
			 System.out.println(" ------- NewIPDIssueToPatTrans.getOnlineTreatmentDtl  ------- ");
				...
				String strReqValues = IPDIssuetoPatDirectTransHLP.getOnlineTreatmentDtls(vo.getOnlineTreatmentDtlsWs() , formBean);
		...
		public static void getBilledItemDtls(IPDIssuetoPatDirectTransFB fb,HttpServletRequest request,HttpServletResponse response)
		{
			 /* Declaring Variables */
		      String strmsgText = "";
			   IPDIssuetoPatDirectTransVO vo = null;
				...
				//   	vo.setStrFlagVal(request.getParameter("strFlagVal"));
		           ...
		           /* Calling BO method */
				    bo.getBilledItemDtls(vo);
				       ...
				       strResult = IPDIssuetoPatDirectTransHLP.getBilledItemDtls(vo);
	...
	public static void deleteIssueDtls(IPDIssuetoPatDirectTransFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		 /* Declaring Variables */
	      String strmsgText = "";
		   IPDIssuetoPatDirectTransVO vo = null;
	...
	public static void getTariffDtl(IPDIssuetoPatDirectTransFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		 /* Declaring Variables */
	      String strmsgText = "";
		   IPDIssuetoPatDirectTransVO vo = null;
	...
	public static void getAlreadyIssueDrug(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request,HttpServletResponse response)
	{
	...
	public static void getDiirecIssueInitData(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request,
			HttpServletResponse response) {
	...
	public static void getReqType(IPDIssuetoPatDirectTransFB fb, HttpServletRequest request, HttpServletResponse response) {
		// TODO Auto-generated method stub
	...
	public static void insertDirectIssue(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
	...
	public static void REPEAT_ISSUE_INSERT(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request) {
...
public static void getEpisodeDtl(IPDIssuetoPatDirectTransFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
...
public static void getPresFormDtl(IPDIssuetoPatDirectTransFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
	IPDIssuetoPatDirectTransBO bo = null;
	IPDIssuetoPatDirectTransVO voObj = null;
	HisUtil util = null;
	...
	public static void afterIssueSave(IPDIssuetoPatDirectTransFB fb,HttpServletRequest request)
	{
		...
		try 
		{
			...
			String strAfterSaveVoucher = IPDIssuetoPatDirectTransHLP.getAfterSaveVoucher(vo,"1");	
		...
		public static void getIssuePopUp(IPDIssuetoPatDirectTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
		...
		try 
		{
		    ...
		    System.out.println("---  IPDIssuetoPatDirectTransHLP.getIssueDtlsInitView  ----");
		    if(viewMode.equals("0"))
		    {		 
		        strAfterSaveVoucher = IPDIssuetoPatDirectTransHLP.getAfterSaveVoucher(vo,"2");
		    }
		    else
		    {
		    	strAfterSaveVoucher = IPDIssuetoPatDirectTransHLP.getAfterSaveVoucher(vo,"1");
		    }
		...
		public static void initViewPageDtl(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request)
		{
			 /* Declaring Variables */
		       String strmsgText = "";
		...
		public static void getViewDtlNEW(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request,HttpServletResponse response)
		{
			 /* Declaring Variables */
		       String strmsgText = "";
		       IPDIssuetoPatDirectTransBO bo    = null;
			   ...
			   try
			   {
				    ...
				    String strResult = IPDIssuetoPatDirectTransHLP.getIssuedDetailNEW(vo.getIssueNoDtlWs());
		...
		public static boolean patientDetailNEW(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request)
		{
				...
				String strPatientDetailhlp = "",strPrevIssueDrugList="";
					...
					try 
					{
						...
						if (vo.getStrMsgType().equals("1")) {
							...
							System.out.println("------------ NewIPDIssueToPatTransDATA . getIssueDetailsNEW -> IPDIssuetoPatDirectTransHLP.getItem_ALL_LIST()----------");
							
													
							strPrevIssueDrugList = IPDIssuetoPatDirectTransHLP.patientRepeatTreatmentDtlfrmIPD(vo.getItemDetailsWS(),vo);
		 ...
		 * @param formBean
		 */
		public static void recommendedBy(IPDIssuetoPatDirectTransFB formBean,HttpServletRequest request) 
		{
			IPDIssuetoPatDirectTransBO bo    = null;
			IPDIssuetoPatDirectTransVO vo    = null;
			HisUtil hisutil = null;
