...
import mms.transactions.bo.IssueToPatientBarCodeTransBO;
import mms.transactions.controller.fb.IssueToPatientBarCodeTransFB;
import mms.transactions.controller.hlp.IssueToPatientBarCodeTransHLP;
import mms.transactions.vo.IssueToPatientBarCodeTransVO;

public class IssueToPatientBarCodeTransDATA {
...
//   private String   rptContents;	
	...
	public static void getViewDtl(IssueToPatientBarCodeTransFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		 /* Declaring Variables */
	       String strmsgText = "";
		   IssueToPatientBarCodeTransVO vo = null;
		   IssueToPatientBarCodeTransBO bo = null;
		   HisUtil util = null;
		   String strResult = "";
		   try
		   {
			    /* Creating Object */   	
			    vo=new IssueToPatientBarCodeTransVO();
			   	bo=new IssueToPatientBarCodeTransBO();
               ...
               /* Calling BO method */
			    bo.setViewPageDtl(vo);
			       ...
			       strResult = IssueToPatientBarCodeTransHLP.getIssuedDetail(vo.getStrIssueDetailWs());
	...
	public static void issueDtlsInit(HttpServletRequest request,
			HttpServletResponse response, IssueToPatientBarCodeTransFB formBean) 
	{
		...
		try {
			...
			*/
			...
			strSearchItemInitView = IssueToPatientBarCodeTransHLP.getIssueDtlsInitView(formBean);
...
//					   System.out.println("setStrCrNo:::"+formBean.getWsIssueDetails().getString(35));
	...
	public static void getStoreDtls(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) 
	{
		IssueToPatientBarCodeTransBO       bo = null;
		IssueToPatientBarCodeTransVO       vo = null;
		HisUtil          util = null;
	...
	public static void getStoreDtlsView(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
	...
	public static void getGroupDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
	...
	public static void getItemCatDtls(IssueToPatientBarCodeTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {

		IssueToPatientBarCodeTransBO bo = null;
		IssueToPatientBarCodeTransVO voObj = null;
		String strmsgText = null;
		HisUtil util = null;
		try {

			bo = new IssueToPatientBarCodeTransBO();
			voObj = new IssueToPatientBarCodeTransVO();
	...
	public static void GET_PAT_ACC_STATUS(IssueToPatientBarCodeTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) 
	{
	...
	public static void getBarCodeDetails(IssueToPatientBarCodeTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try 
		{
			System.out.println(" ------- IssueToPatientBarCodeTransCNT.getBarCodeDetails  ------- "); 
			bo = new IssueToPatientBarCodeTransBO();
			voObj = new IssueToPatientBarCodeTransVO();
			...
			voObj.setStrHospitalCode(formBean.getStrHospitalCode());
			voObj.setStrCrNo(strCrNo);
			voObj.setStrBarCodeBrandId(barCodeValue.split("\\^")[0]);
			voObj.setStrBarCodeBatch(barCodeValue.split("\\^")[1]);
						
			bo.getBarCodeDetails(voObj);
			...
			if(voObj.getStrBrandItemListWs().next() && voObj.getStrBrandItemListWs().size() > 0)
			{
				 temp = voObj.getStrBrandItemListWs().getString(1);
			...
			e.printStackTrace();
			strmsgText = "IssueToPatientBSODATA.getBarCodeDetails --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueToPatientBSODATA->GET_PAT_ACC_STATUS()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "
	...
	public static int getissuetopatientcount(IssueToPatientBarCodeTransFB formBean,
			HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getCancelPatientDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response)
	{
		...
		// HLP Method
		 strPatientDetails = IssueToPatientBarCodeTransHLP.getPatientDtl(formBean);
	...
	public static void getPatientDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, 
						HttpServletResponse response) {
	 ...
	 */
public static void getPatientDetails_BS(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response) {
		...
		try 
		{
			 ...
			 System.out.println(" ------- IssueToPatientBarCodeTrans.getPatientDetails_BS  ------- ");
	...
	public static void getOnlineReqDtl(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientBarCodeTrans.getOnlineReqDtl  ------- ");
				...
				String strReqValues = IssueToPatientBarCodeTransHLP.getRequestDtls(vo.getStrRequestWs());
	...
	public static void getItemDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response ) {
		...
		try {
			 ...
			 System.out.println(" ------- IssueToPatientBarCodeTrans.getItemDetails  ------- ");
			...
			strItemDetails = IssueToPatientBarCodeTransHLP.getItemDetails(vo.getStrHospitalCode(),vo.getStrItemDetailWs());
	...
	public static void getIssueDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response)
		{
			...
			WebRowSet ws = null;
			try {
				 System.out.println(" ------- IssueToPatientBarCodeTrans.getIssueDetails  ------- ");
			...
			String strIssueDetails = IssueToPatientBarCodeTransHLP.getIssueDetailsBS(ws,vo);
	...
	public static void getRequestDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			 System.out.println(" ------- IssueToPatientBarCodeTrans.getRequestDetails  ------- ");
		...
		//	//System.out.println("3----"+vo.getStrCrNumber());
			...
			String strRequestDetails=IssueToPatientBarCodeTransHLP.getRequestDetails(ws);
	...
	public static void getFrequencyDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
	...
	public static void getDoseDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
	...
	public static void getDeptDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
		...
		try {
			 System.out.println(" ------- IssueToPatientBarCodeTrans.getDeptDetails  ------- ");
	...
	public static void getUnitDetails(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getUnitDetails1(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
	...
	public static void getPrescribedBy(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
...
//	System.out.println("vo.getStrUnitCode"+vo.getStrUnitCode());		
	...
	public static void insert(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
		...
		try {
			 System.out.println(" ------- IssueToPatientBarCodeTrans.insert  ------- ");
	...
	public static void insertipd(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
		...
		try {
			 System.out.println(" ------- IssueToPatientBarCodeTrans.insertipd  ------- ");
	...
	public static void inserttemp(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientBarCodeTrans.inserttemp  ------- ");
			...
			vo.setStrPrescribedBy(formBean.getStrPrescribedBy());
		    vo.setStrReqPrescribedBy(formBean.getStrPrescribedBy());
		    vo.setStrPrescriptionFrom(formBean.getStrPrescriptionFrom());
			...
			vo.setStrOutOfStockFlag(formBean.getStrOutOfStockFlag());
			vo.setStrEmpCode(formBean.getStrPrescribedBy());
	...
	public static void insertCancel(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) 
	{
...
//			System.out.println("Issue No==>"+formBean.getStrIssueNo());
	...
	public static void getMmsConfigFlags(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, 
			HttpServletResponse response) 
	{
//		IssueToPatientBarCodeTransBO bo = null;
//		IssueToPatientBarCodeTransVO vo = null;
...
//			    System.out.println("mcu.getStrDoseFrqFlg()==>"+mcu.getStrDoseFrqFlg());
	...
	public static void getGenderCombo(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request) 
	{
		IssueToPatientBarCodeTransBO bo = null;
		IssueToPatientBarCodeTransVO vo = null;
	...
	public static void insertWithoutCrNo(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) 
	{
		int debugPoint = 1;
		IssueToPatientBarCodeTransBO bo  			  = null;
		IssueToPatientBarCodeTransVO vo				  = null;
...
//			}			
			...
			{	
					...
					if (vo.getStrMsgType().equals("1")) 
					{
						...
						formBean.getWsIssueDetails().beforeFirst();
						//String str = IssueToPatientBarCodeTransHLP.getIssueRptForDotMatrix(formBean);
...
*/						
		...
		catch (Exception e) 
		{
			e.printStackTrace();
			strmsgText = "mms.transactions.IssueToPatientBSODATA.insertWithoutCrNo()--> "+e.getMessage() + String.valueOf(" :: Debug Point = " + debugPoint);
		//	HisException eObj = new HisException("mms","IssueToPatientBSODATA->insertWithoutCrNo()",strmsgText + " :: User Value = " + userValue,request);
...
{
	IssueToPatientBarCodeTransBO bo = new IssueToPatientBarCodeTransBO();
	IssueToPatientBarCodeTransVO vo	= new IssueToPatientBarCodeTransVO();
	HisUtil util =  new HisUtil("MMS Transactions", "IssueToPatientBSODATA");	;
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientBarCodeTrans.patientDiagDtl  ------- ");
...
public static String patientDiagDtl_BS(String strCrNo,String strHospitalCode)
{
	...
	HisUtil util =  new HisUtil("MMS Transactions", "IssueToPatientBSODATA");	;
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientBarCodeTrans.patientDiagDtl_BS  ------- ");
...
public static void getOnlineTreatmentDtl(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request, HttpServletResponse response) 
{
	...
	try 
	{
		 System.out.println(" ------- IssueToPatientBarCodeTrans.getOnlineTreatmentDtl  ------- ");
			bo = new IssueToPatientBarCodeTransBO();
			vo = new IssueToPatientBarCodeTransVO();
			mcu = new MmsConfigUtil(request.getSession().getAttribute("HOSPITAL_CODE").toString());
			...
			String strReqValues = IssueToPatientBarCodeTransHLP.getOnlineTreatmentDtls(vo.getOnlineTreatmentDtlsWs() , formBean);
...
public static void getBilledItemDtls(IssueToPatientBarCodeTransFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueToPatientBarCodeTransVO vo = null;
	   ...
	   try
	   {
		   System.out.println(" ------- IssueToPatientBarCodeTrans.getBilledItemDtls  ------- ");
		...
		//   	vo.setStrFlagVal(request.getParameter("strFlagVal"));
           ...
           /* Calling BO method */
		    bo.getBilledItemDtls(vo);
		       ...
		       strResult = IssueToPatientBarCodeTransHLP.getBilledItemDtls(vo);
...
public static void save(IssueToPatientBarCodeTransFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueToPatientBarCodeTransVO vo = null;
	   ...
	   try
	   {
		   System.out.println(" ------- IssueToPatientBarCodeTrans.save  ------- ");
		    ...
		    vo=new IssueToPatientBarCodeTransVO();
		   	...
		   	vo.setStrIssueNo(fb.getStrHiddenIssueNo());
		   	vo.setStrCrNo(fb.getCrNo());
		   	//vo.setStrItemCategoryNo(request.getParameter("itemCatNo"));
		   //System.out.println("Flag==>"+request.getParameter("strFlagVal"));
		//   	vo.setStrFlagVal(request.getParameter("strFlagVal"));
		   /*	if(request.getParameter("strFlagVal").equals("1"))
           ...
           /* Calling BO method */
		    bo.save(vo);		
		    fb.setStoreId(vo.getStrStoreId());
		    if(vo.getStrMsgType().equals("1"))
		    {
		    //fb.setStrNormalMsg("In-Sufficent Stock Available In Store");
		    fb.setStrErrMsg("In-Sufficent Stock Available In Store");
		    //fb.setStrWarningMsg("In-Sufficent Stock Available In Store");
		    //fb.setStrstockflg("1");
		    }else{
		    	//fb.setStrstockflg("2");
		    }
...
public static void deleteIssueDtls(IssueToPatientBarCodeTransFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueToPatientBarCodeTransVO vo = null;
...
public static void getTariffDtl(IssueToPatientBarCodeTransFB fb,HttpServletRequest request,HttpServletResponse response)
{
	 /* Declaring Variables */
      String strmsgText = "";
	   IssueToPatientBarCodeTransVO vo = null;
	   ...
	   try
	   {
		   System.out.println(" ------- IssueToPatientBarCodeTrans.getTariffDtl  ------- ");
...
public static void getAlreadyIssueDrug(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request,HttpServletResponse response)
{
...
try 
{
	System.out.println(" ------- IssueToPatientBarCodeTrans.getAlreadyIssueDrug  ------- ");
...
public static void getDiirecIssueInitData(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request,
		HttpServletResponse response) {
	// TODO Auto-generated method stub
	     ...
	     try
	   {
	    	    ...
	    	    System.out.println(" ------- IssueToPatientBarCodeTrans.getDiirecIssueInitData  ------- ");
	    	 	vo=new IssueToPatientBarCodeTransVO();
			   	bo=new IssueToPatientBarCodeTransBO();
			   	util = new HisUtil("MMS Transactions", "IssueToPatientBSODATA");
			   	vo.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
...
public static void getReqType(IssueToPatientBarCodeTransFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
...
public static void insertDirectIssue(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
	...
	try 
	{
		System.out.println("----  IssueToPatientBarCodeTransDATA.insertDirectIssue  ---");
		debugPoint = 1;
		bo = new IssueToPatientBarCodeTransBO();
		vo = new IssueToPatientBarCodeTransVO();
		mcu = new MmsConfigUtil(request.getSession().getAttribute("HOSPITAL_CODE").toString());
	...
	public static void REPEAT_ISSUE_INSERT(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request) {
...
public static void getEpisodeDtl(IssueToPatientBarCodeTransFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
...
public static void getPresFormDtl(IssueToPatientBarCodeTransFB fb, HttpServletRequest request, HttpServletResponse response) {
	// TODO Auto-generated method stub
	IssueToPatientBarCodeTransBO bo = null;
	IssueToPatientBarCodeTransVO voObj = null;
	HisUtil util = null;
	...
	public static void afterIssueSave(IssueToPatientBarCodeTransFB fb,HttpServletRequest request)
	{
		...
		try 
		{
			System.out.println("************** IssueToPatientBarCodeTransDATA --> afterIssueSave()  **********CHK****"+request.getParameter("chk"));
				...
				*/
				...
				System.out.println("************** IssueToPatientBarCodeTransDATA --> afterIssueSave() --> PatientDtlHLP.patientWithAdmissionDtl **************");
			...
			String strAfterSaveVoucher = IssueToPatientBarCodeTransHLP.getAfterSaveVoucher(vo,"1");	
			...
			e.printStackTrace();
			strmsgText = "Issue Desk.IssueToPatientBarCodeTransDATA.getInitDetailForIssuePage(vo) --> "
					+ e.getMessage();
			HisException eObj = new HisException("mms",
					"IssueToPatientBarCodeTransDATA->getIndentDetails()", strmsgText);
		...
		public static void getIssuePopUp(IssueToPatientBarCodeTransFB formBean, HttpServletRequest request, HttpServletResponse response) {
		...
		try 
		{
			 System.out.println(" ------- IssueToPatientBarCodeTrans.getIssuePopUp  ------- ");
			...
			System.out.println("************** IssueToPatientBarCodeTransDATA --> afterIssueSave() --> mms.patDtl.PatientDtlHLP.patientWithAdmissionDtl **************");
		    ...
		    System.out.println("---  IssueToPatientBarCodeTransHLP.getIssueDtlsInitView  ----");
		    if(viewMode.equals("0"))
		    {		 
		        strAfterSaveVoucher = IssueToPatientBarCodeTransHLP.getAfterSaveVoucher(vo,"2");
		    }
		    else
		    {
		    	strAfterSaveVoucher = IssueToPatientBarCodeTransHLP.getAfterSaveVoucher(vo,"1");
		    }
		...
		public static void initViewPageDtl(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request)
		{
			 /* Declaring Variables */
		       String strmsgText = "";
		...
		public static void getViewDtlNEW(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request,HttpServletResponse response)
		{
			 /* Declaring Variables */
		       String strmsgText = "";
		       IssueToPatientBarCodeTransBO bo    = null;
			   ...
			   try
			   {
				    ...
				    String strResult = IssueToPatientBarCodeTransHLP.getIssuedDetailNEW(vo.getIssueNoDtlWs());
		...
		public static boolean patientDetailNEW(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request)
		{
				...
				String strPatientDetailhlp = "",strPrevIssueDrugList="";
					...
					try 
					{
						...
						if (vo.getStrMsgType().equals("1")) {
							...
							System.out.println("------------ IssueToPatientBarCodeTransDATA . getIssueDetailsNEW -> IssueToPatientBarCodeTransHLP.getItem_ALL_LIST()----------");
							
													
							strPrevIssueDrugList = IssueToPatientBarCodeTransHLP.patientRepeatTreatmentDtlfrmIPD(vo.getItemDetailsWS(),vo);
		 ...
		 * @param formBean
		 */
		public static void recommendedBy(IssueToPatientBarCodeTransFB formBean,HttpServletRequest request) 
		{
			IssueToPatientBarCodeTransBO bo    = null;
			IssueToPatientBarCodeTransVO vo    = null;
			HisUtil hisutil = null;
			...
			try 
			{
				System.out.println("------------ IssueToPatientBarCodeTransDATA .recommendedBy  ------------");
