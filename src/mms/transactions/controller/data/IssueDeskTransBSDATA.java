...
import mms.transactions.controller.hlp.IssueDeskTransBSHLP;
...
public class IssueDeskTransBSDATA {
		...
		try {
			...
			else
			{
				...
				//if(vo.getStrItemCategoryNo().equals("10"))
					strItemDtls = IssueDeskTransBSHLP.getItemDetails_Drug(vo.getStrItemCategoryNo(), vo.getStrHospitalCode(), vo.getItemDetailsWS(), vo.getStrRaisingStoreId(),vo.getStrBudgetFlg(),vo.getStrStoreId());
				//else
				//	strItemDtls = IssueDeskTransBSHLP.getItemDetails(vo.getStrItemCategoryNo(), vo.getStrHospitalCode(), vo.getItemDetailsWS(), vo.getStrRaisingStoreId(),vo.getStrBudgetFlg());
	...
	public static void getPopUp(HttpServletRequest request,
		...
		try {
			...
			{
				strPopUpDtls = IssueDeskTransBSHLP.getPopUpInfo(vo.getPopupWS(),index);
	...
	public static void getPopUpData(HttpServletRequest request,
		...
		try {
			...
			strPopUpDtls = IssueDeskTransBSHLP.getPopUpData(vo.getStrPopUpData());
	...
	public static void getViewDetails1(IssueDeskTransFB formBean,
		...
		try {
			...
			if (vo.getStrMsgType().equals("1")) {
				...
				strItemDtls = IssueDeskTransBSHLP.getViewItemDetails(vo
	...
	public static void getViewDetails2(IssueDeskTransFB formBean,
		...
		try {
			...
			else 
			{
				...
				strItemDtls = IssueDeskTransBSHLP.getIssuedItemDetail(vo.getStrItemCategoryNo(), vo.getStrHospitalCode(), vo
...
//			vo.getWsStockDetails().beforeFirst();
			...
			strSearchItemInitView = IssueDeskTransBSHLP.getStockItemDtlsInitView(formBean);
