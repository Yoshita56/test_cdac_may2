...
public class BillApprovalTransHLP 
{
	...
	public static String getPrintItemDetails(WebRowSet ws,String hosCode) throws Exception 
	{
		...
		System.out.println("--------------------- LocalPurchaseNewTransHLP.getPrintItemDetails -------------------------------");
		StringBuffer sb = new StringBuffer("");
		String strMrnNo = "" , storeName = "",uc_req="",cat="";
		String strMrnDate = "";
		String strPONo="";
		...
		try 
		{
			...
			if(ws != null && ws.size() > 0)
			{
				...
				sb.append("<tr> ");
				sb.append("<td align='center'  colspan='2'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>S.NO.</b></font></td>");
				sb.append("<td align='center'  colspan='3'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>ITEM DESCRIPTION</b></font></td>");
				sb.append("<td align='center'  colspan='3'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>QUANTITY</b></font></td>");			
				sb.append("<td align='center'  colspan='3'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>AMOUNT</b></font></td>");
				sb.append("<td align='right'   colspan='1'><font face='Verdana, Arial, Helvetica, sans-serif' ></font></td>");
				sb.append("</tr> ");
				sb.append("<tr><td width='100%' colspan='12'><hr></td></tr> ");
				sb.append("<tr> ");
				sb.append("<td align='center' 	width='2%'>#</td>");		
				sb.append("<td align='left' 	width='15%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>MRN No/Date</b></font></td>");
				sb.append("<td align='left' 	width='24%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Brand</b></font></td>");			
				...
				sb.append("<td align='center'   width='4%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Ord</b></font></td>");
				sb.append("<td align='center' 	width='4%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Rcd</b></font></td>");
				sb.append("<td align='center'   width='4%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Bal</b></font></td>");
				sb.append("<td align='center' 	width='7%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>#</b></font></td>");
				sb.append("</tr> ");
				sb.append("<tr><td width='100%' colspan='12'><hr></td></tr> ");
				...
				ws.beforeFirst();
					...
					sb.append("<td align='right'  colspan='2'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>"+totamt+"</b></font></td>");
					sb.append("</tr> ");
			...
			else 
			{
				...
				sb.append("<tr> ");
				sb
						.append("<td colspan='12' align='center'><font face='Verdana, Arial, Helvetica, sans-serif' ><br/><b>Details Not Available</b><br/><br/></font></td> ");
				sb.append("</tr> ");
	...
	public static String getSuppPrintItemDetails_NEW(WebRowSet ws,String hosCode) throws Exception 
	{

		System.out.println("--------------------- LocalPurchaseNewTransHLP.getSuppPrintItemDetails_NEW -------------------------------");
		StringBuffer sb = new StringBuffer("");
		String strMrnNo = "" , storeName = "",uc_req="",cat="";
		String strMrnDate = "";
		String strPONo="";
		...
		try 
		{
			...
			if(ws != null && ws.size() > 0)
			{
				...
				sb.append("<td align='center' 	width='14%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>MRN No/Date</b></font></td>");
				sb.append("<td align='center' 	width='24%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Brand</b></font></td>");			
				sb.append("<td align='center' 	width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Batch No.</b></font></td>");
				sb.append("<td align='center' 	width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Exp Dt</b></font></td>");				
				sb.append("<td align='center' 	width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Rate</b></font></td>");
				sb.append("<td align='center' 	width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Tax</b></font></td>");
				sb.append("<td align='center' 	width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Rate<br>(With Tax)</b></font></td>");					
				sb.append("<td align='center'   width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Admn Chg</b></font></td>");
				sb.append("<td align='center' 	width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Sale Price</b></font></td>");
				sb.append("<td align='center'   width='5%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Qty</b></font></td>");
				sb.append("<td align='center' 	width='7%'><font  face='Verdana, Arial, Helvetica, sans-serif' ><b>Value</b></font></td>");
				sb.append("</tr> ");
				sb.append("<tr><td width='100%' colspan='12'><hr></td></tr> ");
				sb.append("<tr><td width='100%' colspan='12' align='left' ><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><u><b>PO Dtl / Supplier Name ::"+poNODate+"/"+strVendor+"</b></u></font></td></tr> ");
				sb.append("<tr><td width='100%' colspan='12'><hr></td></tr> ");
				...
				ws.beforeFirst();
					...
					sb.append("<td align='right'  colspan='1'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>"+FinaltotalCost+"</b></font></td>");
					sb.append("</tr> ");				
					sb.append("<input type='hidden' name='strPONetCost'   id='strPONetCost'  value='"+FinaltotalCost+"' />");
					sb.append("<input type='hidden' name='strConcatPKey'  id='strConcatPKey' value='"+concatPKey+"' />");
		...
		int count=0;
		 try 
		 {
			...
			{	
				 ...
				 sBuffer.append("<td width='20%' colspan='1' class='multiLabel'><div align='center'>Challan No.</div></td>");
	             sBuffer.append("<td width='20%' colspan='1' class='multiLabel'><div align='center'>Schedule No.</div></td>");  
	  	         sBuffer.append("<td width='20%' colspan='1' class='multiLabel'><div align='center'>Schedule Date</div></td>");
	  	         sBuffer.append("<td width='10%' colspan='1' class='multiLabel'><div align='center'>Schedule Type</div></td>");
    			 ...
    			 {		     
                	 count++;
    	  				...
    	  				//	String strScheduleType = wb.getString(3);
    	  					...
    	  					sBuffer.append("<td width='20%' colspan='1' class='multiControl'><img align='middle' name='compile' style='cursor: pointer; ' title='To click for Records' src='../../hisglobal/images/Compile.png' onclick='scheduleCheckCompile();'/></td>");
    	  					sBuffer.append("</tr>");	
    	  		}
	...
	public static String getOtherDetails(BillApprovalTransVO vo,String strSuppliedItemCost,String strPOTotalCost) throws HisException
	 {
		StringBuffer sb = new StringBuffer("");
		HisUtil util=null;
		BillApprovalTransBO bo=null;
		...
		try 
		{
	        ...
	        sb.append("<td class='CONTROL' colspan='1' width='25%'><input type='text' name='strWaiveOffAmt' class='txtFldNormal' value='0' onKeyPress='return(numericWithTwoDecimalPlaces(this,',','.',event));' onKeyUp='calculateNetBillCost();'></td>");
	        sb.append("<td class='LABEL'   colspan='1' width='25%'><font color='red'>*</font>Approved By</td>");
	        sb.append("<td class='CONTROL' colspan='1' width='25%'><select name='strWaiveOffApprovedBy'>"+waiveOffApprovedBy+"</select></td>");
	        sb.append("</tr>");
	        sb.append("<tr>");
	        sb.append("<td class='LABEL'   colspan='1' width='25%'><font color='red'>*</font>Approved Date</td>");
	        sb.append("<td class='CONTROL' colspan='1' width='25%'>"+getDatePicker("strWaiveOffApprovedDate", vo.getStrCurrentDate(), true)+"</td>");	        
	        sb.append("<td class='LABEL'   colspan='1' width='25%'>PO Net Cost :</td>");
            sb.append("<td class='CONTROL' colspan='1' width='25%'><input type='hidden' name='strPONetCost'     value='"+strPOTotalCost+"' /><input type='hidden' name='strSupplyNetCost' value='"+strSuppliedItemCost+"' />     <div id='poNetCostDIV' style='color: red;font-weight:bold'>"+strPOTotalCost+"</div></td>");
            sb.append("</tr>");  
            /*
            sb.append("<tr>");
	...
	public static String getOtherDetails_New(BillApprovalTransVO vo) throws HisException
	 {
		...
		try 
		{
	        ...
	        sb.append("<td class='CONTROL' colspan='1' width='25%'>"+getDatePicker("strWaiveOffApprovedDate", vo.getStrCurrentDate(), true)+"</td>");	        
	        sb.append("<td class='LABEL'   colspan='1' width='25%'><font color='red'>*</font>Approved By</td>");
	        sb.append("<td class='CONTROL' colspan='3' width='25%'><select name='strWaiveOffApprovedBy'>"+waiveOffApprovedBy+"</select></td>");
