...
public class ReceiveFromThirdPartyTransTestHLP 
{

	private static final String strColor = "red";
	private static final String defaultColor = "blue";
	
	public static String getNewReceivedItemsList(ReceiveFromThirdPartyTransTestFB formBean) {
	...
	public static String getNewReceivedItemsListNEW(ReceiveFromThirdPartyTransTestFB formBean) {
	...
	public static String getUpdateReceivedItemsList(ReceiveFromThirdPartyTransTestFB formBean) {
	...
	public static String getUpdateReceivedItemsListNEW(ReceiveFromThirdPartyTransTestFB formBean) {
	...
	public static String getReceivedItemsListtest(ReceiveFromThirdPartyTransTestFB formBean) {
...
/*	ORG
	public static String getReceivedItemsList(ReceiveFromThirdPartyTransTestFB formBean) {
...
*/
	...
	public static String getReceivedItemsList(ReceiveFromThirdPartyTransTestFB formBean, ReceiveFromThirdPartyTransTestVO vo) {
...
//					   sb.append("<input type='hidden' name='strHlpStoreName'    id='strHlpStoreName"    +i+ "'  value=" + strStoreName + " />");
	...
	//RJ
	public static String getvoucherPrintDetails(ReceiveFromThirdPartyTransTestFB fb, ReceiveFromThirdPartyTransTestVO vo) {
	    double sum1 = 0;
	    StringBuffer sb = new StringBuffer("");
