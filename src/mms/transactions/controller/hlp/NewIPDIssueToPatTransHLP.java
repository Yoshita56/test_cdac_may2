...
public class NewIPDIssueToPatTransHLP {
	
	public static String getPatientDtl(NewIPDIssueToPatTransFB formBean) throws Exception 
	{
    ...
    public static String getIssueRptForDotMatrix(NewIPDIssueToPatTransFB formBean)throws SQLException, UnsupportedEncodingException
    {	
	    String rptContents = "";
	 ...
	 *             the exception
	 */
	public static String getIssueDtlsInitView(NewIPDIssueToPatTransFB formBean) throws Exception {
...
//						sb.append("</tr> ");						
	 ...
	 public static String getAfterSaveVoucher(NewIPDIssueToPatTransVO vo,String mode) throws Exception {
	      StringBuffer sb = new StringBuffer("");
	      int i = 1;
	      ResourceBundle res = null;
	      WebRowSet ws = null;
...
//								}
	 ...
	 public static String getBilledItemDtls(NewIPDIssueToPatTransVO vo)throws SQLException 
		{
			StringBuffer br = new StringBuffer();
	 ...
	 public static String getIssueDetailsBS(WebRowSet ws,NewIPDIssueToPatTransVO vo)
				throws SQLException {
					StringBuffer sb = new StringBuffer();
	 ...
	 public static String getOnlineTreatmentDtls(WebRowSet ws , NewIPDIssueToPatTransFB formBean) throws Exception
		{ 
...
//			String totalCost = "";
	        ...
	        public static String patientRepeatTreatmentDtlfrmIPD(WebRowSet ws,NewIPDIssueToPatTransVO vo)	throws Exception 
			{					
					StringBuffer str = new StringBuffer("");	
					str.append("");		
					String prevDrugName="";
