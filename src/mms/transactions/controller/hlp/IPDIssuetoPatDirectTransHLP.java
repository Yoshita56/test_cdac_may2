...
public class IPDIssuetoPatDirectTransHLP {
	
	public static String getPatientDtl(IPDIssuetoPatDirectTransFB formBean) throws Exception 
	{
    ...
    public static String getIssueRptForDotMatrix(IPDIssuetoPatDirectTransFB formBean)throws SQLException, UnsupportedEncodingException
    {	
	    String rptContents = "";
	 ...
	 *             the exception
	 */
	public static String getIssueDtlsInitView(IPDIssuetoPatDirectTransFB formBean) throws Exception {
...
//						sb.append("</tr> ");						
	 ...
	 public static String getAfterSaveVoucher(IPDIssuetoPatDirectTransVO vo,String mode) throws Exception {
	      StringBuffer sb = new StringBuffer("");
	      int i = 1;
	      ResourceBundle res = null;
	      WebRowSet ws = null;
	      ...
	      try {
	    	  ...
	    	  if(mode.equals("1"))
	    	  {
	    		  sb.append("<td colspan='1'><td colspan='1'><div id='printImg' align='right'><img style='cursor: pointer;'  text-align=right  title='Print Page' src='../../hisglobal/images/printer_symbol.gif' onClick='printData_O();' /><img style='cursor: pointer;'  text-align=right  title='Print Page' src='../../hisglobal/images/stop.png' onClick='hideIssuePopup();cancelToDesk();'  /></div></td>");
	    	  }
	    	  else
	    	  {
	    		  if(mode.equals("2"))
...
//								}
	 ...
	 public static String getBilledItemDtls(IPDIssuetoPatDirectTransVO vo)throws SQLException 
		{
			StringBuffer br = new StringBuffer();
	 ...
	 public static String getIssueDetailsBS(WebRowSet ws,IPDIssuetoPatDirectTransVO vo)
				throws SQLException {
					StringBuffer sb = new StringBuffer();
	 ...
	 public static String getOnlineTreatmentDtls(WebRowSet ws , IPDIssuetoPatDirectTransFB formBean) throws Exception
		{ 
...
//			String totalCost = "";
	        ...
	        public static String patientRepeatTreatmentDtlfrmIPD(WebRowSet ws,IPDIssuetoPatDirectTransVO vo)	throws Exception 
			{					
					StringBuffer str = new StringBuffer("");	
					str.append("");		
					String prevDrugName="";
