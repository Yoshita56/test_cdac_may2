...
public class IssueToPatientBarCodeTransHLP {
	
	public static String getPatientDtl(IssueToPatientBarCodeTransFB formBean) throws Exception 
	{
    ...
    public static String getIssueRptForDotMatrix(IssueToPatientBarCodeTransFB formBean)throws SQLException, UnsupportedEncodingException
    {	
	    String rptContents = "";
	 ...
	 *             the exception
	 */
	public static String getIssueDtlsInitView(IssueToPatientBarCodeTransFB formBean) throws Exception {
...
//						sb.append("</tr> ");						
	 ...
	 public static String getAfterSaveVoucher(IssueToPatientBarCodeTransVO vo,String mode) throws Exception {
	      StringBuffer sb = new StringBuffer("");
	      int i = 1;
	      ResourceBundle res = null;
	      WebRowSet ws = null;
...
//								}
	 ...
	 public static String getBilledItemDtls(IssueToPatientBarCodeTransVO vo)throws SQLException 
		{
			StringBuffer br = new StringBuffer();
	 ...
	 public static String getIssueDetailsBS(WebRowSet ws,IssueToPatientBarCodeTransVO vo)
				throws SQLException {
					StringBuffer sb = new StringBuffer();
	 ...
	 public static String getOnlineTreatmentDtls(WebRowSet ws , IssueToPatientBarCodeTransFB formBean) throws Exception
		{ 
...
//			String totalCost = "";
	        ...
	        public static String patientRepeatTreatmentDtlfrmIPD(WebRowSet ws,IssueToPatientBarCodeTransVO vo)	throws Exception 
			{					
					StringBuffer str = new StringBuffer("");	
					str.append("");		
					String prevDrugName="";
