...
public class ChallanProcessTransHLP {
	...
	public static String getScheduleAndReceiveDtls(ChallanProcessTransFB formBean)
	{
		...
		System.out.println("----------ChallanProcessTransHLP.getScheduleAndReceiveDtls------------");
...
//		sb.append(" </tr>  ");	
	...
	public static String getScheduleItemList(ChallanProcessTransFB formBean , ChallanProcessTransVO vo )throws Exception{
		...
		try{
			...
			System.out.println("----------ChallanProcessTransHLP.getScheduleItemList------------");
	...
	{ 
		...
		int count=0;
			try{
				...
				System.out.println("----------ChallanProcessTransHLP.createMemberDetails------------");
	...
	public static String getBalanceQtyDtls(ChallanProcessTransFB formBean){
		...
		System.out.println("----------ChallanProcessTransHLP.getBalanceQtyDtls------------");
	...
	public static String getChallanReceivedDetails(WebRowSet wb) {
		...
		try
		{
			...
			System.out.println("----------ChallanProcessTransHLP.getChallanReceivedDetails------------");
			...
			if (wb != null) 
			{
				if (wb.size() != 0) 
				{
					...
					br.append("<TR>");												
					br.append("<td WIDTH='5%'   colspan='1' class='multiLabel' id='check"+i+"'><input type='radio' title='Select One' name='strCheckOne' value='' id='strCheckOne"+i+"' onclick='selectRecord(this,\""+ i + "\"),fetchReceivedItemDetail(this,\""+ i + "\");'></td>");
					br.append("</td>");						
					br.append("<TD WIDTH='30%'   colspan='1' class='multiLabel'>"+ wb.getString(4) + "</TD>");
					br.append("<TD WIDTH='13%'   colspan='1' class='multiLabel'>"+ wb.getString(5) + "</TD>");
					br.append("<TD WIDTH='13%'   colspan='1' class='multiLabel'>"+ wb.getString(6) + "</TD>");
					br.append("<TD WIDTH='12%'   colspan='1' class='multiLabel'>"+ wb.getString(7) + "</TD>");
		...
		try
		{
			...
			if (wb != null) 
			{
				if (wb.size() != 0) 
				{
					...
					br.append("<div class='col-sm-4 subHeaders'>Received Item Detail(s)</div>");
					br.append("</div>");
					br.append("<table class='table' align='center' border='0' cellspacing ='1px' cellpadding='1px'>");
					br.append("<thead> ");
					//br.append("<td WIDTH='5%'   colspan='1' class='multiLabel'>#</td>");
					br.append("<th>Received Date</th>");
					br.append("<th>Drug Name</th>");
					br.append("<th>Received Qty</th>");					
					...
					br.append("<TD>"+ wb.getString(6) + "</TD>");
			...
			{
				br.append("<div class='row'>");
				br.append("<div class='col-sm-4 subHeader'>Received Item Detail(s)</div>");
				br.append("</div>");
				br.append("<table class='table' align='center' border='0' cellspacing ='1px' cellpadding='1px'>");
				br.append("<thead> ");
				//br.append("<td WIDTH='5%'   colspan='1' class='multiLabel'>#</td>");
				...
				//br.append("<table class='TABLEWIDTH' align='center' border='0' cellspacing ='1px' cellpadding='1px' >");
				br.append("<tbody>");
				br.append("<td colspan='7><b><div id='id' align='center' color='Red'>No Received Item Detail Found</div></b></td>");
				br.append("</tbody>");
				br.append("</table> ");
			}
...
//		System.out.println("getReceivedItemDetails in hlp: "+br.toString());
	...
	*/
	...
	public static String getReceivedItemDetails(WebRowSet wb) {
		...
		try
		{
			System.out.println("----------ChallanProcessTransHLP.getReceivedItemDetails------------");
			
			if (wb != null) 
			{
				if (wb.size() != 0) 
				{
					br.append("<div id='' align='left' class='subHeaders' colspan='8'>Received Item Detail(s)</div>");
					br.append("<table class='table'>");
					br.append("<tr>");
					br.append("<thead class='thead-dark'>");

					//br.append("<td WIDTH='5%'   colspan='1' class='multiLabel'>#</td>");
					br.append("<th WIDTH='20%'  style='font-weight:350 !important ;font-size: 16px !important;'>Received Date</th>");
					br.append("<th WIDTH='40%'  style='font-weight:350 !important ;font-size: 16px !important;'>Drug Name</th>");
					br.append("<th WIDTH='20%'  style='font-weight:350 !important ;font-size: 16px !important;'>Received Qty</th>");					
					br.append("<th WIDTH='20%'  style='font-weight:350 !important ;font-size: 16px !important;'>Batch</th>");
					br.append("<thead>");
					br.append("</tr> ");
					br.append("</table> ");
					...
					//br.append("<td width='5%' class='multiLabel' id='check"+i+"'><input type='radio' title='View' name='strRecvdItems' value='' id='strRecvdItems"+i+"' onclick='fetchVerifiedItemDetail(this,\""+ i + "\");'></td>");
					//br.append("</td>");						
					br.append("<td width='20%'  align='center' style='font-weight:350 !important ;font-size: 16px !important;'>"+ wb.getString(1) + "</TD>");
					br.append("<td width='40%'  align='left's style='font-weight:350 !important ;font-size: 16px !important;'>"+ wb.getString(4) + "</TD>");
					br.append("<td width='20%'  align='center' style='font-weight:350 !important ;font-size: 16px !important;'>"+ wb.getString(6) + "</TD>");
					br.append("<td width='20%'  align='center' style='font-weight:350 !important ;font-size: 16px !important;'>"+ wb.getString(20)+ "</TD>");
					br.append("</TR>");
					i++;
				}                   
					br.append("</table> ");
			...
			if (wb.size() == 0) 
			{
				...
				br.append("<div colspan='8' id='' align='left'  class='subHeaders'>Received Item Detail(s)</div>");
				br.append("<table class='table' align='center'>");
				br.append("<tr>");
				br.append("<thead class='thead-dark'>");
				//br.append("<td WIDTH='5%'   colspan='1' class='multiLabel'>#</td>");
				br.append("<th WIDTH='20%'  colspan='1' class='multiLabel'>Received Date</th>");
				br.append("<th WIDTH='60%'  colspan='1' class='multiLabel'>Drug Name</th>");
				br.append("<th WIDTH='20%'  colspan='1' class='multiLabel'>Received Qty</th>");					
				//br.append("<td WIDTH='15%'  colspan='1' class='multiLabel'>Status</td>");
				br.append("</thead>");
				br.append("</tr> ");
				br.append("</table> ");
				br.append("<table class='table'>");
				br.append("<TR>");
				br.append("<td colspan='7><b><div id='id' align='center' color='Red' style='font-weight:350 !important ;font-size: 16px !important;'>No Received Item Detail Found</div></b></td>");
				br.append("</TR>");
				br.append("</table> ");
			}
...
//		System.out.println("getReceivedItemDetails in hlp: "+br.toString());
	...
	public static String getVerifiedItemDetails(WebRowSet wb) {
		...
		try
		{
			...
			System.out.println("----------ChallanProcessTransHLP.getVerifiedItemDetails------------");
...
//		System.out.println("VerifiedItemDetails in hlp: "+br.toString());
	...
	public static String getPrintItemDetails(WebRowSet ws,String hosCode) throws Exception {
		...
		System.out.println("----------ChallanProcessTransHLP.getPrintItemDetails------------");
