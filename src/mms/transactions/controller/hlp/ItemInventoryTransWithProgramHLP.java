...
public class ItemInventoryTransWithProgramHLP {
	
	
	public static String getAddItemVoucherView(ItemInventoryWithProgramTransFB formBean) throws Exception {
		...
		*/
		...
		try 
		{
				...
				sb.append(
						...
						.append(
								...
								+ "<td align='right' ><font face='Verdana, Arial, Helvetica, sans-serif' size='2' ></font></td></tr>"
										+ "<tr> <td align='left' colspan='4' ><font face='Verdana, Arial, Helvetica, sans-serif' size='2' ><b>Category</b>:Item</font></td></tr></table> ");
			...
			sb.append("<td align='center' width='15%'><font size='1px' face='Verdana, Arial, Helvetica, sans-serif' ><b>Item Name</b></font> ");
			sb.append("</td>");
			...
			sb.append("<td align='center' width='15%'><font size='1px' face='Verdana, Arial, Helvetica, sans-serif' ><b>Adm. Charges %</b></font> ");
			sb.append("</td> ");
