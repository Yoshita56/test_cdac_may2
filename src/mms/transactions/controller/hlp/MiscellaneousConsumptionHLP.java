...
public class MiscellaneousConsumptionHLP 
{
	public static String getAfterSaveVoucher(MiscellaneousConsumptionTransVO vo,String mode) throws Exception {
	      ...
	      try {
	         ...
	         sb.append("<tr>");
	         sb.append("<td width='100%' align='center' colspan='5'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Issue</b></font></td> ");
