...
public class IndentSuperApprovalTransHLP  {
	 ...
	 * @return String
	 */
	public static String getAgendaItemDetails(IndentSuperApprovalTransVO vo) {
		...
		String unitCombo = "";
		String comboVal = "0";
		HisUtil util = new HisUtil("MMS", "IndentSuperApprovalTransHLP");
		...
		try {
			...
			if (ws1 != null) {
				...
				while (ws1.next()) {
					...
					IndentSuperApprovalTransDAO
							.getUnitCombo(vo, strProcIndentQtyUnit);

					IndentSuperApprovalTransDAO.getStockDtls(vo, strItemId,
							strItemBrandId);
			...
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getAgendaItemDetails() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	 ...
	 * @return String
	 */
	public static String getIssueToThirdPartyItemDetails(IndentSuperApprovalTransVO vo) {
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		String strInsertHiddenValue = "";
		String strAjaxHiddenValue = "";
...
//					sb.append("</td>");
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIssueToThirdPartyItemDetails() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
	 ...
	 * @return String
	 */
	public static String getItemDetails1(IndentSuperApprovalTransVO vo) {
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		String strInsertHiddenValue = "";
		String strAjaxHiddenValue = "";
		...
		try {
			...
			sb.append("<table class='TABLEWIDTH' align='center' bgcolor='black' border='0' cellspacing ='1px'>");
			sb.append("<tr>");
			sb.append("<td width='30%' class='multiLabel'>Item Name</td>");
			...
			if (ws1 != null) 
			{
				...
				while (ws1.next()) 
				{
					if (vo.getStrReqTypeId().equals("10")) 
					{
						...
						IndentSuperApprovalTransDAO.getUnitCombo(vo,
					...
					if (vo.getStrReqTypeId().equals("14")) 
					{
						...
						IndentSuperApprovalTransDAO.getUnitCombo(vo,strProcIndentQtyUnit);
					...
					sb.append("<table class='TABLEWIDTH' align='center' bgcolor='#6097BC' border='0' cellspacing ='1px'>");
					sb.append("<tr>");
					sb.append("<td width='30%' class='multiControl'  align='left' >");					
					sb.append(strItemName);							
					sb.append("</td>");
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetails1() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getIssueItemDetails(IndentSuperApprovalTransVO vo) {
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		String strInsertHiddenValue = "";
		String strAjaxHiddenValue = "";
		...
		try
		{
			System.out.println("-----(IndentSuperApprovalTransHLP . getIssueItemDetails)-------");
			
			sb.append("<table class='TABLEWIDTH' align='center' bgcolor='black' border='0' cellspacing ='1px'>");
			sb.append("<tr>");
			sb.append("<td width='35%' class='multiRPTLabel'>Item Name</td>");
			sb.append("<td width='13%' class='multiRPTLabel'>Avl Qty </td>");
			...
			if (ws1 != null) {
				...
				while (ws1.next()) 
				{
				   ...
				   strProcIndentQtyUnit = strReqQtyUnit;
						...
						IndentSuperApprovalTransDAO.getUnitCombo(vo, strReqQtyUnit);

						IndentSuperApprovalTransDAO.getStockDtls(vo, strItemId,strItemBrandId);
						
						IndentSuperApprovalTransDAO.getStockDtlsTwo(vo, strItemId,strItemBrandId);
...
//					sb.append("</td>");
			...
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetails() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getItemDetails(IndentSuperApprovalTransVO vo) {
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		String strInsertHiddenValue = "";
		String strAjaxHiddenValue = "";
...
//					sb.append("</div>");
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIndentDetailsForApproval() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getIndentDetailsForApproval(IndentSuperApprovalTransVO vo) {
...
//					sb.append("</div>");
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIndentDetailsReturnToSupplier() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getIndentDetails(IndentSuperApprovalTransVO vo) {
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					else 
					{
						...
						System.out.println("-----(IndentSuperApprovalTransHLP . getIndentDetails)----Req_type---"+vo.getStrReqTypeId());
						...
						sb.append("</td></tr>");
						sb.append("<tr><td width='25%' class='LABEL'>Remarks</td>");
...
//						sb.append("</div>");
			...
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIndentDetails() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	 ...
	 * @return String
	 */
	public static String getItemDetailsView1(IndentSuperApprovalTransVO vo) {
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		WebRowSet ws1 = vo.getStrItemDetailsWs();
		String strRemarks = "";
		...
		try {
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetailsView1() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getIndentDetailsReturnToSupplierViewPrint(IndentSuperApprovalTransVO vo)
	{
		StringBuffer sb = new StringBuffer("");
		...
		try {
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIndentDetailsReturnToSupplierViewPrint() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getItemDetailsViewPrint(IndentSuperApprovalTransVO vo) 
	{
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		WebRowSet ws1 = vo.getStrItemDetailsWs();
		...
		try {
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetailsViewPrint() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getItemDetailsView1Print(IndentSuperApprovalTransVO vo) 
	{
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		WebRowSet ws1 = vo.getStrItemDetailsWs();
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetailsView1Print() --> "+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	}
	...
	public static String getIndentDetailsViewPrint(IndentSuperApprovalTransVO vo) 
	{
		...
		try {
			...
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIndentDetailsViewPrint() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getItemDetailsReturnFromSupplierPrint(IndentSuperApprovalTransVO vo) 
	{
		StringBuffer sb = new StringBuffer("");	
		WebRowSet ws1 = vo.getStrItemDetailsWs();
		...
		try
		{
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetailsReturnFromSupplierPrint() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
	...
	public static String getItemDetailsForReceiveFromThirdPartyPrint(IndentSuperApprovalTransVO vo) 
	{
		StringBuffer sb = null;
...
//						sb.append("</td>");
			...
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getItemDetailsView() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getItemDetailsView(IndentSuperApprovalTransVO vo) {
		StringBuffer sb = new StringBuffer("");
		String strHiddenValue = "";
		WebRowSet ws1 = vo.getStrItemDetailsWs();
		String strRemarks = "";
...
//						sb.append("</td>");
	...
	public static String getIndentDetailsView(IndentSuperApprovalTransVO vo) {
		...
		try {
			...
			if (ws != null && ws.size() > 0) {
				if (ws.next()) {
					...
					else 
					{
						...
						sb.append("<tr><td colspan='1' class='LABEL'>Remarks </td>");
			...
			vo.setStrMsgString("IndentSuperApprovalTransHLP.getIndentDetailsView() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return sb.toString();
	...
	public static String getBlockedItemDetails(IndentSuperApprovalTransVO vo,
