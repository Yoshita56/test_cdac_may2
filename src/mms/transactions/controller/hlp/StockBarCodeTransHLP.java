...
public class StockBarCodeTransHLP {

	private static final String strColor = "red";
	private static final String defaultColor = "blue";

public static String getIssueDetails(StockBarCodeTransVO vo) 
	 {
...
public static String getBarCodeSave(StockBarCodeTransVO vo,HttpServletRequest request) 
{
	StringBuffer sb = new StringBuffer("");
...
public static String getBarCodeGeneration(StockBarCodeTransVO vo,HttpServletRequest request) throws Exception 
{
    ...
    try 
    {
        ...
        if(ws.next()) 
        {
	       ...
	       /* 
	        sb.append("<table style='margin-left:3%; margin-top:2%' cellspacing='0' cellpadding='0' width='90%'>");
			sb.append("<tr style='font-size:11px;font-family:arial;'>");
			sb.append("<td style='padding-left:12px;'>");
			
			sb.append("<table cellspacing='1'  cellpadding='1' style='margin-left:1%'>");
			sb.append("<tr>");
			sb.append("<td colspan='4' nowrap='nowrap'>"+truncatedString+"</td>");								
			sb.append("</tr>");
			sb.append("<tr>");
			//style='height:30px'
			sb.append("<td colspan='3' rowspan='1'><div id='divBarcodeSlipControl1' class='divBarcodeSlipControls' style=''>"+ws.getString(1).split("\\@")[0]+"</div></td>");
			sb.append("</tr>");
			sb.append("<tr>");  
			sb.append("<td colspan='4' rowspan='1' nowrap='nowrap'><font size='1px;'>"+ws.getString(1).split("\\@")[1]+"</font></td>");
			sb.append("</tr>");						
			sb.append("</table>");
			...
			sb.append("<table cellspacing='1'  cellpadding='1' style='margin-left:3%'>");
			sb.append("<tr>");
			sb.append("<td colspan='4' nowrap='nowrap'>"+truncatedString+"</td>");								
			sb.append("</tr>");
			sb.append("<tr>");
			sb.append("<td colspan='3' rowspan='1'><div id='divBarcodeSlipControl2' class='divBarcodeSlipControls' style=''>"+ws.getString(1).split("\\@")[0]+"</div></td>");
			sb.append("</tr>");
			sb.append("<tr>");  
			sb.append("<td colspan='4' rowspan='1' nowrap='nowrap'><font size='1px;'>"+ws.getString(1).split("\\@")[1]+"</font></td>");
			sb.append("</tr>");						
			...
			*/
			...
			sb.append("<table style='margin-left: 3%; margin-top: 2%;' cellspacing='0' cellpadding='0' width='90%'>");
			sb.append("<tr style='font-size: 11px; font-family: Arial;'>");
			sb.append("<input type='hidden' id='qrCodeValue' value='"+ws.getString(1).split("\\@")[0]+"' />");
			sb.append("<td style='padding-left: 30px;'>");
			sb.append("<table cellspacing='1' cellpadding='1' style='margin-left: 3%;'>");
			sb.append("<tr>");
			sb.append("<td colspan='4' nowrap='nowrap'>");
			sb.append("<table cellspacing='1' cellpadding='1' style='margin-left: 3%;'>");
			sb.append("<tr>");
			sb.append("<td colspan='3'  rowspan='1'><div id='qrcode-1' class='divBarcodeSlipControls'></div></td>"); 
			sb.append("<td colspan='2'  rowspan='1'>");
			sb.append("<table>");
			sb.append("<tr>");
			sb.append("<td colspan='2'  rowspan='1'>"+truncatedString+"</td>");						  
			sb.append("</tr>");
			sb.append("<tr>");						   
			sb.append("<td colspan='2'  rowspan='1'>"+ws.getString(1).split("\\@")[1]+"</td>");
			sb.append("</tr>");
			sb.append("</table>");
			sb.append("</td>");			
			sb.append("</table>");
			...
			sb.append("<table cellspacing='1' cellpadding='1' style='margin-left: 3%;'>");
			sb.append("<tr>");
			sb.append("<td colspan='3' rowspan='1'><div id='qrcode-2' class='divBarcodeSlipControls'></div></td>"); 
			sb.append("<td colspan='2' rowspan='1'>");
			sb.append("<table>");
			sb.append("<tr>");
			sb.append("<td colspan='2'  rowspan='1'>"+truncatedString+"</td>");								  
...
public static String getBarCodeGeneration_v1(StockBarCodeTransVO vo,HttpServletRequest request) throws Exception 
{
...
public static String getBarCodeGeneration_ORG(StockBarCodeTransVO vo,HttpServletRequest request) throws Exception 
{
