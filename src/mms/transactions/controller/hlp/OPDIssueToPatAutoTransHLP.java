...
public class OPDIssueToPatAutoTransHLP {
    ...
    public static String getIssueRptForDotMatrix(OPDIssueToPatAutoTransFB formBean)throws SQLException, UnsupportedEncodingException
    {	
	    String rptContents = "";
	 ...
	 */
		  ...
		  try 
		   {
			 ...
			 catch (SQLException e) 
	         {
				...
				throw	new HisException("Issue Transaction","OPDIssueToPatAutoTransHLP .getIssuePopUp() -->",e.getMessage());
			 }
	 ...
	 public static String getRequestDetails(WebRowSet ws)
	 {
			...
			try {
				...
				throw new HisException("Issue Transaction","OPDIssueToPatAutoTransHLP.getRequestDetails()-->",e.getMessage());
			}
		return sb.toString();
		}
	...
	//		String strUnitValues = "";
			...
			try {
		//		hisutil = new HisUtil("mms", "OPDIssueToPatAutoTransHLP");
		//		bo = new OPDIssueToPatAutoTransBO();
				...
				throw new HisException("Issue Transaction","OPDIssueToPatAutoTransHLP .getItemDetails() -->",e.getMessage());
	 ...
	 public static String getIssueDetails(WebRowSet ws)
		throws SQLException {
			...
			try {
				...
				throw new HisException("Issue Transaction","OPDIssueToPatAutoTransHLP .getIssueDetails() -->",e.getMessage());
	 ...
	 public static String getBilledItemDtls(OPDIssueToPatAutoTransVO vo)throws SQLException 
		{
			StringBuffer br = new StringBuffer();
	...
	/* == new added for printing Issue no & date == */
	 public static String getPreviousIssueDetails(OPDIssueToPatAutoTransVO vo ,WebRowSet ws) 
		{
			StringBuffer sb = new StringBuffer("");
	 ...
	 public static String getOnlineTreatmentDtls(WebRowSet ws , OPDIssueToPatAutoTransFB formBean) throws Exception
		{ 
	...
	/* ============= >> RJ47 */
	 ...
	 public static String getAfterSaveVoucher(OPDIssueToPatAutoTransVO vo,String mode) throws Exception {
	      StringBuffer sb = new StringBuffer("");
	      int i = 1;
		 ...
		 try
		 {
			...
			*/				
			...
			while(vo.getWsIssueDetails().next())
			{
				...
				//hisutil.appendSpace(hisutil.breakString(patient_name[0], 20, "~").get(0).toUpperCase(), 20, 0)
			...
			contents.append(hisutil.appendSpace("TOTAL AMOUNT ",79, 1)+ hisutil.appendSpace(String.format("%1$,.2f", NetAmount),5, 1));			
			contents.append("\n");
			printLine++;
			contents.append(hisutil.appendSpace("", 79,1)+hisutil.appendSpace("---------------",15,1));
			contents.append("\n");
			...
			contents.append(hisutil.appendSpace("BILLED AMT ",79, 1)+ hisutil.appendSpace(String.format("%1$,.2f", NetAmount), 5, 1));			
			contents.append("\n");
			printLine++;
					
			contents.append(hisutil.appendSpace("COLLECTED AMT ",79, 1)+ hisutil.appendSpace(String.format("%1$,.2f", NetAmount), 5, 1));
			contents.append("\n");
			printLine++;
	 ...
	 public static String getNAList(OPDIssueToPatAutoTransVO vo) throws Exception 
	 {
			...
			try 
			{
				...
				*/		
				...
				/*************************************************1*******************************************************************/
				sb.append("<tr> ");	
				sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Patient [ CR No.]:</b></font></td> ");

				sb.append("<td width='75%' align='left' colspan='3'><font face='Verdana, Arial, Helvetica, sans-serif' >"+vo.getStrHiddenPatDtl().split("\\^")[0]+"["+vo.getStrCrNo()+"]</font></td> ");			
						
				sb.append("</tr> ");
				/**************************************************2*****************************************************************/				
								
				sb.append("<tr> ");	
				sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("AGE / SEX:</b></font></td> ");
				sb.append("<td width='25%' align='left'><font face='Verdana, Arial, Helvetica, sans-serif' >").append(vo.getStrHiddenPatDtl().split("\\^")[3])
							.append("</font></td> ");		
				sb.append("<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>").append("Category :</b></font></td> ");
				sb.append("<td width='25%' align='left'><font face='Verdana, Arial, Helvetica, sans-serif' >").append(vo.getStrHiddenPatDtl().split("\\^")[2]).append(
							"</font></td> ");
				sb.append("</tr> ");				
				...
				//sb.append("</td> ");
				sb.append("<td style=\"text-align:center;\" width='45%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Drug Name</b></font> ");
				sb.append("</td>");
				...
				if (ws != null && ws.size() > 0) 
				{
					...
					while (ws.next()) 
					{
						 ...
						 */	
						curGroupName = ws.getString(5);
						
						if(!curGroupName.equals(preGroupName))
						{
							sb.append("<tr>");
							sb.append("<td colspan='5' style='text-align:left; width:5%;'><font size='2' face='Verdana, Arial, Helvetica, sans-serif'><b><u>"+curGroupName+ "</u></b></font></td>");
							sb.append("</tr>");
						}
					...
					sb.append("<tr> ");
					sb.append("<td colspan='3' align='right'></td> ");
					sb.append("<td colspan='2' align='center'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>By User Date & Time<br><b></font></td> ");
					sb.append("</tr> ");
					sb.append("<tr> ");
					sb.append("<td colspan='3' align='right'></td> ");					
	 ...
	 public static String divideCharacter(String input) 
	 {
	   ...
	   /**
		...
		) throws SQLException 
		{
			...
			try 
			{
				...
				if (wb.size() != 0) 
				{
					...
					br.append("<thead>");
					br.append("<tr>");							
					br.append("<th style='text-align:center;' style='width:36%;text-align: center !important;'><b>Item Name [ Freq ]</b></th>");
					...
					while (wb.next()) 
					{
						...
						System.out.println("-OPDIssueToPatAutoTransHLP.getItemDetails_Drug - strHiddenId-"+strHiddenId);
						...
						if (Integer.parseInt(strTotalNoOfBatch) == 1) 
						{
							...
							/*
							System.out.println("-- Single Batch Dtl -Pkg_Mms_View.proc_itemStock_dtl [ Mode - 7 ]-"+strHiddenId.split("\\^")[0] + "^" + strHiddenId.split("\\^")[1] + "^"
									+ wb.getString(13) + "^" + strIssueStoreID + "^" + strItemCategoryNo);
									*/
						...
						temp 				= strAvlQty.replace("^", "#").split("#");
							...
							System.out.println("--- OPDIssueToPatAutoTransHLP -  A ---");
							...
							{
								br.append("<tr>");
								br.append("<td colspan='7' style='text-align:left; width:5%;color:#0000FF;'><font size='2' face='Verdana, Arial, Helvetica, sans-serif'><b><u>"+curGroupName+ "</u></b></font></td>");
								br.append("</tr>");
							}

							br.append("<tr>");
							
							br.append(" <input type='hidden' name='strDeptPKey' id='strDeptPKey" + i+ "' value= '" +strDeptPKey+ "' /> ");

							br.append("<td  id='td1" + i + "'  style='width:36%;font-weight: 400; font-size: 0.8rem; color: #495057;text-align:left;'  >");
							...
							br.append("<td WIDTH='5%' id='td2" + i + "'  style='width:8%;font-weight: 400; font-size: 0.8rem; color: #495057;text-align:center;' >" + strAvlQty	+ "<input type='hidden' name='strAvlQty' id='strAvlQty" + i + "' value='"
									+ strAvlQtyWithUnitId
							...
							br.append("<td  id='td3" + i + "' style='width:8%;font-weight: 400; font-size: 0.8rem; color: #495057;text-align:center;'  >" + strReqSancQty+ "");
							br.append("</td>");
							...
							if (Integer.parseInt(strTotalNoOfBatch) > 1) 
							{
								System.out.println("--- OPDIssueToPatAutoTransHLP -  B ---");
								...
								br.append("<TD style='width:8%;font-weight: 400; font-size: 0.8rem; color: #495057;text-align:center;' id='td8" + i
							...
							else 
							{
								if (vo.getStrSingleBatchDtlWs() != null && vo.getStrSingleBatchDtlWs().size() > 0) 
								{
									...
									if (vo.getStrSingleBatchDtlWs().next()) 
									{
					                     ...
					                     13. Supp Id    					                   
							             */
										System.out.println("--- OPDIssueToPatAutoTransHLP -  C ---");		
								...
								{
									System.out.println("--- OPDIssueToPatAutoTransHLP -  G --[ When BATCH Not Avaliable ]--");
							...
							System.out.println("--- OPDIssueToPatAutoTransHLP -  F ---");
							...
							if (Integer.parseInt(strTotalNoOfBatch) == 1) 
							{
							  br.append("<td id='td8" + i + "' style='width:8%;font-weight: 400; font-size: 0.8rem; color: #495057;text-align:center;'  >"
									+ "<div name='issu"
		...
		public static String getStockItemDtlsInitView(OPDIssueToPatAutoTransFB formBean) throws Exception 
		{
