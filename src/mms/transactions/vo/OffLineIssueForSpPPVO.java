...
public class OffLineIssueForSpPPVO {
	...
	private String[] strReqStoreAvlQty =null;
	...
	private String strAvalaibleBudget = "0";
	private String strAvalaibleBudgetDtl = "0";
	//private String strCost;
	...
	public String[] getStrReqStoreAvlQty() {
		return strReqStoreAvlQty;
	}
	public void setStrReqStoreAvlQty(String[] strReqStoreAvlQty) {
		this.strReqStoreAvlQty = strReqStoreAvlQty;
	}
