 ...
 * 
 */
public class NewChallanProcessTransVO implements TransferObject {
	...
	private String strSupplierInvNo = "0"; 
	private String strSupplierInvDate ; 

	    
	
	
	public String getStrSupplierInvNo() {
			return strSupplierInvNo;
		}
		public void setStrSupplierInvNo(String strSupplierInvNo) {
			this.strSupplierInvNo = strSupplierInvNo;
		}
		public String getStrSupplierInvDate() {
			return strSupplierInvDate;
		}
		public void setStrSupplierInvDate(String strSupplierInvDate) {
			this.strSupplierInvDate = strSupplierInvDate;
		}
  ...
  //added for new challan process
  	...
  	public MultiMap getStrItemWiseMap() {
		return strItemWiseMap;
	}
	public void setStrItemWiseMap(MultiMap strItemWiseMap) {
		this.strItemWiseMap = strItemWiseMap;
	}
	public MultiMap getStrCrNoWiseMap() {
		return strCrNoWiseMap;
	}
	public void setStrCrNoWiseMap(MultiMap strCrNoWiseMap) {
		this.strCrNoWiseMap = strCrNoWiseMap;
	}
	public MultiMap getStrbatchWaiseMultiMap() {
		return strbatchWaiseMultiMap;
	}
	public void setStrbatchWaiseMultiMap(MultiMap strbatchWaiseMultiMap) {
		this.strbatchWaiseMultiMap = strbatchWaiseMultiMap;
	}
	private MultiMap strItemWiseMap=null;
  	private MultiMap strCrNoWiseMap=null;
	private MultiMap strbatchWaiseMultiMap=null;
