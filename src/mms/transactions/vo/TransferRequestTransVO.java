/**********************************************************
 Project:	   DWH_GUJARAT	
 File:         TransferRequestTransVO.java
 Created:      Jul 3, 2014
 ...
 */
public class TransferRequestTransVO {
	...
	/** The Wb transfer detail. */
	private WebRowSet WbTransferDetail = null;

	/** The Wb transfer order detail view. */
	private WebRowSet WbTransferOrderDetailView = null;
	...
	/**
	 * Gets the wb transfer detail.
	 * 
	 * @return the wb transfer detail
	 */
	public WebRowSet getWbTransferDetail() {
		return WbTransferDetail;
	}

	/**
	 * Sets the wb transfer detail.
	 * 
	 * @param wbTransferDetail the new wb transfer detail
	 */
	public void setWbTransferDetail(WebRowSet wbTransferDetail) {
		WbTransferDetail = wbTransferDetail;
	}

	/**
	 * Gets the wb transfer order detail view.
	 * 
	 * @return the wb transfer order detail view
	 */
	public WebRowSet getWbTransferOrderDetailView() {
		return WbTransferOrderDetailView;
	}

	/**
	 * Sets the wb transfer order detail view.
	 * 
	 * @param wbTransferOrderDetailView the new wb transfer order detail view
	 */
	public void setWbTransferOrderDetailView(WebRowSet wbTransferOrderDetailView) {
		WbTransferOrderDetailView = wbTransferOrderDetailView;
	}
