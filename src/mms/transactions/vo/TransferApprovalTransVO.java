...
public class TransferApprovalTransVO {
	 ...
	 * 
	 * @param strTransferStoreIds the new str transfer store ids
	 */
	 ...
	 * 
	 * @param strTransferRequestNos the new str transfer request nos
	 */
	 ...
	 * 
	 * @param strTransferOrderQtys the new str transfer order qtys
	 */
	 ...
	 * 
	 * @param wsDemandRequestDetails the new ws demand request details
	 */
	 ...
	 * 
	 * @param wsTransferingDetails the new ws transfering details
	 */
	 ...
	 * 
	 * @param wsDwhList the new ws dwh list
	 */
