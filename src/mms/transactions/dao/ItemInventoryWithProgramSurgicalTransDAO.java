 ...
 * @file DrugInventoryWithProgramTransDAO.java
 */
public class ItemInventoryWithProgramSurgicalTransDAO {
	 ...
	 *            the vo
	 */
	public static void initAddQuery(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void initAddQuery1(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 *            the vo
	 */
	public static void phdItemCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 */
	public static void getProgrammeCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getItemName(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getDummyItemName(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 *            the vo
	 */
	public static void GetGroupNameCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
		String err = "";
		...
		try {
			...
			dao = new HisDAO("mms",
					"DrugInventoryTransDAO.GetGroupNameCombo(ItemInventoryWithProgramSurgicalTransVO vo)");
	...
	public static void getItemBrandName(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 */
	public static void getUnitList(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 * @return the group id
	 */
	public static void getGroupId(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getItemQCType(ItemInventoryWithProgramSurgicalTransVO vo) {
		HisDAO dao = null;
	 ...
	 */
	public static void getBrandDetails(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getExistingBatchInStock(
			ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getExistingBatchList(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getSuppliedByList(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getCurrencyList(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 */
	public static void getStockStatusList(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 */
	public static void getmanufectuteName(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public static void getSupplierName(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 *            the vo
	 */
	public synchronized static void insert(ItemInventoryWithProgramSurgicalTransVO vo) {
		...
		try {
			...
			if (flag) {
				ItemInventoryWithProgramSurgicalTransDAO.updateCurrStock(vo);
			}
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 */
	public static void getNewSupplierId(ItemInventoryWithProgramSurgicalTransVO vo) {
	...
	public synchronized static void insertDummy(
		...
		try {
			...
			strProcName = "{call PKG_MMS_DML.dml_item_stock_update(?,?,?,?,?,  ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,? ,?,?,?,?,?,?,?)}"; // 22+3 Variable
				...
				for (int i = 0; i < vo.getStrMultiRowFinalBatchNo().length; i++) {					
					...
					if ( vo.getStrMultiRowMfgId() != null && !vo.getStrMultiRowMfgId().equals("") && vo.getStrMultiRowMfgId()[i].equals("1")) {
						...
						if (vo.getStrMultiRowActiveQty()[i].length() > 0 || vo.getStrMultiRowInActiveQty()[i].length() > 0 || vo.getStrMultiRowQuarnQty()[i].length() > 0) {
							...
							daoObj.setProcInValue(nProcIndex, "purrate","0",25); // 11 vo.getStrMultiRowPurRate()[i]
							daoObj.setProcInValue(nProcIndex, "handlingcharges","0",26); // 11 vo.getStrMultiRowHandlingCharges()[i]
							daoObj.setProcInValue(nProcIndex, "tax","0",27); // 11 vo.getStrMultiRowTax()[i]
	...
	public synchronized static void update(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 *            the vo
	 */
	public static void unitNameCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
		String strFuncName = "";
		String strProcName = "";
	 ...
	 *            the vo
	 */
	public static void unitSaleNameCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 *            the vo
	 */
	public static void unitRateNameCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 *            the vo
	 */
	public static void unitInHandNameCombo(ItemInventoryWithProgramSurgicalTransVO vo) {
	 ...
	 */
	public static void getStockModifyValue(ItemInventoryWithProgramSurgicalTransVO vo) {
		String strFuncName = "";
	 ...
	 * @return the brand details
	 */
	public static void getStoreType(ItemInventoryWithProgramSurgicalTransVO vo) {
