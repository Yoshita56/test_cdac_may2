...
public class ReceiveFromThirdPartyTransTestDAO {
	 ...
	 * @throws Exception
	 */
	public static void storeName(ReceiveFromThirdPartyTransTestVO vo)
	{
	 ...
	 * @throws Exception
	 */
	public static void itemCategory(ReceiveFromThirdPartyTransTestVO vo)
	{
	 ...
	 * @throws Exception
	 */
	public static void getReceivedItemListTwo(ReceiveFromThirdPartyTransTestVO vo)
	{
	 ...
	 * @throws Exception
	 */
	public static void getReceivedItemListThree(ReceiveFromThirdPartyTransTestVO vo)
	{
	...
	public static void getImageHeader(ReceiveFromThirdPartyTransTestVO vo)
	{
		String strFuncName = "";
		String strLogoName = "";
	 ...
	 * @throws Exception
	 */
	public static void getReceivedItemList(ReceiveFromThirdPartyTransTestVO vo)
	{
		String strProcName = "{call pkg_mms_view.proc_receivedItem_dtl(?,?,?,? ,?,?,?,?)}"; //8
	...
	//voucher
	public static void getReceivedItemListIndividual(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void initAddQuery(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getSubGroupList(ReceiveFromThirdPartyTransTestVO vo){
	...
	public static void getGenericItemList(ReceiveFromThirdPartyTransTestVO vo){
	...
	public static void getItemName(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getItemBrandName(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getBrandDetails(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getSuppliedByList(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getWarrantyManufList(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getCurrencyList(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getStockStatusList(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getInstituteList(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getmanufectuteName(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public synchronized static void insert(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void updateCurrStock(ReceiveFromThirdPartyTransTestVO vo,HisDAO dao) 
	{
	 ...
	 * 
	 */
	public static void unitNameCombo(ReceiveFromThirdPartyTransTestVO vo) {
		String strFuncName = "";
		String strProcName = "";
	...
	public static void unitInHandNameCombo(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void unitSaleNameCombo(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void unitRateNameCombo(ReceiveFromThirdPartyTransTestVO vo) {
	...
	public static void getVoucherDtl(ReceiveFromThirdPartyTransTestVO vo) 
	{
