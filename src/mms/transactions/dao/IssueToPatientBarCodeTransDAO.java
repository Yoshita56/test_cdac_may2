...
public class IssueToPatientBarCodeTransDAO {
	
	public static void getPatientAddmissionFlag(IssueToPatientBarCodeTransVO vo) 
	{
		// Declearing Variable
		String retVal = null;
		int funcIndex = 0;
		HisDAO dao = null;
		try {
			dao = new HisDAO("MMSModule", "IssueToPatientBarCodeTransDAO");
						
			funcIndex = dao.setFunction("{? = call MMS_MST.get_patient_Admission_status(?,?,?)}");	
			
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .MMS_MST.get_patient_Admission_status  -------- ");
		...
		{
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getPatientAddmissionFlag() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
	}
	...
	public static void getIssueDtlsList(IssueToPatientBarCodeTransVO vo) 
	{
		String err;
		//String strSlNoflg;
		HisDAO        dao = null;
		...
		try 
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getIssueDtlsList  -------- ");
			...
			/*
			  ...
			  5.Issue Qty
			 */				
			dao = new HisDAO("mms","global.IssueToPatientBarCodeTransDAO.getStockItemDtlsList(IssueToPatientBarCodeTransVO vo)");			
		...
		catch (Exception e) 
		{
			e.printStackTrace();
            //e.printStackTrace();
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getIssueDtlsList() --> "+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void getStoreList(IssueToPatientBarCodeTransVO voObj) {
		...
		try
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getStoreList  -------- ");
			System.out.println(" ------- pkg_mms_view.proc_hstt_store_mst  --[ Mode- 12 ]------ ");
			
			    daoObj = new HisDAO("MMS Transactions","IssueToPatientBarCodeTransDAO");
		...
		{
			e.printStackTrace();
			voObj.setStrMsgString("IssueToPatientBarCodeTransDAO.getStoreList() --> "+ e.getMessage());
	...
	public static void getViewStoreList(IssueToPatientBarCodeTransVO voObj) 
	{
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getViewStoreList  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getViewStoreList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getPatinetTypeCmb(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getPatinetTypeCmb  -------- ");
		...
		{
			e.printStackTrace();
			voObj.setStrMsgString("IssueToPatientBarCodeTransDAO.getPatinetTypeCmb() --> "+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getItemCatDtls(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getItemCatDtls  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getItemCatDtls() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
		...
		public static void GET_PAT_ACC_STATUS(IssueToPatientBarCodeTransVO vo) 
		{
			String proc_name1 = "";
			...
			try 
			{
	            System.out.println("------------- IssueToPatientBarCodeTransDAO.GET_PAT_ACC_STATUS -------------");
	             ...
	             */				
				dao = new HisDAO("mms","IssueToPatientBarCodeTransDAO.getAccountDtlWithAcctNo()");
				procIndex1 = dao.setProcedure(proc_name1);
			...
			{
				vo.setStrMsgString("IssueToPatientBarCodeTransDAO.GET_PAT_ACC_STATUS() --> "+ e.getMessage());
				vo.setStrMsgType("1");
			}
			finally 
			{
	...
	public static void getItemCatDtls1(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getItemCatDtls1  -------- ");
	...
	public static void getissuetopatient(IssueToPatientBarCodeTransVO vo) 
	{
		...
		String strErr = "";
		 System.out.println("<------------- IssueToPatientBarCodeTransDAO.getissuetopatient ------------->");
		...
		try 
		{
			...
			e.printStackTrace();
			vo
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getIssueDetailTwo() --> "
							+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void getCancelIssueDtls(IssueToPatientBarCodeTransVO voObj)
	{
		...
		try 
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getCancelIssueDtls  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getCancelIssueDtls() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getIssueDetail(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getIssueDetail() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getIssueDetailTwo(IssueToPatientBarCodeTransVO vo) 
	{
		...
		try 
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getIssueDetailTwo  -------- ");
			System.out.println(" ------- pkg_mms_view.Proc_Issue_Details  --[ Mode- 1 ]------ ");
	...
	public static void getIssueDtlPopUp(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getIssueDtlPopUp  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getIssueDtlPopUp() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getRequestDtls(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println("<------------- IssueToPatientBarCodeTransDAO.getRequestDtls() ------------->"); 
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getRequestDtls() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getOnlineTreatmentDtls(IssueToPatientBarCodeTransFB formBean,IssueToPatientBarCodeTransVO vo) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getOnlineTreatmentDtls  -------- ");
	...
	public static void getAlreadyDrugIssue(IssueToPatientBarCodeTransFB formBean,IssueToPatientBarCodeTransVO vo) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getAlreadyDrugIssue  -------- ");
	...
	public static void getRequestDetails(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getRequestDetails  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getRequestDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getFrequencyDetails(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
            ...
            System.out.println("<------------- IssueToPatientBarCodeTransDAO.getFrequencyDetails() ------------->"); 
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getFrequencyDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getDoseDetails(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","IssueToPatientBarCodeTransDAO");
			  ...
			  System.out.println("<------------- IssueToPatientBarCodeTransDAO.getDoseDetails() ------------->"); 
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getDoseDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getDeptDetails(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getDeptDetails  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getDeptDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getUnitDetails(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getUnitDetails  ---(Dept Wise Unit)----- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getUnitDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getPrescribedBy(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getPrescribedBy  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getPrescribedBy() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getItemDetails(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getItemDetails  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getItemDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getUnitCombo(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getUnitCombo  -------- ");
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getUnitCombo() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getStoreGroupList(IssueToPatientBarCodeTransVO vo) {
		...
		try {
			    ...
			    System.out.println("<------------- IssueToPatientBarCodeTransDAO.getStoreGroupList() ------------->"); 
			    System.out.println("<------------- pkg_mms_view.proc_store_group_list [ Mode - 2 ]------------->"); 

				dao = new HisDAO("MMS Transactions","IssueToPatientBarCodeTransDAO");
			...
			e.printStackTrace();
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getStoreGroupList() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static synchronized void insert(IssueToPatientBarCodeTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	//	MmsConfigUtil mcu;
		...
		try 
		{
			...
			System.out.println("------------- IssueToPatientBarCodeTransDAO.insert ------  START ------");
		...
		//	mcu =new MmsConfigUtil(vo.getStrHospitalCode());
			...
			debugPoint = 12;
					...
					*/
					...
					System.out.println("------------- IssueToPatientBarCodeTransDAO.insert ------  END  ------");
		...
		catch (Exception e) 
		{
			e.printStackTrace();
			vo.setStrMsgType("1");
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.insert() --> "
	...
	public static synchronized void insertipd(IssueToPatientBarCodeTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
		...
		try 
		{
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .insertipd  ---- START --[ Item Finder Selection ]-- ");
			...
			String     strVisitNo = "0" ;
				...
				{				
					...
					System.out.println(" ------- IssueToPatientBarCodeTransDAO .insertipd  ---- END ---- ");	
	...
	public static synchronized void REPEAT_ISSUE_INSERT(IssueToPatientBarCodeTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
		...
		try 
		{
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .REPEAT_ISSUE_INSERT  ---- START ---- ");
	...
	public static synchronized void inserttemp(IssueToPatientBarCodeTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
		...
		*/
		...
		try 
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO.inserttemp --- START --- ");
		...
		else
		{
			...
			debugPoint = 12;
					...
					*/
					...
					System.out.println(" ------- IssueToPatientBarCodeTransDAO.inserttemp --- END --- ");
	 ...
	 * @param vo
	 */
	public static synchronized void insertWithoutCrNo(IssueToPatientBarCodeTransVO vo)
	{
		...
		try 
		{
			...
			System.out.println(" ------- IssueToPatientBarCodeTransDAO.insertWithoutCrNo --- START --- ");
...
//							.append("</b></font></td> ");
				...
				System.out.println(" ------- IssueToPatientBarCodeTransDAO.insertWithoutCrNo --- END --- ");
			}
		} 
		catch (Exception e) 
		{
	...
	public static void getGenderCombo(IssueToPatientBarCodeTransVO voObj) {
		...
		try {
			...
			e.printStackTrace();
			voObj
					.setStrMsgString("IssueToPatientBarCodeTransDAO.getGenderCombo() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getLFAccountDetails(IssueToPatientBarCodeTransVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		try
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getLFAccountDetails  -------- ");
	...
	public static void getLFAccountSummary(IssueToPatientBarCodeTransVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		try
		{
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getLFAccountSummary -------------");
	 ...
	 * 
	 * @param IssueToPatientBarCodeTransVO	the IssueToPatientBarCodeTransVO
	 */
	public static void getPatientDiagDetails(IssueToPatientBarCodeTransVO vo)
	{
    	...
    	try 
		{
    		System.out.println("------------- IssueToPatientBarCodeTransDAO.getPatientDiagDetails -------------");
    	...
    	{
    		e.printStackTrace();
			vo.setStrMsgString("--> IssueToPatientBarCodeTransDAO.getPatientDiagDetails()-->"
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (daoObj != null)
	 ...
	 * @param IssueToPatientBarCodeTransVO	the IssueToPatientBarCodeTransVO
	 */
	public static void getIcdList(IssueToPatientBarCodeTransVO vo)
	{
    	...
    	try 
		{
    		...
    		System.out.println("------------- IssueToPatientBarCodeTransDAO.getIcdList -------------");
	 ...
	 * @param IssueToPatientBarCodeTransVO	the IssueToPatientBarCodeTransVO
	 */
	public static void getEmpList(IssueToPatientBarCodeTransVO vo)
	{
    	...
    	try 
		{
    		...
    		System.out.println("------------- IssueToPatientBarCodeTransDAO.getEmpList -------------");
	...
	public static void getBilledItemDtls(IssueToPatientBarCodeTransVO vo) 
	{
		...
		try 
		{
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getBilledItemDtls -------------");
	...
	public static void save(IssueToPatientBarCodeTransVO vo) 
	{
		...
		try 
		{
			System.out.println("------------- IssueToPatientBarCodeTransDAO.save -------------");
	...
	public static void deleteIssueDtls(IssueToPatientBarCodeTransVO vo) 
	{
		...
		try 
		{
			...
			System.out.println("------------- IssueToPatientBarCodeTransDAO.deleteIssueDtls -------------");
	...
	public static void getTariffDtls(IssueToPatientBarCodeTransVO vo) 
	{
		...
		try 
		{
			...
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getTariffDtls -------------");
			...
			e.printStackTrace();
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getTariffDtls() --> "
							+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void getStoreListBS(IssueToPatientBarCodeTransVO voObj) {
		...
		try
		{
			...
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getStoreListBS -------------");
	...
	public static void getPaymentMode(IssueToPatientBarCodeTransVO vo) {
		...
		try 
		{
			System.out.println(" ------- IssueToPatientBarCodeTransDAO .getPaymentMode  -------- ");
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getPaymentMode() --> "+ e.getMessage());
			vo.setStrMsgType("1");
		} 
		finally 
		{
	...
	public static void getReqType(IssueToPatientBarCodeTransVO vo) {
		// TODO Auto-generated method stub
		...
		try 
		{					
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getReqType -------------");
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getReqType() --> "+ e.getMessage());
			vo.setStrMsgType("1");
		} 
		finally 
		{
	...
	public static synchronized void directIssue(IssueToPatientBarCodeTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
		...
		try 
		{
			...
			System.out.println("------------- IssueToPatientBarCodeTransDAO.directIssue ------  START ------");
			...
			debugPoint = 12;
					...
					System.out.println("------------- IssueToPatientBarCodeTransDAO.directIssue ------ END -------");
	...
	private static void insertDirectIssueBilling(IssueToPatientBarCodeTransVO vo) {
		// TODO Auto-generated method stub
	...
	public static void getEpisodeDtl(IssueToPatientBarCodeTransVO voObj) {
		// TODO Auto-generated method stub
		...
		try
		{
			...
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getEpisodeDtl -------------");
			
			System.out.println("------------- pkg_simple_view.proc_hrgt_episode_unit_based_dtl --[ Mode - 1 ]-----------");
			
			daoObj = new HisDAO("mms", "IssueToPatientBarCodeTransDAO.getEpisodeDtl");
			nProcIndex = daoObj.setProcedure(strProcName);
			daoObj.setProcInValue(nProcIndex, "deptcode", strDeptCode, 2);
		...
		{
			voObj.setStrMsgString("IssueToPatientBarCodeTransDAO.getEpisodeDtl() --> " + e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getPresFormDtl(IssueToPatientBarCodeTransVO voObj) {
		// TODO Auto-generated method stub
		...
		try
		{
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getPresFormDtl -------------");
	...
	public static void getAccountDtl(IssueToPatientBarCodeTransVO VO) 
	{
		String proc_name1 = "";
		...
		try 
		{
            System.out.println("------------- IssueToPatientBarCodeTransDAO.getAccountDtl -------------");
		...
		{
			VO.setStrMsgString("IssueToPatientBarCodeTransDAO.getAccountDtl() --> "+ e.getMessage());
			VO.setStrMsgType("1");
		}
		finally 
		{
	...
	public static void getdeptname(IssueToPatientBarCodeTransVO vo) 
	{
		int nFuncIndex;
		String strFuncName2 = "";
		String deptname = "";
		...
		try 
		{
			System.out.println("------------- IssueToPatientBarCodeTransDAO.getdeptname -------------");
				
			System.out.println("------------- ipd_MST.getdeptname --[ Mode - 12 ]-----------");
				
			dao = new HisDAO("mms","IssueToPatientBarCodeTransDAO.getdeptname()");
		...
		{
			vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getdeptname() --> "+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally 
		{
	...
	public static void getIssuedItemDtlview(IssueToPatientBarCodeTransVO vo) {
	 ...
	 public static void getPatientAccountDetails(final IssueToPatientBarCodeTransVO vo) {
	 ...
	 public static void getImageHeader(IssueToPatientBarCodeTransVO voObj)
		{
			String strFuncName = "";
			String strLogoName = "";
	 ...
	 public static void GetData(IssueToPatientBarCodeTransVO vo) 
		{
			/* Declaring Variable */
			HisDAO dao = null;
			WebRowSet wb = null;
	 ...
	 public static void itemCategoryCombo1(IssueToPatientBarCodeTransVO vo)
	 {
			int     nProcIndex = 0;
			String      strErr = "";
			String         str = "";
	 ...
	 public static WebRowSet STORENAMECOMBO(IssueToPatientBarCodeTransVO vo)
		{
			String proc_name = "";
	 ...
	 /**
		 ...
		 * @param vo
		 */
		public static void getCRIssueDetail(IssueToPatientBarCodeTransVO vo) 
		{
		    // Declaring Variables 
			String        err = "";
			int    procIndex1 = 0;
		 ...
		 * @param vo
		 */
		public static void getRecommendName(IssueToPatientBarCodeTransVO vo)
		{
			String strProcName = "{call PKG_MMS_VIEW.proc_consultant_name(?,?,?,?,?,?)}";
			...
			try
			{
				...
				daoObj=new HisDAO("Return From","IssueToPatientBarCodeTransDAO");
				nProcIndex = daoObj.setProcedure(strProcName);
			...
			{
				vo.setStrMsgString("IssueToPatientBarCodeTransDAO.getRecommendName() --> "
						+ e.getMessage());
				vo.setStrMsgType("1");
			}
		}
		 ...
		 * @param vo
		 */
		public static void getItem_ALL_LIST(IssueToPatientBarCodeTransVO vo) {
		 ...
		 */
		public static void getItemBrandList(IssueToPatientBarCodeTransVO vo) {
			...
			try {
				...
				dao = new HisDAO("mms", "IssueToPatientBarCodeTransDAO.getItemBrandList(IssueToPatientBarCodeTransVO vo)");
		 ...
		 * @return the item brand list
		 */
		public static void getBarCodeDetails(IssueToPatientBarCodeTransVO vo) 
		{

			String err = "";
			String proc_name1 = "";

			proc_name1 = "{call pkg_mms_view2.proc_bar_code_itembrand_detail(?,?,?,?,?   ,?,?,?,?,?   ,?)}"; // 11

			System.out.println("-- IssueToPatientBarCodeTransDAO . getBarCodeDetails -- - " + proc_name1 + " - [ Mode - 8 ]---");
			...
			try {
				...
				dao = new HisDAO("mms", "IssueToPatientBarCodeTransDAO");

				procIndex1 = dao.setProcedure(proc_name1);
				dao.setProcInValue(procIndex1, "modeval", 		"1", 1);
				dao.setProcInValue(procIndex1, "hosp_code", 	vo.getStrHospitalCode(), 2);
				dao.setProcInValue(procIndex1, "itemCat", 		vo.getStrBarCodeBrandId().substring(0, 2), 3);
				dao.setProcInValue(procIndex1, "frmStrId", 		vo.getStrStoreId(), 4);
				dao.setProcInValue(procIndex1, "itemBrandId",   vo.getStrBarCodeBrandId(), 5);
				dao.setProcInValue(procIndex1, "reqType", 		"32", 6);
				dao.setProcInValue(procIndex1, "userInfo", 		"0", 7);
				dao.setProcInValue(procIndex1, "grpId", 		"0", 8);
				dao.setProcInValue(procIndex1, "batch", 		vo.getStrBarCodeBatch(), 9);
				dao.setProcOutValue(procIndex1, "err",			 1, 10); // 1 for string return
				dao.setProcOutValue(procIndex1, "resultset", 	 2, 11); // 2 for object
