 ...
 * 
 */
public class ItemInventoryTransDAO {
	/**
	...
	public static void initAddQuery(ItemInventoryTransVO vo) {
	...
	public static void getItemName(ItemInventoryTransVO vo) {
		...
		try {
			...
			//System.out.println(vo.getStrGroupId()+" "+vo.getStrSubGroupId()+" "+vo.getStrStoreId()+" "+vo.getStrItemCategoryNo()+" "+vo							.getStrHospitalCode());
			dao.setProcInValue(nprocIndex, "modeval", "1",1);
			dao.setProcInValue(nprocIndex, "group_id", vo.getStrGroupId(),5);
...
//System.out.println("size of item:::  "+wb.size());
	...
	public static void getItemBrandName(ItemInventoryTransVO vo) {
	...
	public static void getSuppliedByList(ItemInventoryTransVO vo) {
	...
	public static void getWarrantyManufList(ItemInventoryTransVO vo) {
	...
	public static void getCurrencyList(ItemInventoryTransVO vo) {
	...
	public static void getStockStatusList(ItemInventoryTransVO vo) {
	...
	public static void getmanufectuteName(ItemInventoryTransVO vo) {
	...
	public static void getBrandDetails(ItemInventoryTransVO vo) {
	...
	public static void insert(ItemInventoryTransVO vo) {
...
*/
	...
	public static void modifyRecord(ItemInventoryTransVO vo) {
	...
	public static void update(ItemInventoryTransVO vo) {
...
/*
	 ...
	 * 
	 */
	/*public static void unitNameCombo(ItemInventoryTransVO vo) {
		String strFuncName = "";
		String strProcName = "";
...
//System.out.println("strUnitRate>>>>"+strUnitRate);
	...
	public static void unitInHandNameCombo(ItemInventoryTransVO vo) {
	...
	public static void unitSaleNameCombo(ItemInventoryTransVO vo) {
	...
	public static void unitRateNameCombo(ItemInventoryTransVO vo) {
	...
	public static void getStockModifyValue(ItemInventoryTransVO vo) {
		String strFuncName = "";
