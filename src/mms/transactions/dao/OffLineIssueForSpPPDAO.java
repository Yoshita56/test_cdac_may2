...
public class OffLineIssueForSpPPDAO {
	/**
	...
	public static void GetData(OffLineIssueForSpPPVO vo) 
	{
		/* Declaring Variable */
		HisDAO dao = null;
		WebRowSet wb = null;
	 ...
	 * @param vo
	 */
	public static void getIndentDetail(OffLineIssueForSpPPVO vo) 
	{
		...
		try {
			...
			dao = new HisDAO("mms",
					"OffLineIssueForSpPPDAO.getIndentDetail(OffLineIssueForSpPPVO vo)");
		...
		{
            e.printStackTrace();
			vo.setStrMsgString("OffLineIssueForSpPPDAO.getIndentDetail() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	 ...
	 * @param vo
	 */
	public static void getItemDetail(OffLineIssueForSpPPVO vo) 
	{
		...
		try {
			...
			dao = new HisDAO("mms", "OffLineIssueForSpPPDAO");
			...
			vo.setStrMsgString("OffLineIssueForSpPPDAO.getItemDetail() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
     ...
     * from Table 
     */
	public static WebRowSet STORENAMECOMBO(OffLineIssueForSpPPVO vo)
	{
		String proc_name = "";
	 ...
	 */
	public static void getAvalBudgetDetails(OffLineIssueForSpPPVO vo) 
	{
		String err = "";
		...
		try {
				...
				dao = new HisDAO("MMS Transactions","OffLineIssueForSpPPDAO");
	 ...
	 * @param budgetAllocationDetailProcessTransVO_p
	 */
	public static void getPendingDemand(OffLineIssueForSpPPVO vo) 
	{
		String err = "";
...
//                System.out.println("Indenting::getPendingDemand:::"+vo.getStrIndentingStoreID());
	 ...
	 * @param vo
	 */
	public static void IndentPeriodCombo(OffLineIssueForSpPPVO vo) 
	{
		// Declaring Variables
		String        err = "";
		int    procIndex1 = 0;
		...
		{
			// Creating Object
			   hisutil = new HisUtil("master", "OffLineIssueForSpPPDAO");
			       dao = new HisDAO("mms","OffLineIssueForSpPPDAO.GetDeptCombo(OffLineIssueForSpPPVO vo)");
        	procIndex1 = dao.setProcedure(proc_name1);
			...
			vo.setStrMsgString("OffLineIssueForSpPPDAO.ToStoreCombo() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
	 ...
	 * @throws Exception
	 */
	public static void itemCategoryCombo(OffLineIssueForSpPPVO vo)
	{
		int     nProcIndex = 0;
		String      strErr = "";
		String         str = "";
	 ...
	 * @throws Exception
	 */
	public static void itemCategoryCombo1(OffLineIssueForSpPPVO vo)
	{
		int     nProcIndex = 0;
		String      strErr = "";
		String         str = "";
	 ...
	 * @param vo
	 */
	public static void IndentingStoreCombo(OffLineIssueForSpPPVO vo) 
	{
       // Declaring Variables
		String        err = "";
		int    procIndex1 = 0;
		...
		try 
		{
			...
			// set value
				...
				dao.setProcInValue(procIndex1, "hosp_code", vo	.getStrHospitalCode(),2);
  				...
  				dao.setProcInValue(procIndex1, "reqType", "10",4);
	 ...
	 */
	public static void getApprovedByCombo(OffLineIssueForSpPPVO offlineIssueIndent_VO)
	{
		// Declaring Variables
	 ...
	 * @param _OfflineIssueIndentVO
	 */
	public static void getVerifyByCombo(OffLineIssueForSpPPVO _OfflineIssueIndentVO)
	{
	 ...
	 * @param vo
	 */
	public static void getPopUpInfoProc(OffLineIssueForSpPPVO vo) 
	{
        // Declaring Variables
		HisDAO         dao = null;
		WebRowSet       ws = null;
		...
		{
			vo.setStrMsgString("OffLineIssueForSpPPDAO.getPopUpInfoProc() --> "	+ e.getMessage());
			vo.setStrMsgType("1");
	 ...
	 * @param vo
	 */
	public static void getIssueDetail(OffLineIssueForSpPPVO vo) 
	{
	    // Declaring Variables 
		String        err = "";
		int    procIndex1 = 0;
		...
		{
            // Cerating Object			
			       dao = new HisDAO("MMS",	"OffLineIssueForSpPPDAO.getIssueDetail(OffLineIssueForSpPPVO vo)");
			procIndex1 = dao.setProcedure(proc_name1);
            ...
            e.printStackTrace();
			vo.setStrMsgString("OffLineIssueForSpPPDAO.getIssueDetail() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	 ...
	 * @param vo
	 */
	public static void InsertOffLineforExistingDemand(OffLineIssueForSpPPVO vo)
	{
		boolean retVal;
		retVal = OffLineIssueForSpPPDAO.InsertExistingDemandData(vo);
		if(!retVal)
		{
			vo.setStrMsgType("1");
		}
	 ...
	 * @param vo
	 */
	public static boolean InsertExistingDemandData(OffLineIssueForSpPPVO vo) 
	{
	...
	public synchronized static boolean NewDemandOffLineIssueInsert(OffLineIssueForSpPPVO vo) 
	{		
		HisDAO         dao = null;
		String strFuncName = "";
		int     nFuncIndex = 0;
    	...
    	try 
		{
    		...
    		System.out.println("------------- OffLineIssueForSpPPDAO . NewDemandOffLineIssueInsert -----------------");
...
//			System.out.println("------------------End--PROC ONE---OrignalOffLineIssue Indent-------------------------");
		    ...
		    System.out.println("------------- PKG_MMS_DML.dml_offline_issue_dtls -------[ Mode - 1]----------");
		    ...
		    dao.setProcInValue(procIndex1, "indentPeriod"	,"15",10);    //10
...
/*		    	System.out.println("Req Qty:::"+vo.getStrReqQty()[i]);
		    	...
		    	System.out.println("GST Per Item:::"+vo.getStrReqStoreAvlQty()[i]); 	*/
...
//				System.out.println("------------------End--PROC TWO--OrignalOffLineIssue Indent--------------------------");	
				    ...
				    System.out.println("------------- PKG_MMS_DML.dml_offline_issue_item_dtls ------[ Mode - 2]-----------");
				
					procIndex = dao.setProcedure(proc_name);	
					dao.setProcInValue(procIndex, "modeval", "2",1);                             //1
 			...
 			System.out.println("------------- PKG_MMS_DML.dml_offline_issue_budget_dtl ------[ Mode - 1]-----------");
	...
	public static boolean CreateNewOffLineIndent(OffLineIssueForSpPPVO vo) 
	{
		HisDAO dao = null;
		int procIndex1 = 0;
		String indentNo = "";
		...
		{	
			...
			dao = new HisDAO("MMS", "transactions.OffLineIssueForSpPPDAO.CreateNewOffLineIndent()");
...
//			System.out.println("-----------------------END CreateNewOffLineIndent--PROC THREE-------------------------");
			...
			// System.out.println("Genrated Approval Flg-->>"+approvalFlg);
			 ...
			 {	 
				 ...
				 if(retVal)
				 {
					 retVal = OffLineIssueForSpPPDAO.InsertNewIndentApprovalRaisingStore(vo, indentNo);
					 if(retVal)
					 {
						 retVal = OffLineIssueForSpPPDAO.InsertNewIndentApprovalIssuingStore(vo, indentNo);
					 }
				 }
			 } 
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
			retVal = false;
			vo.setStrMsgString("--> OffLineIssueForSpPPDAO.CreateNewOffLineIndent()-->"
					+ e.getMessage());
			vo.setStrMsgType("1");
		} 
		finally 
	...
	public static boolean InesertNewIndentItem(OffLineIssueForSpPPVO vo, String indentNo,String approvalFlg)
	{
		HisDAO dao = null;
		String[] temp = null;
		String[] strTemp = null;
		...
		try {
			...
			dao = new HisDAO("MMS", "transactions.OffLineIssueForSpPPDAO.InesertNewIndentItem()");
...
//					System.out.println("------------------End--Item--Offline Indent--------------------------");
	...
	public static boolean InsertNewIndentApprovalRaisingStore(OffLineIssueForSpPPVO vo,String strIndentNo) 
	{
		HisDAO       dao  = null;
...
//    		 System.out.println("------------------END--InesertNewIndentItem--PROC FIVE----------------------------");
    		 ...
    		 strFuncName = "{? = call MMS_MST.get_Approval_No(?,?,?)}";
			    ...
			    synchronized(dao)   
			      ...
			      {	  
			    	  ...
			    	  //(OffLineIssueForSpPPVO vo,String appNo,String status,String lstStatus,String strIndentNo) 
			      }
	...
	public static boolean InsertNewIndentApprovalIssuingStore(OffLineIssueForSpPPVO vo,String strIndentNo) 
	{
		HisDAO       dao  = null;
		int    procIndex1 = 0;
		DmlApprovalDtlDAO globalDao = null;
...
//    		 System.out.println("------------------END--InsertNewIndentApprovalIssuingStore--PROC FIVE----------------------------");
	...
	public static boolean InsertNewIndentApprovalItemTable(OffLineIssueForSpPPVO vo,String appNo,String status,String lstStatus,String strIndentNo) 
	{
		HisDAO   dao         = null;
		HisUtil  util        = null;
		String[] temp        = null;
...
//    		 				  System.out.println("------------------End--InesertNewIndentItem--PROC SIX--------------------------");
	 ...
	 * @param vo
	 */
	public static void getUnitCombo(OffLineIssueForSpPPVO vo) {
		...
		try {
			...
			vo.setStrMsgString("OffLineIssueForSpPPDAO.getUnitCombo() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void getIssueDtlsList(OffLineIssueForSpPPVO vo) {
		...
		try 
		{
			...
			dao = new HisDAO("mms","global.MmsDAO.getStockItemDtlsList(OffLineIssueForSpPPVO vo)");
			
			
			nFuncIndex = dao.setFunction(strFuncName);
			
			System.out.println("----------------------- OffLineIssueForSpPPDAO.getIssueDtlsList() --------pkg_mms_view.proc_issue_detail--[ Mode- 8]----------");
