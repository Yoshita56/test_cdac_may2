...
public class NewIPDIssueToPatTransDAO {
	
	public static void getPatientAddmissionFlag(NewIPDIssueToPatTransVO vo) 
	{
		// Declearing Variable
		String retVal = null;
		int funcIndex = 0;
	...
	public static void getIssueDtlsList(NewIPDIssueToPatTransVO vo) 
	{
		String err;
		//String strSlNoflg;
		HisDAO        dao = null;
		...
		try 
		{
			...
			/*
			  ...
			  5.Issue Qty
			 */				
			dao = new HisDAO("mms","global.NewIPDIssueToPatTransDAO.getStockItemDtlsList(NewIPDIssueToPatTransVO vo)");			
	...
	public static void getStoreList(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getViewStoreList(NewIPDIssueToPatTransVO voObj) 
	{
	...
	public static void getPatinetTypeCmb(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getItemCatDtls(NewIPDIssueToPatTransVO voObj) {
		...
		public static void GET_PAT_ACC_STATUS(NewIPDIssueToPatTransVO vo) 
		{
			String proc_name1 = "";
	...
	public static void getItemCatDtls1(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getissuetopatient(NewIPDIssueToPatTransVO vo) 
	{
	...
	public static void getCancelIssueDtls(NewIPDIssueToPatTransVO voObj)
	{
	...
	public static void getIssueDetail(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getIssueDetailTwo(NewIPDIssueToPatTransVO vo) 
	{
	...
	public static void getIssueDtlPopUp(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getRequestDtls(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getOnlineTreatmentDtls(NewIPDIssueToPatTransFB formBean,NewIPDIssueToPatTransVO vo) {
	...
	public static void getAlreadyDrugIssue(NewIPDIssueToPatTransFB formBean,NewIPDIssueToPatTransVO vo) {
	...
	public static void getRequestDetails(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getFrequencyDetails(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getDoseDetails(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getDeptDetails(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getUnitDetails(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getPrescribedBy(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getItemDetails(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getUnitCombo(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getStoreGroupList(NewIPDIssueToPatTransVO vo) {
	...
	public static synchronized void insert(NewIPDIssueToPatTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	public static synchronized void insertipd(NewIPDIssueToPatTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	public static synchronized void REPEAT_ISSUE_INSERT(NewIPDIssueToPatTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	public static void getGenderCombo(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getLFAccountDetails(NewIPDIssueToPatTransVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
	...
	public static void getLFAccountSummary(NewIPDIssueToPatTransVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
	 ...
	 * 
	 * @param NewIPDIssueToPatTransVO	the NewIPDIssueToPatTransVO
	 */
	public static void getPatientDiagDetails(NewIPDIssueToPatTransVO vo)
	{
	 ...
	 * @param NewIPDIssueToPatTransVO	the NewIPDIssueToPatTransVO
	 */
	public static void getIcdList(NewIPDIssueToPatTransVO vo)
	{
	 ...
	 * @param NewIPDIssueToPatTransVO	the NewIPDIssueToPatTransVO
	 */
	public static void getEmpList(NewIPDIssueToPatTransVO vo)
	{
	...
	public static void getBilledItemDtls(NewIPDIssueToPatTransVO vo) 
	{
	...
	public static void deleteIssueDtls(NewIPDIssueToPatTransVO vo) 
	{
	...
	public static void getTariffDtls(NewIPDIssueToPatTransVO vo) 
	{
	...
	public static void getStoreListBS(NewIPDIssueToPatTransVO voObj) {
	...
	public static void getPaymentMode(NewIPDIssueToPatTransVO vo) {
	...
	public static void getReqType(NewIPDIssueToPatTransVO vo) {
		// TODO Auto-generated method stub
	...
	public static synchronized void directIssue(NewIPDIssueToPatTransVO vo) 
	{
		HisDAO         dao = null;		
		String strFuncName = "";
		int     nFuncIndex = 0;
	...
	private static void insertDirectIssueBilling(NewIPDIssueToPatTransVO vo) {
		// TODO Auto-generated method stub
	...
	public static void getEpisodeDtl(NewIPDIssueToPatTransVO voObj) {
		// TODO Auto-generated method stub
	...
	public static void getPresFormDtl(NewIPDIssueToPatTransVO voObj) {
		// TODO Auto-generated method stub
	...
	public static void getAccountDtl(NewIPDIssueToPatTransVO VO) 
	{
		String proc_name1 = "";
	...
	public static void getdeptname(NewIPDIssueToPatTransVO vo) 
	{
		int nFuncIndex;
		String strFuncName2 = "";
		String deptname = "";
	...
	public static void getIssuedItemDtlview(NewIPDIssueToPatTransVO vo) {
	 ...
	 public static void getPatientAccountDetails(final NewIPDIssueToPatTransVO vo) {
	 ...
	 public static void getImageHeader(NewIPDIssueToPatTransVO voObj)
		{
			String strFuncName = "";
			String strLogoName = "";
	 ...
	 public static void GetData(NewIPDIssueToPatTransVO vo) 
		{
			/* Declaring Variable */
			HisDAO dao = null;
			WebRowSet wb = null;
	 ...
	 public static void itemCategoryCombo1(NewIPDIssueToPatTransVO vo)
	 {
			int     nProcIndex = 0;
			String      strErr = "";
			String         str = "";
	 ...
	 public static WebRowSet STORENAMECOMBO(NewIPDIssueToPatTransVO vo)
		{
			String proc_name = "";
	 ...
	 /**
		 ...
		 * @param vo
		 */
		public static void getCRIssueDetail(NewIPDIssueToPatTransVO vo) 
		{
		    // Declaring Variables 
			String        err = "";
			int    procIndex1 = 0;
		 ...
		 * @param vo
		 */
		public static void getRecommendName(NewIPDIssueToPatTransVO vo)
		{
			String strProcName = "{call PKG_MMS_VIEW.proc_consultant_name(?,?,?,?,?,?)}";
		 ...
		 * @param vo
		 */
		public static void getItem_ALL_LIST(NewIPDIssueToPatTransVO vo) {
		 ...
		 */
		public static void getItemBrandList(NewIPDIssueToPatTransVO vo) {
			...
			try {
				...
				dao = new HisDAO("mms", "NewIPDIssueToPatTransDAO.getItemBrandList(NewIPDIssueToPatTransVO vo)");
