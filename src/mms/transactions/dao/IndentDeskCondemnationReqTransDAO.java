...
/**
 * @author Amit Kumar Date of Creation : 27/4/2009 Date of Modification : / /
 *         Version : 1.0 Module : Store
 */
public class IndentDeskCondemnationReqTransDAO {
	/**
	 * This Method is used to get group name for Item Search Utility
	 * 
	 * @param vo
	 */
	public static void GetData(IndentDeskCondemnationReqTransVO vo) {
		String err = "";
		...
		try {
			hisutil = new HisUtil("master", "IndentDeskCondemnationReqTransDAO");
			dao = new HisDAO(
					"mms",
					"IndentDeskCondemnationReqTransDAO.GetData(IndentDeskCondemnationReqTransVO vo)");
			...
			dao.setProcInValue(procIndex1, "hosp_code", "100",3);
			...
			vo.setStrMsgString("IndentDeskCondemnationReqTransDAO.GetData() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
	...
	/*
	 * This Method is Used to get Item Type Combo (Check It ........) by passing
	 * two variable a) Store_type_id b) Hospital Code
	 */

	public static void GetItemType(IndentDeskCondemnationReqTransVO vo) {
		String err = "";
		...
		try {
			...
			vo.setStrMsgString("IndentDeskCondemnationReqTransDAO.GetItemType() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
	 ...
	 * @param vo
	 */
	public static void ToStoreCombo(IndentDeskCondemnationReqTransVO vo) {
		String err = "";
		...
		try {
			...
			dao = new HisDAO(
					"mms",
					"IndentDeskCondemnationReqTransDAO.GetDeptCombo(IndentDeskCondemnationReqTransVO vo)");
			...
			vo.setStrMsgString("IndentDeskCondemnationReqTransDAO.ToStoreCombo() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
	...
	/*
	 * This Method is Used to get Item Combo by passing two variable a)
	 * Store_type_id b) Hospital Code
	 */

	public static void GetItemCombo(IndentDeskCondemnationReqTransVO vo) {
		String err = "";
		String proc_name1 = "{call pkg_mms_view.proc_store_group_list(?,?,?,?,?,?,?)}";
		...
		try {
			...
			e.printStackTrace();
			vo.setStrMsgString("IndentDeskCondemnationReqTransDAO.GetItemCombo() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
	 ...
	 * Code b) Store Id
	 */
	public static void callingFunctionStoreName(
			IndentDeskCondemnationReqTransVO vo) {
		// Declearing Variable
		String retVal = null;
		int funcIndex = 0;
		HisDAO dao = null;
	...
	public static void callingItemCategory(IndentDeskCondemnationReqTransVO vo) {
	...
	public static void INSERT(IndentDeskCondemnationReqTransVO vo) {
		HisDAO dao = null;
		int procIndex1 = 0;
		String indentNo = "";
		String approvalFlg = "";
		...
		try {
			...
			dao = new HisDAO("MMS",
					"transactions.IndentDeskCondemnationReqTransDAO.INSERT()");
			...
			e.printStackTrace();
			vo.setStrMsgString("--> IndentDeskCondemnationReqTransDAO.INSERT()-->"
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (dao != null)
	...
	public static void INSERTINTABLE(IndentDeskCondemnationReqTransVO vo,
			String indentNo, String approvalFlg) {
		HisDAO dao = null;
		...
		try {
			hisutil = new HisUtil("MMS",
					"transactions.IndentDeskCondemnationReqTransDAO.INSERTINTABLE()");
			...
			for (int i = 0; i < length; i++) {
				...
				tableDao1
						.setStrFinancialStarDate(vo.getStrFinancialStartYear());
			...
			// e.printStackTrace();
			vo.setStrMsgString("-->IndentDeskCondemnationReqTransVO.INSERTINTABLE()-->"
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (dao != null)
