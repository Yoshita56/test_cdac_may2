 ...
 */
public class LocalPurchaseMRN_DtlsDAO {
	...
	public void insert(HisDAO dao) throws Exception {
		...
		try {
			...
			dao.setProcInValue(nProcIndex, "fin_str_date",
					strFinancialStartYear,23);
