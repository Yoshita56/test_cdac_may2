...
public class MmsDAO {
	...
	public static void getItemList(MmsVO vo) {
		...
		//	proc_item_list(modeval , catcode , grpid , subgroup_id , hosp_code ,  err ,  resultset )
			...
			dao.setProcInValue(procIndex1, "subgroup_id", vo.getStrSubGroupId());			
	 ...
	 * @return the item list
	 */
	public static void getItemList_WITHOUTCATG(MmsVO vo) {
	...
	public static void getItemBrandList(MmsVO vo) {
		...
		if(vo.getStrRequestType().equals("23"))
		{
			proc_name1 = "{call pkg_mms_view2.proc_itembrand_detail_na_cert(?,?,?,?,?,?,?,?,?,?,?)}"; //9	
		}
		else
		{
	        ...
	        {
	        	 proc_name1 = "{call pkg_mms_view.Proc_Itembrand_Detail(?,?,?,?,?,?,?,?,?,?,?)}"; //9	
	        }	
		}
		
		System.out.println("-- MMSDAO . getItemBrandList -- [ "+vo.getStrRequestType()+" ] --["+strModeVal+"]-- "+proc_name1+" ----");
		...
		//	//System.out.println("reqType "+ vo.getStrRequestType());
			...
			dao.setProcInValue(procIndex1, "reqType", vo.getStrRequestType(),6);
			...
			{
				dao.setProcInValue(procIndex1, "userInfo",vo.getStrUserInfo().replace("@", "^"),7);
			}	
	 ...
	 * @return the item brand list
	 */
	public static void getItemBrandList_ALLCatg(MmsVO vo) {
		...
		//	//System.out.println("subGrpId "+ vo.getStrSubGroupId());	
            ...
            e.printStackTrace();
			vo.setStrMsgString("MmsDAO.getItemBrandList_ALLCatg() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
...
//			//System.out.println("RESER_STOCK FLAG::MMS DAO::"+vo.getStrReservedFlag());
	...
	public static void getImageHeader(MmsVO vo)
	{
		String strFuncName = "";
		String strLogoName = "";
		...
		try 
		{
			...
			//System.out.println("---------------------"+strLogoName);
	 ...
	 * @return the group list
	 */
	public static void getGroupList_WITHOUTCATG(MmsVO vo) {
