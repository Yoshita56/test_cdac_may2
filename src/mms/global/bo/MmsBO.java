...
public class MmsBO {
	 ...
	 * @return the search item init dtls
	 */
	public void getSearchItemInitDtls_WITHOUTCATG(MmsVO vo) {

		MmsDAO.getGroupList_WITHOUTCATG(vo);
		MmsDAO.getItemList_WITHOUTCATG(vo);	

		if (vo.getStrMsgType().equals("1")) {

			String strErr = vo.getStrMsgString();

			vo.setStrMsgString("MmsBO.getSearchItemInitDtls_WITHOUTCATG() --> " + strErr);
	 ...
	 * @return the search item brand list dtls
	 */
	public void getSearchItemBrandListDtls_ALLCatg(MmsVO vo) {

		MmsDAO.getItemBrandList_ALLCatg(vo);

		if (vo.getStrMsgType().equals("1")) {

			String strErr = vo.getStrMsgString();

			vo.setStrMsgString("MmsBO.getSearchItemBrandListDtls_ALLCatg() --> "
					+ strErr);
	...
	public void getImgHeader(MmsVO vo){
		MmsDAO.getImageHeader(vo);
		if (vo.getStrMsgType().equals("1")){
			vo.setStrMsgString("ReturnFromTransBO.getImgHeader() --> "+ vo.getStrMsgString());
		  }
	}
	/**
	...
	public void getIssueDtlsInitDtls(MmsVO vo) {
		...
		if (vo.getStrMsgType().equals("1")) {
			String strErr = vo.getStrMsgString();
			vo.setStrMsgString("MmsBO.getStockItemDtlsInitDtls() --> "+ strErr);
		}
	}
