 ...
 */
public class StoreItemMappingMstVO {
	...
	public void setStrMaxLevel(String strMaxLevel) {
		this.strMaxLevel = strMaxLevel;
	}
	public String getStrReOrder() {
		return strReOrder;
	}
	public void setStrReOrder(String strReOrder) {
		this.strReOrder = strReOrder;
	}
