...
/**
 * The Class ItemTypeMstVO.
 */
public class ModelTypeMstVO implements TransferObject {
	...
	private WebRowSet wsGroupNameCombo = null;
	...
	public WebRowSet getWsGroupNameCombo() {
		return wsGroupNameCombo;
	}

	public void setWsGroupNameCombo(WebRowSet wsGroupNameCombo) {
		this.wsGroupNameCombo = wsGroupNameCombo;
	}
	 ...
	 * 
	 * @param strItemTypeName the new str item type name
	 */
