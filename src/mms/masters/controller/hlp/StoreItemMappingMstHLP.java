...
/**
 * The Class StockOnHandRptHLP.
 */
public class StoreItemMappingMstHLP {

	/**
	 * Prints the vital drug list.
	 * 
	 * @param vo the vo
	 * @return the string
	 * @throws Exception the exception
	 */
	public static String printVitalDrugList(StoreItemMappingMstVO vo) throws Exception {
		int programmeSize = 0;
		int counter = 0;
		int slNo = 0;
		int keyValue = 0;
	...
	public static String printReportRpt1(StoreItemMappingMstVO vo,String reportHeader, HttpServletRequest request) throws Exception
	{
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
	...
	public static String printBatchWiseReportRpt(StoreItemMappingMstVO vo,String reportHeader, HttpServletRequest request,StoreItemMappingMstFB formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
...
//		HttpServletRequest request=null;
		...
		try 
		{
				...
				br.append("<table  width='100%' align='center' cellspacing='1px' cellpadding='1px' border='0'>"
						+ " <tr> "
//						+ " <td colspan='1'><div align='center'><img src='/INVMGM/hisglobal/images/aiims_header_10811.png' ></div></td>"
				...
				*/
				...
				br.append(strHeader.toString());
				br.append("<table border='0' width='" + strTableWidth + "' align='center'> ");
				br.append("<tr> ");
				br.append("<td align='right'>");
				br.append("<div id='saveId' style='display : block'> <div id='printImg' class='hidecontrol' align='right'>");
				br.append("<img style='cursor: pointer; '  name='PrintPage' tabindex='1' title='Print Page'");
				br.append(" src='../../hisglobal/images/printer_symbol.gif' onClick='printDataOne();'/> ");
				br.append("</div>");
				br.append(" </td> ");
				br.append(" </tr> ");
				br.append(" </table> ");
...
//							br.append("</tr>");
	...
	public static String printBatchWiseReportRptNew(StoreItemMappingMstVO vo,String reportHeader, HttpServletRequest request,StoreItemMappingMstFB formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
		...
		try 
		{
				...
				br.append(" <tr> "
					//	+ " <td colspan='1'></td>" 
						+ " <td colspan='12'align='center'><b>Re-Order Level Report</b></td>");
					//	+ " <td colspan='1'></td>");
				br.append("</tr>");
	...
	public static String printBatchWiseReportRptForMail(StoreItemMappingMstVO vo,String reportHeader, HttpServletRequest request,StoreItemMappingMstFB formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
	...
	public static String printWithOutBatchReport(StoreItemMappingMstVO vo,String reportHeader, HttpServletRequest request ,StoreItemMappingMstFB formBean) throws Exception {
		//WebRowSet wsItem = null;
		StringBuffer br = new StringBuffer(2000);
...
//				br.append("<table  width='100%' align='center' cellspacing='1px' cellpadding='1px' border='0'>"
//						+ " <tr> "
//						//+ " <td colspan='1'><div align='center'><img src='/INVMGM/hisglobal/images/aiims_header.png' ></div></td>"
...
//						+ "onClick='generateXLSCommon(event, indentItemListDivId);' /></div></td></tr></table>");
	...
	public static String getReportHeader(
			StoreItemMappingMstVO vo,
			StoreItemMappingMstFB formBean,  String strIndentItemList,
		...
		try
		{
			...
			sb.append("<tbody><tr><td style='text-align:right;'><div><img src='/INVMGM/hisglobal/images/logo.png' width='100' style='margin-left: 100%;float: left;'></div> </td>");
