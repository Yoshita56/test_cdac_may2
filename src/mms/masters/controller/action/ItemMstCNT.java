...
import mms.masters.controller.utl.ItemMstUTL;
 ...
 */
public class ItemMstCNT extends GenericController {
	 ...
	 */
	public ItemMstCNT() {
		super(new ItemMstUTL(), "/masters/ItemMstCNT");
	}
	...
	public ActionForward INSERT(ActionMapping mapping, ActionForm form,
		...
		System.out.println("MAX_VALUE--------------->"+formBean.getMAX_VALUE());
		System.out.println("MIN_VALUE--------------->"+formBean.getMIN_VALUE());
		System.out.println("TEMP_SENS_FLAG--------------->"+formBean.getTEMP_SENS_FLAG());
		System.out.println("formBean.getStrItemName--------------->"+formBean.getStrItemName());
		System.out.println("formBean.getStrEclCat--------------->"+formBean.getStrEclCat());
