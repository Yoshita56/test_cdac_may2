...
import mms.masters.controller.utl.DrugMstUTL;
...
public class DrugMstCNT extends GenericController {
	 ...
	 */
	public DrugMstCNT() // Constructor for DrugMstCNT
	{
		super(new DrugMstUTL(), "/masters/DrugMstCNT");
	}
	...
	public ActionForward INSERT(ActionMapping mapping, ActionForm form,
		...
		/*
		 * System.out.println("formBean.getMAX_VALUE()---------CNT-------->"+formBean.
		 * getMAX_VALUE());
		 * System.out.println("formBean.getTEMP_SENS_FLAG()----------------->"+formBean.
		 * getTEMP_SENS_FLAG());
		 * System.out.println("formBean.getMIN_VALUE()----------------->"+formBean.
		 * getMIN_VALUE());
		 */
	...
	public ActionForward UPDATE(ActionMapping mapping, ActionForm form,
		...
		//System.out.println("formBean.getMAX_VALUE()----------------->"+formBean.getMAX_VALUE());
		//System.out.println("formBean.getTEMP_SENS_FLAG()----------------->"+formBean.getTEMP_SENS_FLAG());
		//System.out.println("formBean.getMIN_VALUE()----------------->"+formBean.getMIN_VALUE());
	...
	public ActionForward CHECKDRUGDUPLICACY(ActionMapping mapping, ActionForm form,
		    HttpServletRequest request, HttpServletResponse response)
		    throws HisException, SQLException {
	    
	    // Save the token to prevent duplicate form submissions
	    saveToken(request);
	    ...
	    fb.setStrSeatId(request.getSession().getAttribute("SEATID").toString());
	    fb.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
	    // Call the method to check if the drug name exists
	    DrugMstDATA.checkDrugDuplicacy(fb, request, response);
	    return null; 
