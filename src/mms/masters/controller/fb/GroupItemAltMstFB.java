...
public class GroupItemAltMstFB extends GenericFormBean 
{
	...
	private String strNewDrugCnt;
	private String strExDrugCnt;
	
	public String getStrNewDrugCnt() {
		return strNewDrugCnt;
	}
	public void setStrNewDrugCnt(String strNewDrugCnt) {
		this.strNewDrugCnt = strNewDrugCnt;
	}
	public String getStrExDrugCnt() {
		return strExDrugCnt;
	}
	public void setStrExDrugCnt(String strExDrugCnt) {
		this.strExDrugCnt = strExDrugCnt;
	}
