...
public class ItemMstFB extends GenericFormBean {
	...
	/** The str set ECL flag. */
	private String strEclCat = "0";
	
	private String TEMP_SENS_FLAG="";
	private String MIN_VALUE="";
	private String MAX_VALUE ="";
	
	public String getStrEclCat() {
		return strEclCat;
	}

	public void setStrEclCat(String strEclCat) {
		this.strEclCat = strEclCat;
	}
	...
	/*
	 * public FormFile getStrLocation() { return strLocation;
	 * 
	 * }
	 * 
	 * public void setStrLocation(FormFile strLocation) { this.strLocation =
	 * strLocation;
	 * 
	 * }
	 */
