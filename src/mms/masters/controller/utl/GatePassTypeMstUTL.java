...
/**
 * The Class GatePassTypeMstUTL.
 */
public class GatePassTypeMstUTL implements MasterInterface {
	...
	public String[] getColumnHeader() {
		String col_header[] = { "Gate Pass Type Name", "Effective From" };
		return col_header;
	}
	...
	public String[] getDeleteQuery() {
		...
		deleteQuery[0] = mms.qryHandler_mms.getQuery(1, "delete.GatePassMst.0")
				.replace("?", seatId);
		deleteQuery[0] = deleteQuery[0].concat("  where "
				+ mms.qryHandler_mms.getQuery(1, "delete.GatePassMst.cond.0"));
		return deleteQuery;
	}
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				mms.qryHandler_mms.getQuery(1, "select.GatePassMst.0").replace(
						"?", "" + hosCode + "")).append(
				" AND "
						+ mms.qryHandler_mms.getQuery(1,
								"select.GatePassMst.cond.0").replace("?", "1"));
		...
		////System.out.println("main query gatepass type mst:: "+brMainQuery.toString());
	...
	public String getMasterName() {
		String masterName = "Gate Pass Type Master";
		return masterName;
	}
	...
	public String[] getOrderBy() {
		String orderBy[] = { "1", "HSTSTR_GATEPASS_TYPE_NAME" };
		return orderBy;
	}
	...
	public String[] getSearchField() {
		String search_field[] = { "1", "HSTSTR_GATEPASS_TYPE_NAME" };
		return search_field;
	}
	...
	public List<String> getViewHeader() {
		...
		viewHdr.add("Gate Pass Type Name");
		viewHdr.add("D");
		viewHdr.add("Remarks");
		viewHdr.add("D");
