...
public class StoreMstBSUTL implements MasterInterface {
	...
	public String[] getComboQuery() {
		 ...
		 */
		 ...
		 comboQuery[0] = "SELECT A.HSTNUM_STORETYPE_ID,INITCAP(A.HSTSTR_STORETYPE_NAME) as data FROM HSTT_STORETYPE_MST A WHERE  GNUM_ISVALID=1";
...
//			}
//		}
        System.out.println("StoreMstBSUTL - Main Qry::::"+brMainQuery.toString());
