...
* The Class LabMstUTL.
*/
public class SmsMobileSetupMstUTL implements MasterInterface{
	...
	public String getButtons() {
		...
		strButtons.append("<br><a  href='#' class='btn btn-sm btn-primary'  onKeyPress='if(event.keyCode==13) add(\"ADD\");' onClick='add(\"ADD\");' ><span class='add'>Add</span>");
