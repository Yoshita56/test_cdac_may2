	...
	private static void setConfigPath(int connType) {
		...
		try {
			if (connType == 1) {
				...
				// System.out.println("lookUpName1 ::"+lookUpName1);
		...
		try {
			...
			if (getConnType().equals("1")) {
				...
				if (!lookUpName1.equals("")) {
					 ...
					 */
					ic = new InitialContext();
					ds = (DataSource) ic.lookup(lookUpName1);
					conn = ds.getConnection();
				}
			}
