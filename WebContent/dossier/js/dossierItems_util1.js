...
function setItemStockParameters(cmbObj) {
	...
	if (gblMode == '3') {
		...
		document.getElementById("stockParamSpecificationDivId").innerHTML = temp0[1];
		if(document.getElementById("stockParamReOrderDivId") != null)
		document.getElementById("stockParamReOrderDivId").innerHTML = temp0[2];
		
		if(document.getElementById("purchaseStockInHandDivId") != null)
		document.getElementById("purchaseStockInHandDivId").innerHTML = temp0[3];
		
		if(document.getElementById("purchaseBatchNoDivId") != null)
...
*/
	...
	if(gblRequestType == "32" || gblRequestType == "34"){
		//gblRequestType1= 32 ;
	if (true) {
			//alert('1');
		var strRequestType1=32;
		//alert(document.getElementById("searchItemsDtlsDivId").innerHTML);
		if(document.getElementById("searchItemsDtlsDivId").innerHTML=="")
			{
			//alert('2');
			...
			var url = "/INVMGM/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=" + strMode
					+ "&strGroupId=0&strFromStoreId=" + fromStoreId + "&strRequestType="
					+ strRequestType1 +  "&strItemCategory=" + gblItemCategory+"&strUserInfo="+strUserInfo;
			//alert(url);
			ajaxFunction2(url, "1", "getMyAjaxResponse");
			}
		else
...
function searchItemsWithUserFunction1(strMode, strItemCat, strRequestType, fromStoreId, strMultiRowCompArray,
		strMultiRowCompTypeArray, strMultiRowFetchDataArray, layerIndex,
		userFunctionName, userFunctionArgument ,strUserInfo , strUnitMode ) {

//alert("searchItemsWithUserFunction1 :: "+userFunctionName);
...
*/
		//if (itemParaObj.innerHTML == "" || oldStoreId != fromStoreId) {
	//alert('gblRequestType'+gblRequestType);
	if(gblRequestType == "32" || gblRequestType == "34" || gblRequestType == "35"){
		//gblRequestType1= 32 ;
	if (true) {
			//alert('1');
		var strRequestType1=32;
...
function getLeftItemBrandListOnly1(mode) 
{
 		//alert("getLeftItemBrandListOnly1 1");
		var brandItemListObj = document.getElementById("brandItemListDivId");
		brandItemListObj.innerHTML = "<select name='strBrandedItemList'  multiple='multiple' size='12' style='width :100%' ></select>";
		//alert("getLeftItemBrandListOnly 2");
		document.getElementById("popUpItemNameDivId").innerHTML = "";
		...
		gblRequestType= 32;
		////alert("getLeftItemBrandListOnly 6");
		var url = "/INVMGM/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=3&strGroupId="
			+ gblStrGroupIdForItemSearch + "&strSubGroupId=" + subGrpId + "&strItemId="
			+ ItemId + "&strRequestType=" + gblRequestType + "&strFrmStoreId="
			+ gblFromStoreId + "&strItemCatId=" + gblItemCategory +"&strUserInfo="+gblUserInfo;
	 //alert(url);
...
function getBrandItemList1(mode) 
{		
		//alert('getBrandItemList1');
 		var brandItemListObj = document.getElementById("brandItemListDivId");
		brandItemListObj.innerHTML = "<select name='strBrandedItemList'  multiple='multiple' size='12' style='width :100%' ></select>";
		document.getElementById("popUpItemNameDivId").innerHTML = "";
		document.getElementById("popUpItemLoadDivId").style.display="block";
...
function getMyAjaxResponse(res, mode) {
	...
	if(gblRequestType == "32" || gblRequestType == "34" || gblRequestType == "35"){
		gblMode='2';
		if(gblRequestType == "34")
		getBrandItemList("2");
		else if (gblRequestType == "35")
		getBrandItemList1('3');
		else
		getBrandItemList("3");
...
if(mode == '6'){
	...
	{	
		...
		if(gblRequestType == '34'){
			//alert('1::::::34');
			getLeftItemBrandListOnly(2);
		}
		else if(gblRequestType == '35'){
			//alert('1::::::34');
			getLeftItemBrandListOnly1(2);
		}
		else{
			getLeftItemBrandListOnly(3);
		}
