...
<link href="/INVMGM/mms/css/transaction.css" rel="stylesheet" type="text/css">
...
<center>
<tag:tab tabLabel="Dossier Return" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab>
</center>
...
<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
	...
	<div id="strRequestItemDtlId" style="display: block">
		...
		<logic:equal value="1" name="lpIssueDeskTransBean" property="strSettlementFlag">
		<div id='settlementId'>
		  <table class="TABLEWIDTH" align="center" cellspacing="1px">
	 	<tr>
	 		<td class="LABEL" colspan=2 width="100%">Dossier final settlement request<input type = 'checkbox' name='strSettlementFlag' checked='checked' disabled/></td>
	 	</tr>
...
<input type="hidden" name="strGstrReqNo" value="${lpIssueDeskTransBean.strGstrReqNo}"/>
