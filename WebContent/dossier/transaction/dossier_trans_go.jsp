		...
		if(conf)
			{
			   if($("#requestMode").val()=='OT'){    //Added By Ranjit for Dossier OT Integration
				  ...
				  $.ajax({
					     url:'/INVMGM/dossier/transaction/DossierRequisitionCNT.cnt?hmode=INSERTOT',
...
function getDossierOT(){
	...
	document.getElementById("dossierId").innerHTML="";
	  ...
	  $.ajax({
          url: "/INVMGM/dossier/transaction/DossierRequisitionCNT.cnt?hmode=getOTDossierRadio",
          type: "POST",
          cache: false,
          data: {
...
function rejectDossier(otReqNo,opCode,dossCode){
	  ...
	  $.ajax({
          url: "/INVMGM/dossier/transaction/DossierRequisitionCNT.cnt?hmode=rejectDossier",
          type: "POST",
          cache: false,
          data: {
        	  otReqNo:$("#otPacReqNo").val(),
