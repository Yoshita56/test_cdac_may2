...
<script language="Javascript" src="/INVMGM/dossier/masters/DossierMaster.js"></script>
...
<html:form action="/masters/DossierMstCNT" name="DossierMasterBean"
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="4" width="25%">Dossier Master&gt;&gt; Add</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" class="CONTROL" width="45%">
				<textarea rows="2" cols="20" name="strDossierName"></textarea>
			</td>
		</tr>
		<tr>
		<tr>
			...
			<td colspan="2" class="CONTROL" width="45%">
				<input type="text" rows="2" cols="20" maxlength="15" name="strDossierShortName"></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2" class="LABEL" width="45%">Dossier Description</td>
			<td colspan="2" class="CONTROL" width="45%">
				<textarea rows="2" cols="20" name="strDossierDescription"></textarea>
			</td>
		</tr>
	...
	<input type="hidden" value="${DossierMasterBean.strServiceTypeID }"
		name="strServiceTypeID" />
	<input type="hidden" value="${DossierMasterBean.strServiceTypeName }"
		name="strServiceTypeName" />
	<input type="hidden" value="${DossierMasterBean.strDossierType}" name="dossierType" />
	<input type="hidden" value="${DossierMasterBean.strCurrentDate}"
		name="strCurrentDate" />
	...
	<%-- <input type="hidden" value="${DossierMasterBean.strDepartmentCode }"
		name="strDepartmentCode" />
	<input type="hidden" value="${DossierMasterBean.strDepartmentName }"
