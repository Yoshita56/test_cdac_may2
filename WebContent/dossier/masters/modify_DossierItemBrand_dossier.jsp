...
<script language="Javascript" src="/INVMGM/dossier/masters/dossiernew_trans.js"></script>
<script language="Javascript" src="/INVMGM/dossier/masters/dossierItemsnew_util.js"></script>
<script language="Javascript" src="/INVMGM/dossier/masters/dossierDetailsnew_util.js"></script>
<script language="Javascript" src="/INVMGM/dossier/masters/dossierissueDetailsnew_util.js"></script>
...
<script type="text/javascript">
	...
	function validate() {
	    ...
	    var selectedValue = document.getElementsByName("strNewDeptName")[0].value;
		if(selectedValue=="0"){
			alert("Department Name is a mandatory field.");
			return false;
		}
	    ...
	    if(retVal)
	    {
	    	var conf = confirm("Are you Sure, Want to Modify!!!!");
...
<body>
	<html:form action="/masters/DossierItemBrandMstCNT" name="DossierItemBrandMasterBean"
		...
		<table class="TABLEWIDTH" align="center" cellspacing="1px">
			<tr class="HEADER">
				<td colspan="4">Dossier Item Brand Master&gt;&gt; Modify</td>
			</tr>
		</table>
	   <table class="TABLEWIDTH" align="center" cellspacing="1px">
			<%-- 
			...
			<tr>
				...
				<td width="25%" class="CONTROL">
					<select name="strNewDeptName" class="comboNormal" onchange="">
						<bean:write name="DossierItemBrandMasterBean" property="strDeptNameValues" filter="false" />
					</select>
				</td>
				<td width="25%" class="LABEL"><font color="red">*</font>Item Kit Name</td>
				<td width="25%" class="CONTROL">
					<input type="text" value="${DossierItemBrandMasterBean.strItemKitName}" name="strItemKitName" maxlength="100" class="txtFldMax" onkeypress="return validateData(event,18);">
				</td>
			</tr>
			<tr>
				<td width="25%" class="LABEL"><font color="red">*</font>Item Kit Description</td>
				<td width="25%" class="CONTROL">
					<textarea rows="2" cols="20" name="strItemKitDescription">${DossierItemBrandMasterBean.strItemKitDescription}</textarea>
				</td>
				<td width="25%" class="LABEL"><font color="red">*</font>Item Kit Rate(per day)</td>
				<td width="25%" class="CONTROL">
					<input type="text" value="${DossierItemBrandMasterBean.strItemKitRate}" name="strItemKitRate" maxlength="100" class="txtFldMax" onkeypress="return validateData(event,7);">				
				</td>
			</tr>
			<tr>
				...
				<td width="25%" class="LABEL"><font color="red">*</font>Record Status</td>
				<td width="25%" class="CONTROL">
					<input type="radio" name="strIsValid" value="1" checked="true">Active&nbsp;
					<input type="radio" name="strIsValid" value="0">Inactive
				</td>
			</tr>
			<!-- <tr>
...
<div id="blanket" style="display: none;"></div>
	...
	<div class="popUpDiv" id="popUpDiv1" style="display: none;">
				...
				<tbody>
					<tr>
						...
						<td class="multiLabel" width="4%"></td>
				     	...
				     	<td class="multiLabel" id="totalCostDossier" width="8%"></td>
						<td class="multiLabel" width="4%"></td>
					</tr>
				</tbody>
			</table>
		...
		<input type="hidden" value="${DossierItemBrandMasterBean.strItemBrandId}" name="strItemBrandId" />
		<input type="hidden" value="${DossierItemBrandMasterBean.strMiscId}" name="strMiscId" />
