...
//document.forms[0].strDoseFrqFlg.value="1";
	...
	console.log("strFromStoreId======>"+strFromStoreId);
	//var strFromStoreId ="10201100"; 		//document.getElementsByName('strId')[0].value.split("^")[0];
...
//	{
	...
	//}
		var strMultiRowFetchDataArray = new Array('1', '22', '23', '18', '24' , '21', '3');
		//var strMultiRowFetchDataArray = new Array('1', '22', '18', '21', '3');
	...
	//alert('going to searchItemsWithUserFunction');
	...
	//searchItems(strModeVal, strItemCategory, strRequestType, strFromStoreId, strMultiRowCompArray, strMultiRowCompTypeArray,strMultiRowFetchDataArray, layerIndex,strUserInfo , strUnitMode)
	...
	searchItemsWithUserFunction2(strModeVal, strItemCategory, strRequestType, strFromStoreId,strMultiRowCompArray,strMultiRowCompTypeArray,strMultiRowFetchDataArray, layerIndex,userFunctionName, userFunctionArgument ,strUserInfo , strUnitMode);
}
