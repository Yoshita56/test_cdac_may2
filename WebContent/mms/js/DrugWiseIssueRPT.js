 ...
 */
	...
	function onClearPage()
	{
		...
		document.getElementById("AckReport").style.display = "none";
		objVal.innerHTML = "";
		
		 document.getElementById("StoreId").disabled = false;
		 document.getElementById("strFromDate").disabled = false; 
		 document.getElementById("strToDate").disabled = false;
		 document.getElementById("strActId").disabled = false;
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "DrugWiseIssueRPTCNT.cnt?hmode="+mode+
...
if (mode == "6") {
		...
		objVal.innerHTML = "<select name='strItemCategoryId' id='strItemCategoryId' onchange='reSetViewDetails();' class='comboNormal'>"+res+"</select>";
	...
	if (mode == "7") {
	   ...
	   document.getElementById("strActId").disabled = true;
	   document.getElementById("strItemCategoryId").disabled = true;
...
function pageResetMethod()
{
  ...
  */
  function getInventoryDtls() 
  {
   	...
   	var hisValidator = new HISValidator("DrugWiseIssueRPTbean");
	...
	var url = "DrugWiseIssueRPTCNT.cnt?hmode="+hmode+
