...
function getMemberDtl(mode)
{
	...
	var url="ChallanProcessTransBSCNT.cnt?hmode="+mode+"&committeType="+document.forms[0].strCommitteeType[document.forms[0].strCommitteeType.selectedIndex].value+"&itemCategNo="+document.forms[0].strItemCategoryId.value;
	ajaxFunction(url,"2");
	document.getElementsByName("strReportNumber")[0].focus();
}
	  ...
	  */
	  function getScheduleDtls(cmbObj) 
	  {
		...
		var url = "ChallanProcessTransBSCNT.cnt?hmode=" + mode + "&strScheduleDtls="+cmbObj.value+"&strPoNo="+
	...
	{			
		...
		if (retVal) 
		{
			...
			// alert(document.getElementsByName("strPoNo")[0].value);
			 ...
			 var url = "NewChallanProcessTransBSCNT.cnt?hmode="+mode+"&strPoNo="+document.forms[0].strPoNo.value+"&strPoStoreId="+document.forms[0].strPoStoreId.value+"&strStoreId="+document.forms[0].strStoreId.value;
			 //alert(url);
			 ajaxFunction(url, "4");
			//}
	/*	} 
...
function createBatchRow(i)
{
	...
	var batch='0';
		...
		//alert(rate.split('#')[1]);
		var tmp,idx;
		tmp = "<table id = 'tbl"+i+"'class='table'><thead><tr class='HEADER'><th colspan='11'> Details for : "+document.getElementById("strItemName"+i).value +",Order Qty : "+ document.getElementById("strBalQty"+i).value +"  </th></tr><tr><th ><font color='red'>*</font>Batch/Serial No.</th><th ><font color='red'>*</font>Qty.</th><th ><font color='red'>*</font>Pur. Rate/Unit</th><th ><font color='red'>*</font>GST%</th><th ><font color='red'>*</font>Pur. Rate Incl.Tax</th><th >Mfg Date</th><th ><font color='red'>*</font>Exp. Date</th><th ><font color='red'>*</font>Administrative Charges(%)</th><th ><font color='red'>*</font>Administrative Charges</th><th ><font color='red'>*</font>Cost to Patient</th><th></th></tr></thead><tbody>";
		for(idx=0;idx < batch;idx++)
		{
			tmp += "<tr id='batchRow"+i+""+idx+"'><td  style='width: 10%;'><input type='text' autocomplete='off' name='strBatch' id='strBatch"+i+""+idx+"' onkeypress='return validateData(event,8);' class='form-control'></td>";
			tmp += "<td  style='width: 4%;'><input type='text' autocomplete='off' name='strAcceptedQty' id='strAcceptedQty"+i+""+idx+"' onkeypress='return validateData(event,5);' class='form-control'></td>";
			tmp += "<td style='width: 9%;' ><input type='text' autocomplete='off' name='strPurRate' id='strPurRate"+i+""+idx+"' value="+temp.split('#')[1]+" onkeypress='return validateData(event,7);' onchange='calPurRate1(this,"+i+""+idx+");' class='form-control'></td>";
			tmp += "<td  style='width: 5%;'><input type='text' autocomplete='off' name='strGST'  value="+temp.split('#')[2]+"  id='strGST"+i+""+idx+"' onkeypress='return validateData(event,7);' onchange='calPurRate(this,"+i+""+idx+");' class='form-control'></td>";
			tmp += "<td  style='width: 10%;'><input type='text' autocomplete='off' name='strPurRateWithGST'   value="+temp.split('#')[3]+"   id='strPurRateWithGST"+i+""+idx+"' onkeypress='return validateData(event,7);' class='form-control' ></td>";
			//tmp += "<td  ><input onblur='Trim(this)' onkeyup='lTrim(this)' tabindex='1' size='9%' class='txtFldDate' name='strMfgDate"+idx+"' id='strMfgDate"+idx+"' readonly='false' type='text'><img tabindex='1' src='../../hisglobal/images/imgDatepicker.png' id='strMfgDate' style='cursor: pointer; border: 1px solid red;' title='Date selector' onmouseover='this.style.background='red';' onmouseout='this.style.background='' '> 	<script language='JavaScript'> Calendar.setup( { inputField     :  'strMfgDate',eventName : 'click', ifFormat       :    '%d-%b-%Y', button         :    'strMfgDate1', singleClick    :    true });Calendar.setup( { inputField     :    'strMfgDate',eventName : 'keypress',mapKey : '32', ifFormat       :    '%d-%b-%Y', button         :    'strMfgDate1', singleClick    :    true });</script> </td>";
			//tmp += "<td   ><input size='9%' type='text' name='strMfgDate' readonly='readonly' id='strMfgDate1#delIndex#' class='txtFldDate'/><img src='/HBIMS/hisglobal/images/imgDatepicker.png'  style='cursor: pointer; border: 1px solid red; width: 12px;'  title='Date selector' onmouseover='datePickerMultiRow(event,'strMfgDate1',this);this.style.background='red';'	  onmouseout='this.style.background='' ' id='strMfgDate2#delIndex#'  name='strMfgDate2'/> </td>";
		...
		//	tmp += "<img src='/HBIMS/hisglobal/images/imgDatepicker.png'  style='cursor: pointer; border: 1px solid red; width: 12px;' title='Date selector' onmouseover=\"datePickerMultiRowGeneric(event,'strExpDate2',this,'strExpDate12-"+idx+"');this.style.background='red';\" onmouseout=\"this.style.background=''\" id='strExpDate22-"+idx+"'  name='strExpDate2'/></td>";
			...
			tmp += "<td  style='width: 10%;'><input type='text' autocomplete='off' placeholder='(dd.mm.yyyy)' maxlength='10' onkeyup='validateDate(this);' name='strMfgDate' id='strMfgDate"+i+""+idx+"' onkeypress='return validateData(event,7);' class='form-control'></td>";
			tmp += "<td  style='width: 10%;'><input type='text' autocomplete='off' placeholder='(dd.mm.yyyy)' maxlength='10' onkeyup='validateDate(this);' name='strExpDate' id='strExpDate"+i+""+idx+"' onkeypress='return validateData(event,7);' class='form-control'></td>";
			
			tmp += "<td  ><input type='text' autocomplete='off' name='strHandlingCharges' maxlength='5' id='strHandlingCharges"+i+""+idx+"'  onchange='calCost(this,"+i+""+idx+");' onkeypress='return validateData(event,7);' class='form-control'></td>";
			tmp += "<td  ><input type='text' autocomplete='off' name='strHandlingChargesVal' id='strHandlingChargesVal"+i+""+idx+"' onkeypress='return validateData(event,7);' class='form-control' ></td>";
			tmp += "<td  style='width: 9%;'><input type='text' autocomplete='off' name='strMRP' maxlength='8' id='strMRP"+i+""+idx+"'  onkeypress='return validateData(event,7);' class='form-control' ></td><td   >";
		...
		tmp += "<tr><td  colspan='11' style='text-align: center'><button type='button' class='btn btn-primary' onClick='closePopUpDiv(1,"+i+");' style='line-height: 0.8;'>Ok</button>&nbsp;<button type='button' class='btn btn-danger' onClick='closePopUpDiv(2,"+i+");' style='line-height: 0.8;'>Cancel</button></td></tr></tbody></table>";
...
function calCost(e,idx)
{
	...
	var tx=parseFloat(document.getElementById('strPurRateWithGST'+idx).value)+((parseFloat(document.getElementById('strPurRate'+idx).value)*parseFloat(e.value))/100);
	document.getElementById('strHandlingChargesVal'+idx).value=Math.round(((parseFloat(document.getElementById('strPurRate'+idx).value)*parseFloat(e.value))/100)*100)/100;
	document.getElementById('strMRP'+idx).value=Math.round(tx * 100) / 100;
...
//			}
	...
	var PurRateWithGST =$("input[name=strPurRateWithGST]").val();
	var MRP =$("input[name=strMRP]").val();
	document.getElementById("RateWithGST").innerHTML = PurRateWithGST;
	document.getElementById("mrp").innerHTML = MRP;
	document.getElementById("hidenew").style.display="";
	document.getElementById("hidenew1").style.display="";
	document.getElementById("RateWithGST").style.display="";
	document.getElementById("mrp").style.display="";
	//alert(name);
}
	  ...
	  */
	  function getBalanceQtyDtls(parentObj) {
	  	...
	  	display_popup_menu(parentObj, "balQtyDtlsDivId" , "","");
			...
			var url = "ChallanProcessTransBSCNT.cnt?hmode=" + mode + "&strPoNo="+ document.forms[0].strPoNo.value + 
...
{		  	
	...
	var url = "ChallanProcessTransBSCNT.cnt?hmode=" + mode + "&strPoNo="+ poNo + "&strChallanNo="+ challanNo+ "&strStoreId="+ storeId ;
...
{		  	
	...
	var url = "ChallanProcessTransBSCNT.cnt?hmode=" + mode + "&strPoNo="+ poNo + "&strChallanNo="+ challanNo+ "&strStoreId="+ storeId+ "&strItemId="+ itemId+ "&strItemBrandId="+ itemBrandId ;
...
function printPage(index)
{
	...
	if (itemStockObj.innerHTML == "") {
		...
		var hmode = "PRINT";
		var url = "ChallanProcessTransBSCNT.cnt?hmode=" + hmode
