 ...
 */
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "New_Report_For_AcknowledgeCNT.cnt?hmode="+mode+
...
function pageResetMethod()
{
  ...
  */
  function getInventoryDtls() 
  {
   	...
   	var hisValidator = new HISValidator("New_Report_For_Acknowledgebean");
...
//  	document.forms[0].strSupplierName.value = document.forms[0].strSupplierId[document.forms[0].strSupplierId.selectedIndex].text;
	...
	var url = "New_Report_For_AcknowledgeCNT.cnt?hmode="+hmode+
  ...
  function printDataOne() 
  {
	  ...
	  var x = document.getElementById("AckReport");
	  x.style.display = "block";
