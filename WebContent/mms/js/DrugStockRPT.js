 ...
 */
	...
	function getInventoryDtls() 
	{
	   	    ...
	   	    var hisValidator = new HISValidator("DrugStockRPTbean");
			...
			var url = "DrugStockRPTCNT.cnt?hmode="+hmode+	
			...
			"&endDate="+document.forms[0].strFromDate.value+
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "DrugStockRPTCNT.cnt?hmode="+mode+
