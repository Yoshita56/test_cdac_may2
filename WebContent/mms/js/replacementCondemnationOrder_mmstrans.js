...
function getPendingOrderDtl()
{
    ...
    {	    	
    	   ...
    	   * */
	        ...
	        console.log("getPendingOrderDtl().URL--------->"+url);
	        ajaxFunction(url,"4");
	...
	{ //alert("JII");
	 ...
	 function getAjaxResponse(res, mode) 
	 {
			...
			if (mode == "4") 
			{
				...
				console.log("Mode - 4 -A--res.split($)[1]------>"+res.split("$")[1]);				
				...
				*/
				...
				console.log("Mode - 4 -C--res.split($)[2]------>"+res.split("$")[2]);
				
				objVal = document.getElementById("CommitteTypeCmb");
				objVal.innerHTML = "<select name='strCommitteType' class='comboMax'>"+res.split("$")[2]+"</select>";
				getNOSQDrugListHLP();
