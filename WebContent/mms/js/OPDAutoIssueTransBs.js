...
/*function getPrevIssueDtl_OffLine() {
	...
	if (strFromStoreId != 0) {
		var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=PREVISSUEDTL"
				+"&strId="
...
function getItemCat() {
		...
		var url = "OPDIssueToPatAutoTransCNT.cnt?hmode="+mode+"&storeId="
...
/*	if (document.getElementsByName("strStoreId")[0].value == "0") {
	...
	var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=" + mode+ "&strId="
...
function getAjaxResponse(res, mode) {
	...
	if (mode == "11") {
		...
		var hisValidator = new HISValidator("opdIssuePatAutoBean");
...
function getPatientAccStatus() {
	 ...
	 * document.forms[0].strItemCat.value;
	 * 
	 * var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=GET_PAT_ACC_STATUS&crNo="+
...
function getReport() {
	...
	if (parseInt(transferNo) != 0 && document.forms[0].printReq.value == 1) {
		...
		var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=" + mode + "&strIssueNo="
...
function getReport2() {
	...
	if (parseInt(transferNo) != 0) {
		var mode = "ISSUEDTLPOPUP";
		var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=" + mode + "&issueNo="
...
function getReqType() {
	// alert('11');
	var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=GETREQTYPE&storeId="
...
function getPresData() {
	var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=GETPRESCDATA&storeId="
...
function checkEpidoseData() {
	...
	var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=ALREADYISSUEDRUG&itemTmp="
...
function getEpisodeList(obj) {
	...
	var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=" + hmode + "&crNo="
...
function getReport() {
	...
	if (issueNo != "") {
		if (issueNo != "0") {
			...
			var url = "OPDIssueToPatAutoTransCNT.cnt?hmode=" + hmode + "&strMode="
