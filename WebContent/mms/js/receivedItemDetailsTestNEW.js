...
// 		document.getElementById("giftedNewItemDivId").style.display = "none";
  ...
  function getNewReceving(chkValue) 
  {
			...
			var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+hmode+"&storeId="+chkValue;
 ...
 */
 function getItemCategorys(strCombo) {
			...
			var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+hmode+"&storeId="+strCombo.value;
			createFHashAjaxQuery(url);
 			ajaxFunction(url,"6");
...
//	hisValidator.clearAllValidations();
  ...
  /*	var hmode = "GETRECEIVEDITEMVIEWDTLS"; 
			var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+hmode+"&storeId="+document.forms[0].strStoreId[document.forms[0].strStoreId.selectedIndex].value+"&strCategoryId="+document.forms[0].strItemCategoryId[document.forms[0].strItemCategoryId.selectedIndex].value.split('^')[0]
	...
	var endDate = document.forms[0].strToDate.value;
			...
			var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode=" + hmode 
			        + "&storeId=" + storeId 
			        + "&storeName=" + storeName
 ...
 */
 function getSubGroupListDtls(grpObj) {
	...
	var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+mode+"&GroupId="
			+ grpObj.value ;
	createFHashAjaxQuery(url);
	ajaxFunction(url, "8");
...
function ajaxItemName(mode) {
	...
	var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+mode+"&strSubGroupId="
...
function ajaxItemBrandName1(mode) {
	...
	var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+mode+"&strItemId="
...
function getItemBrandDetails() {
	...
	if(document.forms[0].strItemBrandId.value != 0){	
			...
			var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode="+mode+"&strItemBrandId="
...
function ajaxManufectureName(mode) {
	...
	var url = "ReceiveFromThirdPartyTransTestCNTNEW.cnt?hmode=MANUFECTURENAME&strItemBrandId="
