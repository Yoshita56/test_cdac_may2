...
//		document.forms[0].strToDate.value = document.forms[0].strCurrentDate.value ;
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "IssueAgainstIndentRptCNT.cnt?hmode="+mode+
...
// 		document.getElementById("giftedNewItemDivId").style.display = "none";
  ...
  function getNewReceving(chkValue) 
  {
			...
			var url = "IssueAgainstIndentRptCNT.cnt?hmode="+hmode+"&storeId="+chkValue;
 			ajaxFunction(url,"10");
...
function pageResetMethod()
{
  ...
  */
  function getInventoryDtls() 
  {
   	...
   	var hisValidator = new HISValidator("IssueAgainstIndentRptbean");
...
//  	document.forms[0].strSupplierName.value = document.forms[0].strSupplierId[document.forms[0].strSupplierId.selectedIndex].text;
	...
	var url = "IssueAgainstIndentRptCNT.cnt?hmode="+hmode+
 ...
 */
 function getItemCategorys(strCombo) {
			...
			var url = "IssueAgainstIndentRptCNT.cnt?hmode="+hmode+"&storeId="+strCombo.value;
 ...
 */
 function getSubGroupListDtls(grpObj) {
	...
	var url = "IssueAgainstIndentRptCNT.cnt?hmode="+mode+"&ItemId="
			+ grpObj.value ;
...
function ajaxItemName(mode) {
	...
	var url = "IssueAgainstIndentRptCNT.cnt?hmode="+mode+"&strSubGroupId="
...
function ajaxItemBrandName1(mode) {
	...
	var url = "IssueAgainstIndentRptCNT.cnt?hmode="+mode+"&strItemId="
...
function getItemBrandDetails() {
	...
	if(document.forms[0].strItemBrandId.value != 0){	
			...
			var url = "IssueAgainstIndentRptCNT.cnt?hmode="+mode+"&strItemBrandId="
...
function ajaxManufectureName(mode) {
	...
	var url = "IssueAgainstIndentRptCNT.cnt?hmode=MANUFECTURENAME&strItemBrandId="
 ...
 */
 function setWarrantyManfacturer(comboObj) {
	...
	if (retVal) {
	 	...
	 	getItemOtherDetailsView(mode, isBatchReq , isExpDtReq , '1' , "IssueAgainstIndentRptbean");
	}else{
	...
	if (retVal) {
	 	...
	 	getItemOtherDetailsView(mode, isBatchReq , isExpDtReq , '2' , "IssueAgainstIndentRptbean");
