...
function printData_Fix() 
{
	...
	// newwin.document.write('}\n');
	newwin.document.write('}\n');
	newwin.document.write('<style type="text/css"> .hidecontrol { display: none; }  @media print { { margin:12.7 mm  !important;  padding:0  } @page{size:landscape !important; margin:12.7mm;}}  </style>\n')
    newwin.document.write('<script>\n');
...
function setStore()
{
	var obj=document.getElementsByName("strStoreId");
