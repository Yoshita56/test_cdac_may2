...
function getGroupCmb(){ 
	...
	if(document.forms[0].strItemCatNo.value!=0){
		var url ="StockLedgerForSubStoresRptCNT.cnt?hmode=GROUPCMB&itemCatId="+document.forms[0].strItemCatNo.value;
 		ajaxFunction(url,"2");
 		}else{
		document.forms[0].strGroupId.value="0";
		document.forms[0].strItemId.value="0";
...
function getItemCmb(){ 
	...
	if(document.forms[0].strGroupId.value!=0){
		var url ="StockLedgerForSubStoresRptCNT.cnt?hmode=ITEMCMB&groupId="+document.forms[0].strGroupId.value+"&storeId="+document.forms[0].strStoreId.value+"&itemCatId="+document.forms[0].strItemCatNo.value;
 		ajaxFunction(url,"3");
 		}else{
		document.forms[0].strGroupId.value="0";
	}
...
function validate()
{
		...
		if(retVal){
					...
					var url="StockLedgerForSubStoresRptCNT.cnt?hmode="+mode+
...
{	  
	...
	var url="StockLedgerForSubStoresRptItemCNT.cnt?hmode="+mode+
			"&storeId="+storeId+
			"&itembrandId="+itemBrandId+
			"&batchNo="+batchNo+
			"&fromDate="+fromDate+
...
function getDrugName()
{
	    ...
	    var url ="StockLedgerForSubStoresRptCNT.cnt?hmode=ITEMCMB&storeId="+document.forms[0].strStoreId.value+
