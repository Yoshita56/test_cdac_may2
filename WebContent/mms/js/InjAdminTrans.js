...
function getIssuePopUp_Org(these, index) 
{
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=ISSUEDTLPOPUP&strId="
...
/*function getPrevIssueDtl_OffLine() {
	...
	if (strFromStoreId != 0) {
		var url = "InjAdministrationTransCNT.cnt?hmode=PREVISSUEDTL"
				+"&strId="
...
function getItemCat() {
		...
		var url = "InjAdministrationTransCNT.cnt?hmode="+mode+"&storeId="
...
/*	if (document.getElementsByName("strStoreId")[0].value == "0") {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=" + mode+ "&strId="
...
function getAjaxResponse(res, mode) {
	...
	if (mode == "11") {
		...
		var hisValidator = new HISValidator("injAdminTransBean");
...
function getItemDetails() {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=ITEMDETAILS&reqNo=" + gblObject
...
function getConsultantCombo() {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=PRESCRIPEDBY&unitCode="
...
function getUnitCombo() {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=UNITCMB&deptCode="
...
function getRequestDetail(obj) {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=REQUESTDTLS&reqNo=" + obj.value
...
function validateTariff() {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=TARIFFCHK&itemTmp=" + itemTmp;
	ajaxFunction(url, "11");
}
...
function getPatientAccStatus() 
{
	...
	if(document.getElementsByName("checkFlg")[0].value=="1")  // CR No Wise 
	{	
		
		if(parseInt(document.getElementById('strCrNo').value.length)<14)
		{
			alert("In-Valid PIN !!");
			document.forms[0].strCrNo.focus();
	...
	if(document.getElementsByName("checkFlg")[0].value=="2")  // Search Type  Wise 
	{	
		...
		if (retVal) 
		{
				document.forms[0].hmode.value = "INJ_ADMINISTRATION_WITHOUT_CR";		
			    document.forms[0].submit();
		} 
		else 
		{
...
function getReport() {
	...
	if (parseInt(transferNo) != 0 && document.forms[0].printReq.value == 1) {
		...
		var url = "InjAdministrationTransCNT.cnt?hmode=" + mode + "&strIssueNo="
...
function getReport2() {
	...
	if (parseInt(transferNo) != 0) {
		var mode = "ISSUEDTLPOPUP";
		var url = "InjAdministrationTransCNT.cnt?hmode=" + mode + "&issueNo="
...
function getReqType() {
	// alert('11');
	var url = "InjAdministrationTransCNT.cnt?hmode=GETREQTYPE&storeId="
...
function getPresData() {
	var url = "InjAdministrationTransCNT.cnt?hmode=GETPRESCDATA&storeId="
...
function checkEpidoseData() {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=ALREADYISSUEDRUG&itemTmp="
...
function getEpisodeList(obj) {
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=" + hmode + "&crNo="
...
function getReport() {
	...
	if (issueNo != "") {
		if (issueNo != "0") {
			...
			var url = "InjAdministrationTransCNT.cnt?hmode=" + hmode + "&strMode="
	...
	else
	{
		...
		var conf1 = confirm("Do you want to administer "+injName+" - "+dosage+" to "+patientName+"? ");
          ...
          {	 
              ...
              //if(conf2 == true)
              //{             	 
            	  var url = "InjAdministrationTransCNT.cnt?hmode=saveInjAdministratedDtl_Ajax"
...
function refreshPage(){
	...
	var url = "InjAdministrationTransCNT.cnt?hmode=reloadAdministrationDtl_Ajax&checkFlg="+checkFlg+"&strSearchStr="+strSearchStr+"&storeId="+storeId;           	  
