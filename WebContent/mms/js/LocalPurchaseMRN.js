...
//		document.forms[0].strToDate.value = document.forms[0].strCurrentDate.value ;
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "LocalPurchaseMRN_CNT.cnt?hmode="+mode+
 ...
 function ajaxItemBrandName(mode) {
		...
		var url = "LocalPurchaseMRN_CNT.cnt?hmode="+mode+"&strItemId="
				...
				+ document.forms[0].strStoreId.value+"&strSubGroupId="
					+ document.forms[0].strGroupId.value + "&strItemId="
...
//	hisValidator.addValidation("strItemCategoryId", "dontselect=0","Please Select a Category");
	...
	var url = "LocalPurchaseMRN_CNT.cnt?hmode="+hmode+
	...
	"&strGroupName="+document.forms[0].strGroupId[document.forms[0].strGroupId.selectedIndex].text+"&strActId="+document.forms[0].strActId[document.forms[0].strActId.selectedIndex].value;
 ...
 */
 function getItemCategorys(strCombo) {
			...
			var url = "LocalPurchaseMRN_CNT.cnt?hmode="+hmode+"&storeId="+strCombo.value;
