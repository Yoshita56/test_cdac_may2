 ...
 */
	...
	function getInventoryDtls() 
	{
	   	    ...
	   	    var hisValidator = new HISValidator("injStoreRptBean");		
			...
			var url = "INJStoreIssueRptCNT.cnt?hmode="+hmode+	
			...
			"&strItemId="+document.forms[0].strBItemId.value+
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "INJStoreIssueRptCNT.cnt?hmode="+mode+
	...
	{	
	   ...
	   if(temp1[0] == "ERROR")
	    ...
	    {   
			 ...
			 objVal.innerHTML = "<select name ='strItemId' id ='strItemId' class='browser-default custom-select'>" + res + "</select>";
