...
function getItemCat() {
	...
	if (strStoreId != null && strStoreId != "0") {
		...
		document.getElementById("itemcatDivId").innerHTML = "<select name ='strItemCat' class='form-control' ><option value='0'>Select Value</option></select>";
	}
}
		 	...
		 	else
		 	{
		 		...
		 		//	{
		 			//	saveObj.style.display = "none"; 
		 				...
		 				hisValidator.addValidation("strReceiveBy", "req","Revised By is Mandatory");
...
function onGoButton() {
	...
	{
		document.forms[0].strStoreId.disabled=false;
		document.forms[0].hmode.value = "issuetopatientcountNew";
		document.forms[0].submit();
