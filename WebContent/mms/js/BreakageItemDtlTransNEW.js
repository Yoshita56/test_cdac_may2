...
function initPage()
{
 ...
 {  
   ...
   var url="BreakageItemDtlTransCNTNEW.cnt?hmode="+mode+"&modName="+temp[0];
   ajaxFunction(url,"2"); 
 }
 function getGroupNameCombo()
 {
   ...
   var url="BreakageItemDtlTransCNTNEW.cnt?hmode="+mode+"&modName="+temp;
   ajaxFunction(url,"1"); 
 }
 ...
 function getAjaxResponse(res,mode)
 {
     ...
     if(mode=="1")
     {
        ...
        objVal1.innerHTML = "<select name = 'strGroupIdForItemSearch' class='browser-default custom-select'>" + res + "</select>";
       
     }
     if(mode=="2")
     {
        var objVal = document.getElementById("ItemCatg");
        objVal.innerHTML = "<select name = 'strItemCatgCombo' class='browser-default custom-select'>" + res + "</select>";
         getApprovedByCombo();
     }
      ...
      if(mode=="3")
     {
        ...
        objVal.innerHTML = "<select name = 'strItemCatgCombo' class='browser-default custom-select' onchange='getGroupNameCombo();'>" + res + "</select>";
	 ...
	 if(mode=="5")
	  {	  	    
	 	    document.getElementById("ApprovedBy").innerHTML  = "<select name = 'strApprovedBy' class='browser-default custom-select' >" + res + "</select>";
...
function getViewItemDtl()
{
	...
	//alert(diffdate);
	 if(parseInt(diffdate)>365)
	 {
	    ...
	    var mode="GOVIEWPAGE";
	    var url="BreakageItemDtlTransCNTNEW.cnt?hmode="+mode+"&storeId="+temp+"&itemCatNo="+document.forms[0].strItemCatgCombo.value+"&startDate="+document.forms[0].strFromDate.value+"&endDate="+document.forms[0].strToDate.value;
	    ajaxFunction(url,"4"); 	
	}
