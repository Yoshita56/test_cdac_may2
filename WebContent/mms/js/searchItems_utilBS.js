 ...
 function getSubGroupList(grpObj) {
 	...
 	if(gblStrGroupIdForItemSearch == -1){
		...
		document.getElementById("itemListDivId").innerHTML =  "<select name='strItemList' class='comboMax' ><option value='0'>All</option></select>";
 		 ...
 		 document.getElementById("brandItemListDivId").innerHTML = "<select name='strBrandedItemList' class='browser-default custom-select'  multiple='multiple' ></select>";
 		 return false;
...
function getBrandItemList(mode) 
{
		...
		brandItemListObj.innerHTML = "<select name='strBrandedItemList' class='browser-default custom-select'   multiple='multiple' ></select>";
		...
		if(mode =="1")
		{
			ItemId = document.forms[0].strItemList[document.forms[0].strItemList.selectedIndex].value;
		}	
		else
		{
			ItemId = 0;
 ...
 */
 function clearItemBrandDtls() {
 		...
 		document.getElementById("brandItemListDivId").innerHTML = "<select  name='strBrandedItemList' class='browser-default custom-select'  multiple='multiple'  onchange='setItemBrandParameters(\""
					+ gblMode + "\" , this);'></select>";
...
function getMyAjaxResponse(res, mode) {
	...
	if (mode == '3') {
		...
		if (gblMode == '1') 
		{
			...
			brandItemListObj.innerHTML = "<select name='strBrandedItemList' class='browser-default custom-select'  onkeyup='selectItemsInPopup(event);' multiple='multiple'  onchange='setItemName(this);setItemBrandParameters(\""
					+ gblMode + "\" , this);'>" + res + "</select>";

		} else if (gblMode == '2') 
		{
            
			brandItemListObj.innerHTML = "<select name='strBrandedItemList' class='browser-default custom-select'  onkeyup='selectItemsInPopup(event);' multiple='multiple' onchange='setItemName(this);setItemStockParameters(this);'> "
					+ res + "</select>";
...
if (gblMode != '2') {
					...
					if (tempVal.length > 1) {
						...
						if (tempVal.length == 3) {
							...
							obj.innerHTML = "<select class='browser-default custom-select' onchange='"
									+ tempVal[2]
									+ "("
									+ gblMode
									+ ","
							...
							obj.innerHTML = "<select class='browser-default custom-select' name='"
