...
function getAjaxResponse(res, mode) {
	...
	if (mode == "5") {
		if (res == "") {
			document.getElementById("unitDivId").innerHTML = "<select name ='strUnitCode' id='unit' class='form-control' ><option value='0'>Select Value</option></select>";
		} else {
			var objVal = document.getElementById("unitDivId");
			//alert(res);
			objVal.innerHTML = "<select name ='strUnitCode' id='unit' class='form-control' onchange='getConsultantCombo();' >"
					+ res + "</select>";
		}
	...
	if (mode == "6") {
		if (res == "") {
			document.getElementById("consultantDivId").innerHTML = "<select name ='strPrescribedBy' class='form-control' ><option value='0'>Select Value</option></select>";
		} else {
			var objVal = document.getElementById("consultantDivId");
			objVal.innerHTML = "<select name ='strPrescribedBy' class='form-control' >"
					+ res + "</select>";
		}
	}
	if (mode == "7") {
