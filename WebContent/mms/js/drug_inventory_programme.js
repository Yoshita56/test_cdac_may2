	...
	if(document.getElementById("strMultiRowItemId").value!='0')
	{
		if(parseInt(obj.value,10) > 0)
		{
			...
			for(var i=0; i<obj.value;i++)
		 	{   
				addRows(new Array( 'strMultiRowExistingBatchId','strMultiRowFinalBatchNo','strMultiRowPackSizeId','strMultiRowPurRatePerPack','strMultiRowPurRate','strMultiRowPackets','strMultiRowActiveQty','strMultiRowRateUnitId','strMultiRowTax','strMultiRowRate','strMultiRowHandlingCharges', 'strMultiRowHandlingChargesFinal','strMultiRowCosttoPat','strMultiRowMfgDate','strMultiRowExpiryDate','strMultiRowMfgId','strMultiRowMfgName','strMultiRowPONo','strMultiRowTenderNo','strMultiRowInvoiceNo','strMultiRowInvoiceDate','strMultiRowFlag'),new Array('s','t','t','t','t','t','t','s','t','t','t','t','t','d','d','s','t','t','t','t','d','s'),'1','1','R');
		 	 generateSlNo();
		 	}
			 	for(var j=0; j<document.getElementsByName("strMultiRowExistingBatchId").length;j++)
			 	{
			 		...
			 		//document.getElementsByName("strMultiRowRate")[j].value = document.getElementById("strMultiRowItemId").value.split("^")[4];	
			 		//document.getElementsByName("strMultiRowPurRate")[j].value = document.getElementById("strMultiRowItemId").value.split("^")[4];	
			 		//document.getElementsByName("strMultiRowMfgId")[j].value = document.getElementById("strMultiRowItemId").value.split("^")[10];
			 	// document.getElementsByName("strMultiRowRateUnitId")[j].value  = document.getElementById("strMultiRowItemId").value.split("^")[11]+'^'+document.getElementById("strMultiRowItemId").value.split("^")[12]+'^'+document.getElementById("strMultiRowItemId").value.split("^")[13];
...
{	
     if(parseInt(document.getElementById("strMultiRowActiveQty"+index).value.trim().length)== 0)
     {
	...
	{	
      ...
      // var inActiveQty         = document.getElementsByName("strMultiRowInActiveQty");    
       ...
       for(var j=0;j<len-1;j++)
   		{
    	   /*if(parseFloat(document.getElementsByName("strMultiRowRate")[j].value) == 0.00)
    		{
    		   alert("Enter rate greater than 0");
    		   document.getElementsByName("strMultiRowRate")[j].focus();
    		   document.getElementsByName("strMultiRowRate")[j].value="";
    		   return false;
    		}*/
       ...
       var hisValidator = new HISValidator("drugInventoryProgramTransBean");
  	 ...
  	 hisValidator.addValidation("strMultiRowMfgId","req","Please select Manufacturer Name" );
  	   hisValidator.addValidation("strMultiRowRate","req","Please select Sale Price" );
  	 hisValidator.addValidation("strMultiRowPurRate","req","Please enter purchase Rate" );
  	hisValidator.addValidation("strMultiRowHandlingCharges","req","Please enter Administrative Charges" );
  	 //  hisValidator.addValidation("strMultiRowTenderNo","req","Please enter DC No.");
  	   if(document.forms[0].strBatchMandFlg.value=='1')
       ...
       if(retVal1)
       {
	       ...
	       var costtopat			= document.getElementsByName("strMultiRowCosttoPat");
	       var packsizeid		=document.getElementsByName("strMultiRowPackSizeId");
	       var strPurRate		= document.getElementsByName("strMultiRowPurRate");
          ...
          if(conf == true)
          {
               ...
               {   			
			       ...
			       {	
		           	...
		           	costtopat[i].disabled = false;		
		           	 packsizeid[i].disabled=false;
		           	strPurRate[i].disabled=false;
          ...
          if(conf == true)
          {
               ...
               {   			
			       ...
			       {	
		           	 ...
		           	 if(trimAll(finalBatch[i].value).length == 0) 
		             	finalBatch[i].value='NA';    			 	
		           	document.forms[0].strMultiRowCosttoPat[i].disabled = false;		
			       }
               	   document.forms[0].strSelDrugName.value = document.getElementById("DrugNameId").innerHTML;		       
			       flag = 1;
			       document.forms[0].strMultiRowItemId.disabled = false;		
...
function ajaxExistingBatchName() 
{
	  ...
	  if(document.getElementById("strMultiRowItemId").value.split("^")[0]!='0')
	  {
		 ...
		 // alert("1"+document.getElementById("strMultiRowItemId").value);
	  		document.forms[0].strBatchMandFlg.value = document.getElementById("strMultiRowItemId").value.split("^")[6];
		    document.forms[0].strExpMandFlg.value = document.getElementById("strMultiRowItemId").value.split("^")[7];
			//alert("1 "+document.forms[0].strBatchMandFlg.value);
			//alert("1 "+document.forms[0].strExpMandFlg.value);
		    var mode = "EXISTINGBATCH";	
			var url = "DrugInventoryWithProgramTransCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value.split("^")[0] +"&strProgrammeId="+"00"+ "&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1";
		    ajaxFunction(url, "1");
	  }
}
...
function ajaxExistingBatchNameModify() 
{
	  ...
	  if(document.getElementById("strMultiRowItemId").value.split("^")[0]!='0')
	  {
		  ...
		  //alert("store id"+ document.forms[0].strStoreId.value);
			//document.forms[0].strProgrammeId.value=document.getElementById("strProgrammeId").value;  
	  		//alert("2"+document.getElementById("strMultiRowItemId").value);
		  document.forms[0].strBatchMandFlg.value = document.getElementById("strMultiRowItemId").value.split("^")[6];
		    document.forms[0].strExpMandFlg.value = document.getElementById("strMultiRowItemId").value.split("^")[7];
			var mode = "EXISTINGBATCHMODIFY";	
			//var url = "DrugInventoryWithProgramTransCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value.split("^")[0] +"&strProgrammeId="+document.getElementById("strProgrammeId").value + "&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1"+"&batchSel="+ document.forms[0].strSelBatch.value;
			var url = "DrugInventoryWithProgramTransCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value.split("^")[0]+"&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1"+"&batchSel="+ document.forms[0].strSelBatch.value;
		    ajaxFunction(url, "4");
	  }
}
...
function getRateUnitCmb()
{
    ...
    {	
	  var mode = "RATEUNIT";
	  var url = "DrugInventoryWithProgramTransCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value+ "&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1";
      ajaxFunction(url, "2");
   }	
}
...
function getPrevExistBatchForSupplier(itemBrandId,batchNo,supplierId,index) 
{
	...
	var url = "DrugInventoryWithProgramTransCNT.cnt?hmode=EXISTINGSUPPBATCHINSTCOK&storeId="
...
function getAjaxResponse(res, mode) 
{
	...
	{		
        ...
        if(document.forms[0].strBatchMandFlg.value == '1')
        {
        	document.getElementById("mandBatchId").innerHTML="<font color='red'>*</font>Batch";
        }
        else
        {
        	document.getElementById("mandBatchId").innerHTML="Batch";
        }
        //if(document.forms[0].strExpMandFlg.value == '1')
       // {
	...
	{	
        ...
        var tmp = res.split("$");  
        //alert('------------------------->'+tmp[0])	;      
		document.getElementById("RateUnitId").innerHTML = "<select name='strMultiRowRateUnitId' class='comboNormal' id='strMultiRowRateUnitId#delIndex#' >"+ tmp[0] + "</select>";
		showFirstBatchRow();
	}
	if (mode == "3") 
	{
...
function checkBatchExistence(obj,index)
{
	...
	if(parseInt(document.getElementById("strMultiRowFinalBatchNo"+index).value.trim().length)>0)
	{
		for (var i=0; i<sel.options.length; i++) 
		{
	      ...
	      {
				//sel.selectedIndex = i;
				alert("New Batch No ["+ str +"] Value is already entered for this drug Please enter another Batch!!!");
...
{  
  ...
  {  
	...
	// alert(document.getElementById("strMultiPurRowRate"+index).value);
	  document.getElementById("strMultiPurRowRate"+index).value=obj.value.split("#")[6];
	  ...
	  document.getElementById("strMultiPurRowRatePerPack"+index).value = parseFloat(obj.value.split("#")[17])*parseFloat(obj.value.split("#")[6]);
	  document.getElementById("strMultiRowInvoiceNo"+index).value =obj.value.split("#")[19];
	  document.getElementById("strMultiRowInvoiceDate"+index).value =obj.value.split("#")[20];
	  ...
	  //alert("111");
	  document.getElementById("strMultiRowHandlingCharges"+index).value=obj.value.split("#")[15];	
	  document.getElementById("strMultiRowCosttoPat"+index).disabled = false;
	  document.getElementById("strMultiRowCosttoPat"+index).value=obj.value.split("#")[14];	 
	  document.getElementById("strMultiRowCosttoPat"+index).disabled = true;
	  document.getElementById("strMultiRowPackSizeId"+index).value=obj.value.split("#")[17];	
	  document.getElementById("strMultiRowPackets"+index).value=obj.value.split("#")[18];	
	  document.getElementById("strMultiRowTax"+index).value=obj.value.split("#")[16];	
	  
	 // alert("Rate_6_---"+parseFloat(obj.value.split("#")[6])+"-- Tax_16--"+parseFloat(obj.value.split("#")[16]));
	 // alert("Rate_Wth Tax_----"+Math.round(((parseFloat(obj.value.split("#")[6]))+((parseFloat(obj.value.split("#")[6])*parseFloat(obj.value.split("#")[16]))/100))*100)/100);
	 // alert("Rate_Wth Tax_Round_2_---"+Math.round((((parseFloat(obj.value.split("#")[6]))+((parseFloat(obj.value.split("#")[6])*parseFloat(obj.value.split("#")[16]))/100))*100),2)/100);
	 
	  document.getElementById("strMultiRowRate"+index).value = Math.round((((parseFloat(obj.value.split("#")[6]))+((parseFloat(obj.value.split("#")[6])*parseFloat(obj.value.split("#")[16]))/100))*100),2)/100;
	  document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled = false;
	  
	 // alert("Sale Price_14_----"+parseFloat(obj.value.split("#")[14]));
	  //alert("strMultiRowRate_---"+parseFloat(document.getElementById("strMultiRowRate"+index).value));
	  if(parseFloat(obj.value.split("#")[14]) > parseFloat(document.getElementById("strMultiRowRate"+index).value))
	  {
		 // alert("Sale Price "+parseFloat(obj.value.split("#")[14]) +" >  Than Calculated Prices--"+parseFloat(document.getElementById("strMultiRowRate"+index).value));
		  
	  }
	  
	  document.getElementById("strMultiRowHandlingChargesFinal"+index).value=Math.round(((parseFloat(obj.value.split("#")[14])-parseFloat(document.getElementById("strMultiRowRate"+index).value))*100),2)/100 ;
	  document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled = true;
  }
  else
  {
	...
	//  document.getElementById("strMultiRowInActiveQty"+index).value="";
	  ...
	  document.getElementById("strMultiRowHandlingCharges"+index).value="";
	  document.getElementById("strMultiRowActiveQty"+index).disabled = false; 
	  //document.getElementById("strMultiRowQuarnQty"+index).disabled = false; 
      //document.getElementById("strMultiRowInActiveQty"+index).disabled = false;
      document.getElementById("strMultiRowCosttoPat"+index).disabled = false;
      document.getElementById("strMultiRowRate"+index).disabled = false;
      document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled = false;
      document.getElementById("strMultiRowPackSizeId"+index).value="";
      document.getElementById("strMultiPurRowRatePerPack"+index).value="";
      document.getElementById("strMultiPurRowRate"+index).value="";
      document.getElementById("strMultiRowPackets"+index).value="";
      document.getElementById("strMultiRowTax"+index).value="";
      document.getElementById("strMultiRowRate"+index).value="";
      document.getElementById("strMultiRowHandlingCharges"+index).value="";
      document.getElementById("strMultiRowHandlingChargesFinal"+index).value="";
      document.getElementById("strMultiRowCosttoPat"+index).value="";
      document.getElementById("strMultiRowInvoiceNo"+index).value="";
      document.getElementById("strMultiRowInvoiceDate"+index).value ="";
      
  }
  document.getElementById("strMultiRowFinalBatchNo"+index).focus();
}
...
function ajaxExistingBatchDtl() 
{
	...
	var url = "DrugInventoryWithProgramTransCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.forms[0].strItemBrandId.value + "&storeId="+ document.forms[0].strStoreId.value+ "&strItemId="+ document.forms[0].strItemId.value+ "&strExistingBatchId="+ document.forms[0].strExistingBatchId.value;
	ajaxFunction(url, "8");
}
	 ...
	 */
	 function addFreeItems() {
	 	...
	 	getItemOtherDetailsView(mode, isBatchReq , isExpDtReq , '1' , "drugInventoryProgramTransBean");
...
function calCost(obj,index)
{
	...
	if(obj.value != '')
	{
		...
		document.getElementById("strMultiRowRate"+index).disabled=false;
		document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled=false;
		var costtopat=parseFloat(document.getElementById("strMultiRowRate"+index).value)+(parseFloat(document.getElementById("strMultiPurRowRate"+index).value) * (parseFloat(obj.value)/100));
		//alert("costtopat"+(parseFloat(document.getElementById("strMultiRowRate"+index).value) * (parseFloat(obj.value)/100)));
		document.getElementById("strMultiRowHandlingChargesFinal"+index).value=Math.round(((parseFloat(document.getElementById("strMultiPurRowRate"+index).value) * (parseFloat(obj.value)/100)))*100)/100;
		//alert(document.getElementById("strMultiRowHandlingChargesFinal"+index).value);
		if((parseFloat(document.getElementById("strMultiRowHandlingChargesFinal"+index).value)) > 1000)
		{
			alert("Max. limit for Administrative charges is 1000");
			//document.getElementById("strMultiRowHandlingCharges"+index).value="";
			document.getElementById("strMultiRowHandlingChargesFinal"+index).value="1000";
			//alert(parseFloat(document.getElementById("strMultiRowRate"+index).value));
			document.getElementById("strMultiRowCosttoPat"+index).value=parseFloat(document.getElementById("strMultiRowRate"+index).value)+1000;
			//return false;
		}
		else
		{
			document.getElementById("strMultiRowCosttoPat"+index).value=Math.round(costtopat*100)/100;
			document.getElementById("strMultiRowCosttoPat"+index).disabled=true;
			document.getElementById("strMultiRowRate"+index).disabled=true;
			document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled=true;
		}
	...
	{
		document.getElementById("strMultiRowCosttoPat"+index).disabled=false;
		//var costtopat=parseFloat(document.getElementById("strMultiRowRate"+index).value)+(parseFloat(document.getElementById("strMultiRowRate"+index).value) * (parseFloat(obj.value)/100));
		//alert("costtopat"+costtopat);
		document.getElementById("strMultiRowCosttoPat"+index).value="";
		document.getElementById("strMultiRowCosttoPat"+index).disabled=true;
		document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled=false;
		//var costtopat=parseFloat(document.getElementById("strMultiRowRate"+index).value)+(parseFloat(document.getElementById("strMultiRowRate"+index).value) * (parseFloat(obj.value)/100));
...
function calSalePrice(obj,index)
{
	//alert(obj.value);
	//alert(index);
	//alert(document.getElementById("strMultiRowPurRate"+index).value);
	if(obj.value != '')
	{
		document.getElementById("strMultiRowRate"+index).disabled=false;
		var costtopat=parseFloat(document.getElementById("strMultiPurRowRate"+index).value)+(parseFloat(document.getElementById("strMultiPurRowRate"+index).value) * (parseFloat(obj.value)/100));
		//alert("costtopat"+costtopat);
		document.getElementById("strMultiRowRate"+index).value=Math.round(costtopat*100)/100;
		document.getElementById("strMultiRowRate"+index).disabled=true;
	}
	else
	{
...
function calQty(obj,index)
{
	//alert(obj.value);
	
	//alert(document.getElementsByName("strMultiRowPackSizeId")[0].options[document.getElementsByName("strMultiRowPackSizeId")[0].selectedIndex].text);
	var idx =index.split("-")[1];
	//alert(idx);
	if(document.getElementById("strMultiRowPackSizeId"+index).value != "")
	{
		document.getElementById("strMultiRowActiveQty"+index).value=obj.value*document.getElementById("strMultiRowPackSizeId"+index).value;
		document.getElementById("strMultiRowPackSizeId"+index).disabled=true;
		document.getElementById("strMultiRowActiveQty"+index).disabled=true;
...
function calPurRate(e,indx)
{
	if(document.getElementById("strMultiRowPackSizeId"+indx).value != "")
	{
		document.getElementById("strMultiPurRowRate"+indx).disabled = false;
		document.getElementById("strMultiPurRowRate"+indx).value = Math.round((parseFloat(e.value)/parseFloat(document.getElementById("strMultiRowPackSizeId"+indx).value))*100)/100;
		document.getElementById("strMultiPurRowRate"+indx).disabled = true;
	}
	else
		document.getElementById("strMultiPurRowRate"+indx).disabled = false;
...
function calPurRate1(e,indx)
{
	document.getElementById("strMultiPurRowRate"+indx).disabled = false;
	document.getElementById("strMultiPurRowRate"+indx).value = Math.round((parseFloat(document.getElementById("strMultiPurRowRatePerPack"+indx).value/parseFloat(e.value)))*100)/100;
	document.getElementById("strMultiPurRowRate"+indx).disabled = true;
	//document.getElementById("strMultiRowHandlingCharges"+indx).value="";
	//document.getElementById("strMultiRowHandlingChargesFinal"+indx).value="";
	//document.getElementById("strMultiRowCosttoPat"+indx).value="";
	calCost(document.getElementById("strMultiRowHandlingCharges"+indx),indx);
	
	/*alert('1');
	alert(document.getElementById("strMultiRowPackSizeId"+indx).value);
	alert(document.getElementById("strMultiRowPackets"+indx).value);*/
	var packsize=document.getElementById("strMultiRowPackSizeId"+indx).value;
	var NoOfPkts=document.getElementById("strMultiRowPackets"+indx).value;
	//alert(packsize * NoOfPkts);
	if(packsize !='' &&  NoOfPkts !=''){
		//alert(packsize * NoOfPkts);
		document.getElementById("strMultiRowActiveQty"+indx).value=packsize * NoOfPkts;
	}
