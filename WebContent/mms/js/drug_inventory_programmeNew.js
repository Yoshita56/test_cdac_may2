		...
		if(parseInt(obj.value,10) > 0)
		{
			...
			for(var i=0; i<obj.value;i++)
		 	{   
				...
				addRows(new Array( 'strMultiRowExistingBatchId','strMultiRowFinalBatchNo','strMultiRowPackSizeId','strMultiPurRowRatePerPack','strMultiRowPurRate',
						'strMultiRowPackets','strMultiRowActiveQty','strMultiRowRateUnitId', 'strMultiRowTax','strMultiRowRate','strMultiRowHandlingCharges','strMultiRowHandlingChargesFinal','strMultiRowCosttoPat','strMultiRowMfgDate','strMultiRowExpiryDate',
						'strMultiRowMfgId','strMultiRowMfgName','strMultiRowPONo','strMultiRowTenderNo','strMultiRowInvoiceNo','strMultiRowInvoiceDate','strMultiRowFlag'),
						new Array('s','t','t','t','t','t','t','s','t','t','t','t','t','d','d','s','t','t','t','t','d','s'),'1','1','R');
				generateSlNo();
		 	}
...
function ajaxExistingBatchName() 
{
	  ...
	  if(document.getElementById("strMultiRowItemId").value.split("^")[0]!='0')
	  {
		 ...
		 // alert("1"+document.getElementById("strMultiRowItemId").value);
			...
			var url = "DrugInventoryWithProgramTransBSCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value.split("^")[0] +"&strProgrammeId="+"00"+ "&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1";
		    ajaxFunction(url, "1");
	  }
}
...
function ajaxExistingBatchNameModify() 
{
	  ...
	  if(document.getElementById("strMultiRowItemId").value.split("^")[0]!='0')
	  {
		  ...
		  document.forms[0].strBatchMandFlg.value = document.getElementById("strMultiRowItemId").value.split("^")[6];
			...
			//var url = "DrugInventoryWithProgramTransBSCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value.split("^")[0] +"&strProgrammeId="+document.getElementById("strProgrammeId").value + "&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1"+"&batchSel="+ document.forms[0].strSelBatch.value;
			var url = "DrugInventoryWithProgramTransBSCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value.split("^")[0]+"&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1"+"&batchSel="+ document.forms[0].strSelBatch.value;
		    ajaxFunction(url, "4");
	  }
}
...
function getRateUnitCmb()
{
    ...
    {	
	  var mode = "RATEUNIT";
	  var url = "DrugInventoryWithProgramTransBSCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.getElementById("strMultiRowItemId").value+ "&storeId="+ document.forms[0].strStoreId.value+ "&index=1-1";
      ajaxFunction(url, "2");
   }	
}
...
function getPrevExistBatchForSupplier(itemBrandId,batchNo,supplierId,index) 
{
	...
	var url = "DrugInventoryWithProgramTransBSCNT.cnt?hmode=EXISTINGSUPPBATCHINSTCOK&storeId="
...
function getAjaxResponse(res, mode) 
{
	...
	{		
        ...
        document.getElementById("ExistingBatchId").innerHTML = "<select  name='strMultiRowExistingBatchId' class='form-control form-control-sm '  id='strMultiRowExistingBatchId#delIndex#' onChange='getStockDetails(\"#delIndex#\",this);'>"+ tmp[0] + "</select>";
	...
	{	
        ...
        var tmp = res.split("$");  
        // alert('------------------------->'+tmp[0])	;      
		document.getElementById("RateUnitId").innerHTML = "<select name='strMultiRowRateUnitId' class='form-control form-control-sm' id='strMultiRowRateUnitId#delIndex#' >"+ tmp[0] + "</select>";
		showFirstBatchRow();
	}
	if (mode == "3") 
	{
	...
	{		
        ...
        document.getElementById("ExistingBatchId").innerHTML = "<select  name='strMultiRowExistingBatchId' class='form-control form-control-sm'  id='strMultiRowExistingBatchId#delIndex#' onChange='getStockDetailsModify(\"#delIndex#\",this);'>"+ tmp[0] + "</select>";
...
{  
  ...
  {  
	...
	// alert(document.getElementById("strMultiPurRowRate"+index).value);
	  ...
	  document.getElementById("strMultiRowRate"+index).value = Math.round(((parseFloat(obj.value.split("#")[6]))+((parseFloat(obj.value.split("#")[6])*parseFloat(obj.value.split("#")[16]))/100))*100)/100;
	  document.getElementById("strMultiRowHandlingChargesFinal"+index).disabled = false;
	  document.getElementById("strMultiRowHandlingChargesFinal"+index).value=Math.round((parseFloat(obj.value.split("#")[14])-parseFloat(document.getElementById("strMultiRowRate"+index).value))*100)/100 ;
...
function ajaxExistingBatchDtl() 
{
	...
	var url = "DrugInventoryWithProgramTransBSCNT.cnt?hmode="+mode+"&strItemBrandId="+ document.forms[0].strItemBrandId.value + "&storeId="+ document.forms[0].strStoreId.value+ "&strItemId="+ document.forms[0].strItemId.value+ "&strExistingBatchId="+ document.forms[0].strExistingBatchId.value;
	ajaxFunction(url, "8");
}
