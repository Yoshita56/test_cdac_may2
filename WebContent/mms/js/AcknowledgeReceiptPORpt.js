...
//		document.forms[0].strToDate.value = document.forms[0].strCurrentDate.value ;
 ...
 function itemNameCombo()
 {
	...
	var mode = "LPITEMNAME"; 
	var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+mode+
...
// 		document.getElementById("giftedNewItemDivId").style.display = "none";
  ...
  function getNewReceving(chkValue) 
  {
			...
			var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+hmode+"&storeId="+chkValue;
 			ajaxFunction(url,"10");
...
function pageResetMethod()
{
  ...
  */
  function getInventoryDtls() 
  {
   	...
   	var hisValidator = new HISValidator("AcknowledgeReceiptPORptbean");
...
//	hisValidator.addValidation("strItemCategoryId", "dontselect=0","Please Select a Category");
	...
	var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+hmode+
 ...
 */
 function getItemCategorys(strCombo) {
			...
			var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+hmode+"&storeId="+strCombo.value;
 ...
 */
 function getSubGroupListDtls(grpObj) {
	...
	var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+mode+"&ItemId="
			+ grpObj.value ;
...
function ajaxItemName(mode) {
	...
	var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+mode+"&strSubGroupId="
...
function ajaxItemBrandName1(mode) {
	...
	var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+mode+"&strItemId="
...
function getItemBrandDetails() {
	...
	if(document.forms[0].strItemBrandId.value != 0){	
			...
			var url = "AcknowledgeReceiptPORptCNT.cnt?hmode="+mode+"&strItemBrandId="
...
function ajaxManufectureName(mode) {
	...
	var url = "AcknowledgeReceiptPORptCNT.cnt?hmode=MANUFECTURENAME&strItemBrandId="
 ...
 */
 function setWarrantyManfacturer(comboObj) {
	...
	if (retVal) {
	 	...
	 	getItemOtherDetailsView(mode, isBatchReq , isExpDtReq , '1' , "AcknowledgeReceiptPORptbean");
	}else{
	...
	if (retVal) {
	 	...
	 	getItemOtherDetailsView(mode, isBatchReq , isExpDtReq , '2' , "AcknowledgeReceiptPORptbean");
