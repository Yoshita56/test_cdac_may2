...
<script type="text/javascript">
    function setFocus()
    {
    	var input = document.getElementById('strCrNo');
    	input.focus();
    	input.select();
    }
	...
	<div class="container-fluid">
		<div class="prescriptionTile">
			...
			<div class="container">					 
				...
				<div class="row" style="margin:1% 12%">
					<div class="col-sm-2">
						<label>Administer Mode</label>
					</div>
					<div class="col-sm-4">
						<select name="strAdministrationMode" onchange="   " class="browser-default custom-select">
							<bean:write name="injAdminTransBean" property="strAdmnModeCombo" filter="false" />
						</select>
					</div>	
					<div class="col-sm-2">
							<label>Administer Type</label>
					</div>
					<div class="col-sm-4">
				...
				<div class="row my-1" style="margin:1% 12%">
					...
					<div class="col-sm-4" style="position:relative">
						<input id="fromDate" name="strFromDate" class="form-control datepicker" value="${injAdminTransBean.strFromDate}" style="color: rgba(113, 111, 111, 0.87);top:100px"> 
					</div>
					
				    <div class="col-sm-2">To Date</div>
				    <div class="col-sm-4" style="position:relative">
				       	<input id="toDate" name="strToDate" class="form-control datepicker" value="${injAdminTransBean.strToDate}" style="color: rgba(113, 111, 111, 0.87);top:100px">    	
				    </div>
  				</div> 
  			</div>
		...
		<input type="hidden" name="strHospitalCode" value="${injAdminTransBean.strHospitalCode}"/>				
		<input type="hidden" name="strIssueNum"     value="0" />		
		<input type="hidden" name="strStoreName" value="${injAdminTransBean.strStoreName}" />
