...
// 	  popup('popUpDiv1', '60', '80');
         ...
         $.ajax({
          url: "/INVMGM/mms/transactions/DrugInventoryWithProgramTransCNT.cnt?hmode=PRINTVOUCHER",
          type: "POST",
          cache: false,
          data: {
  ...
  function cancelToList(){
	  ...
	  document.forms[0].action="/INVMGM/mms/transactions/DrugInventoryTransCNT.cnt?hmode=LISTPAGE1";
...
<html:form name="drugInventoryProgramTransBean"  styleClass="formbg" action="/transactions/DrugInventoryWithProgramTransCNT"
	...
	<!-- 	<tr class='multiCLRLabel'>
		...
		<tr >
			...
			<td class="LABEL" colspan="1"><font color="red">*</font> No of Batch :: <input type='text' class='txtFldMin' name='strNoOfMultiRow' id='strNoOfMultiRow'  value ='' maxlength='2' onkeypress='if(event.keyCode==13) return getMultiRow(this);'></td>
		</tr>
