...
<html:form name="issueBean" action="/transactions/IssueToPatientTransBSCNT" type="mms.transactions.controller.fb.IssueTransFB">
		...
		<%-- Change Request		 --%>
				 <td align="right" >
			     	  <div style="display: none;">  
			     	  	<html:checkbox name="issueBean" property="strViewChk" onclick="transferToViewPage();" title="Click Here To View Off Line Issue Drug Detail">Issue/View</html:checkbox>
			     	  </div>
			     </td>
		    </tr>
	    </table>
	...
	<div id="goBox">
		<div class="row rowFlex reFlex">
			...
			<div class="col-sm-1  py-2" align="right"><font id="mandCRId" color="red">*</font><label>CR No.</label></div>
				<div class="col-sm-3">
				...
				<div class="col-sm-1" align="left">
					...
					<button type="button" class="btn btn-info btn-sm" tabindex="2"   style="float: right;" onclick="getPatientList();">
			   		<span class="btn-label"></span><i class="fas fa-user-injured"></i>&nbsp;Search</button> 
				</div>						
		 </div>
	</div>
				
			<div  id="patSearchId" style="display:none;">	
			   <hr>									 
				<div class="row rowFlex reFlex">
						<div class="col-sm-2  py-2" align="right">
								<label><font id="" color="red">*</font>Department Name</label>
						</div>
						<div class="col-sm-7">	
							<select name="strDeptCode" onchange="getPatientList();" class="browser-default custom-select">
				...
				<div class="row rowFlex reFlex">
						<div class="col-sm-12" id="onLineReqDtl"></div>
