...
<html:form name="indentApprovalTransBean" action="/transactions/IndentApprovalDeskBSCNT" type="mms.transactions.controller.fb.IndentApprovalDeskFB">
     ...
     <%--    <tag:tab tabLabel="Approval Desk View" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab> --%>
	
<div class="container-fluid">
	<div class="prescriptionTile">	
	<div class='legendHeader my-2' id='nonPrintableLegend' style="font-weight:600;font-size:18px;" >Indent Approval Desk</div>
	
	<div class="legend2" id="saveId">
		<button type="button" id="cancelButton" class="float-right btn btn-danger mt-1 btn-circle" style="border-radius:50%; padding:12px;" onclick="cancelToDesk();" title="Cancel" >
	...
	<div class='popup' id='Return' style="display:none">
		<table width='400' border="0" cellspacing ="0px">
			<tr class="HEADER"> 
				...
				<th align='right'><img  style='cursor:pointer;cursor:pointer' src='../../hisglobal/images/popUp_cancel.JPG' onClick="hideItemDetails('Return');"></th>
		    </tr>
	 	</table>   
...
<!-- 
		 ...
		 </table><table class="TABLEWIDTH" align="center" cellspacing="1" cellpadding="1">   
 -->		      
 		<bean:write name="indentApprovalTransBean" property="strIndentDetails"	filter="false" />

	<!-- 	</table>
		<table class="TABLEWIDTH" align="center" cellspacing="1" cellpadding="1">   
		<tr class="TITLE"><td colspan="4"><div id="" style="color:white;">Drug Details</div></td></tr>
		</table> -->
	
		<div class='row'>
			<div class='subHeaders col-sm-12 mt-3' style="font-weight:600;font-size:18px;">Drug Details</div>
		</div>
...
<!-- 		</table>
			<table class="TABLEWIDTH" align="center" cellspacing="1" cellpadding="1">   
			<tr class="TITLE"><td colspan="5"><div id="" style="color:white;">Approval Details</div></td></tr>
			</table> -->
			
		<div class='row'>
			<div class='subHeaders col-sm-12 mt-3' style="font-weight:600;font-size:18px;">Approval Details</div>
		</div>
	...
	<tr class="FOOTER"><td width="TABLEWIDTH" colspan="2" ></td></tr>
