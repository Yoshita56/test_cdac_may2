...
<script type="text/javascript">
	...
	function getItemSelectPopup()
	{
       ...
       {		
		...
		var strUserInfo 	            = document.forms[0].strToStore.value;
...
<html:form action="/transactions/RequestForLPDeptBSCNT.cnt" name="requestForLpDept" type="mms.transactions.controller.fb.RequestForLPDeptFB" method="post">
...
<div class="container-fluid">
	<div class="prescriptionTile">					
 		<fieldset><legend class="legendHeader" id="nonPrintableLegend">Request For LP Transaction</legend>
	...
	<div class="container">
		<div class="row my-1 ">
			  ...
			  <div class="col-md-4"><bean:write name="requestForLpDept" property="strStoreName" filter="false" /></div>
			  <div class="col-md-2">Item Category:<font color="red">*</font></div>
			  <div class="col-md-4"><bean:write name="requestForLpDept" property="strItemCatg" filter="false" /></div>
		 </div>
	
	    <div class="row my-1 ">
			 <div class="col-md-2 ">Req Date:</div>
			 <div class="col-md-4"><bean:write name="requestForLpDept" property="strReqDate" filter="false" /></div>
			 <div class="col-md-2">Sub Store:<font color="red">*</font></div>
			 <div class="col-md-4"><select class='browser-default custom-select' name='strToStore'> <bean:write name="requestForLpDept" property="strToStoreCombo" filter="false" /></select></div>
	    </div>
	
	   <div class="row my-1 ">
			<div class="col-md-2 ">Urgent Status:</div>
			<div class="col-md-4"><input type="radio" name="strIsNormal" value="1" checked="checked" />Normal &nbsp;&nbsp; <input type="radio" name="strIsNormal" value="0" />Urgent</div>
	   </div> 
	</div>
	<hr>
		<div class="row my-1">
	...
	<hr>
		...
		<table class="table" >
			...
			<tr>
				...
				<th scope='col' width="20%" style='font-weight:350 !important ;font-size: 16px !important;'>Avl Qty</th>
				<th scope='col' width="20%" style='font-weight:350 !important ;font-size: 16px !important;'>Req Qty<font size="2" color="red">*</font></th>
				<th scope='col' width="20%" style='font-weight:350 !important ;font-size: 16px !important;'>Unit<font size="2" color="red">*</font></th>
			</tr>
	        </thead>
		</table>
...
<hr>
	<div class="row my-1 ">
       <div class="col-sm-10"></div>
             <div class="col-sm-2" align="right"><i class="fa fa-asterisk" style="color: red; size:smaller;"></i>Fields Mandatory</div>				
         </div>
