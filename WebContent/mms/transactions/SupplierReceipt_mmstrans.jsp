...
function previewForm()
{
	...
	if((document.forms[0].strExpDeliveryDate.value)!="")
	{
	 ...
	 do
	 {
		console.log("purwidtax--A--"+ document.getElementsByName("strPurRate")[i].value +"-----"+document.getElementsByName("strPurWidTax")[i].value);
		...
		console.log("purwidtax--B--"+purtax+"--roundVale--"+roundValue(purtax,4)+"--Float--"+parseFloat(purtax,4));
		 tmpdiv1 = tmpdiv1 + "<tr>";
		...
		tmpdiv1 = tmpdiv1 + otd + roundValue(document.getElementsByName("strPurRate")[i].value,4) + ctd;
		tmpdiv1 = tmpdiv1 + otd + roundValue(purtax,4)  + ctd;
		var totamt = Math.round((roundValue(purtax,4) * parseFloat(document.getElementsByName("strTotalQty")[i].value)) *100.0)/100.0;
		console.log("-totamt-C-"+totamt+"--RoundValue--"+roundValue(totamt,3)+"----");
