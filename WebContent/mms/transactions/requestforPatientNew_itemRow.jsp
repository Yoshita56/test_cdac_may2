...
<tr>
<td class="multiControl" width="40%">
...
<td class="" width="20%" style="display:none">
<div id="itemParaId4#delIndex#" style="font-weight:350 !important ;font-size: 16px !important;text-align:center">
</div>
</td>

<td class=""  width="20%" style="font-weight:350 !important ;font-size: 16px !important;text-align:center">
   <input type="text" name="strReqQty" id="strReqQty#delIndex#" autocomplete='off' class="custom-select" maxlength ="5" onkeyup="return checkQty('#delIndex#','strReqQty','strUnitName');" onkeypress="return validateData(event,7);">
