...
<center>
    ...
    <tag:tab tabLabel="Indent Approval Desk11" selectedTab="FIRST" align="center" width="TABLEWIDTH"></tag:tab>
	...
	<jsp:include page="discrepancyReportglobal.jsp"></jsp:include>
		...
		<td colspan='3' class='TITLE' align='left'><b><div id=''>Non-Discrepancy Report</div></b></td>  
		</tr>
		</table>
		 ...
		 <table class='TABLEWIDTH' align='center'  border='0'  cellspacing ='1px'>
		  <tr>
		    ...
		    <td colspan='3' class='TITLE' align='left'><b><div id='' '>Discrepancy Report</div></b></td>  
		  </tr>
		</table>
	  ...
	  <table class="TABLEWIDTH" align="center" cellspacing="1" cellpadding="1">   
		 <tr class="TITLE">
			<td colspan="5">Approval Details</td>
		 </tr>
		</table>
