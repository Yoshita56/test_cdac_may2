...
<html:form name="newIPDIssueToPatBean" action="/transactions/NewIPDIssueToPatTransCNT" type="mms.transactions.controller.fb.NewIPDIssueToPatTransFB">
	...
	<div class="errMsg"     id="errMsg"     style="font-size:18px;"><bean:write name="newIPDIssueToPatBean" property="strErrMsg" /></div>
	<div class="warningMsg" id="warningMsg" style="font-size:18px;"><bean:write name="newIPDIssueToPatBean" property="strWarningMsg" /></div>
	<div class="normalMsg"  id="normalMsg"  style="font-size:18px;"><bean:write name="newIPDIssueToPatBean" property="strNormalMsg" /></div>	
...
<div class="container">
	<div class="row ">
		...
		<div class="col-md-2" style=""><b><bean:write name="newIPDIssueToPatBean" property="storeName" filter="false" /></b></div>
		<div class="col-md-2">Item Category</div>
		<div class="col-md-2" style=""><b><bean:write name="newIPDIssueToPatBean" property="itemCatName" filter="false" /></b></div>
		<div class="col-md-2">CR No.</div>
		<div class="col-md-2" style=""><b><bean:write name="newIPDIssueToPatBean" property="crNo" filter="false" /></b></div>
	</div>
<br>
...
<div id = "patientDetailsDivId" style="display:block;">
  ...
  <tr>
      <bean:write name="newIPDIssueToPatBean" property="strPatientDetail" filter="false" />
  </tr>
 </table>
</div>
	...
	<input type="hidden" name="hospCode" 				value="${newIPDIssueToPatBean.strHospitalCode}" />
	<input type="hidden" name="storeName" 				value="${newIPDIssueToPatBean.storeName}" />
	<input type="hidden" name="itemCatName" 			value="${newIPDIssueToPatBean.itemCatName}" />
	<input type="hidden" name="crNo" 					value="${newIPDIssueToPatBean.crNo}" />
	<input type="hidden" name="strCrNo" 				value="${newIPDIssueToPatBean.crNo}" />
	<input type="hidden" name="strId" 					value="${newIPDIssueToPatBean.strId}" />
	<input type="hidden" name="itemCategory" 			value="${newIPDIssueToPatBean.itemCategory}" />	
