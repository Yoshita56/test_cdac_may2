...
<html:form name="issuePatBean" action="/transactions/IssueTransCNT"
	type="mms.transactions.controller.fb.IssueTransFB">

	<div id="errMsg" class="errMsg"><bean:write name="issuePatBean"
		property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write
		name="issuePatBean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write
		name="issuePatBean" property="strNormalMsg" /></div>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1"
		...
		<tr>
			...
			<td width="25%" colspan="1" class="CONTROL"><bean:write
				name="issuePatBean" property="storeName" filter="false" /></td>

			<td width="25%" colspan="1" class="LABEL">Item Category</td>
			<td width="25%" colspan="1" class="CONTROL"><bean:write
				name="issuePatBean" property="itemCatName" filter="false" /></td>
		</tr>
		
		<tr>
			<td width="25%" class="LABEL">CR No.</td>
			<td colspan="3" class="CONTROL"><bean:write name="issuePatBean"
		...
		<tr>
			...
			<td width="25%" colspan="1" class="CONTROL"><bean:write
				name="issuePatBean" property="strLFAccountNo" filter="false" /></td>
...
<div style='display:none;'>
 <table class="TABLEWIDTH" align="center" border="0" cellspacing="1px">
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		<tr>
			<bean:write name="issuePatBean" property="strPatientTreatmentDtl"
				filter="false" />
		</tr>
	</table>
	</div>
		...
		<table class="TABLEWIDTH" align="center" cellspacing="1px"
			...
			<tr>
				...
				<td class="CONTROL" width="25%"><select name="strDeptCode"
					...
					<bean:write name="issuePatBean" property="strDeptValues"
						filter="false" />
				</select></td>
			...
			<tr>
				...
				<td width="25%" class="CONTROL"><date:date name="strPrescriptionDate"
					value="${issuePatBean.strCtDate}"></date:date></td>
	...
	<input type="hidden" name="itemCatName"
		value="${issuePatBean.itemCatName}" />
	...
	<input type="hidden" name="strIssueMode"
		value="${issuePatBean.strIssueMode}">
