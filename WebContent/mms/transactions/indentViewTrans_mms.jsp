...
{    
   ...
   var url="IndentViewTransCNT.cnt?hmode="+mode+"&strChk="+ strChk+"&strReqTypeId="+strReqTypeId;
   ajaxFunction(url,"1");
...
<center>
	<div id="errMsg" class="errMsg"><bean:write name="indentViewBean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="indentViewBean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="indentViewBean" property="strNormalMsg" /></div>
   ...
   <div class='popup' id='AnnualPurchase' style="display:none">
	<table width='400' border="0" cellspacing ="0px">
	 ...
	 <logic:equal   value="1" name="indentViewBean" 	property="strBudgetRequired">
		...
		<table class="TABLEWIDTH" align="center" cellspacing="1" cellpadding="1">   
		<tr class="TITLE">
			<td colspan="5"><div id='' style='font-family: Arial, Helvetica, sans-serif;font-size:13px;'>Approval Details</div></td>
		</tr>
		</table>
	     <bean:write name="indentViewBean" property="strSetApprovedDetails"	filter="false" />
	
	<table border="0" class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">
	<tr class="FOOTER">
               <td width="TABLEWIDTH" colspan="2" >['*'] Reserved/Branded Item</td>
               </tr>
		<!-- <tr>
			<td align="center">
	...
	<div align="center" id=" ">		
			            <a href="#" class="button" id=""  onclick=" getVoucher();" tabindex="1"><span class="print">Print</span></a>			 
					 	<a href="#" class="button" id=" " onclick=' cancelToDesk();'><span class="back">Back</span></a>
					</div>
