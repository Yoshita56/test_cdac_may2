...
function getBrandCombo(obj)
{		
	var catgId         = document.forms[0].strItemCategoryNo.value;	
	var modelId        = obj.value;	
	var url ="LocalPurchaseNewTransCNT.cnt?hmode=ITEMCOMBO&catgId="+catgId+"&modelId="+modelId;
	//alert(url);
    ajaxFunction(url,"1");
}
function getAjaxResponse(res,mode)
{
	//alert(res);
		...
		if (mode == "1") 
		{
			...
			objVal.innerHTML = "<select name='strMultiRowItemId' id='strMultiRowItemId' >"+ res + "</select>";
		}
}
			...
			<div class="container-fluid">
						<div class="prescriptionTile">
						    ...
						    <div class="row">
								<div class="col-sm-12">
									<p class="subHeaders">
										Mfg & Expiry Date is Mandatory If User Not Enter System will automatically take 10 Year Span !!
									</p>
								</div>							
							</div>		
							...
							<div class="row">
								...
								<div class="col-sm-2" align="left" style="color: #173479;font-weight: bold;">Store Name:
        		                  <label style="color: #736767;">
        		                     <b><bean:write  name="localPurchaseNewTransBean" property="strStoreName" filter="false" /></b>
        		                 </label>
        		                </div>
								<div class="col-sm-2" align="left" style="color: #173479;font-weight: bold;">Type:
        		                  <label style="color: #736767;">
        		                     <b><bean:write  name="localPurchaseNewTransBean" property="strItemCategoeryName" filter="false" /></b>
        		                 </label>
        		                </div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<select  class='browser-default custom-select' name='strSupplier'>
									  <bean:write name="localPurchaseNewTransBean" property="strSupplierCombo" filter="false" />
									</select>
								</div>
								...
								<div class="col-sm-3">
									...
									<div class="col-sm-3">
										<select  class='browser-default custom-select' name='strInstituteId' id="InstituteId">
											<bean:write name="localPurchaseNewTransBean" property="strInstituteCombo" filter="false"/>
										</select>
									</div>							
							</div>
							<div class="row">
							    <input type="hidden" name="strUcChk" value="0" checked="checked" style="margin-left:10px";>	
									...
									<div class="col-sm-1 py-2"><label>Model</label></div>
									<div class="col-sm-3">
										 <select  class='browser-default custom-select' name='strModelId' onChange="getBrandCombo(this);">
										   <bean:write name="localPurchaseNewTransBean" property="strModelCombo" filter="false" />
										 </select>
									</div>								
							...
							<table id="POITable" class="table" style="font-size: 13px;margin-bottom: 0;">
							    <thead>
							      <tr>
							        ...
							        <th>Batch/Serial No<font color="red">*</font></th>
							        ...
							        <th>Total Amt<font color="red">*</font></th>
							    ...
							    <tr id='0' style='display:none;'>
							        <td  style="width: 10%;padding: .25rem;"><input type="text" maxlength="30" name="strbatchno" onkeyup="uppercasefn(this)" value="0" class="form-control"></td>
							        <td  style="width: 25%;padding: .25rem;">							        
							           <input type="text" class="form-control" value="0" placeholder='Enter atleast 3 characters' onkeypress="drugNameFun(this);" id="strSearchDrug" name="strSearchDrug" size="120%"/> 
							        </td>
							        <td style="width: 9%;">
							           <label>
							            <bean:write  name="localPurchaseNewTransBean" property="strItemCategoeryName" filter="false" />
							           </label>
							        </td>
							        ...
							        <td style="width: 13%;padding: .25rem;"><input id="strExpDate0" value="${localPurchaseNewTransBean.strTenYrCtDate}" type="text" name="strExpDate"></td>
							        ...
							        <td style="width: 5%;padding: .25rem;"><input type="text" onkeypress="return validateData(event,7);" class="form-control" autocomplete="off" name="strGST" maxlength="5" value="0" onchange="calRateWithTax(this);">
							            <input type="hidden" onkeypress="return validateData(event,7);" class="form-control" autocomplete="off" name="strAdmchg" value="0" maxlength="5"  onchange="calMRP(this);">
							        </td>
							        <td style="width: 8%;"><button type="button" class="btn btn-info" onclick="deleteRow(this)" style="padding: 3px .55rem;font-size: 13px;"><i class="fa fa-minus" ></i></button>
								       	...
								       	<input type="hidden" name="strCosttoPat" value="0"/>
										<input type="hidden" name="strPurWidTax" value="0"/>
										<input type="hidden" name="strPurRate" value="0"/> 
							       	</td>
							      </tr>
							      <tr id='1'>
							        ...
							        <td  style="width: 15%;padding: .25rem;">
							        ...
							        <td style="width: 6%;padding: .25rem;">
...
<!-- 							        
 ...
 -->							        
							       ...
							       <!--  <td style="width: 8%;padding: .25rem;">
							        ...
							        <input type="hidden" onkeypress="return validateData(event,7);" class="form-control" autocomplete="off" name="strAdmchg" maxlength="5"  value='0' onchange="calMRP(this);">
...
<div class="modal fade" id="preModal" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width: 1000px;">
      ...
      <div class="modal-header" style="font-size: 20px;font-weight: bold;color: black;">Preview<button type="button" class="close" data-dismiss="modal">&times;</button></div>      
...
<div id="previewItem" class="row">
	<div class="col-sm-3" align="right"><label style="margin-bottom: 0;">MRN No:</label></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-3" align="right"><label style="margin-bottom: 0;">MRN Date:</label></div>
	<div class="col-sm-2"></div>

	<div class="col-sm-3"align="right"><label style="margin-bottom: 0;">Challan No:</label></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-3" align="right"><label style="margin-bottom: 0;">Invoice No:</label></div>
	<div class="col-sm-2"></div>

	<div class="col-sm-3" align="right"><label style="margin-bottom: 0;">Challan Date:</label></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-3" align="right"><label style="margin-bottom: 0;">Invoice Date:</label></div>
	<div class="col-sm-2"></div>
	...
	<div class="col-sm-3" align="right"><label style="margin-bottom: 0;">PO No:</label></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-2"></div>
...
function previewForm()
{
	...
	var tmpDiv = lDiv + "<b>Invoice No. : </b>"+ cDiv + rDiv + document.forms[0].strDCNo.value + cDiv + rDiv + cDiv + lDiv + "<b> Bill No. : </b>"+ cDiv + rDiv + document.forms[0].strInvoiceNo.value + cDiv;
	tmpDiv = tmpDiv + lDiv + "<b>Invoice Date : </b>"+ cDiv + rDiv + document.forms[0].strChallanDate.value + cDiv + rDiv + cDiv + lDiv + "<b>Bill Date : </b>"+ cDiv + rDiv + document.forms[0].strInvoiceDate.value + cDiv;
	...
	tmpDiv = tmpDiv + lDiv + "<b>Supplier : </b>"+ cDiv + rDiv + document.forms[0].strSupplier[document.forms[0].strSupplier.selectedIndex].text + cDiv + rDiv + cDiv + lDiv + "<b>P.O No. : </b>"+ cDiv + rDiv + document.forms[0].strLpoNo.value + cDiv;
	if((document.forms[0].strExpDeliveryDate.value)!="")
	{
...
<input type="hidden" name="strCurrentFYYear" value="${localPurchaseNewTransBean.strCurrentFYYear}" />
<input type="hidden" name="strCtDate" value="${localPurchaseNewTransBean.strCtDate}" />
<input type="hidden" name="strTenYrCtDate" value="${localPurchaseNewTransBean.strTenYrCtDate}" />
