...
<html:form name="newchallanProcessBean"
	...
	<div class="container-fluid">
      <div class="prescriptionTile">
                                  <p class="subHeaders">
										<button type="button" class="btn btn-info" style="padding: 0.175rem 0.75rem;">
	...
	<div class="col-sm-2" align="right"><label for="storeName">Store Name:</label></div>
	<div class="col-sm-2" align="left"><bean:write name="newchallanProcessBean" property="strStoreName"/></div>
	<div class="col-sm-2" align="right"><label for="categoryName">Item Category:</label></div>
	<div class="col-sm-2" align="left"><bean:write name="newchallanProcessBean" property="strItemCategoryName"/></div>
	<div class="col-sm-3"></div>
	</div>
	
	<div class="row">
	<div class="col-sm-1"></div>
	<div class="col-sm-2" align="right"><label>PO Type :</label></div>
	<div class="col-sm-2" align="left"><input style="display:none;" type="radio" name="challanOpt" value="2" onchange="changePoType()" checked>Local PO</div>
	<div class="col-sm-2" align="right"><label><font color="red">*</font>Enter PO No :</label></div>
	<div class="col-sm-2" align="left"><input type="text" class="form-control form-control-sm" name="strPoNo"  placeholder="Enter LPO No" onkeypress="return isNumber(event)" onkeyup="return onEnter(this,event,'onEnterPoNo()')" autocomplete="off" required></div>
	<div class="col-sm-3"></div>
	</div>
	...
	<div class="row">
	<div class="col-sm-1"></div>
	<div class="col-sm-2" align="right"><label>Purchase Order No : </label></div>
	<div class="col-sm-2" align="left"><bean:write name="newchallanProcessBean" property="strPoNoDisplay"/></div>
	<div class="col-sm-2" align="right"><label>Purchase Order Dt :</label></div>
	<div class="col-sm-2" align="left"><bean:write name="newchallanProcessBean" property="strPoDate"/></div>
	<div class="col-sm-3"></div>
	</div>
	
	<div class="row">
	<div class="col-sm-1"></div>
	<div class="col-sm-2" align="right"><label>Entry Dt : </label></div>
	<div class="col-sm-2" align="left">04/01/2019</div>
	<div class="col-sm-2" align="right"><label>VND Name :</label></div>
	<div class="col-sm-5" align="left"><bean:write name="newchallanProcessBean" property="strSupplierName"/></div>
	
	</div>
	<div class="row">
	<div class="col-sm-1"></div>
	<div class="col-sm-2" align="right"><label><font color="red">*</font>CD No : </label></div>
	<div class="col-sm-2" align="left"><input type="text" name="strSupplierReceiptNo" class="form-control form-control-sm" placeholder="Enter CD No." required></div>
	<div class="col-sm-2" align="right"><label>DC Dt :</label></div>
	<div class="col-sm-2" align="left"><input id="dcDateInput" type="text" name="strSupplierReceiptDate" class="form-control form-control-sm currentDate" required></div>
	<div class="col-sm-3"></div>
	</div>
	<div class="row">
	<div class="col-sm-1"></div>
	<div class="col-sm-2" align="right"><label>RCD Store CD : </label></div>
	<div class="col-sm-2" align="left">MEDSTR</div>
	<div class="col-sm-2" align="right"><label><font color="red">*</font>DC Received By :</label></div>
	<div class="col-sm-2" align="left">
	  <select name="strReceivedBy" class=" form-control form-control-sm">    <!-- onchange="checkValCombo(this);" -->
	...
	<div class="col-sm-3"></div>
		...
		<div class="row">
	<div class="col-sm-1"></div>
	<div class="col-sm-2" align="right"><label>Supplier Discount :  </label></div>
	<div class="col-sm-2" align="left">20 %</div>
	<div class="col-sm-2" align="right"></label></div>
	<div class="col-sm-2" align="left">
		                  ...
		                  {  
							...
							<td colspan="5">
		                   	 ...
		                   	 %>
		                   		...
		                   		%>
		                   		<tr>
		                   		<td colspan="5" class="alert alert-danger text-center">No Record Found / Please enter correct PO number</td>
		                   		</tr>
		                   		<%
		                   	}
		                   	%>
	...
	<div class="col-sm-2"></div>
					        ...
					        <button type="button" class="btn btn-success" onclick="saveForm(this)" id='saveid' style="display: none;padding: 0.175rem 0.75rem;">Save</button>
				              <button type="button" class="btn btn-danger" onclick="closePage('LIST')" style="padding: 0.175rem 0.75rem;">Cancel</button>
					        </div>
