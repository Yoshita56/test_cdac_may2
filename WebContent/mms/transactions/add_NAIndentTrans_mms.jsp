...
<head>
<meta charset=UTF-8">
<title>NA Certificate Generation</title>
...
<div class="container-fluid">
	...
	<fieldset>					
		<legend class="legendHeader" id='nonPrintableLegend'>NA Certificate Generation</legend>
	...
	<div class="container">
	   ...
	   <div class="row my-1">
	    ...
	    <div class="row my-1">
		 ...
		 <div class="col-sm-4"><input type="radio" name=isNormal value="1" checked="checked" />Normal&nbsp;&nbsp;<input type="radio" name="isNormal" value="0" />Urgent</div>
...
<hr>
	 <table class="table" >
		<thead class='thead-dark' align='center'>
			<tr>
				<th  scope='col'width="20%" style='font-weight:350 !important ;font-size: 16px !important;'>Drug/Item Name</th>
				<!--<th width="20%" class="multiLabel"><font size="2" color="aqua">*</font>Rate/Unit</th>  -->
				<th  scope='col' width="10%" style='font-weight:350 !important ;font-size: 16px !important;'>Item Type</th>
				<th  scope='col' width="10%" style='font-weight:350 !important ;font-size: 16px !important;'>Available Qty</th>
	...
	<div class="col-sm-10"><textarea name="strRemarks" class="form-control" cols="25"   rows="2" id="strRemarks" style="height:38px;">CR No :- </textarea></div>
	</div>
