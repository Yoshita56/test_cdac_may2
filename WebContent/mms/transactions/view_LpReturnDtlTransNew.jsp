...
<fieldset>
	...
	<div class="legend2" id="saveId">
		...
		<button  id="printbutton" type="button" class="btn btn-outline-primary mt-1 btn-circle printbtn" data-toggle="modal" data-target="" style="background-color:#2e79b4;" id=" " onclick=' getReport();'>
...
<div class='col-sm-2' style='font-weight: 400; color: blue;' align="left"></div>
<div class='col-sm-2'>
<label></label>
</div>
<div class='col-sm-2' style='font-weight: 400; color: blue;' align="left"></div>
...
<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
		<tr>
		 ...
		 <div id="patientAdmissionDtlId" style="display:block">
			<bean:write property="strPatientDtlNew" name="lpIssueDeskTransBean" filter="false"/>
		</div> 
	 ...
	 <div class='subHeaders'>Item/Drug Detail</div>
