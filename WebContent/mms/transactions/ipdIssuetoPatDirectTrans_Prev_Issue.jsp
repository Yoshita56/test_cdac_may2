...
<html:form name="ipdIssuetoPatDirectBean" action="/transactions/IPDIssuetoPatDirectTransCNT" type="mms.transactions.controller.fb.IPDIssuetoPatDirectTransFB">
	...
	<div class="errMsg"     id="errMsg"     style="font-size:18px;"><bean:write name="ipdIssuetoPatDirectBean" property="strErrMsg" /></div>
	<div class="warningMsg" id="warningMsg" style="font-size:18px;"><bean:write name="ipdIssuetoPatDirectBean" property="strWarningMsg" /></div>
	<div class="normalMsg"  id="normalMsg"  style="font-size:18px;"><bean:write name="ipdIssuetoPatDirectBean" property="strNormalMsg" /></div>	
...
<div class="container">
	<div class="row ">
		...
		<div class="col-md-2" style=""><b><bean:write name="ipdIssuetoPatDirectBean" property="storeName" filter="false" /></b></div>
		<div class="col-md-2">Item Category</div>
		<div class="col-md-2" style=""><b><bean:write name="ipdIssuetoPatDirectBean" property="itemCatName" filter="false" /></b></div>
		<div class="col-md-2">CR No.</div>
		<div class="col-md-2" style=""><b><bean:write name="ipdIssuetoPatDirectBean" property="crNo" filter="false" /></b></div>
	</div>
<br>
...
<div id = "patientDetailsDivId" style="display:block;">
  ...
  <tr>
      <bean:write name="ipdIssuetoPatDirectBean" property="strPatientDetail" filter="false" />
  </tr>
 </table>
</div>
	...
	<input type="hidden" name="hospCode" 				value="${ipdIssuetoPatDirectBean.strHospitalCode}" />
	...
	<input type="hidden" name="strCrNo" 				value="${ipdIssuetoPatDirectBean.crNo}" />
