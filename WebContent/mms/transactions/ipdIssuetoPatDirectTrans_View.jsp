...
<div class="errMsg"     id="errMsg">       <bean:write name="ipdIssuetoPatDirectBean" property="strErrMsg"/></div>
<div class="warningMsg" id="warningMsg">   <bean:write name="ipdIssuetoPatDirectBean" property="strWarningMsg"/></div>
<div class="normalMsg"  id="normalMsg">    <bean:write name="ipdIssuetoPatDirectBean" property="strNormalMsg"/></div>
...
<div class="container-fluid">
	...
	<!-- 	<div class="row">
			<div class="legend2" id='nonPrintableLegend2'>
				<button type="button" onclick="cancelFunc();" class="float-right btn btn-danger mt-1 btn-circle cancelbtn" style="border-radius:50%; padding:10px 13px;">
					<i class="fas fa-times iround" title="Cancel"></i>
				</button>
				<button type="button" onclick="controlToMainPage();" class="float-right btn btn-danger mt-1 btn-circle cancelbtn" style="border-radius:50%; padding:10px 13px;">
					<i class="fas fa-times iround" title="Cancel"></i>
				</button>
			</div>
		</div>
		...
		<div class="container">
			<div class="row my-1" style="margin:1% 5%" >
				...
				<div class="col-md-4"> 
					...
					<select name="strStoreName" class="browser-default custom-select"   onChange="">
						<bean:write name="ipdIssuetoPatDirectBean" property="strStoreName" filter="false"/>
			       </select>
			    </div>
			    ...
			    <div class="col-md-4">
				    <div id="ItemCatg" >
				      <%--  <select class='browser-default custom-select' name='strItemCatgCombo'> 
				           <bean:write name="ipdIssuetoPatDirectBean" property="strItemCatgCombo" filter="false"/>
				       </select> --%>
				       <input type="text" class="form-control" name="strItemCatgCombo"	onkeypress="return validateData(event,18);" maxlength="15">
					</div>
			    </div>
			</div>
			...
			<div class="row my-1" style="margin:1% 5%">
				...
				<div class="col-md-4">
					<input  name="strFromDate" class="form-control datepicker" value="${ipdIssuetoPatDirectBean.strFromDate}" style="color: rgba(113, 111, 111, 0.87);"> 
				</div>
		       	<div class="col-md-2"><font color="red">*</font>To Date</div>
		       	<div class="col-md-4">
		       		<input  name="strToDate" class="form-control datepicker" value="${ipdIssuetoPatDirectBean.strToDate}" style="color: rgba(113, 111, 111, 0.87);">    	
		       	</div>
		   </div> 
