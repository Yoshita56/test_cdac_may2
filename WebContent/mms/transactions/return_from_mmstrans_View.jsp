	...
	<div class="prescriptionTile">
		...
		<div class="container">
			<div class="row my-1" style="margin:1% 5%" >
				...
				<div class="col-md-4"> 
					...
					<select name="strStoreName" class="browser-default custom-select"   onChange="">
						<bean:write name="returnFromTransBean" property="strStoreName" filter="false"/>
			       </select>
			    </div>
			    ...
			    <div class="col-md-4">
				    <div id="ItemCatg" >
				      <%--  <select class='browser-default custom-select' name='strItemCatgCombo'> 
				           <bean:write name="returnFromTransBean" property="strItemCatgCombo" filter="false"/>
				       </select> --%>
			...
			<div class="row my-1" style="margin:1% 5%">
				...
				<div class="col-md-4">
					<input  name="strFromDate" class="form-control datepicker" value="${returnFromTransBean.strFromDate}" style="color: rgba(113, 111, 111, 0.87);"> 
				</div>
		       	<div class="col-md-2"><font color="red">*</font>To Date</div>
		       	<div class="col-md-4">
		       		<input  name="strToDate" class="form-control datepicker" value="${returnFromTransBean.strToDate}" style="color: rgba(113, 111, 111, 0.87);">    	
		       	</div>
		   </div> 
