...
<html:form name="ItemTenderUploadDocFB" action="/transactions/ItemTenderUploadDocCNT" type="mms.transactions.controller.fb.ItemTenderUploadDocFB">
	...
	<div id="errMsg"     class="errMsg"    style="font-size:16px;"><bean:write name="ItemTenderUploadDocFB" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg" style="font-size:16px;"><bean:write name="ItemTenderUploadDocFB" property="strWarningMsg" /></div>
	<div id="normalMsg"  class="normalMsg"  style="font-size:16px;"><bean:write name="ItemTenderUploadDocFB" property="strNormalMsg" /></div>
...
<%-- 	<tag:tab tabLabel="Update Stock Status" selectedTab="FIRST" align="center" width="TABLEWIDTH"> </tag:tab> --%> 
    	...
    	<div class="prescriptionTile" align="center">
     	...
     	<div class="container">
			...
			<div class="row my-1" style="margin:1% 5%">
				...
				<div class="col-md-4">
					<%-- <input  name="strFromDate" class="form-control datepicker" value="${ItemTenderUploadDocFB.strCurrentDate}" style="color: rgba(113, 111, 111, 0.87);"> --%> 
					<input name="strFromDate" id="datepicker1" class="form-control" value="${ItemTenderUploadDocFB.strCurrentDate}" />
				</div>
		       	<div class="col-md-2">To Date</div>
		       	<div class="col-md-4">
		       		<%-- <input  name="strToDate" class="form-control datepicker" value="${ItemTenderUploadDocFB.strCurrentDate}" style="color: rgba(113, 111, 111, 0.87);"> --%>    	
		       		<input name="strToDate" id="datepicker2" class="form-control" value="${ItemTenderUploadDocFB.strCurrentDate}" />
		       	</div>
		   </div> 
	...
	<%-- <table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">   
	    ...
	    <tr >
			...
			<td class="CONTROL" colspan="2"><dateTag:date name="strFromDate" value="${ItemTenderUploadDocFB.strCurrentDate}" /></td>
		</tr>
		<tr >
			<td class="LABEL" colspan="2"><font color="red">*</font>To Date</td>
			<td class="CONTROL" width="25%" ><dateTag:date name="strToDate" value="${ItemTenderUploadDocFB.strCurrentDate}" /></td>
	...
	<table  class="TABLEWIDTH" align="center">
	  <tr>
		...
		<input type="hidden" name="strCurrentDate" value="${ItemTenderUploadDocFB.strCurrentDate}" />
		<input type="hidden" name="strHiddenValues" value="${ItemTenderUploadDocFB.strHiddenValues}" />
