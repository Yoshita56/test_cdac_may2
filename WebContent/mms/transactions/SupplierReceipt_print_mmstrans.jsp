...
<html:form action="/transactions/SupplierReceiptCNT.cnt" name="SupplierReceiptBean" type="mms.transactions.controller.fb.SupplierReceiptFB" method="post" >
	...
	<div class="errMsg" id="errMsg"><bean:write name="SupplierReceiptBean" property="strErr" /></div>
	<div class="warningMsg" id="warningMsg"><bean:write name="SupplierReceiptBean" property="strWarning" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write
		name="SupplierReceiptBean" property="strMsg" /></div>
	...
	<div id = "printDtlsDivId">
		<bean:write name="SupplierReceiptBean" property="strPrintDtls" filter="false" />
	</div>
