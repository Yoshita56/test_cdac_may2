...
<html:form name="billApprovalTransBean" action="transactions/BillApprovalTransCNT"
	type="mms.transactions.controller.fb.BillApprovalTransFB" >
...
<center>
	...
	<div id="normalMsg" class="normalMsg"><bean:write name="billApprovalTransBean" property="strNormalMsg"/></div>
			...
			<tag:tab tabLabel="Supplier Invoice Dtls"
...
<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">   
 ...
 <div id="onGOClickDtlsDivId" style="display:none">	
    ...
    <table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">   
		<tr>		
		 <td  colspan="4" class="TITLE" width="100%">PO Details</td>	
		</tr>
	</table>
  ...
  <div id="poDtlDivId">	
   ...
   <div id="agentNameDivId" style="display:none">  
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">   
		<tr>		 
		 <td  colspan="4" class="TITLE" width="95%">Supply Details</td>	
		</tr>
	</table>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">   
		<tr>		 
		 <td  colspan="4" class="TITLE" width="95%">Previous Invoice Details</td>	
		</tr>
	</table>
		
	<table class="TABLEWIDTH" align="center"> 
	 <tr>
	   <bean:write name="billApprovalTransBean" property="strPreviousPaymentDtls" filter="false" />
	 </tr>
	</table>
	<table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">   
		<tr>		 
		 <td  colspan="4" class="TITLE" width="95%">Previous Invoice Payment Details</td>	
		</tr>
	</table>
		
	<table class="TABLEWIDTH" align="center"> 
	 <tr>
	   <bean:write name="billApprovalTransBean" property="strPreviousInvoicePaymentDtls" filter="false" />
	 </tr>
	</table>	
	<table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">   
	  <tr>		 
		 <td  colspan="4" class="TITLE" width="95%">Invoice Details</td>	
	  </tr>
	</table>	
		
		<table class="TABLEWIDTH" bgcolor='#6097BC' align="center" cellpadding="1" cellspacing="1">   	
			  <tr>
				<th class='multiLabel' width="5%"  style='text-align:center;'><b>S.No.</b></th>
				<th class='multiLabel' width="14%" style='text-align:center;'><b>Invoice No</b></th>
				<th class='multiLabel' width="14%" style='text-align:center;'><b>Invoice Date</b></th>
				<th class='multiLabel' width="14%" style='text-align:center;'><b>Amount</b></th>
				<th class='multiLabel' width="14%" style='text-align:center;'><b>GST</b></th>				
				<th class='multiLabel' width="14%" style='text-align:center;'><b>Discount</b></th>
				<th class='multiLabel' width="14%" style='text-align:center;'><b>Cost</b></th>				
				<th class='multiLabel' width="5%"  style='text-align:center;'>				
				<img  Src="../../hisglobal/images/plus.gif" style="cursor: pointer;"
								title="Add Detail's"
								OnClick="generateSlNo(1);">
	...
	<div id="showTotalDiv" style="display:none;">
	  <table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1"> 
	    <tr>
	    	<td width='100%' colspan='8'><hr></td>
	    </tr>				
		<tr>
			<td align='right'  colspan='3'><b>Total :: </b></font></td>
			<td align='right'  colspan='1'><font face='Verdana, Arial, Helvetica, sans-serif' ><input type='hidden' id='strInvoiceNetValue'      name='strInvoiceNetValue' value='0' />     <div id='invoiceNetCostDIV' style='color: red;font-weight:bold'>0.00</div></font></td>
			<td align='right'  colspan='1'><font face='Verdana, Arial, Helvetica, sans-serif' ><input type='hidden' id='strGSTNetValue'          name='strGSTNetValue' value='0' />         <div id='invoiceNetGSTDIV'  style='color: red;font-weight:bold'>0.00</div></font></font></td>
			<td align='right'  colspan='1'><font face='Verdana, Arial, Helvetica, sans-serif' ><input type='hidden' id='strDiscNetValue'         name='strDiscNetValue' value='0' />        <div id='invoiceNetDiscDIV' style='color: red;font-weight:bold'>0.00</div></font></td>
			<td align='right'  colspan='2'><font face='Verdana, Arial, Helvetica, sans-serif' ><input type='hidden' id='strFinalInvoiceNetValue' name='strFinalInvoiceNetValue' value='0' /><div id='invoiceFinalNetCostDIV' style='color: red;font-weight:bold'>0.00</div></font></font></td>
		</tr>					
		<tr>
		    <td width='100%' colspan='8'><hr></td>
		</tr>	
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">   
	  <tr>		 
		 <td  colspan="4" class="TITLE" width="95%">Invoice Payment Details</td>	
	  </tr>
	</table>
	<table class="TABLEWIDTH" bgcolor='#6097BC' align="center" cellpadding="1" cellspacing="1">  	
	 <tr>
		<th class='multiLabel' width="5%"  style='text-align:center;'  bordercolor="black">S.No.</th>
		<th class='multiLabel' width="14%" style='text-align:center;'  bordercolor="black">Invoice No</th>
		<th class='multiLabel' width="14%" style='text-align:center;'  bordercolor="black">Pay Type</th>
		<th class='multiLabel' width="14%" style='text-align:center;'  bordercolor="black">Amount</th>				
		<th class='multiLabel' width="14%" style='text-align:center;'  bordercolor="black">GST</th>
		<th class='multiLabel' width="14%" style='text-align:center;'  bordercolor="black">Discount</th>	
		<th class='multiLabel' width="14%" style='text-align:center;'  bordercolor="black">Cost</th>				
		<th class='multiLabel' width="5%"  style='text-align:center;'>				
		<img  Src="../../hisglobal/images/plus.gif" style="cursor: pointer;"
						title="Add Detail's"
						OnClick="addRows(new Array('strMultiPayInvoiceNo','strMultiPayInvoiceType','strMultiPayInvoiceAmount','strMultiPayInvoiceTax','strMultiPayInvoiceDisc','strMultiPayInvoiceValue'),new Array('s','s','t','t','t','t'),'2','1','R');generateSlNo(2);">
	...
	<div id='otherDetailsDIV' style='display:block;'>		
	...
	<tr>
	   ...
	   <td class="TITLE" colspan="4" width="100%">Supplier Bill Details</td>
	 </tr>
	</table>
	<div id="suppBillDtlDivId">
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">    
	<tr>
	    <td class="LABEL" width="25%" ><font color="red">*</font>Payment Status</td>
        <td class ="CONTROL" width="25%" >
            <select name="strPaymentStatus">
               <option value="1">Full Payment</option>
               <option value="2">Partial Payment</option>
            </select>
        </td>
        <td class="LABEL" width="25%" ><font color='red'>*</font>Payment Date</td>
        <td class ="CONTROL" width="25%" >     
	          <date:date name="strPaymentDate" value="${billApprovalTransBean.strCurrentDate}"></date:date>
       </td>  </tr>
       
    <tr>
	    <td class="LABEL" colspan="1" width="25%"><font color="red">*</font>UTR No</td>
	    <td class="CONTROL" colspan="1" width="25%">
	       <input type="text"  name="strUTRNo" value="" class="txtFldMax" onkeypress="" maxlength="14">
	    </td>
	    
	     <td class="LABEL" colspan="1" width="25%"><font color="red">*</font>Bill Amt</td>
	    <td class="CONTROL" colspan="1" width="25%">
	       <input type="text"  name="strBillAmount" value="${billApprovalTransBean.strBillAmount}" class="txtFldMax" onkeypress="return(numericWithTwoDecimalPlaces(this,',','.',event))" maxlength="14">
	    </td>
    ...
    <tr>
	    ...
	    <td class="CONTROL" colspan="2" width="50%">
	       <textarea rows="3" cols="25" name="strRemarks"></textarea>
	    </td>
    </tr>
    </table>  
 </div>
...
<div align="center" id="saveId">					 
			<img style="cursor: pointer; " src="../../hisglobal/images/btn-sv.png" onClick="return validateNew();" />
...
<input type="hidden" name="strBillAmtAfterPayment" value="${billApprovalTransBean.strBillAmount}" />
...
<jsp:include page="invoice_multirow.jsp"></jsp:include>
<jsp:include page="invoice_payment_multirow.jsp"></jsp:include>
