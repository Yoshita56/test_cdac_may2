...
<div class="errMsg"     id="errMsg">       <bean:write name="newIPDIssueToPatBean" property="strErrMsg"/></div>
<div class="warningMsg" id="warningMsg">   <bean:write name="newIPDIssueToPatBean" property="strWarningMsg"/></div>
<div class="normalMsg"  id="normalMsg">    <bean:write name="newIPDIssueToPatBean" property="strNormalMsg"/></div>
	...
	<!-- 	<div class="row">
		...
		<div class="container">
			<div class="row my-1" style="margin:1% 5%" >
				...
				<div class="col-md-4"> 
					...
					<select name="strStoreName" class="browser-default custom-select"   onChange="">
						<bean:write name="newIPDIssueToPatBean" property="strStoreName" filter="false"/>
			       </select>
			    </div>
			    ...
			    <div class="col-md-4">
				    <div id="ItemCatg" >
				      <%--  <select class='browser-default custom-select' name='strItemCatgCombo'> 
				           <bean:write name="newIPDIssueToPatBean" property="strItemCatgCombo" filter="false"/>
				       </select> --%>
			...
			<div class="row my-1" style="margin:1% 5%">
				...
				<div class="col-md-4">
					<input  name="strFromDate" class="form-control datepicker" value="${newIPDIssueToPatBean.strFromDate}" style="color: rgba(113, 111, 111, 0.87);"> 
				</div>
		       	<div class="col-md-2"><font color="red">*</font>To Date</div>
		       	<div class="col-md-4">
		       		<input  name="strToDate" class="form-control datepicker" value="${newIPDIssueToPatBean.strToDate}" style="color: rgba(113, 111, 111, 0.87);">    	
		       	</div>
		   </div> 
