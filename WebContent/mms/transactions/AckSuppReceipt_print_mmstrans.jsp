...
<html:form action="/transactions/AckSuppReceiptCNT.cnt" name="AckSuppReceiptBean" type="mms.transactions.controller.fb.AckSuppReceiptFB" method="post" >
	...
	<div class="errMsg" id="errMsg"><bean:write
		name="AckSuppReceiptBean" property="strErr" /></div>
	<div class="warningMsg" id="warningMsg"><bean:write
		name="AckSuppReceiptBean" property="strWarning" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write
		name="AckSuppReceiptBean" property="strMsg" /></div>
	...
	<div id = "printDtlsDivId"><bean:write name="AckSuppReceiptBean"
