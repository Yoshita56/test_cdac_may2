...
<html:form name="issuePatBean" action="/transactions/IssueToPatOPDTransCNT" type="mms.transactions.controller.fb.IssueToPatOPDTransFB">
	<fieldset>
		...
		<legend class='legendHeader' id='nonPrintableLegend'>Drug Dispensing For OPD OFF-LINE</legend>
		...
		<div class="legend2" id='nonPrintableLegend2'>
		    ...
		    <button  type="button" id="savebutton" class="btn btn-outline-success mt-1 btn-circle savebtn"  tabindex='2' onClick="return DirectIssue_Off();"   data-toggle="" data-target="#previewModal" >					
				<div class="popupToast"><i class="fa fa-save iround"  title="Save"></i> <span class="popuptextToast">Save</span></div>
			</button>	
			
			<!-- <button name="offlineIssueIndentBean"  type="button" class="btn btn-primary mt-1 btn-circle" property="strViewChk" onclick="getPrevIssueDtl_OffLine();" title="Click Here To View Previous Issue">
					<i class="fas fa-eye iround" title="View"></i>
			</button> -->
			<!-- <button name="issuePatBean"  type="button" class="btn btn-primary mt-1 btn-circle" property="strViewChk" onclick="toViewPage();" title="Click Here To View Previous Issue">
					<i class="fas fa-eye iround" title="View"></i>
			</button> -->
  		...
  		<div class="container-fluid">		
			...
			<!-- <div class="row rowFlex reFlex">
					...
					<div class="col-sm-2"></div>
					<div class="col-sm-6">			 
						<button type="button" class="btn btn-warning btn-sm" tabindex="2"  onclick="getPrevIssueDtl_OffLine();" style="float:right;">
				...
				<div class="row rowFlex reFlex">	
					...
					<legend class="legendHeader"><i class="fa fa-file-prescription" style="color: #5cb85c;"></i>&nbsp;Drug Finder</legend>		
					</div>
				...
				<div style='display: none;'>							
					<select name="strMultiRowItemId"     id="strMultiRowItemId" class="form-control form-control-sm" >										       
					     <bean:write name="issuePatBean" property="strItemNameValues" filter="false" />
					</select> 
				</div>
		...
		<div style="display: none;">
			<div id="patientDetailsDivId" style="display: none;">
				<table class="TABLEWIDTH" align="center" cellspacing="1px">
					<tr>
						<bean:write name="issuePatBean" property="strPatientDetails" filter="false" />
					</tr>
				</table>
	...
	<input type="hidden" name="strOfflineOPDFlag" 		value="${issuePatBean.strOfflineOPDFlag}" />
		<!-- added47 -->
	<input type="hidden" name="strHospitalCode" 		value="${issuePatBean.strHospitalCode}"/>
...
<!-- 			<div class="modal-container" id="issueModeModalMenu" > style="display: none;">
				<div id="issueModeModal" class="modal fade" role="dialog">
					<div class="modal-dialog" style="max-width:700px;">
						Modal content
						<div class="modal-content">
							<div class="modal-header" style="border-top: 1px solid black;">
								<h5 class="modal-title">Issue Voucher</h5>								
							</div>
							...
							<div class="modal-footer" style="border-top: 1px solid black;">
							  <div class="row rowFlex reFlex">
			              	 	<div class="col-sm-12" align="center">
			               			 <button type="button" class="btn btn-success" onClick='return printDiv();'>Print</button>
							     </div>
							   </div>
							</div>
						</div>
...
<jsp:include page="opd_offline_trans_search_row.jsp"></jsp:include>
