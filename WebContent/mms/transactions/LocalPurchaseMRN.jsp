...
<head>
<meta charset=UTF-8">
<title>Local Purchase MRN</title>
...
<body>
<html:form action="/transactions/LocalPurchaseMRN_CNT.cnt"  name="LocalPurchaseMRNbean" type="mms.transactions.controller.fb.LocalPurchaseMRN_FB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="LocalPurchaseMRNbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="LocalPurchaseMRNbean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="LocalPurchaseMRNbean" property="strNormalMsg" /></div>
<br>
<br>    
    <div class="container">
    	<div class="row">
    		<div class="prescriptionTile col-sm-12" align="center">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="LocalPurchaseMRNbean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>
				...
				<div class="col-sm-3">
					<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
						<bean:write name="LocalPurchaseMRNbean" property="strItemCategoryCombo" filter="false"/>
					</select>
				</div>
    		  </div>
    		  ...
    		  <div class="row">
    		       ...
    		       <div class="col-sm-3">
					...
					<div class="col-sm-3">
						<select name='strGroupId' class="browser-default custom-select" id="grpCombo">
    		  ...
    		  <div class="row">
					...
					<div class="col-sm-3">
						<select class="browser-default custom-select" name="strInstituteId" id="InstituteId" >
							<bean:write name="LocalPurchaseMRNbean" property="strInstituteValues" filter="false"/>
						</select>
					</div>
					...
					<div class="col-sm-3">
						<select name="strSupplierId" id="SupplierDivId" class="browser-default custom-select">
							<bean:write name="LocalPurchaseMRNbean" property="strSupplierCombo" filter="false" />
						</select>
					</div>
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<input name="strFromDate" class="form-control datepicker" value="${LocalPurchaseMRNbean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" class="form-control datepicker" value="${LocalPurchaseMRNbean.strCurrentDate}" />
					</div>
    		  </div> 	
    		  <div class="row">
				...
				<div class="col-sm-3">
					<select class="browser-default custom-select" name="strActId" id="strActId"  >
		...
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for Local Purchase MRN</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${LocalPurchaseMRNbean.strCurrentDate}" />
		</div>
	</div>
</div>
