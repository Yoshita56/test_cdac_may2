...
//	  popup('popUpDiv1', '60', '80');
       ...
       $.ajax({
        url: "/INVMGM/mms/transactions/ItemInventoryWithProgramTransCNT.cnt?hmode=PRINTVOUCHER",
        type: "POST",
        cache: false,
        data: {
...
function cancelToList(){
	  ...
	  document.forms[0].action="/INVMGM/mms/transactions/ItemInventoryTransCNT.cnt?hmode=LISTPAGE1";
