...
<body onload="return OnLoadFunction_NEW(),costReq();">
<script language="Javascript" src="../../hisglobal/js/wz_tooltip.js"></script>
<html:form action="/transactions/IssueToPatIndentCNT.cnt"
		 ...
		 <legend style="width:auto; margin-bottom: 0px;font-size: 1.5rem;font-weight: 400;margin-left:10px;color: #666;" id='nonPrintableLegend'> Request For Patient</legend>
		    ...
		    <div class="container">
			     ...
			     <div class="row my-1">
					 ...
					 <div class="col-sm-4">
					      <select class='browser-default custom-select' id='strToStoreCombo' name='strToStoreCombo'>
				...
				<div class="row my-1">
					...
					<div class="col-sm-4">
						<crNo:crNo value="${requestForLpPatient.strCrNo}"></crNo:crNo>
					</div>
		...
		<div id="costDivNotReqId" style="display: none">
	        <div class="row">
				<div class="col my-1" align="right">
					<button type="button" class="btn btn-info" id='strSearchItemButtonDivId' data-toggle="modal" data-target="#tariffDtlsModal" onclick='getItemSelectPopup();'/><i class="fas fa-plus"></i>&nbsp;Add Items</button>
				</div>
			</div>
		<hr>
			 <table class="table" >
...
<jsp:include page="requestforPatientNew_itemRow.jsp"></jsp:include>
