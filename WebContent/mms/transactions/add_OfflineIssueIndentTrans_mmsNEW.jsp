...
<div class="errMsg"     id="errMsg" style="font-size:18px;"><bean:write name="offlineIssueIndentBean" property="strErr"/></div>
<div class="warningMsg" id="warningMsg" style="font-size:18px;"><bean:write name="offlineIssueIndentBean" property="strWarning"/></div>
<div class="normalMsg"  id="normalMsg" style="font-size:18px;"><bean:write name="offlineIssueIndentBean" property="strMsg"/></div>
...
<div class="container-fluid">
	<div class="prescriptionTile">
		<!-- <div class='legendHeader my-2' id='nonPrintableLegend' style="font-weight:600;font-size: 22px;" >Issue(Off Line)</div> -->
			...
			<div class="row">
				...
				<div class="col-sm-6 legend2" id="saveId">
					<button type="button" onclick="cancelFunc();" class="float-right btn btn-danger mt-1 btn-circle cancelbtn" style="border-radius:50%; padding:12px 13px;">
						<i title="Cancel" class="fas fa-times iround"></i>
					</button>
					
					<button type="button"  class="float-right btn btn-primary mt-1 btn-circle " name="offlineIssueIndentBean" property="strViewChk" onclick="transferToViewPage();" title="Click Here To View Off Line Issue Item Detail" style="border-radius:50%; padding:12px 11px;" >
						<i class="fas fa-eye iround" title="View"></i>
					</button>
					
					<button type="button" onclick="initPage();" style="border-radius:50%; padding:12px 10px;background: #2196f3;" class="float-right btn btn-secondary btn-circle mt-1">
						<i class="fas fa-broom iround" title="Clear"></i>
					</button>
					
					<button type="button" id="savebutton" class="float-right btn btn-success mt-1 btn-circle"  tabindex="2" onclick=" return validateNewDemand();" name="patientAdmissionModiTransBean" style="background-color: #5cb85c;border-radius:50%; padding:12px 12px;">
			...
			<div class="container">
				<div class="row" style="margin:1% 4%">
				...
				<div class="row " style="margin:1% 4%">
					<div class="col-md-2 "><font color="red">*</font>Indenting Store:</div>
					<div class="col-md-4">
					...
					<div class="col-md-4"><input  name="strIndentIssueDate" class="form-control datepicker" value="${offlineIssueIndentBean.strFromDate}" style="color: rgba(113, 111, 111, 0.87);">
					</div>
				</div>
		...
		<div class="row" style="margin:1% 4%">
				<div class="col-md-6" align="left"> 
					<div id="minus" style="display: block">
						<p class="subHeaders">
							<i class="fas fa-minus-circle" id='imgStockDetails' onclick='showOrHideStockDetails(this)' title='Hide' style="font-size: 24px;"></i>
							&nbsp;New Demand
						</p>
					</div>
				</div>
				
				<div class="col-md-4" align="right"><font color="red">*</font>Indent Status: </div>
					...
					<!-- <div class="col-sm-1"> -->
						<div class="custom-control custom-radio">
							<input type="radio" id='customRadio' class="custom-control-input" name="strIsNormal" checked="checked" value="1" onclick="changeViewMode(this);"> 
								<label class="custom-control-label" for="customRadio">Normal</label>
						</div>
					<!-- </div> -->
					<!-- <div class="col-sm-1"> -->
						<div class="custom-control custom-radio">
							<input type="radio" id='customRadio1' class="custom-control-input" name="strIsUrgent" value="2" onclick="changeViewMode(this);"> 
								<label class="custom-control-label" for="customRadio1">Urgent</label>
						</div>
					<!-- </div> -->	
		  </div>
	</div>
...
<div id="newDemandDivID" style="display:block;">
    	<div class="row" style="margin:1% 4%">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" readonly="readonly" name="strIndentPeriodValue" value="${offlineIssueIndentBean.strIndentPeriodValue }"	onkeypress="return validateData(event,3);" maxlength="50"></div>
    		
    		<div class="col-md-2"><font color="red">*</font>Indent Type</div>
			<div class="col-md-4"> 
		...
		<div class="row" style="margin:1% 4%">
    		<div class="col-md-2 "><font color="red">*</font>Indent No:</div>
			<div class="col-md-4"><input type="text" class="form-control" name="strIndentNo"	onkeypress="return validateData(event,5);" maxlength="15"></div>
			<div class="col-md-2"><font color="red">*</font>Indent Date:</div>
			<div class="col-md-4"><input  name="strApprovedDate" class="form-control datepicker" value="" style="color: rgba(113, 111, 111, 0.87);"></div>
    	</div>	
    	
		<div id="budgetIDTwo" style='display:none;'></div>
        <!-- <div class="row ">
        	<div class="col-md-12" align="right"><button type="button" class="btn btn-success" style="padding: 0.175rem 0.75rem;"   title='Click Here To Search Items' height="20"  id='strSearchItemButtonDivId'  onclick='getItemSelectPopup();'><i class="fas fa-search"></i>Item Finder</button></div>
        </div> -->
<hr>
        <!-- <div class="row">
			<div class="col-sm-12 my-1" align="right">
				<button type="button" class="btn btn-info" id='strSearchItemButtonDivId' data-toggle="modal" data-target="#tariffDtlsModal" onclick='getItemSelectPopup();'/>
		...
		<div class="row">
		   <div class="col" align="right">
				<button type="button" class="btn btn-success" id='strSearchItemButtonDivId' onclick="getItemSelectPopup();" title="Click Here To Search Items" data-toggle="modal" data-target="#tariffDtlsModal">
		...
		<logic:equal value="0" name="offlineIssueIndentBean" property="strBudgetFlg">
			<table class="table">
				<thead class='thead-dark' align='center'>
					<tr>
						<th  align='center' width='35%' style='font-weight:350 !important ;font-size: 16px !important;'>Item/Drug Name</th>
						<th  align='center' width='20%' style='font-weight:350 !important ;font-size: 16px !important;'>Batch/SlNo</th>
						<th  align='center' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'>Avl Qty</th>
						<th  align='center' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'>Req Qty</th>
						<th  align='center' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'><font color='red'>*</font>Issue Qty</th>
						<th  align='center' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'><font color='red'>*</font>Unit</th>
					</tr>
				</thead>
			 </table>
	       <div id="id1"></div>
        ...
        <logic:equal value="1" name="offlineIssueIndentBean" property="strBudgetFlg">
			<table class="table">
				<thead class='thead-dark' align='center'>
					<tr>
						<th  scope='col' width='30%' style='font-weight:350 !important ;font-size: 16px !important;'>Item/Drug Name</th>
						<th  scope='col' width='15%' style='font-weight:350 !important ;font-size: 16px !important;'>Batch/SlNo</th>
						<th  scope='col' width='5%' style='font-weight:350 !important ;font-size: 16px !important;'>Avl Qty</th>
						<th  scope='col' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'>Indenting Store Avl Qty</th>
						<th  scope='col' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'>Req Qty</th>
						<th  scope='col' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'><font color='red'>*</font>Issue Qty</th>
						<th  scope='col' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'><font color='red'>*</font>Unit</th>
						<th  scope='col' width='10%' style='font-weight:350 !important ;font-size: 16px !important;'>Cost</th>
					</tr>
				</thead>
			</table>
	    <div id="id1"></div>
       ...
       <div class="row" style="margin:1% 4%">
			<div class="col">
				<p class="subHeaders">
					<i class="fas fa-thumbs-up" style="font-size:20px;"></i>&nbsp; Approval  &amp; Receive Details
				</p>
			</div>
       	</div>
       	...
       	<div class="row"  style="margin:1% 4%">
       		...
       		<div class="col-md-4"><div id="ApprovedBy" >
       		...
       		<div class="col-md-4">
       			<input  name="strApprovalDate" class="form-control datepicker" value="${offlineIssueIndentBean.strApprovalDate}" style="color: rgba(113, 111, 111, 0.87);">
			</div>
       	</div> 
       	
       	<div class="row " style="margin:1% 4%">
       		<div class="col-md-2 ">Verified By:</div>
       		<div class="col-md-4"><div id="VerifiedBy" >
       		...
       		<div class="col-md-4"><input  name="strVerifiedDate"
						  ...
						  <table class="table">
							<thead class='thead-dark' align='center'>
								<tr>
									...
									<th  scope='col' style='font-weight:350 !important ;font-size: 16px !important;' title="Item/Drug Preferences"><font color='red'>*</font>#</th>
								</tr>
							</thead>
						 </table>
					</div>
    ...
    <br>
    <div class="row" style="margin:1% 4%">
    	<div class="col-md-2 "><font color='red'>*</font>Received By</div>
    	<div class="col-md-4">
	    	<div id="ReceivedBy">
		...
		<div class="col-md-4"><textarea class="form-control" name='strAprovedRemarks' style="height:38px"></textarea></div>	
    </div> 
    <div class="row" style="margin:1% 4%">
		<div class="col">	 	 
