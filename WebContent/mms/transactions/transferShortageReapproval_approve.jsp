...
<title>Transfer Shortage Reapproval</title>
...
<html:form name="transferShortageApprovalTransBean" action="/transactions/TransferShortageApprovalTransCNT" type="mms.transactions.controller.fb.TransferShortageApprovalTransFB" styleClass="formbg">
...
<center>
	...
	<div  id ="Raising" style="display:block">
       <table class="TABLEWIDTH" align="center" cellspacing="0px" cellpadding="1">   
			 <tr class="HEADER">
				<td colspan="4"><bean:message key="label.common.Transfer_shortage_approval"/> &gt;&gt; <bean:message key="label.common.Reapproval"/></td>
			 </tr>
		 </table>
	</div>	 
		 <table class="TABLEWIDTH" align="center" cellspacing="0px" cellpadding="1">   
	...
	<bean:write name="transferShortageApprovalTransBean" property="strSetApprovedDetails"  filter="false" />
...
<div class="legends"><font size="2" color="red">*</font><bean:message key="label.common.Mandatory_Field(s)"/></div>  
			...
			<tr id="saveId">
			  <td align="center">
			    <div >
					...
					<a href="#" style="cursor:pointer;" title="Click Here Go Back To Main Desk" class="button" onClick="cancel();"><span class="back"><bean:message key="label.common.Back"/></span></a>				 
				</div>
			  </td>
			</tr>	  
		</table>
	...
	<input type="hidden" name="strApprovalFlag"    value="${transferShortageApprovalTransBean.strApprovalFlag}">
	<input type="hidden" name="strReApprovalFlag"  value="1">	
	<input type="hidden" name="strReqTypeId"       value="${transferShortageApprovalTransBean.strReqTypeId}">	
