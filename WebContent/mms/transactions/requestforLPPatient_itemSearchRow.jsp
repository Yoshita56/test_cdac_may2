...
<logic:equal value="0" name="requestForLpPatient" property="strCostRequired">
	<div id="rowAdded1" style="display:none">
		<table class="" width="100%" align="center" cellpadding="1px" cellspacing="1px" >
				<tr>
				<td class="" width="45%">
				...
				<td class=""  width="18%" style="font-weight:350 !important ;font-size: 16px !important;text-align:center">
