...
<table class="table"  align="center" cellpadding="1px" cellspacing="1px"  id="td#delIndex#">
 <tr>
	...
	<td  class="" width="15%" align="">
			 ...
			 <div align="center"   id="strItemType#delIndex#" style='font-size: 0.8rem; color: black;text-align:center;'></div>  <!--  Batch -->
	</td>	
	<td  class="" width="15%" align="">
	...
	<td  class="" width="15%" align="center">
			 <input type="number" name="strReqQty"  id="strReqQty#delIndex#"  style='display:inline!important;' class='form-control'  onblur="QtyValidation_OffLine('#delIndex#');"   min='1' maxlength="3" onkeypress="return validateData(event,5);"  tabindex="3"> 
	</td>		
	<td  align="" width="5%">
