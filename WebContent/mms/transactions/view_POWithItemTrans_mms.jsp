	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			<tr>
				...
				<td width="25%" class="CONTROL"><bean:write name="PODeskGenerateTransBean"
					property="strApprovedBy" filter="false"></bean:write>
				</td>
				<td width="25%" class="LABEL" ><Font color="red">*</Font>Approval Date</td>
				<td width="25%" class="CONTROL"><bean:write name="PODeskGenerateTransBean"
					property="strApprovalDate" filter="false"></bean:write></td>
			</tr>
			<tr>
