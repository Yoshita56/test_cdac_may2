...
<span id="progress12">&nbsp; &nbsp;</span>
	...
	<table width='800' border="0" cellspacing ="0px">
	 ...
	 <table width='800' border="0" bgcolor='#6097BC' cellspacing ="1px" cellpadding="1px">
		<tr>
			...
			<td colspan="1" class='multiPOLabel'>Qty Ordered by RMSC</td>
			...
			<td colspan="1" class='multiPOLabel'>Qty in Quarntine</td>
		...
		<tr>
			...
			<td colspan="1" class='multiRPTControl'><div id ='4'></div></td>
	...
	<tag:tab tabLabel="Purchase Order Modify Form" selectedTab="FIRST"	align="center" width="TABLEWIDTH"></tag:tab>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"	cellspacing="1px">
		...
		<tr>
		  <td width="25%" class="LABEL"><font color="red">*</font>Item/Drug Name</td>
	...
	<br>
	<div align="center" id=" ">					 
					 	<a href="#" class="button" id="submitId" onclick='return modify();'><span class="save">Save</span></a>
