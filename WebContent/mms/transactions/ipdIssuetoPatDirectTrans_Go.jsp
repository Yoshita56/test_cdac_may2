...
<!-- EXT JS -->
<script language="Javascript" src="../js/ipdIssuetoPatDirect.js"></script>
...
<html:form name="ipdIssuetoPatDirectBean" action="/transactions/IPDIssuetoPatDirectTransCNT" type="mms.transactions.controller.fb.IPDIssuetoPatDirectTransFB">
	...
	<div class="legend2" id='nonPrintableLegend2'>
  	...
  	<div class="container-fluid">		
		<div class="viewport" id="nonPrintable">
			<div class="alert alert-danger  alert-dismissible fade show" id="errID" style="display: none;"><bean:write name="ipdIssuetoPatDirectBean" property="strErrMsg" /></div>
			<div class="alert alert-warning  alert-dismissible fade show" id="wrnID" style="display: none;"><bean:write name="ipdIssuetoPatDirectBean" property="strWarningMsg" /></div>
			<div class="alert alert-success  alert-dismissible fade show" id="normalMsg" style="display: none;"><bean:write name="ipdIssuetoPatDirectBean" property="strNormalMsg" /></div>			
		</div>
				
		<pDtl:patDtlNew crNo="${ipdIssuetoPatDirectBean.crNo}" address="false"></pDtl:patDtlNew>
				
		<div id="strAdmDtl">
			<bean:write name="ipdIssuetoPatDirectBean" property="strAdmDtl" filter="false" />
		</div>
		...
		<div class="prescriptionTile">
			...
			<div class="row rowFlex reFlex">
				...
				<div class="col-sm-6"  style="display: none;">						
					<select name="strStoreId" onchange="   " class="browser-default custom-select">
						<bean:write name="ipdIssuetoPatDirectBean" property="strStoreValues" filter="false" />
					</select>
				</div>
			</div>
			...
			<div class="collapse" id="TreatmentId">
				<div class="row newrow2"></div>
					<bean:write name="ipdIssuetoPatDirectBean" property="strPatientTreatmentDtl"	filter="false" />
				<div class="row newrow2"></div>			
				<br>
			</div>
			...
			<div class="row rowFlex reFlex" style="display:none;">
				...
				<div class="col-sm-2">									
					<select id='dep' name="strDeptCode" onchange="getUnitCombo();" class="browser-default custom-select">
						<bean:write name="ipdIssuetoPatDirectBean" property="strDeptValues" filter="false" />
					</select>
				</div>
				<div class="col-sm-2">
				...
				<div class="col-sm-2" id="unitDivId">										
					<select	id='unit' name="strUnitCode" onchange="getEpisodeList(document.getElementById('dep'))" class="browser-default custom-select" >
						...
						<bean:write name="ipdIssuetoPatDirectBean" property="strUnitValues" filter="false" />
					</select>
				</div>				
			...
			<div class="row rowFlex reFlex">			
				...
				<div class="col-sm-2">
				<%-- <date:date name="strPrescriptionDate" value="${ipdIssuetoPatDirectBean.strCtDate}"></date:date> --%>

					<input  style='font-size: 14px; font-weight: 400; color: #495057;' class="form-control datepicker1" value="${ipdIssuetoPatDirectBean.strCtDate}" name="strPrescriptionDate">	
				</div>
			</div>
			...
			<div id='strPresData'>
				<bean:write name="ipdIssuetoPatDirectBean" property="strOnlineTreatment"	filter="false" />
			</div>		
			...
			<div><input class='form-control' type="text" id="strSearchDrug" name="strSearchDrug" style="border:1px solid;" placeholder="Enter first 3 characters of Drug Name to Search" size="120%"/></div>
				...
				<div style='display: none;'>							
					<select name="strMultiRowItemId"     id="strMultiRowItemId" class="form-control form-control-sm" >										       
					     <bean:write name="ipdIssuetoPatDirectBean" property="strItemNameValues" filter="false" />
					</select> 
				</div>
			...
			<div class="row rowFlex reFlex" style='margin: 5px;'>			
				<logic:equal value="1"  name="ipdIssuetoPatDirectBean" property="strPatStatus">			
					<div class="col-sm-2">
						<label>Payment Mode </label>
					</div>
					<div class="col-sm-2">
						<select	id='strPayMode' name="strPayMode"  class="browser-default custom-select" >
							<bean:write name="ipdIssuetoPatDirectBean" property="strPayModeValues" filter="false" />
						</select>
					</div>
					<div class="col-sm-2">
				...
				<logic:equal value="2"  name="ipdIssuetoPatDirectBean" property="strPatStatus">
	...
	<logic:equal value="0" name="ipdIssuetoPatDirectBean" property="strMode">
	...
	<logic:equal value="1" name="ipdIssuetoPatDirectBean" property="strMode">
		<table class="TABLEWIDTH" align="center" border="0" cellspacing="1px">
			<tr class="HEADER">
	...
	<logic:equal value="2" name="ipdIssuetoPatDirectBean" property="strMode">
		<table class="TABLEWIDTH" align="center" border="0" cellspacing="1px">
			<tr class="HEADER">
		...
		<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
			...
			<tr>
				...
				<td width="25%" colspan="1" class="CONTROL"><bean:write
					name="ipdIssuetoPatDirectBean" property="strLFAccountOpenDate" filter="false" /></td>
		
				<td width="25%" colspan="1" class="LABEL">Current Balance</td>
				<td width="25%" colspan="1" class="CONTROL"><bean:write
					name="ipdIssuetoPatDirectBean" property="strLFBalanceAmount" filter="false" /></td>
			</tr>
			<tr>
		
				<td width="25%" colspan="1" class="LABEL">LF Account Status</td>
				<td width="25%" colspan="3" class="CONTROL"><bean:write
					name="ipdIssuetoPatDirectBean" property="strLFAccountStatus" filter="false" /></td>
			</tr>
		</table>
	</div>
	...
	<div style="display: none;">
		<div id="patientDetailsDivId" style="display: none;">
			<table class="TABLEWIDTH" align="center" cellspacing="1px">
				<tr>
					<bean:write name="ipdIssuetoPatDirectBean" property="strPatientDetails" filter="false" />
				</tr>
			</table>
			...
			<div id="patientDiagDetailsDivId" style="display: block;">
				<table class="TABLEWIDTH" align="center" cellspacing="1px">
					<tr>
						<bean:write name="ipdIssuetoPatDirectBean" property="strPatientDiagDetails" filter="false" />
					</tr>
				</table>
			</div>
		</div>
	...
	<input type="hidden" name="storeName" 				value="${ipdIssuetoPatDirectBean.storeName}" />
	<input type="hidden" name="strCrNo" 				value="${ipdIssuetoPatDirectBean.strCrNo}" />		
	<input type="hidden" name="crNo" 					value="${ipdIssuetoPatDirectBean.crNo}" />
	<input type="hidden" name="strId" 					value="${ipdIssuetoPatDirectBean.strId}" />	
	<input type="hidden" name="strConfCatCode"			value="${ipdIssuetoPatDirectBean.strConfCatCode}" />
	<input type="hidden" name="strIssueNo" 				value="${ipdIssuetoPatDirectBean.strIssueNo}" />
	<input type="hidden" name="strIssueDtl"				value="${ipdIssuetoPatDirectBean.strIssueDtl}" />
	<input type="hidden" name="disFlag" 				value="${ipdIssuetoPatDirectBean.disFlag}" />
	<input type="hidden" name="mode" 					value="${ipdIssuetoPatDirectBean.strMode}" />
	<input type="hidden" name="strMode" 				value="${ipdIssuetoPatDirectBean.strMode}">
	<input type="hidden" name="strIssueMode"			value="${ipdIssuetoPatDirectBean.strIssueMode}">
	<input type="hidden" name="strCtDate" 				value="${ipdIssuetoPatDirectBean.strCtDate}" />
	<input type="hidden" name="strVisitDtl" 			value="${ipdIssuetoPatDirectBean.strVisitDtl}" />
	<input type="hidden" name="strIssueNum" 			value="${ipdIssuetoPatDirectBean.strIssueNum}" />
	<input type="hidden" name="isUpdateOpdDrugReq" 		value="" />
	<input type="hidden" name="strGlobalval" 			value="" />
	<input type="hidden" name="strErrMsg" 				value="${ipdIssuetoPatDirectBean.strErrMsg}" />
	<input type="hidden" name="strBillingHiddenValue" 	value="${ipdIssuetoPatDirectBean.strBillingHiddenValue}" />
	<input type="hidden" name="strTariff_Flag" 			value="1" />
	<input type="hidden" name="strPatStatus" 			value="${ipdIssuetoPatDirectBean.strPatStatus}" />
	<input type="hidden" name="strRowCount" 			value="${ipdIssuetoPatDirectBean.strRowCount}" />
						...
						<div class="modal-body" id="modalSpaceId">
							<div  id='payDtlCDMenuInner ' style="display: block">
								...
								<div class="row rowFlex reFlex">
									...
									<div class="col-sm-6"><input type="text" class="form-control" tabindex="1" maxlength="11" placeholder="(DD-Mon-YYYY)" name="strAuthDate" value="${ipdIssuetoPatDirectBean.strCtDate }"  style="border:0.5px solid black;"/></div>
								</div>
								<div class="row rowFlex reFlex">
								...
								<div class="row rowFlex reFlex">
									...
									<div class="col-sm-6">
										<input type="text" tabindex="1" placeholder="(DD-Mon-YYYY)" class="form-control"
											...
											value="${ipdIssuetoPatDirectBean.strCtDate }" style="border:0.5px solid black;"/>
									</div>
								</div>
							</div>
						</div>
