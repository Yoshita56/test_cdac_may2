...
<html:form name="newIPDIssueToPatBean" action="/transactions/NewIPDIssueToPatTransCNT" type="mms.transactions.controller.fb.NewIPDIssueToPatTransFB">
	...
	<div class="alert alert-danger  alert-dismissible fade show" id="errID" style=""><bean:write name="newIPDIssueToPatBean" property="strErrMsg" /></div>
	...
	<div class="prescriptionTile" id="issueDtlsDivId">									 
		<div id="goBox">
			    <div class="row rowFlex reFlex">
						<div class="col-sm-12" >						       
								  <bean:write name="newIPDIssueToPatBean" property="strAfterSaveVoucher" 	filter="false" /> 	
	...
	<input type="hidden" name="strReOrderFlgColor" value="${newIPDIssueToPatBean.strReOrderFlgColor}" />
