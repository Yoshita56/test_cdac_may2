...
<div class="container-fluid">
 <div class="prescriptionTile">
  ...
  <!-- <div class="legendHeader" id="nonPrintableLegend" style="font-weight:600;font-size: 22px;">Approval Desk View</div>
   ...
   <div class='popup' id='AnnualPurchase' style="display:none">
	<table width='400' border="0" cellspacing ="0px">
	 ...
	 <table width='400' border="0" cellspacing ="1px" cellpadding="1px">
		...
		<!-- --------------------------------IndentApprovalDeskHLP.getIndentDetailsView()---------------------------- -->
		 <table class="table">   
	...
	<!-- 	<table class="TABLEWIDTH" align="center" cellspacing="1" cellpadding="1">   
		...
		<div>
			<p class="subHeaders mb-0"><i class="fas fa-th-list iround" style="font-size: 16px; color: #28a745" title=""></i>&nbsp;Drug Details</p>
		</div>
