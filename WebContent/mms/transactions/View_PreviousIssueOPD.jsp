...
<body>
<html:form action="/transactions/IssueToPatOPDTransCNT.cnt"  name="issuePatBean" type="mms.transactions.controller.fb.IssueToPatOPDTransFB" method="POST">
		...
		<div class="prescriptionTile">
			...
			<div class="container">					 
				<div class="row" style="margin:1% 12%">
					...
					<div class="col-sm-4">
							<%-- <crNo:crNo value ="${issuePatBean.strCrNo}" js=" onkeypress='return initGoFunc(event);'"></crNo:crNo> --%>
							<crNo:crNo value ="${issuePatBean.strCrNo}" js=" onkeypress='');'"></crNo:crNo>
					</div>
				</div>
