...
<br>		
						<div class="prescriptionTile">
							...
							<div class="row">
        						...
        						<div class="col-sm-2" align="right" style="color: #173479;font-weight: bold;">Store Name:
        							<label style="color: #736767;">
							...
							<div class="row">
								...
								<div class="col-sm-2">
									<input id="datepicker4" type="text" name="strPoDate">
								</div>
								<div class="col-sm-2">
								...
								<div class="col-sm-2">
									...
									<bean:write name="localPurchaseNewTransBean" property="strSupplierCombo" filter="false" /></select>
								</div>
...
<!-- 								</div> -->
<!-- 								<div class="col-sm-2"> -->
<!-- 									<input type="text" class="form-control" id="InstituteId" name="strInstituteId" autocomplete="off"> -->
<!-- 								</div> -->
							...
							<table id="POITable" class="table" style="font-size: 13px;margin-bottom: 0;">
							    ...
							    <tr id='0' style='display:none;'>
							      ...
							      <tr id='1'>
							        ...
							        <input type="hidden" name="strBrandId" value="" /></td>
...
<div class="row">
 ...
 -->      </div>
  ...
  <div id='mainDiv' style='display:none;'>
	...
	$('#datepicker4').datepicker({uiLibrary: 'bootstrap4', modal: true, header: true, footer: true ,format: 'dd-mmm-yyyy'});
