...
<html:form action="/transactions/LPIssueDeskTransBSCNT"  name="lpIssueDeskTransBean" type="mms.transactions.controller.fb.LPIssueDeskTransFB" method="post">

<fieldset>
	<legend class='legendHeader' id='nonPrintableLegend'>LP Issue/Return Transaction</legend>
	<div class="legend2" id="saveId">
	    ...
	    <button  type="button" id="savebutton" class="btn btn-outline-success mt-1 btn-circle savebtn"  tabindex='2' id="" onclick='SAVERETURN();' data-toggle="" data-target="#previewModal" >					
...
<!-- <table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
 ...
 <div class='col-sm-2' style="color: blue; font-weight: 400;" align="left">
...
<div class='row'>
<div class='col-sm-2'></div>
<div class='col-sm-2'><label>Issue No.</label></div>
<div class='col-sm-2' style='color: blue; font-weight: 400;' align="left">
...
<div class='col-sm-2'><label>Emp No.</label></div>
<div class='col-sm-2' style='color: blue; font-weight: 400;' align="left">
<bean:write property="strCrNo" name="lpIssueDeskTransBean" filter="false"/>
</div>
<div class='col-sm-2'></div>
...
<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
	...
	<div class='subHeaders'>Item Details</div>
	<br>
	<!-- <div id="strRequestItemDtlId" style="display: block"> -->
		<bean:write property="strRequestDtlNew" name="lpIssueDeskTransBean" filter="false" />
		<!-- </div> -->
		
		
		<div id='recommendationId'>
		<div class='subHeaders'>Recommendation Details</div>
		<div class='row'>
		<div class='col-sm-2'><label><font color='red'>*</font>Recommend by</label></div>
		<div class='col-sm-2'>
		<select name="strRecommendBy" class='form-control'>
		...
		<div class='col-sm-4'>
		<textarea class='form-control' name="strRemarks"></textarea>
		</div>
	...
	<div class='subHeaders'>
	<div id="plusHelpId">
	<button type="button" class="btn btn-info btn-sm" name="plusHelp"
						 style="cursor: pointer;"
						onclick="view1('plusHelpId','minusHelpId','HelpId');"><i class="fa fa-plus"></i>
						Help</button></div>
					<div id="minusHelpId" style="display: none">
					<button type="button" class="btn btn-info btn-sm" name="minusHelp"
							onclick="view2('plusHelpId','minusHelpId','HelpId');"><i class="fa fa-minus"></i>
							Help</button>
							 </div>
	</div>
	...
	<div id="HelpId" style="display:none">
			...
			<div class='row'>
			<div class='col-sm-4'>
			 <button style="background-color:#F5786B;height: 20px;width: 20px;" disabled></button>
			 <label>Drug/Item has been expired</label>
			</div>
			</div>
			<!-- </tr>
			</table> -->
