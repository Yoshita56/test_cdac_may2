...
<html:form name="itemInventoryProgramTransBean"  styleClass="formbg" action="/transactions/ItemInventoryWithProgramTransCNT"
	...
	<table width='100%' align="center" border="0" cellpadding="1px"	cellspacing="0">
		...
		<tr>
			<td colspan="4" class="LABEL" style='text-align:left;'>Store : <bean:write	name="itemInventoryProgramTransBean" property="strStoreName" filter="false" /></td>
    ...
    <table width='100%' align='center' border='0' cellpadding='1px'	cellspacing='0'>
		...
		<td colspan="2" class="LABEL" style="text-align:left;">		
		     <bean:write name="itemInventoryProgramTransBean" property="strProgrammeName" filter="false" />		     
		 </td>
		</tr> -->
		<tr class='multiCLRLabel'>
		...
		<td  width="100%" colspan="3" class="TITLE" style='text-align:left;'>Drug Name ::<div id="itemBrandDivId" style="display: none;"><select name="strMultiRowItemId" id="strMultiRowItemId" class="comboTooMax" ><bean:write name="itemInventoryProgramTransBean" property="strItemBrandCombo" filter="false" /></select> </div><input type="text" id="strSearchDrug" name="strSearchDrug" size="120%"/> </td>
		</tr>
...
<div class="control_button"><table  class="TABLEWIDTH" align="center">
	...
	<input type="hidden" name="strStoreId"	value="${itemInventoryProgramTransBean.combo[0]}" />
	<input type="hidden" name="strStoreName" value="${itemInventoryProgramTransBean.strStoreName}" />
	...
	<input type="hidden" name="strProgrammeId" id="strProgrammeId"	value="${itemInventoryProgramTransBean.combo[2]}" />
	<input type="hidden" name="strItemBrandId" id="strItemBrandId"	value="${itemInventoryProgramTransBean.strItemBrandId}" />
	<input type="hidden" name="strSelBatch" id="strSelBatch"	value="${itemInventoryProgramTransBean.strSelBatch}" />
	<input type="hidden" name="strPath" value="${itemInventoryProgramTransBean.strPath}">
