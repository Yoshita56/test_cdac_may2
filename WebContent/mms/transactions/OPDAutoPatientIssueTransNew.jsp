...
<html:form name="issuePatBean" action="/transactions/IssueTransBSCNT" type="mms.transactions.controller.fb.IssueTransFB">
	<div class="alert alert-danger  alert-dismissible fade show" id="errID" style="display: none;">
		<bean:write name="issuePatBean" property="strErrMsg" />
	</div>
	
	<div class="alert alert-warning  alert-dismissible fade show" id="wrnID" style="display: none;">
		<bean:write name="issuePatBean" property="strWarningMsg" />
	</div>
	<div class="alert alert-success  alert-dismissible fade show" id="normalMsg" style="display: none;">
		<bean:write name="issuePatBean" property="strNormalMsg" />
	</div>	
	<table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">
			...
			<span>
     		    <html:radio property="strByCurrentAndDate"    name="issuePatBean" value="1" onclick="openViewPage(1);">Current Date</html:radio>
     		    <html:radio property="strByCurrentAndDate"    name="issuePatBean" value="2" onclick="openViewPage(2);">Back Date</html:radio>
     	      </span>
     	      <div>
			</td>
		</tr>
		<tr style="display: none;">
			...
			<td  colspan="1" class="CONTROL">
				<div id="itemcatDivId">
					...
					<bean:write name="issuePatBean" property="strCatValues"
						filter="false" />
				</select>				
				</div>
			</td>			
	   ...
	   <div id="fromDate" style="display:none;"> 
			...
			<tr>
				<td class="LABEL" width="25%">Entry From Date</td>
					<td class="CONTROL" width="25%"><dateTag:date name="strFromDate" value="${issuePatBean.strCtDate}" ></dateTag:date> </td>
					<td class="LABEL" width="25%">Entry To Date</td>
					<td class="CONTROL" width="25%"><dateTag:date name="strToDate" value="${issuePatBean.strCtDate}" ></dateTag:date> </td>
		    </tr>
	...
	<input type="hidden" name="strFlagVal" value="${issuePatBean.strFlagVal}">
	<input type='hidden' name='strHlpIssueNo' value='${issuePatBean.strHlpIssueNo}'> 
	<input type='hidden' name='strHiddenIssueNo' value='${issuePatBean.strHiddenIssueNo}'>
	<input type='hidden' name='storeId' value='${issuePatBean.strStoreId}'>
	...
	<input type="hidden" name="strflg" value="${issuePatBean.strflg}" />
	<input type="hidden" name="newreqflg" value="${issuePatBean.newreqflg}" />
