...
<table class="TABLEWIDTH" bgcolor='#6097BC' cellpadding="1px" cellspacing="1px" id="td#delIndex#">
 <tr>
...
<div id="rowAdded1" style="display:none">
<table class="table" bgcolor='#6097BC' cellpadding="1px" cellspacing="1px"  id="td#delIndex#">
 <tbody>
    <td  width="45%">
		<input type="hidden" name="itemParamValue" id="itemParamValue#delIndex#">
		<input type="hidden" name="itemCalcValue" id="itemCalcValue#delIndex#">
	...
	<td  width="10%">
		...
		<input type="hidden" name="strReqQty" id="strReqQty#delIndex#" class='form-control-sm'  >
		<div id="strQuantity#delIndex#" style="display: none">0 No.</div>
		<div id="strQuantityText#delIndex#" style="display: block">
			<input type="text" name="strQtyText" id="strQtyText#delIndex#" class='form-control-sm'  onblur="QtyValidation('#delIndex#');" maxlength="5" onkeypress="return validateData(event,5);"  tabindex="1"> No.
		</div>
	
	</td>
	<td  width="10%">
		
		<input type="hidden" name="strTotalCost" id="strTotalCost#delIndex#" class='form-control-sm'  >
		<div id="strQuantityText#delIndex#" style="display: block">
			<input type="text" name="strTotalCostText" id="strTotalCostText#delIndex#" class='form-control-sm'  onkeyup="" maxlength="5"    readonly/>
		</div>
