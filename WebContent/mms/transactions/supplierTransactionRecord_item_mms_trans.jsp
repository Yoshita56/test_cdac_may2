...
<link href="../../hisglobal/bootstrap_4.4.1/css/bootstrap.min.css"
...
<script type="text/javascript"
	src="../../mms/bootstrap/js/bootstrap.min.js"></script>

<link rel="stylesheet"
	href="/INVMGM/mms/flexdatalist/jquery.flexdatalist.min.css">
<script src="/INVMGM/mms/flexdatalist/jquery.flexdatalist.min.js"></script>

<!-- EXT-JS -->
<script language="JavaScript"
	src="../js/supplierTransactionRecord_mms_trans.js"></script>
		...
		<div class="container-fluid">
			<div class="prescriptionTile">
				...
				<div class="container" style="max-width: 100%;">
					...
					<div class="row my-1">
						...
						<div class="col-auto px-2">
							<label class="text-muted"><bean:write
									name="supplierTransactionRecordBean" property="strStoreName"
									filter="false" /></label>
						</div>
						<div class="col-auto px-2">Item Category:</div>
						<div class="col-auto px-2">
							<label class="text-muted"><bean:write
									name="supplierTransactionRecordBean" property="strItemCategoryName" filter="false" /></label>
						</div>
					</div>
					<!-- TITLE STRIP END -->
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<select class="form-control browser-default custom-select"
								name="strSupplierId" id="supplierDropdown"
								onchange="">
								<bean:write name="supplierTransactionRecordBean"
						...
						<div class="col-sm-3">
							<input type="text" class="form-control"
								...
								onblur="if (this.value === '') this.value = '0';" id="strDCNoId"
								name="strDCNo" autocomplete="off">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="strLpoNoId"
								...
								onkeypress="return alphanumeric(event);" name="strLpoNo"
						...
						<div class="col-sm-3">
							<input id="datepicker1" name="strPoDate" class="form-control"
								type="text"
								value="${supplierTransactionRecordBean.strCurrentDate}">
						</div>
						...
						<div class="col-sm-3">
							<input id="datepicker2" name="strChallanDate"
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<input id="datepicker3" name="strInvoiceDate"
								class="form-control" type="text"
								value="${supplierTransactionRecordBean.strCurrentDate}">
						...
						<div class="col-sm-3">
							<input id="datepicker4" name="strExpDeliveryDate"
								class="form-control" type="text"
								value="${supplierTransactionRecordBean.strCurrentDate}">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-11">
							<select class="form-control browser-default custom-select"
								name="strInstituteId" id="InstituteId">
								<bean:write name="supplierTransactionRecordBean"
				...
				<div>
					<input type="hidden" 
						name="strStoreId"
						value="${supplierTransactionRecordBean.strStoreId}" /> <input
						type="hidden" name="hmode" value="" /> 
					
					<input type="hidden"
						name="strItemCategoryId"
...
//     <input type="text" name="strSearchDrug" class="form-control" placeholder="Enter at least 3 characters" onfocus="drugNameFun(this);" onmouseenter="drugNameFun(this);" onblur="drugNameFun(this);">
	...
	//alert("New row added & row no. is : " + (rowIndex -1)); // Updated to current the index
