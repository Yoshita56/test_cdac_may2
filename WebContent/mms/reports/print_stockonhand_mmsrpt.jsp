...
<html:form action="/reports/StockOnHandRptCNT_NEW" method="post" styleClass="formbg">
	...
	<div class="errMsg" id="errMsg"><bean:write name="stockOnHandRPT" property="strErrMsg" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="stockOnHandRPT" property="strNormalMsg" /></div>
	<div class="warningMsg" id="warningMsg"><bean:write name="stockOnHandRPT" property="strWarningMsg" /></div>
	
	<!-- CONCERN DATA FRM DB -->
	<div id="indentItemListDivId" class="prescriptionTile">
		<table width="100%" align="center" border="0" cellspacing ="1px" id='mstTable'>
			 <bean:write name="stockOnHandRPT" property="strViewItemDtls" filter="false" />				 	 
	    </table>
	</div> 
	...
	<input type="hidden" name="strTableWidth" id="strTableWidth" value="${stockOnHandRPT.strTableWidth}">
