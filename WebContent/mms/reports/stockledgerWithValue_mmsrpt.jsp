...
<!-- EXT JS -->
<script language="Javascript" src="../../mms/js/stockLedgerWithValue_mmsrpt.js"></script>
...
<html:form action="/reports/StockLedgerWithValueRptCNT" method="post" styleClass="formbg">
	
<div class="errMsg" id="errMsg"><bean:write name="stockLedgerWithValueBean" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="stockLedgerWithValueBean" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="stockLedgerWithValueBean" property="strWarningMsg"/></div>
				...
				<div class="row my-2" id="itemManageDtlId1">
					...
					<div class="col-sm-2" id="storeDivId">
						<select name="strStoreId" id="storeDivId1" class='custom-select ' onchange="getItemCatCmb();"> 
							<bean:write name="stockLedgerWithValueBean" property="strStoreValues" filter="false" />
						</select>
					...
					<div class="col-sm-2" id="catDivId">
						<select name="strItemCatId"  class="custom-select " onchange='getGroupName();'>
							<bean:write name="stockLedgerWithValueBean" property="strCatCombo"	filter="false" />
					...
					<select name="strGroupId"  id="strGroupId1" class="custom-select " onchange='getDrugName();'>
						<bean:write name="stockLedgerWithValueBean" property="strGroupCombo"	filter="false" />
						<option value="0">Select Value</option>
					</select>					
					</div>		
				...
				<div id="itemManageDtlId2" style="display: block">	
						...
						<tr>
				 			...
				 			<td class="CONTROL" colspan="1" width="25%">  			 
								<div id="LeftItemIds" align="left">
									<select id="strLeftItemIds" name="strLeftItemIds" size="10" multiple style="width: 560px" onChange='showSelection(this);' >
										<bean:write name="stockLedgerWithValueBean" property="strLeftItemList" filter="false"/>
									</select>
								</div>				
							</td>
							...
							<div id="RightItemIds" align="left" style='display:inline;'>
									<select id="strRightItemIds" name="strRightItemIds" size="10" multiple style="width: 560px">
										<bean:write name="stockLedgerWithValueBean" property="strRightItemList" filter="false"/>
									</select>
								</div>
							</td>		
						</tr>		
					...
					<div class="row my-2">
						...
						<div class="col-sm-4 p-2">
							<html:checkbox property="strWhetherBatchWise" name="stockLedgerWithValueBean" value="1" >
							</html:checkbox>
						</div>
					
						<div class="col-sm-2"><label>From Date <font color="red">*</font></label></div>
						<div class="col-sm-4">
							<input name="strFromDate" id="datepicker" class="form-control datepicker" value="01-Apr-2024"  readonly/>	
						...
						<div class="col-sm-4">
							<select name="strFTD" id="strFTDId" class='custom-select '	onchange="">
								<bean:write name="stockLedgerWithValueBean" property="strFTDValues"	filter="false" />
							</select>
						</div> --%>
					</div>
					<div class="row my-2">
						...
						<div class="col-sm-4 p-2">
							<html:checkbox property="strValueWise" name="stockLedgerWithValueBean" value="1" >
							</html:checkbox>
						</div>
			            ...
			            <div class="col-sm-4">
							<input name="strToDate" id="datepicker2" class="form-control datepicker2" value="${stockLedgerWithValueBean.strCurrentDate}" />
				        </div>
		            </div>	
					</div>
...
<input type="hidden" name="strCurrentDate" 		value="${stockLedgerWithValueBean.strCurrentDate}"/>
<input type="hidden" name="strStoreName" 		value="${stockLedgerWithValueBean.strStoreName}" />
<input type="hidden" name="strItemBrandId" 		value="0" />
<input type="hidden" name="selPageIndex" 		value="1"/>
<input type="hidden" name="strJobInitialDate" 	value="${stockLedgerWithValueBean.strJobInitialDate}"/>
			</div>
			</fieldset>
		</div>
	</div>
