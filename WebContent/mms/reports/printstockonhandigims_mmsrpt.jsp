...
<html:form action="/reports/StockOnHandIgimsRptCNT" method="post" styleClass="formbg">
	...
	<div class="errMsg" id="errMsg"><bean:write name="stockOnHandIgimsRpt" property="strErrMsg" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="stockOnHandIgimsRpt" property="strNormalMsg" /></div>
	<div class="warningMsg" id="warningMsg"><bean:write name="stockOnHandIgimsRpt" property="strWarningMsg" /></div>
	
	<!-- CONCERN DATA FRM DB -->
<!-- 	<div id="indentItemListDivId" class="prescriptionTile"> -->
	<div id="indentItemListDivId" class="">
	
		<table width="100%" align="center" border="0" cellspacing ="1px" id='mstTable'>
			 <bean:write name="stockOnHandIgimsRpt" property="strViewItemDtls" filter="false" />				 	 
	    </table>
	</div> 
	...
	<input type="hidden" name="strTableWidth" id="strTableWidth" value="${stockOnHandIgimsRpt.strTableWidth}">
