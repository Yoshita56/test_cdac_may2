...
<head>
<meta charset=UTF-8">
<title>Acknowledge Receipt PO Report</title>
...
<script language="JavaScript" src="../js/AcknowledgeReceiptPORpt.js"></script>
...
<body>
<html:form action="/reports/AcknowledgeReceiptPORptCNT.cnt"  name="AcknowledgeReceiptPORptbean" type="mms.reports.controller.fb.AcknowledgeReceiptPORptFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="AcknowledgeReceiptPORptbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="AcknowledgeReceiptPORptbean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="AcknowledgeReceiptPORptbean" property="strNormalMsg" /></div>
<br>
<br>    
    <div class="container">
    	<div class="row">
    		<div class="prescriptionTile col-sm-12" align="center">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select">
							<bean:write name="AcknowledgeReceiptPORptbean" property="strItemCategoryCombo" filter="false"/>
						</select>
					</div>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<select name="strSupplierId" id="SupplierDivId" class="browser-default custom-select">
							<bean:write name="AcknowledgeReceiptPORptbean" property="strSupplierCombo" filter="false" />
						</select>
					</div>
    		  </div>
    		  ...
    		  <div class="row">
					...
					<div class="col-sm-3">
						<select class="browser-default custom-select" name="strInstituteId" id="InstituteId" >
							<bean:write name="AcknowledgeReceiptPORptbean" property="strInstituteValues" filter="false"/>
						</select>
					</div>
    		  </div>
    		  <div class="row">	
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<input name="strFromDate" class="form-control datepicker" value="${AcknowledgeReceiptPORptbean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" class="form-control datepicker" value="${AcknowledgeReceiptPORptbean.strCurrentDate}" />
					</div>
    		  </div> 	
		<hr id='hr4' style="display: none;"><hr>
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for Acknowledge Receipt PO Report</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${AcknowledgeReceiptPORptbean.strCurrentDate}" />
		</div>
	</div>
</div>
