...
<html:form action="/reports/IssueReceiveLedgerRptCNT" method="post" styleClass="formbg">
	...
	<div id="indentItemListDivId" class="prescriptionTile">
		<table width="100%" align="center" border="0" cellspacing ="1px" id='mstTable'>
			 <bean:write name="issueReceiveLedgerRptBean" property="strViewItemDtls" filter="false" />				 	 
	    </table>
	</div> 
	...
	<input type="hidden" name="strTableWidth" id="strTableWidth" value="${issueReceiveLedgerRptBean.strTableWidth}">
