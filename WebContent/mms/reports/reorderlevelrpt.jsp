...
<title>Order Projection Report</title>
...
var len = parseInt(document.forms[0].strRightItemIds.length);
	...
	var hisValidator = new HISValidator("reorderLevelBean");
...
function getItemCatCmb(){ 
		if(document.forms[0].strStoreId.value!=0)
		{
			...
			var url ="ReorderLevelBhuvRptCNT.cnt?hmode=ITEMCATCMB&storeId="+document.forms[0].strStoreId.value;
	 		ajaxFunction(url,"1");
...
function getGroupCmb(){ 
	...
	{
		var url ="ReorderLevelBhuvRptCNT.cnt?hmode=GROUPCMB&itemcat="+document.forms[0].strItemCatNo.value;
 		ajaxFunction(url,"6");
 	}
 	else
 	{
...
function getDrugName1()
{
		...
		/* var url ="StockOnHandRptCNT_NEW_NEW.cnt?hmode=DRUGNAME&storeId="+document.forms[0].strStoreId.value+ */
				...
				var url ="ReorderLevelBhuvRptCNT.cnt?hmode=DRUGNAME&storeId="+document.forms[0].strStoreId.value+
		         "&itemcat=0"+
...
function getDrugName3()
{
	    ...
	    var url ="ReorderLevelBhuvRptCNT.cnt?hmode=DRUGNAME1&storeId="+document.forms[0].strStoreId.value+
		         "&itemcat="+document.forms[0].strItemCatNo.value+
		         "&groupId="+document.forms[0].strGroupId.value+
		         "&itemType="+document.forms[0].strItemType.value+
	   			 "&statusId="+document.forms[0].strStatusId.value+
...
function getStoreTypeCmb(){
		...
		//alert("in");
    	var url ="ReorderLevelBhuvRptCNT.cnt?hmode=STORETYPECMB&strDistrictStoreId="+strDistrictStoreId;
    	ajaxFunction(url,"4");
...
var url ="ReorderLevelBhuvRptCNT.cnt?hmode=SUBSTORECOMBO&strDistrictId="+strDistrictId+
...
<html:form action="/reports/ReorderLevelBhuvRptCNT" method="post" styleClass="formbg">
		
		<div class="errMsg" id="errMsg" style="font-size:18px;"><bean:write name="reorderLevelBean" property="strErrMsg" /></div>
		<div class="normalMsg" id="normalMsg" style="font-size:18px;"><bean:write name="reorderLevelBean" property="strNormalMsg" /></div>
		<div class="warningMsg" id="warningMsg" style="font-size:18px;"><bean:write name="reorderLevelBean" property="strWarningMsg" /></div>
	<br>
						...
						<div class="col-sm-3">
							<div id="strSubStoreDivId">
								<select name="strStoreId" class="custom-select"
									...
									<bean:write name="reorderLevelBean" property="strStoreValues" filter="false" />
								</select>
							</div>
						</div>
						<div class="col-sm-3" >
						...
						<div class="col-sm-3" align="left" >
							<div id="itemCatDivId">
								<select name="strItemCatNo" class="custom-select"
									...
									<bean:write name="reorderLevelBean" property="strItemCatgCombo"  filter="false" /> 
									<!--  
						...
						<div class="col-sm-3">
							<div id="groupDivId">
								<select name="strGroupId" class="custom-select" onchange=' '>
									<bean:write name="reorderLevelBean" property="strGroupCombo" filter="false" />
						...
						<div class="col-sm-3" align="left" >
							<div id="itemDivId">
								<select name="strItemType" class="custom-select" onchange=" ">
									<bean:write name="reorderLevelBean" property="strItemTypeValues" filter="false" />
									<option value="0">All</option>
								</select>
						...
						<div class="col-sm-3">
							<div id="drugNameDivId" style="display: none;">
								<select id="strDrugName" name="strDrugName" class="browser-default custom-select">
									<bean:write name="reorderLevelBean" property="strDrugCombo" filter="false" />
								</select>
							</div>
						...
						<div class="col-sm-3">
							<div id="StatusDivId">
								<select name="strFYId" class="browser-default custom-select"  onchange="">
									<bean:write name="reorderLevelBean" property="strFYCombo" filter="false" />
								</select>
							</div>
						</div>
						...
						<div class="col-sm-5">
							<div id="LeftItemIds" align="right">
								<select id="strLeftItemIds" name="strLeftItemIds"
									...
									<bean:write name="reorderLevelBean" property="strLeftItemList" filter="false" />
								</select>
							</div>
						</div>
						...
						<div class="col-sm-5">
							<div id="RightItemIds" align="left">
								<select name="strRightItemIds" size="6" multiple=""
									...
									<bean:write name="reorderLevelBean" property="strRightItemList" filter="false" />
								</select>
							</div>
						</div>
					</div>
					...
					<div id="dateDivId" style="display: none;">
						<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
							<tr>
								...
								<td class="CONTROL" width="50%" colspan="2"><dateTag:date name="strDate" value="${reorderLevelBean.strCurrentDate}" /></td>
							</tr>
						</table>
					</div>
					...
					<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px"  style="display: none;">
						<tr>
							...
							<td width="50%" colspan="1" class="CONTROL">
								<html:checkbox property="strIsFooter" name="reorderLevelBean" value="1"></html:checkbox>
							</td>
						</tr>
					</table>
<hr>
					...
					<input type="hidden" name="strCurrentDate" value="${reorderLevelBean.strCurrentDate}" />
					<input type="hidden" name="strCurrentStock" value="${reorderLevelBean.strCurrentStock}" />
					<input type="hidden" name="strSeatId" value="${reorderLevelBean.strSeatId}" />
					...
					<input type="hidden" name="strIsDdwFlag" value="${reorderLevelBean.strIsDdwFlag}" />
					<input type="hidden" name="strItemBrandId" value="${reorderLevelBean.strItemBrandId}" />
					</div>
				</div>
</html:form>
