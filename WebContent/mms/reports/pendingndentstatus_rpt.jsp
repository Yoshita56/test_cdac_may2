...
function getConsolidate() {
    ...
    // Update the value of the checkbox based on its state
    if (checkoutConsolidated.checked) {
        checkoutConsolidated.value = "1"; // Checked state
        document.forms[0].strStoreId.value = "0";
        document.forms[0].strStoreId.disabled = true;
        getItemCatCmb();
    } else {
        checkoutConsolidated.value = "0"; // Unchecked state
        document.forms[0].strStoreId.disabled = false;
        document.forms[0].strStoreId.value = "-1";
    }
}
...
<div class="container-fluid">
	...
	<div class="container">
		<div class="row" style="margin: 1% 10%;">
			<div class="col">
			Consolidated &nbsp;<input type="Checkbox" name="strIsConsolidated" value="0" tabindex="1" id="StrIsConsolidated" onChange="getConsolidate();">
