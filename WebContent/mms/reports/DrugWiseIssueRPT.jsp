...
<!-- EXT JS -->
<script language="JavaScript" src="../js/DrugWiseIssueRPT.js"></script>
...
<body>
<html:form action="/reports/DrugWiseIssueRPTCNT.cnt"  name="DrugWiseIssueRPTbean" type="mms.reports.controller.fb.DrugWiseIssueRPTFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="DrugWiseIssueRPTbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="DrugWiseIssueRPTbean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="DrugWiseIssueRPTbean" property="strNormalMsg" /></div>
<br>
<br>    
			  ...
			  <div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="DrugWiseIssueRPTbean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>				
	   				<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
							<bean:write name="DrugWiseIssueRPTbean" property="strItemCategoryCombo" filter="false"/>
						</select>
					</div>
<!-- 					<div class="col-sm-3"> -->
...
<!-- 					</div> -->
    		  ...
    		  <div class="row ">
					...
					<div class="col-sm-3">
						<input name="strFromDate" id="strFromDate" class="form-control datepicker" value="${DrugWiseIssueRPTbean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" id="strToDate" class="form-control datepicker" value="${DrugWiseIssueRPTbean.strCurrentDate}" />
					</div>
    		  </div> 
    		  </div>	
		<hr id='hr4' style="display: none;"><hr>
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for Drug Wise Issue.</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${DrugWiseIssueRPTbean.strCurrentDate}" />
