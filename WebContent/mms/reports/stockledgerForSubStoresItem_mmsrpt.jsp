...
<script language="Javascript" src="../../mms/js/stockledgerForSubStoresItem_mmsrpt.js"></script>

</head>
<body onload="onLoadPage();hideMenuFrame();" class="background">
<html:form action="/reports/StockLedgerForSubStoresRptItemCNT" method="post" styleClass="formbg">
	
<div class="errMsg" id="errMsg"><bean:write name="stockLedgerForSubStoresRptItem" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="stockLedgerForSubStoresRptItem" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="stockLedgerForSubStoresRptItem" property="strWarningMsg"/></div>
	...
	<tr class="HEADER">
			...
			<img src="../../hisglobal/images/plus.gif" onClick="view1('itemManagePlusId','itemManageMinusId','itemManageDtlId1','itemManageDtlId2');"
				style="cursor: pointer; " />Stock Ledger Items 
			...
			<img src="../../hisglobal/images/minus.gif" onClick="view2('itemManagePlusId','itemManageMinusId','itemManageDtlId1','itemManageDtlId2');"
				style="cursor: pointer; " />Stock Ledger Items</div>
			</td>
		</tr>
	</table> -->
	...
	<tr class="HEADER">
			<td colspan="4" class='all-four-rounded-corners'>
			<div id="itemManagePlusId" align="left" style="display: none;">	Stock Ledger Items 
				<div id="storeDtlsDivId"></div>
			</div>
			<div id="itemManageMinusId" style="display: block;" align="left"> Stock Ledger Items</div>
			</td>
		</tr>
	</table> 
		...
		<tr>
			...
			<div id="storeDivId" style="display: block;">
				<select name="strStoreId" class="comboNormal" onchange="getItemCatCmb();">
					<bean:write name="stockLedgerForSubStoresRptItem" property="strStoreValues" filter="false" />
				</select>
			</div>	
			<div id="storeNameDivId" style="display: none;"></div>
			</td>
		</tr>
		<tr>	<td width="25%" colspan="1" class="LABEL">Category</td>
			<td width="75%" colspan="3" class="CONTROL">
				<div id="catDivId">
					<select name="strItemCatId"  class="comboNormal" onchange='getGroupName();'>
						<bean:write name="stockLedgerForSubStoresRptItem" property="strCatCombo"	filter="false" />
					</select>					
				</div>
			...
			<td width="75%" colspan="3" class="CONTROL">
				<div id="groupDivId">
					<select name="strGroupId"  class="comboNormal" onchange='getDrugName();'>
						<bean:write name="stockLedgerForSubStoresRptItem" property="strGroupCombo"	filter="false" />
					</select>					
				</div>
		...
		<!-- <tr>
			...
			<td colspan="3" width="75%" class="CONTROL">
				<select name="strItemType" class="comboNormal" onchange="getDrugName();">
						<bean:write name="stockLedgerForSubStoresRptItem" property="strItemTypeValues" filter="false" />
				</select>
			...
			<td colspan="3" width="25%" class="CONTROL">
				<div id="itemDivId" style="display: none;">
					<select	id="strItemId" name="strItemId" class="comboNormal" >
						<bean:write name="stockLedgerForSubStoresRptItem" property="strItemValues" filter="false" />
					</select>
				</div>
	...
	<div id="itemManageDtlId2" style="display: block">	
		...
		<td class="LABEL" width="25%" colspan="1">Section Name</td>
			...
			<select	name="strSectionId" style= "width:15%;" onchange="getDrugName();">
					<bean:write name="stockLedgerForSubStoresRptItem" property="strSectionName" filter="false" />
			</select>
		  </td></tr>	
		 --><tr>
		<td class="LABEL" width="25%" colspan="1"></td>
  			<td class="CONTROL" colspan="1" width="25%">  			 
				<div id="LeftItemIds" align="left">
					<select id="strLeftItemIds" name="strLeftItemIds" size="6" multiple style="width: 280px" onChange='showSelection(this);' >
						<bean:write name="stockLedgerForSubStoresRptItem" property="strLeftItemList" filter="false"/>
					</select>
				</div>				
			</td>
			...
			<div id="RightItemIds" align="left" style='display:inline;'>
					<select id="strRightItemIds" name="strRightItemIds" size="6" multiple style="width: 280px">
						<bean:write name="stockLedgerForSubStoresRptItem" property="strRightItemList" filter="false"/>
					</select>
				</div>
			</td>		
		</tr>		
	...
	<tr>	<td class="LABEL" width="25%"></td>
		...
		<tr>
			...
			<td colspan="2" width="50%" class="CONTROL">
				<html:checkbox property="strWhetherBatchWise" name="stockLedgerForSubStoresRptItem" value="1" >
				</html:checkbox>
			</td>
		...
		<tr>
			...
			<td class="CONTROL" colspan="1" width="25%" >
				<dateTag:date name="strFromDate" value="${stockLedgerForSubStoresRptItem.strCurrentDate}" />
			</td>

			<td class="LABEL" colspan="1" width="25%" ><font color="red">*</font>To Date(Entry)</td>
			<td class="CONTROL" colspan="1" width="25%" >
				<dateTag:date name="strToDate" value="${stockLedgerForSubStoresRptItem.strCurrentDate}" />
			</td>
		</tr>		
...
<input type="hidden" name="strCurrentDate" value="${stockLedgerForSubStoresRptItem.strCurrentDate}"/>
<input type="hidden" name="strStoreName" value="${stockLedgerForSubStoresRptItem.strStoreName}" />
