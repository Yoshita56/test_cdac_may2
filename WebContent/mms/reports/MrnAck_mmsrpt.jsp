...
<head>
<meta charset=UTF-8">
<title>Supplier Material Receipt Report</title>
...
<script language="JavaScript" src="../js/MRNAckReport.js"></script>
...
<!-- RJ47 -->
<body>
<html:form action="/reports/MRNAckReportCNT.cnt"  name="mrnAckReportBean" type="mms.reports.controller.fb.MRNAckReportFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="mrnAckReportBean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="mrnAckReportBean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="mrnAckReportBean" property="strNormalMsg" /></div>
<br>
<br>    
    <div class="container">
    	<div class="row">
    		<div class="prescriptionTile col-sm-12" align="center">
    			<div class="row rowFlex reFlex">
					<div class="col-sm-6" style="text-align: initial;">
						<p class="subHeaders">
							...
							&nbsp; Supplier Material Receipt Report
						</p>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="mrnAckReportBean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>
    		  ...
    		  <div class="row">
				...
				<div class="col-sm-3">
					<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
						 <bean:write name="mrnAckReportBean" property="strItemCategoryCombo" filter="false"/> 
    		  ...
    		  <div class="row">
				...
				<div class="col-sm-3">
					<select name="strSupplierId" id="SupplierDivId" class="browser-default custom-select">
						<bean:write name="mrnAckReportBean" property="strSupplierCombo" filter="false" />
					</select>
				</div>
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<select class="browser-default custom-select" name="strInstituteId" id="InstituteId" >
							<bean:write name="mrnAckReportBean" property="strInstituteValues" filter="false"/>
						</select>
					</div>
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<input name="strFromDate" class="form-control datepicker" value="${mrnAckReportBean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" class="form-control datepicker" value="${mrnAckReportBean.strCurrentDate}" />
					</div>
    		  </div> 
    		  	
		<hr id='hr4' style="display: none;"><hr>
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for Supplier Material Receipt Report</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${mrnAckReportBean.strCurrentDate}" />
		</div>
	</div>
</div>
