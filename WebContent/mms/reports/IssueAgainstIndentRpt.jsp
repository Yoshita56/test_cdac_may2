...
<head>
<meta charset=UTF-8">
<title>Issue Against Indent Report</title>
...
<script language="JavaScript" src="../js/IssueAgainstIndentRpt.js"></script>
...
<body>
<html:form action="/reports/IssueAgainstIndentRptCNT.cnt"  name="IssueAgainstIndentRptbean" type="mms.reports.controller.fb.IssueAgainstIndentRptFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="IssueAgainstIndentRptbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="IssueAgainstIndentRptbean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="IssueAgainstIndentRptbean" property="strNormalMsg" /></div>
<br>
<br>    
    <div class="container">
    	<div class="row">
    		<div class="prescriptionTile col-sm-12" align="center">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="IssueAgainstIndentRptbean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>
				...
				<div class="col-sm-3">
					<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
						<bean:write name="IssueAgainstIndentRptbean" property="strItemCategoryCombo" filter="false"/>
					</select>
				</div>
    		  </div>
...
<%-- 							<bean:write name="IssueAgainstIndentRptbean" property="strInstituteValues" filter="false"/> --%>
<!-- 						</select> -->
<!-- 					</div> -->
<!--     		  </div> -->
<!--     		  <div class="row"> -->
...
<%-- 							<bean:write name="IssueAgainstIndentRptbean" property="strSupplierCombo" filter="false" /> --%>
<!-- 						</select> -->
<!-- 					</div> -->
...
<!--     		  </div> -->
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<input name="strFromDate" class="form-control datepicker" value="${IssueAgainstIndentRptbean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" class="form-control datepicker" value="${IssueAgainstIndentRptbean.strCurrentDate}" />
					</div>
    		  </div> 	
		<hr id='hr4' style="display: none;"><hr>
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for Issue Against Indent Report</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${IssueAgainstIndentRptbean.strCurrentDate}" />
		</div>
	</div>
</div>
