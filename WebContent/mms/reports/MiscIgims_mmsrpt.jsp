...
function validate(){
	var hisValidator = new HISValidator("MiscIgimsRptBean");
	...
	if(retVal){
		...
		var hmode = "SHOWRPT"; 
		var url = "MiscellaneousIgimsRptCNT.cnt?hmode="+hmode+
...
<!-- RJ47 -->
<html:form action="/reports/MiscellaneousIgimsRptCNT" method="post">
	
<div class="errMsg" id="errMsg">		 <bean:write name="MiscIgimsRptBean" property="strErrMsg"/>     </div>
<div class="normalMsg" id="normalMsg">   <bean:write name="MiscIgimsRptBean" property="strNormalMsg"/>  </div>
<div class="warningMsg" id="warningMsg"> <bean:write name="MiscIgimsRptBean" property="strWarningMsg"/> </div>
		...
		<div class="prescriptionTile">
			<div class="row rowFlex reFlex">
				<div class="col-sm-6" style="text-align: initial;">
					<p class="subHeaders">
						...
						&nbsp; IGIMS Miscellaneous Consumption Report 
					</p>
				</div>
			...
			<div class="container">
				<div class="row mx-5">
					...
					<div class="col-sm-3">
						<div id="storeDivId">
							<select name="strStoreId" class="browser-default custom-select">
								<bean:write name="MiscIgimsRptBean" property="strStoreCmb"
									filter="false" />
							</select>
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div id="itemCatDivId">
							<select name="strItemCatId" class="browser-default custom-select">
								<bean:write name="MiscIgimsRptBean"
                ...
                <div class="row mx-5">
					...
					<div class="col-sm-3">
						<input type="text" name="strCrNo" id="strCrNo"  value="" class="form-control" maxlength="15">
					</div>
				<%-- 	<div class="col-sm-3">
						<div id="patientCrEdId">
							<crNo:crNo value ="${MiscIgimsRptBean.strCrNo}" js=" onkeypress='return initGoFunc(event);'"></crNo:crNo>
						</div>													
					</div> --%>
					<div class="col-sm-6">
					</div>
...
<%-- 			<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
				<tr style="display: none;">
					...
					<html:checkbox property="strIsFooter" name="MiscIgimsRptBean" value="1"></html:checkbox>
					</td>
				</tr>
			</table> --%>
<hr>
			...
			<input type="hidden" name="strCurrentDate" value="${MiscIgimsRptBean.strCurrentDate}"/>
			<%-- <input type="hidden" name="strCrNo" value="${MiscIgimsRptBean.strCrNo}"/> --%>
