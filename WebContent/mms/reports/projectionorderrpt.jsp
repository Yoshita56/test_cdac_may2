...
var len = parseInt(document.forms[0].strRightItemIds.length);
	...
	var hisValidator = new HISValidator("projectionorderRPT");
...
function getItemCatCmb(){ 
		if(document.forms[0].strStoreId.value!=0)
		{
			...
			var url ="ProjectionOrderRptCNT.cnt?hmode=ITEMCATCMB&storeId="+document.forms[0].strStoreId.value;
	 		ajaxFunction(url,"1");
...
function getGroupCmb(){ 
	...
	{
		var url ="ProjectionOrderRptCNT.cnt?hmode=GROUPCMB&itemcat="+document.forms[0].strItemCatNo.value;
 		ajaxFunction(url,"6");
 	}
 	else
 	{
...
function getDrugName1()
{
		...
		/* var url ="StockOnHandRptCNT_NEW_NEW.cnt?hmode=DRUGNAME&storeId="+document.forms[0].strStoreId.value+ */
				...
				var url ="ProjectionOrderRptCNT_NEW.cnt?hmode=DRUGNAME&storeId="+document.forms[0].strStoreId.value+
		         "&itemcat=0"+
...
function getDrugName()
{
		...
		var url ="ProjectionOrderRptCNT.cnt?hmode=DRUGNAME&storeId="+document.forms[0].strStoreId.value+
...
function getDrugName3()
{
	    ...
	    var url ="ProjectionOrderRptCNT.cnt?hmode=DRUGNAME1&storeId="+document.forms[0].strStoreId.value+
		         "&itemcat="+document.forms[0].strItemCatNo.value+
		         "&groupId="+document.forms[0].strGroupId.value+
		         "&itemType="+document.forms[0].strItemType.value+
	   			 "&statusId="+document.forms[0].strStatusId.value+
...
function getStoreTypeCmb(){
		...
		//alert("in");
    	var url ="ProjectionOrderRptCNT.cnt?hmode=STORETYPECMB&strDistrictStoreId="+strDistrictStoreId;
    	ajaxFunction(url,"4");
...
var url ="ProjectionOrderRptCNT.cnt?hmode=SUBSTORECOMBO&strDistrictId="+strDistrictId+
						...
						<div class="col-sm-3">
							<div id="strSubStoreDivId">
								<select name="strStoreId" class="custom-select"
									...
									<bean:write name="projectionorderRPT" property="strStoreValues" filter="false" />
								</select>
							</div>
						</div>
						<div class="col-sm-3" >
						...
						<div class="col-sm-3" align="left" >
							<div id="itemCatDivId">
								<select name="strItemCatNo" class="custom-select"
									...
									<bean:write name="projectionorderRPT" property="strItemCatgCombo"  filter="false" /> 
									<!--  
						...
						<div class="col-sm-3">
							<div id="groupDivId">
								<select name="strGroupId" class="custom-select" onchange=' '>
									<bean:write name="projectionorderRPT" property="strGroupCombo" filter="false" />
						...
						<div class="col-sm-3" align="left" >
							<div id="itemDivId">
								<select name="strItemType" class="custom-select" onchange=" ">
									<bean:write name="projectionorderRPT" property="strItemTypeValues" filter="false" />
									<option value="0">All</option>
								</select>
						...
						<div class="col-sm-3">
							<div id="drugNameDivId" style="display: none;">
								<select id="strDrugName" name="strDrugName" class="browser-default custom-select">
									<bean:write name="projectionorderRPT" property="strDrugCombo" filter="false" />
								</select>
							</div>
						...
						<div class="col-sm-3">
							<div id="StatusDivId">
								<select name="strFYId" class="browser-default custom-select"  onchange="">
									<bean:write name="projectionorderRPT" property="strFYCombo" filter="false" />
								</select>
							</div>
						</div>
						...
						<div class="col-sm-5">
							<div id="LeftItemIds" align="right">
								<select id="strLeftItemIds" name="strLeftItemIds"
									...
									<bean:write name="projectionorderRPT" property="strLeftItemList" filter="false" />
								</select>
							</div>
						</div>
						...
						<div class="col-sm-5">
							<div id="RightItemIds" align="left">
								<select name="strRightItemIds" size="6" multiple=""
									...
									<bean:write name="projectionorderRPT" property="strRightItemList" filter="false" />
								</select>
							</div>
						</div>
					</div>
					...
					<div id="dateDivId" style="display: none;">
						<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
							<tr>
								...
								<td class="CONTROL" width="50%" colspan="2"><dateTag:date name="strDate" value="${projectionorderRPT.strCurrentDate}" /></td>
							</tr>
						</table>
					</div>
					...
					<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px"  style="display: none;">
						<tr>
							...
							<td width="50%" colspan="1" class="CONTROL">
								<html:checkbox property="strIsFooter" name="projectionorderRPT" value="1"></html:checkbox>
							</td>
						</tr>
					</table>
<hr>
					...
					<input type="hidden" name="strCurrentDate" value="${projectionorderRPT.strCurrentDate}" />
					<input type="hidden" name="strCurrentStock" value="${projectionorderRPT.strCurrentStock}" />
					<input type="hidden" name="strSeatId" value="${projectionorderRPT.strSeatId}" />
					...
					<input type="hidden" name="strIsDdwFlag" value="${projectionorderRPT.strIsDdwFlag}" />
					<input type="hidden" name="strItemBrandId" value="${projectionorderRPT.strItemBrandId}" />
					</div>
				</div>
</html:form>
