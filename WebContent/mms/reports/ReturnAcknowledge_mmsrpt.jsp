...
<head>
<meta charset=UTF-8">
<title>Return Acknowledge Report</title>
...
<!-- EXT JS -->
<script type="text/javascript" src="../js/ReturnAcknowledge_mmsrpt.js"></script>
...
<body>
<html:form action="/reports/ReturnAcknowledgeRPTCNT.cnt"  name="ReturnAcknowledgeRptbean" type="mms.reports.controller.fb.ReturnAcknowledgeRPTFB" method="post">

  	<div id="errMsg" 	 class="errMsg" 		style="font-size:16px;"><bean:write name="ReturnAcknowledgeRptbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg" style="font-size:16px;"><bean:write name="ReturnAcknowledgeRptbean" property="strWarningMsg" /></div>
	<div id="normalMsg"  class="normalMsg" 	style="font-size:16px;"><bean:write name="ReturnAcknowledgeRptbean" property="strNormalMsg" /></div>
<br>
    <div class="container-fluid">
    			...
    			<div class="row ">
						...
						<div class="col-sm-6" id="viewCancelButtonDivId1">
							<div class="legend2" id='nonPrintableLegend2'>
								...
								<button type="button" id="saveid" class="float-right btn btn-outline-success mt-1 btn-circle savebtn" tabindex='2' onclick='return getReportDtls();'>
				  ...
				  <div class="container">
					  <div class="row">
							...
							<div class="col-sm-3">
								<select name="strStoreId" id="StoreId" class="browser-default custom-select">
									<bean:write name="ReturnAcknowledgeRptbean" property="strStoreNameCombo" filter="false" />
								</select>
							</div>				
			   				<div class="col-sm-3">
							...
							<div class="col-sm-3">
								<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="">
									<bean:write name="ReturnAcknowledgeRptbean" property="strItemCategoryCombo" filter="false"/>
								</select>
							</div>
		    		  </div>
		    		  ...
		    		  <div class="row ">
							...
							<div class="col-sm-3">
								<input name="strFromDate" id="strFromDate" class="form-control datepicker" value="${ReturnAcknowledgeRptbean.strCurrentDate}" />
							</div>
							...
							<div class="col-sm-3">
								<input name="strToDate" id="strToDate" class="form-control datepicker" value="${ReturnAcknowledgeRptbean.strCurrentDate}" />
							</div>
		    		  </div> 
	    		  </div>	
 		<hr>
		...
		<input type="hidden" name="strCurrentDate" value="${ReturnAcknowledgeRptbean.strCurrentDate}" />
