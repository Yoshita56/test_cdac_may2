...
<!-- EXT JS -->
<script language="JavaScript" src="../js/IndentWiseIssueRPT.js"></script>
...
<body>
<html:form action="/reports/IndentWiseIssueRPTCNT.cnt"  name="IndentWiseIssueRPTbean" type="mms.reports.controller.fb.IndentWiseIssueRPTFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="IndentWiseIssueRPTbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="IndentWiseIssueRPTbean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="IndentWiseIssueRPTbean" property="strNormalMsg" /></div>
<br>
<br>    
			  ...
			  <div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="IndentWiseIssueRPTbean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>				
	   				<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
							<bean:write name="IndentWiseIssueRPTbean" property="strItemCategoryCombo" filter="false"/>
						</select>
					</div>
<!-- 					<div class="col-sm-3"> -->
...
<!-- 					</div> -->
    		  ...
    		  <div class="row ">
					...
					<div class="col-sm-3">
						<input name="strFromDate" id="strFromDate" class="form-control datepicker" value="${IndentWiseIssueRPTbean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" id="strToDate" class="form-control datepicker" value="${IndentWiseIssueRPTbean.strCurrentDate}" />
					</div>
    		  </div> 
    		  </div>	
...
<input type="hidden" name="strCurrentDate" value="${IndentWiseIssueRPTbean.strCurrentDate}" />
