...
<head>
<meta charset=UTF-8">
<title>Breakage Item Report</title>
...
<script language="JavaScript" src="../js/BreakageItem.js"></script>
...
<body>
<html:form action="/reports/BreakageItemCNT.cnt"  name="BreakageItembean" type="mms.reports.controller.fb.BreakageItemFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="BreakageItembean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="BreakageItembean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="BreakageItembean" property="strNormalMsg" /></div>
<br>
<br>    
    <div class="container">
    	<div class="row">
    		<div class="prescriptionTile col-sm-12" align="center">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="BreakageItembean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>
				...
				<div class="col-sm-3">
					<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
						<bean:write name="BreakageItembean" property="strItemCategoryCombo" filter="false"/>
					</select>
				</div>
    		  </div>
...
<%-- 							<bean:write name="BreakageItembean" property="strInstituteValues" filter="false"/> --%>
<!-- 						</select> -->
<!-- 					</div> -->
    		  </div>
<!--     		  <div class="row"> -->
...
<%-- 							<bean:write name="BreakageItembean" property="strSupplierCombo" filter="false" /> --%>
<!-- 						</select> -->
<!-- 					</div> -->
...
<!--     		  </div> -->
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<input name="strFromDate" class="form-control datepicker" value="${BreakageItembean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" class="form-control datepicker" value="${BreakageItembean.strCurrentDate}" />
					</div>
    		  </div> 	
		<hr id='hr4' style="display: none;"><hr>
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for Breakage Item Report</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${BreakageItembean.strCurrentDate}" />
		</div>
	</div>
</div>
