...
<!-- EXT JS -->
<script language="JavaScript" src="../js/DrugStockRPT.js"></script>
...
<body>
<html:form action="/reports/DrugStockRPTCNT.cnt"  name="DrugStockRPTbean" type="mms.reports.controller.fb.DrugStockRPTFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="DrugStockRPTbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="DrugStockRPTbean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="DrugStockRPTbean" property="strNormalMsg" /></div>
<br>
<br>    
			  ...
			  <div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="DrugStockRPTbean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>				
	   				<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
							<bean:write name="DrugStockRPTbean" property="strItemCategoryCombo" filter="false"/>
						</select>
					</div>
<!-- 					<div class="col-sm-3"> -->
...
<!-- 					</div> -->
    		  ...
    		  <div class="row ">
			  		<div class="col-sm-3">
						<label><font color="red">*</font>On Date</label>
					</div>
					<div class="col-sm-3">
						<input name="strFromDate" id="strFromDate" class="form-control" value="${DrugStockRPTbean.strCurrentDate}"  readonly/>
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" id="strToDate" class="form-control datepicker" value="${DrugStockRPTbean.strCurrentDate}" />
					</div> --%>
    		  </div> 
    		  </div>	
...
<input type="hidden" name="strCurrentDate" value="${DrugStockRPTbean.strCurrentDate}" />
