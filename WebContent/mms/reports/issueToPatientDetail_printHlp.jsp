...
<script type="text/javascript">
	...
	function generateReportExcel(e) {	
	    ...
	    var itemObj = document.getElementById("printDtlsDivId");
	    
	    if (itemObj && itemObj.innerHTML.trim() !== "") {  // Check if the div has content
	        var uri = 'data:application/vnd.ms-excel;charset=utf-8,' + encodeURIComponent(itemObj.innerHTML);
	        
	        var downloadLink = document.createElement("a");
	        downloadLink.href = uri;
	        
	        var reportName = 'IssueToPatientRpt';
	        if (document.title && document.title.trim() !== "") {
	            reportName = document.title;
	        }
	        
	        downloadLink.download = reportName + ".xls"; // Set file name
	        
	        document.body.appendChild(downloadLink);
	        downloadLink.click();
	        document.body.removeChild(downloadLink);	
	    } else {
	        alert("No data to convert to Excel format!");
	    }
	}
	
/* 	function generateXLS(e,printDtlsDivId)
	{
	        let printlogoId = document.getElementById("printid1");
	        printlogoId.style.display = "none";
	     //document.forms[0].hmode.value = "getStockLedgerDtlXLS";
	    //document.forms[0].submit();
	            window.open('data:application/vnd.ms-excel,' + encodeURIComponent($("#"+printDtlsDivId+"").html()));
	            printlogoId.style.display = "flex";
	} */
...
<body>
<html:form name="issueToPatientRptBean" action="/reports/IssueToPatientDetailRptCNT"
	type="mms.reports.controller.fb.IssueToPatientDetailRptFB" enctype="">
...
<div id="saveId" style="display : block"> 
<div id="printid1" class="hidecontrol" align="right">
<img style="cursor: pointer; margin-right: 0px" title="Print Page"     src="../../hisglobal/images/printer_symbol.gif" 
onclick="printDataOne('1')"/> 
<img style='cursor: pointer;'   title='Excel Generate' src='../../hisglobal/images/excel.png' 
onClick='generateReportExcel(event);' />	
<!-- <img style='cursor: pointer;'   title='Excel Generate' src='../../hisglobal/images/excel.png' 
onClick='generateXLS(this, "printDtlsDivId");' />	 -->
...
onclick="cancelPage('CANCELTODESK')"/> 
		...
		<div id = "printDtlsDivId">
			<bean:write name="issueToPatientRptBean"	property="strPrintDtls" filter="false" />
		</div>
