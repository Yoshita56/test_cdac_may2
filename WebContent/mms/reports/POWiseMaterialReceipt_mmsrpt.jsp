...
<head>
<meta charset=UTF-8">
<title>PO Wise Material Receipt Report</title>
...
<script language="JavaScript" src="../js/POWiseMaterialReceiptRpt.js"></script>
...
<!-- RJ47 -->
<body>
<html:form action="/reports/POWiseMaterialReceiptRptCNT.cnt"  name="POWiseMaterialReceiptRptBean" type="mms.reports.controller.fb.POWiseMaterialReceiptRptFB" method="post">

  	<div id="errMsg" class="errMsg"><bean:write name="POWiseMaterialReceiptRptBean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="POWiseMaterialReceiptRptBean" property="strWarningMsg" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="POWiseMaterialReceiptRptBean" property="strNormalMsg" /></div>
<br>
<br>    
    <div class="container">
    	<div class="row">
    		<div class="prescriptionTile col-sm-12" align="center">
    			<div class="row rowFlex reFlex">
					<div class="col-sm-6" style="text-align: initial;">
						<p class="subHeaders">
							...
							&nbsp; PO Wise Material Receipt Report
						</p>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<select name="strStoreId" id="StoreId" class="browser-default custom-select">
							<bean:write name="POWiseMaterialReceiptRptBean" property="strStoreNameCombo" filter="false" />
						</select>
					</div>
					...
					<div class="col-sm-3">
						<select class="browser-default custom-select" name="strActId" id="strActId"  onChange="setCombo();">
    		  ...
    		  <div class="row">
				...
				<div class="col-sm-3">
					<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="itemNameCombo();">
						 <bean:write name="POWiseMaterialReceiptRptBean" property="strItemCategoryCombo" filter="false"/> 
    		  ...
    		  <div class="row">
				...
				<div class="col-sm-3">
					<select name="strSupplierId" id="SupplierDivId" class="browser-default custom-select">
						<bean:write name="POWiseMaterialReceiptRptBean" property="strSupplierCombo" filter="false" />
					</select>
				</div>
				...
				<div class="col-sm-3">
					<input type="text" name="strPoNo" id="strPoNo"  value="" class="form-control" maxlength="15">
				</div>
			 </div>
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<select class="browser-default custom-select" name="strInstituteId" id="InstituteId" >
							<bean:write name="POWiseMaterialReceiptRptBean" property="strInstituteValues" filter="false"/>
						</select>
					</div>
    		  ...
    		  <div class="row rowFlex reFlex">
					...
					<div class="col-sm-3">
						<input name="strFromDate" id="strFromDate" class="form-control datepicker" value="${POWiseMaterialReceiptRptBean.strCurrentDate}" />
					</div>
					...
					<div class="col-sm-3">
						<input name="strToDate" id="strToDate" class="form-control datepicker" value="${POWiseMaterialReceiptRptBean.strCurrentDate}" />
					</div>
    		  </div> 
    		  	
		<hr id='hr4' style="display: none;"><hr>
		<div class="col-sm-12" id="myDIV">
    		<label><font color="red">We keep a record here for PO Wise Material Receipt Report</font></label>
    	</div>
...
<input type="hidden" name="strCurrentDate" value="${POWiseMaterialReceiptRptBean.strCurrentDate}" />
		</div>
	</div>
</div>
