...
<body>
<html:form name="ItemMstforBMEDRptFB" action="/reports/ItemMstforBMEDRptCNT"
...
<div class="warningMsg"   id="warningMsg"><bean:write name="ItemMstforBMEDRptFB" property="strWarningMsg"/></div>
	...
	<img style="cursor: pointer; margin-right: 0px" title="Print Page"     src="../../hisglobal/images/printer_symbol.gif" onclick="printDataOne('1')"> 
	<img style="cursor: pointer; "                  title="Cancel Process" src="../../hisglobal/images/stop.png" 	       onclick="cancelPage('CANCELTODESK')"> </div> 
	</div>
	
	<div id = "printDtlsDivId"><bean:write name="ItemMstforBMEDRptFB"	property="strPrintDtls" filter="false" /></div>
