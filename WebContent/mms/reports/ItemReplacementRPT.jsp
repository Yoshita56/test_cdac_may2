...
<head>
<meta charset=UTF-8">
<title>Item Replacement Report</title>
...
<!-- EXT JS -->
<script language="JavaScript" src="../js/ItemReplacementRPT.js"></script>
...
<body>
<html:form action="/reports/ItemReplacementRPTCNT.cnt"  name="ItemReplacementRptbean" type="mms.reports.controller.fb.ItemReplacementRPTFB" method="post">

  	<div id="errMsg" 	 class="errMsg" 		style="font-size:16px;"><bean:write name="ItemReplacementRptbean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg" style="font-size:16px;"><bean:write name="ItemReplacementRptbean" property="strWarningMsg" /></div>
	<div id="normalMsg"  class="normalMsg" 	style="font-size:16px;"><bean:write name="ItemReplacementRptbean" property="strNormalMsg" /></div>
<br>
    <div class="container-fluid">
    			...
    			<div class="row ">
				  ...
				  <div class="container">
					  <div class="row">
							...
							<div class="col-sm-3">
								<select name="strStoreId" id="StoreId" class="browser-default custom-select">
									<bean:write name="ItemReplacementRptbean" property="strStoreNameCombo" filter="false" />
								</select>
							</div>				
			   				<div class="col-sm-3">
							...
							<div class="col-sm-3">
								<select name="strItemCategoryId" id="itemCategoryDivId" class="browser-default custom-select" onChange="">
									<bean:write name="ItemReplacementRptbean" property="strItemCategoryCombo" filter="false"/>
								</select>
							</div>
		    		  </div>
		    		  ...
		    		  <div class="row ">
							...
							<div class="col-sm-3">
								<input name="strFromDate" id="strFromDate" class="form-control datepicker" value="${ItemReplacementRptbean.strCurrentDate}" />
							</div>
							...
							<div class="col-sm-3">
								<input name="strToDate" id="strToDate" class="form-control datepicker" value="${ItemReplacementRptbean.strCurrentDate}" />
							</div>
		    		  </div> 
	    		  </div>	
 		<hr>
		...
		<input type="hidden" name="strCurrentDate" value="${ItemReplacementRptbean.strCurrentDate}" />
