...
<div class="col-sm-6">
<textarea class="form-control" name="strSpecification" rows="2" cols="16" style="height:38px;">
...
<!-- 
	...
	<input type="hidden" value="${drugBean.strTempCmbValue}" name="comboValue" />
	<input type="hidden" value="${drugBean.strGenericItemId}" name="strGenericItemId" />
	<input type="hidden" value="${drugBean.strDrugName}" name="strDrugName" />
	<input type="hidden" value="${drugBean.strGroupName}" name="strGroupName" />
	<input type="hidden" value="${drugBean.strGenericItemName}" name="strGenericItemName" />
