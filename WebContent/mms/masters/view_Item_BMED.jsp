...
<html:form action="/masters/ItemMstForBMEDCNT" name="ItemMstForBMEDFB"
	type="mms.masters.controller.fb.ItemMstForBMEDFB" ENCTYPE="multipart/form-data">


	<center>
	<div class="errMsg" id="errMsgId"><bean:write name="ItemMstForBMEDFB"
		property="strErrMssgstring" /></div>
	<div class="warningMsg" id="warningMsgId"><bean:write
		name="ItemMstForBMEDFB" property="strWarnMssgstring" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="ItemMstForBMEDFB"
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		<tr>
			...
			<td width="25%" class="CONTROL"><bean:write name="ItemMstForBMEDFB"
		...
		<tr>
			...
			<td class="CONTROL" width="25%" colspan="1"><bean:write
				name="ItemMstForBMEDFB" property="strItemTypeName" filter="false" /></td>
			<td class="LABEL" width="25%" colspan="1">Item Name</td>
			<td class="CONTROL" width="25%" colspan="1"><bean:write
				name="ItemMstForBMEDFB" property="strItemName" filter="false" /></td>
		</tr>
		<tr>
			<td class="LABEL">Item Class</td>
			<td class="CONTROL"><bean:write name="ItemMstForBMEDFB"
		...
		<tr>
			...
			<td class="CONTROL" width="25%" colspan="1"><bean:write
				name="ItemMstForBMEDFB" property="strDefaultRate" filter="false" /></td>
			<td class="LABEL" width="25%" colspan="1">Rate Unit</td>
			<td class="CONTROL" width="25%" colspan="1"><bean:write
				name="ItemMstForBMEDFB" property="strRateUnitName" filter="false" /></td>
		</tr>
		
		<tr>
			<td class="LABEL" width="25%" colspan="1">Item Code</td>
			<td class="CONTROL" width="25%" colspan="3"><bean:write
				name="ItemMstForBMEDFB" property="strCPACode" filter="false" /></td>
		...
		<tr>
			...
			<td class="CONTROL" width="25%"><bean:write name="ItemMstForBMEDFB"
		...
		<tr>
			...
			<td class="CONTROL" colspan="2"><bean:write name="ItemMstForBMEDFB"
		...
		<tr>
			...
			<td colspan="2" class="CONTROL"><bean:write name="ItemMstForBMEDFB"
				property="strIsValid" filter="false" /></td>
		</tr>
	...
	<input type="hidden" value="${ItemMstForBMEDFB.strChk}" name="strChk" />
	<input type="hidden" value="${ItemMstForBMEDFB.strItemCatName}"
		name="ItemCatName" />
	<input type="hidden" value="${ItemMstForBMEDFB.strGroupName}" name="GroupName" />
	<input type="hidden" value="${ItemMstForBMEDFB.strGenItemName}"
		name="GenItemName" />
