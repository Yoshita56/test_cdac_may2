...
{	
	 ...
	 url="ShortenURLMstBean.cnt?hmode="+mode+"&StoreId="+document.forms[0].strFromStoreId.value+"&ItemCatId="+document.forms[0].strItemCatgory.value+"&RequestTypeId="+document.forms[0].strRequestTypeId.value+"&Flag="+flg;       
	 //alert(url);
	 ajaxFunction(url,"1");
}
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		...
		<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
			...
			<div id="LeftStores" align="right">
				...
				<bean:write name="ShortenURLMstBean" property="strLeftStoreNamesList" filter="false"/>
				</select>
			</div>
			</td>
			...
			multiple style="width: 280px"><bean:write name="ShortenURLMstBean" property="strRightStoreNamesList" filter="false"/>
			</select></div>
			</td>		
			</tr> 
		</table>
		...
		<tr>
			...
			<td class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${ShortenURLMstBean.strCtDate}"></dateTag:date></td>
		</tr>
...
<input type="hidden" name="comboValue" value="${ShortenURLMstBean.strComboValue}">
<input type="hidden" name="strCheck" value="">
<input type="hidden" name="strFromStoreId" value="${ShortenURLMstBean.strFromStoreId}">
<input type="hidden" name="strRequestTypeId" value="${ShortenURLMstBean.strRequestTypeId}">
<input type="hidden" name="strItemCatId" value="${ShortenURLMstBean.strItemCatId}">
<input type="hidden" name="strItemCatgory" value="${ShortenURLMstBean.strItemCatgory}">
