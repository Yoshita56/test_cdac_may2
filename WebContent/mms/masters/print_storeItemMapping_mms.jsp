...
<html:form action="/masters/StoreItemMappingMstCNT" name="storeItemMappingBean" type="mms.masters.controller.fb.StoreItemMappingMstFB" method="post" styleClass="formbg">
	...
	<div class="errMsg" id="errMsg"><bean:write name="storeItemMappingBean" property="strErrMsg" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="storeItemMappingBean" property="strNormalMsg" /></div>
	<div class="warningMsg" id="warningMsg"><bean:write name="storeItemMappingBean" property="strWarningMsg" /></div>
	
	<!-- CONCERN DATA FRM DB -->
	<div id="indentItemListDivId" class="prescriptionTile">
		<table width="100%" align="center" border="0" cellspacing ="1px" id='mstTable'>
			 <bean:write name="storeItemMappingBean" property="strViewItemDtls" filter="false" />				 	 
	    </table>
	</div> 
	...
	<input type="hidden" name="strTableWidth" id="strTableWidth" value="${storeItemMappingBean.strTableWidth}">
