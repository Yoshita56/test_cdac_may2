...
<script type="text/javascript">
	...
	function validate() {
		...
		for (var i = 0; i < document.forms[0].strItemName.value.length; i++) {
		    ...
		    document.forms[0].strItemName.value="";
		    return false;
		        }
		    }
		for (var i = 0; i < document.forms[0].strSpecification.value.length; i++) {
		    if (iChars.indexOf(document.forms[0].strSpecification.value.charAt(i)) != -1) {
		    alert ("Specification has special character(s). \nThese are not allowed.\n");
		    document.forms[0].strSpecification.value="";
		    return false;
		        }
		    }
		...
		document.forms[0].strBatchNo.value = "1";
		var hisValidator = new HISValidator("ItemMstForBMEDFB");
	...
	function setCPACode(cmbObj)
	 {
		...
		var url="ItemMstForBMEDCNT.cnt?hmode="+mode+"&value="+str;
		ajaxFunction(url,"1");
...
<body onload="setMandatoryDivOnLoad();">
	<html:form action="/masters/ItemMstForBMEDCNT" name="ItemMstForBMEDFB" type="mms.masters.controller.fb.ItemMstForBMEDFB" enctype="multipart/form-data" >
<fieldset form="form1">
<br>
...
<i class="fa fa-save iround"  title="Save" ></i>
		...
		<center>
			<div class="errMsg" id="errMsgId">
				<bean:write name="ItemMstForBMEDFB" property="strErrMssgstring" />
			</div>
			<div class="warningMsg" id="warningMsgId">
				<bean:write name="ItemMstForBMEDFB" property="strWarnMssgstring" />
			</div>
			<div class="normalMsg" id="normalMsg">
				<bean:write name="ItemMstForBMEDFB" property="strNormMssgstring" />
			</div>
...
<div class="col-sm-3" style="font-weight: 400" align="left">
 <bean:write name="ItemMstForBMEDFB"	property="strItemCatName" filter="false" />
</div>
<div class="col-sm-2">
<label>Item Category:</label>
</div>
<div class="col-sm-5" style="font-weight: 400" align="left">
<bean:write name="ItemMstForBMEDFB"	property="strGroupName" filter="false" />
</div>
</div>
</div>
</div>
...
<html:radio name="ItemMstForBMEDFB"	property="strItemType" value="1" onclick="checkMandatoryDetails(this);">&nbsp;Branded</html:radio>&nbsp;
<html:radio name="ItemMstForBMEDFB" property="strItemType" value="2" onclick="checkMandatoryDetails(this);">&nbsp;Non-Branded</html:radio>
</div>
</div>
...
<bean:write name="ItemMstForBMEDFB" property="strGenItemValues" filter="false" />
</select>
</div>
<div class="col-sm-2">
...
<div class="col-sm-2">
<html:text style="width: 100%; padding: 0.375rem 0.75rem;border: 1px solid #ced4da;border-radius: 0.25rem;" name="ItemMstForBMEDFB" 
...
<bean:write name="ItemMstForBMEDFB" property="strItemTypeCombo"	filter="false" />
</select>
</div>
<div class="col-sm-2">
...
<bean:write name="ItemMstForBMEDFB" property="strManufacturerCombo" filter="false" />
</select>
</div>
</div>
...
<option value="${ItemMstForBMEDFB.strRateUnitId }"><bean:write name="ItemMstForBMEDFB" property="strRateUnitName"/></option>
</select>
					
					<!-- <bean:write name="ItemMstForBMEDFB"	property="strRateUnitName" filter="false" />-->
					  <input type="hidden" name="strRateUnitId" value="${ItemMstForBMEDFB.strRateUnitId }">
</div>
</div>
...
<html:checkbox property="strBatchNo" onclick="setBatchNo();" name="ItemMstForBMEDFB" ></html:checkbox>
</div>
<div class="col-sm-2">
<label>Manuf. Date</label>
</div>
<div class="col-sm-2" align="right">
<html:checkbox property="strManufDate" onclick="setManufDate();" name="ItemMstForBMEDFB"></html:checkbox>
</div>
<div class="col-sm-2">
<label>Expiry Date</label>
</div>
<div class="col-sm-2" align="right">
<html:checkbox property="strExpiryDate" onclick="setExpiryDate();" name="ItemMstForBMEDFB"></html:checkbox>
</div>
</div>
...
<bean:write name="ItemMstForBMEDFB" property="strApprovedTypeOptions" filter="false" />
</select>
</div>
<div class="col-sm-2">
...
<html:checkbox	property="strIsMisc" name="ItemMstForBMEDFB" onclick="setIsMisc();"></html:checkbox>
</div>	
<div class="col-sm-3">
...
<div class="col-sm-2">
<input class='form-control datepicker' name="strEffectiveFrom" value="${ItemMstForBMEDFB.strCurrentDate}">
</div>
</div>
<hr>
<div class="row">
...
<label>&nbsp;Mandatory Fields</label>
		...
		<%-- <table class="TABLEWIDTH" align="center" cellspacing="1px">
			<tr>
				<td colspan="2" class="LABEL"><html:radio name="ItemMstForBMEDFB"
						property="strItemType" value="1"
						onclick="checkMandatoryDetails(this);">Branded</html:radio> <html:radio
						name="ItemMstForBMEDFB" property="strItemType" value="2"
						onclick="checkMandatoryDetails(this);">Non-Branded</html:radio> <!--<html:radio name="ItemMstForBMEDFB" property="strItemType" value="3" onclick="checkMandatoryDetails(this);">Reserved</html:radio> -->
				</td>
			</tr>
	   </table> --%>
	  <%--  <table class="TABLEWIDTH" align="center" cellspacing="1px">
			<tr>
				...
				<td class="CONTROL" width="15%"><bean:write name="ItemMstForBMEDFB"	property="strItemCatName" filter="false" /></td>
			    <td class="LABEL" width="25%">Group Name</td>
				<td class="CONTROL" width="15%">
				<bean:write name="ItemMstForBMEDFB"	property="strGroupName" filter="false" /></td>
			</tr>
			...
			<tr>
				...
				<td class="CONTROL" width="15%"><select class="comboNormal"
					name="strGenItemId" id="strGenItemId"  onchange="setCPACode(this);">
						<bean:write name="ItemMstForBMEDFB" property="strGenItemValues" 
							filter="false" />
				</select></td>
				<td class="LABEL" width="25%"><font color='red'>*</font>Consumable Type</td>
				<td class="CONTROL" width="15%">	
					<html:text name="ItemMstForBMEDFB" styleId="strConsumableType" property="strConsumableType" value="" />
				</td>						
			</tr>
		</table> --%>
			...
			<tr>
				...
				<select
					name="strItemTypeId" class='comboNormal'>
						<bean:write name="ItemMstForBMEDFB" property="strItemTypeCombo"
							filter="false" />
				</select>
				</td>
			...
			<div class="col-sm-2">Serial No.</div>
				<div class="col-sm-2">	
					...
					<html:checkbox
							...
							name="ItemMstForBMEDFB"></html:checkbox></div>
					...
					<html:checkbox
							...
							name="ItemMstForBMEDFB"></html:checkbox>
							</div>
		</div></div>
 --%>
 ...
 -->
			<%-- <tr>
				...
				<td class="CONTROL" width="25%"> <select name="strApprovedType"
					class="comboNormal">
						<bean:write name="ItemMstForBMEDFB" property="strApprovedTypeOptions"
							filter="false" />
				</select></td>
		...
		<%-- <table class="TABLEWIDTH" align="center" cellspacing="1px"	cellpadding="1px">
			...
			<td class="CONTROL" colspan="1" width="25%"  >
			<html:checkbox	property="strIsMisc" name="ItemMstForBMEDFB" onclick="setIsMisc();"></html:checkbox></td>
		...
		<%-- <table class="TABLEWIDTH" align="center" cellspacing="1px">
			...
			<tr>
				...
				<td colspan="2" class="CONTROL" width="50%"><date:date
						name="strEffectiveFrom" value="${ItemMstForBMEDFB.strCurrentDate}"></date:date></td>
			</tr>
 ...
 --%>
	...
	<!-- 	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		...
		<input type="hidden" value="${ItemMstForBMEDFB.strCurrentDate}"
			name="strCurrentDate" />
		<input type="hidden" value="${ItemMstForBMEDFB.strItemCatName}"
			name="strItemCatName" />
		<input type="hidden" value="${ItemMstForBMEDFB.strGroupName}"
			name="strGroupName" />
		<input type="hidden" value="${ItemMstForBMEDFB.strItemCatNo}"
			name="strItemCatNo" />
		<input type="hidden" value="${ItemMstForBMEDFB.strGroupId}" name="strGroupId" />
		
		<input type="hidden" value="${ItemMstForBMEDFB.strIsItemCodeRequired}" name="strIsItemCodeRequired" />
		<input type="hidden" name="comboValue"
value="${ItemMstForBMEDFB.strComboValues}" />
