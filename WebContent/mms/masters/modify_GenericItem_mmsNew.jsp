...
<head>
<meta charset="utf-8">
<title>Generic Item Master Modify Page</title>
...
<script type="text/javascript">
	...
	function checkForPopup(these,catNo,itemID){
		if(document.forms[0].strCatNo.value!="0"){
			if(these.checked==false && catNo=="#"){
				if(confirm("Are You Sure to Delete Parameters Values!")){
					document.getElementById("modifyParamShow").style.display="none";
					document.getElementById("itemParameterDtlDivId").innerHTML="";
				}else
				...
				showPopup(these , '2' , document.forms[0].strCatNo.value , itemID);
			}
		}else{
...
<body onload="getDetails(),onloadCall(${genericitemBean.strParam });">
   ...
   <div class="row">
				<div class="col-sm-9" align="left">
							<p class="subHeaders" style="margin-bottom: 0;">
								<i class="fas fa-university" style="font-size: 26px;">&nbsp;</i>Generic Item Master&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp;Modify			
							</p>
				       </div>
							<div class="col-sm-3" align="right">
							<div class="legendNew" id="nonPrintableLegend2">
									<button type="button" class="float-right btn btn-outline-danger mt-1 btn-circle cancelbtn" onclick="cancel1('LIST');">
										<i class="fas fa-ban iround" title="Cancel"></i>
									</button>
									
									<button type="button" id="savebutton" class="float-right btn btn-outline-success mt-1 btn-circle" tabindex="2" onclick=' return validate();' style="background-color: #5cb85c;">
...
<bean:write name="genericitemBean" property="strGroupNameValue" filter="false"/>
	...
	<div class="col-sm-2">
	<input type="text" name="strItemName" maxlength="100" class="form-control" onkeypress="return validateDataWithSpecialChars(event,18,'%.:;+-/*,½');" value="${genericitemBean.strItemName}" />
	</div>
	<div class="col-sm-2">
	...
	<div class="col-sm-2">
	<input type="text" name="strPurchaseLeadTime" maxlength="3" class="form-control" onkeypress="return validateData(event,5);" value="${genericitemBean.strPurchaseLeadTime}" />
	...
	<div class="col-sm-2">
	<html:select property="strTimeFormat" name="genericitemBean" style="display: block;
    width: 100%;
    height: 34px;
    padding: 6px 12px;
    font-size: 14px;
	...
	<div class="col-sm-2">
	<bean:write name="genericitemBean" property="strInventoryUnitName" filter="false"/>
	</div>
	</div>
	...
	<div class="col-sm-2">
	<input type="text" name="strShelfLife" maxlength="3" class="form-control" onkeypress="return validateData(event,5);" value="${genericitemBean.strShelfLife}"/>
	...
	<div class="col-sm-2">
	<html:select property="strShelfTimeFormat" name="genericitemBean" style="display: block;
    width: 100%;
    height: 34px;
    padding: 6px 12px;
    font-size: 14px;
	...
	<div class="col-sm-2">
	<%-- <dateTag:date name="strEffectiveFrom" value="${genericitemBean.strEffectiveFrom}"></dateTag:date> --%>
	<input  type="text" class="form-control datepicker" name="strEffectiveFrom" value="${genericitemBean.strEffectiveFrom}">
	</div>
	...
	<div class="col-sm-6">
	<textarea rows="2" cols="20" name="strRemarks" class="form-control"><bean:write name="genericitemBean" property="strRemarks" filter="false"/></textarea>
	...
	<div class="col-sm-2">
	 <html:radio name="genericitemBean" property="strIsValid" value="1">Active</html:radio>
    <html:radio name="genericitemBean" property="strIsValid" value="2">Inactive</html:radio>
	</div>
	</div>
	</div>
	<hr>
   <div class="row rowFlex reFlex">
	...
	<tr class="HEADER">
		<td colspan="4" width="25%">Generic Item Master&gt;&gt; Modify</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="25%" class="CONTROL" >
				<input type="text" name="strItemName" maxlength="100" class="txtFldMax" onkeypress="return validateDataWithSpecialChars(event,18,'%.:;+-/*,½');" value="${genericitemBean.strItemName}" />
			</td>
		...
		<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
			<tr>
				...
				<td width="25%" class="CONTROL"  ><input type="text"
						...
						onkeypress="return validateData(event,9);" value="${genericitemBean.strCPACode }" /></td>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" style="display:none;">
		...
		<%--
		Generic Item Code cannot be modified. Because, if a generic item code is
		GO1, an item code of this generic item should start with GO1, followed
		by a '.'.Example: G01.D123. If we change G01 to L12 or whatever else, 
		it will not be reflected in item code. 
		 --%>
		<tr>
		...
		<!--  
		commneted after discussion with priyesh sir
		<td width="25%"   class="LABEL">Item Code</td>
			<td width="25%" class="CONTROL"  ><input type="text"
				name="strCPACode" maxlength="6" class="txtFldNormal"
				onkeypress="return validateData(event,9);" value="0" readonly="readonly" />
	   </td>
		-->
	...
	<div id='auctionParmId' style='display: none;'>
		...
		<tr>
			...
			<td width="75%" class="CONTROL">
			<input type="text" name="strDepreciationcost" onkeypress="return validateData(event,7);" maxlength="6" class="txtFldNormal" value="${genericitemBean.strDepreciationcost }">&nbsp;% 
			</td>
		</tr>
		</table>
		</div>
	<table class="TABLEWIDTH" align="center" cellspacing="1px" style="display: none;">		
				...
				<div id="itemManagePlusId" align="left" style="display:none;">
					<img src="../../hisglobal/images/plus.gif" 
									onClick="view1('itemManagePlusId','itemManageMinusId','itemManageDtlId');" style="cursor: pointer; "/>
						Item Managed By
					</div>
					<div id="itemManageMinusId" style="display:block;" align="left">
						<img src="../../hisglobal/images/minus.gif" 
								onClick="view2('itemManagePlusId','itemManageMinusId','itemManageDtlId');" style="cursor: pointer; "/>
								Item Managed By
					</div>
					</td>
				</tr>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="0px" style="display: none;">
		<tr>
			...
			<td class="CONTROL" colspan="" width="25%">
				<input type="checkbox" name="strBatchNo" value="${genericitemBean.strBatchNo}" onclick="setBatchNo();">
			</td>
			<td class="LABEL" width="25%">
				Expiry Date
			</td>
			<td class="CONTROL" width="25%">
				<input type="checkbox" name="strExpiryDate" value="${genericitemBean.strExpiryDate}" onclick="setExpiryDate();">
			</td>
		...
		<tr>
			...
			<td class="CONTROL" colspan="1" width="25%">
				<html:checkbox property="strParam" value="1" name="genericitemBean" onclick="checkForPopup(this,'#','#')"></html:checkbox>
			...
			<img src="../../hisglobal/images/modify_parameter_values.GIF" onclick="checkForPopup(this,'${genericitemBean.strCatNo}','${genericitemBean.strItemID}')" style="cursor: pointer; ">
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="0px" style="display:none;">		
				...
				<div id="purchasePlusId" align="left" style="display:none;">
					<img src="../../hisglobal/images/plus.gif" 	onClick="view1('purchasePlusId','purchaseMinusId','purchaseId');" style="cursor: pointer; "/>
						Purchase/Inventory
				</div>
				<div id="purchaseMinusId" style="display:block;" align="left">
					<img src="../../hisglobal/images/minus.gif"	onClick="view2('purchasePlusId','purchaseMinusId','purchaseId');" style="cursor: pointer; "/>
						Purchase/Inventory
				</div>
				</td>
				</tr>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="0px" style="display:none;">
		<tr>
			<td class="LABEL" colspan="1" width="25%">
				<font color="red">*</font>Purchase Lead Time
			</td>
			<td class="CONTROL" colspan="" width="25%">
				<input type="text" name="strPurchaseLeadTime" maxlength="3" class="txtFldMin" onkeypress="return validateData(event,5);" value="${genericitemBean.strPurchaseLeadTime}" />
			</td>
			<td class="LABEL" colspan="1" width="25%">Time Format</td>
			<td class="CONTROL" colspan="1" width="25%">
				<html:select property="strTimeFormat" name="genericitemBean">
					<html:option value="1"> Day</html:option>
					<html:option value="2"> Month</html:option>
				</html:select>
			</td>
		...
		<tr>
			<td class="LABEL" colspan="1" width="25%">
				<font color="red">*</font>Shelf Life
			</td>
			<td class="CONTROL" colspan="" width="25%">
				<input type="text" name="strShelfLife" maxlength="3" class="txtFldMin" onkeypress="return validateData(event,5);" value="${genericitemBean.strShelfLife}"/>
			</td>
			<td class="LABEL" colspan="1" width="25%">Time Format</td>
			<td class="CONTROL" colspan="1" width="25%">
				<html:select property="strShelfTimeFormat" name="genericitemBean">
					<html:option value="1"> Day</html:option>
					<html:option value="2"> Month</html:option>
					<html:option value="3"> Year</html:option>
				</html:select>
...
<table cellspacing="1px" class="TABLEWIDTH" align="center" style="display:none;">
	<tr>
		...
		<td class="CONTROL"  width="25%" colspan="">
				<textarea rows="2" cols="20" name="strRemarks"><bean:write name="genericitemBean" property="strRemarks" filter="false"/></textarea>
			</td>
			<td class="LABEL" width="25%"> 
...
<input type="hidden" value="${genericitemBean.strStockMaintainedCode}" name="strStockMaintainedCode"/>
