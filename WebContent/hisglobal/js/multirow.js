...
function addRows(ctlNameArray,ctlType,layerIndex,no_of_rows,mode) {
	...
	//console.log("rowIndexObj:::::::::::"+rowIndexObj.id);
	//console.log("rowIndexObj:::::::::::"+rowLengthObj);
	rowIndex = parseInt(rowIndexObj[0].value);
	rowLength = parseInt(rowLengthObj[0].value);
	ctlLength = ctlNameArray.length;
	//console.log("rowIndex:::"+rowIndex+" rowLength:::"+rowLength+" ctlLength:::"+ctlLength);
	...
	//console.log("existRowId:::"+existRowId.id);
	//console.log("addRowId:::"+addRowId.id);
	//add rows
	addRowData = addRowId.innerHTML;
	//console.log("addRowId.innerHtml:::"+ addRowId.innerHTML);
	for(i=0;i<no_of_rows;i++) {
		...
		//console.log("existRowId.innerHTML:::"+existRowId.innerHTML);
	}
...
function addRowsBS(ctlNameArray,ctlType,layerIndex,no_of_rows,mode) {
	var existRowId;
	var addRowId;
	var oldRowId;
	var rowIndexObj;
	...
	for(i=0;i<no_of_rows;i++) {
		...
		if(mode.toUpperCase() == "I") {
			existRowId.innerHTML += "<div id = 'id" + (layerIndex.toString() + "-" + tempRowIndex) + "'></div>";
		}
		else{
			g = document.createElement('div');
			g.setAttribute("id", "id"+ (layerIndex.toString() + "-" + tempRowIndex) );
			existRowId.appendChild(g);     
		}
			
		//alert(existRowId.innerHTML);
		document.getElementById("id"+(layerIndex.toString() + "-" + tempRowIndex)).innerHTML=newData;
		//console.log("existRowId.innerHTML:::"+existRowId.innerHTML);
	}
