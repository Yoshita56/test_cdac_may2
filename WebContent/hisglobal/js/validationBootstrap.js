...
var mainDivs=document.getElementById("mainDiv");
if(mainDivs!=null && mainDivs!=undefined)
	mainDivs.style.display="none";

var warnDiv=document.getElementById("warn");
if(warnDiv!=null && warnDiv!=undefined)
	warnDiv.innerHTML="";
...
{
	/*console.info(strError);
	console.info('here');
	swal(strError);
	$('#myModal').modal('hide');
	  $('.modal-backdrop').remove();*/
/*	//$("#validateModal").modal('toggle'); //see here usage
	var mainDiv=document.getElementById("mainDiv");  
	mainDiv.style.display="";
	validateModal.classList.add("modal");
	document.getElementById("warn").innerHTML=strError;*/
...
var createFHashAjaxQuery = function(str){
	...
	str=replaceAll(str,"^","___");
	str=replaceAll(str,"|","a__b__c");
	//alert(str);
	return str;
};
...
$my_jQuery(document).ready(function () {
	...
	//alert(" 1 inside fhttf creation"+document.getElementsByTagName("form").length);
...
function confirmBS(msg,obj,values)
{
	swal({
		//  title: "Are you sure?",
		  text: msg,
