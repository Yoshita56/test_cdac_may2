...
if(document.getElementById(gbldivPart) != null)
document.getElementById(gbldivPart).innerHTML = "";

 input= document.getElementById(txtId).value.toLowerCase();  //document.forms[0].realtxt.value.toLowerCase();
...
//alert(document.getElementById(gblTxtId).id);
...
if(e.keyCode == 13 || res ){
	 ...
	 if(listObj[listObj.selectedIndex].text.includes("["))
	    {
	    	listObj[listObj.selectedIndex].text=listObj[listObj.selectedIndex].text.split("[")[0];
	    }
